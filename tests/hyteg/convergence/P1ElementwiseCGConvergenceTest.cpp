...
int main( int argc, char* argv[] )
{
   ...
   hyteg::P1ElementwiseCGTest( hyteg::prependHyTeGMeshDir( "/2D/tri_1el.msh" ), 0, 1, false, false );
   hyteg::P1ElementwiseCGTest( hyteg::prependHyTeGMeshDir( "/2D/quad_4el.msh" ), 0, 1, false, false );
   ...
   hyteg::P1ElementwiseCGTest( hyteg::prependHyTeGMeshDir( "/2D/tri_1el.msh" ), 1, 1e-12, false, false );
   hyteg::P1ElementwiseCGTest( hyteg::prependHyTeGMeshDir( "/2D/quad_4el.msh" ), 1, 2.1e-04, false, false );
   ...
   hyteg::P1ElementwiseCGTest( hyteg::prependHyTeGMeshDir( "/2D/tri_1el.msh" ), 0, 1, false, true );
   hyteg::P1ElementwiseCGTest( hyteg::prependHyTeGMeshDir( "/2D/quad_4el.msh" ), 0, 1, false, true );
   ...
   hyteg::P1ElementwiseCGTest( hyteg::prependHyTeGMeshDir( "/2D/tri_1el.msh" ), 1, 1e-12, false, true );
   hyteg::P1ElementwiseCGTest( hyteg::prependHyTeGMeshDir( "/2D/quad_4el.msh" ), 1, 2.1e-04, false, true );
