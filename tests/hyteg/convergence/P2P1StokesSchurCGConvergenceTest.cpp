...
void P2P1SchurCGConvergenceTest( const uint_t& level, const MeshInfo& meshInfo )
{
   ...
   auto velocitySolver = std::make_shared< GeometricMultigridSolver< P2ConstantLaplaceOperator > >(
       storage, smoother, coarseGrid, restriction, prolongation, minLevel, level, 2, 2 );
...
int main( int argc, char* argv[] )
{
   ...
   P2P1SchurCGConvergenceTest( 3, MeshInfo::fromGmshFile( prependHyTeGMeshDir( "2D/quad_center_at_origin_4el.msh" ) ) );
