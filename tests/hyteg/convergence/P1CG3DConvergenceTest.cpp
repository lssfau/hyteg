...
int main( int argc, char* argv[] )
{
   ...
   const std::string meshFile     = prependHyTeGMeshDir( "3D/regular_octahedron_8el.msh" );
   ...
   WALBERLA_LOG_INFO( "Residual L2 on level " << lowerLevel << ": " << std::scientific << discrL2ResLowerLevel
                                              << " | Error L2: " << discrL2ErrLowerLevel );
   WALBERLA_LOG_INFO( "Residual L2 on level " << higherLevel << ": " << std::scientific << discrL2ResHigherLevel
