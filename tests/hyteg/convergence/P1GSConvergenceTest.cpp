...
{
   WALBERLA_LOG_INFO_ON_ROOT( "Mesh: " << meshFile << ", level: " << level
                                       << ", smoother: " << ( smoother == 0 ? "forward SOR" : "backward SOR" ) )
   ...
   hyteg::P1Function< real_t > residuum( "residuum", storage, level, level );
   hyteg::P1Function< real_t > rhs( "rhs", storage, level, level );
   hyteg::P1Function< real_t > p2function( "p1Function", storage, level, level );
   hyteg::P1Function< real_t > Lu( "Lu", storage, level, level );
   hyteg::P1Function< real_t > p2Exact( "p1Exact", storage, level, level );
   hyteg::P1Function< real_t > error( "error", storage, level, level );
   hyteg::P1Function< real_t > helperFun( "helperFun", storage, level, level );
...
int main( int argc, char* argv[] )
{
   ...
   test( hyteg::prependHyTeGMeshDir( "2D/quad_8el.msh" ), 4, 20, 0 );
   test( hyteg::prependHyTeGMeshDir( "2D/quad_8el.msh" ), 4, 20, 1 );
   test( hyteg::prependHyTeGMeshDir( "3D/tet_1el.msh" ), 4, 20, 0 );
   test( hyteg::prependHyTeGMeshDir( "3D/tet_1el.msh" ), 4, 20, 1 );
   test( hyteg::prependHyTeGMeshDir( "3D/regular_octahedron_8el.msh" ), 4, 20, 0 );
   test( hyteg::prependHyTeGMeshDir( "3D/regular_octahedron_8el.msh" ), 4, 20, 1 );
