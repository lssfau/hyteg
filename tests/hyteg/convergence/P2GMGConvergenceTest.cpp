...
int main( int argc, char* argv[] )
{
   ...
   const std::string meshFile                  = hyteg::prependHyTeGMeshDir( "quad_8el.msh" );
   ...
   WALBERLA_CHECK_LESS( discr_l2_res, dp ? 3.0e-16 : 8e-08 );
   WALBERLA_CHECK_LESS( discr_l2_err, dp ? 5.0e-10 : 2e-5 );
