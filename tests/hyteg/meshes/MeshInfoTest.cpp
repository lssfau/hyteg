...
{
   const std::string meshFileDir = HYTEG_MESH_DIR;

   std::vector< std::string > gmshFiles;

   std::filesystem::recursive_directory_iterator dirIterator( meshFileDir );
   std::filesystem::recursive_directory_iterator dirIteratorEnd;
