...
static void testEnumerate( bool beVerbose, std::string typeName )
{
   ...
   MeshInfo mesh = MeshInfo::fromGmshFile( prependHyTeGMeshDir( "2D/flow_around_cylinder.msh" ) );
   // MeshInfo mesh = MeshInfo::fromGmshFile( prependHyTeGMeshDir( "2D/quad_2el.msh" ) );
