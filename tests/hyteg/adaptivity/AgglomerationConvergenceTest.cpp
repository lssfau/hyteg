...
void runTests( bool usePetsc )
{
   ...
   hyteg::AgglomerationConvergenceTest( prependHyTeGMeshDir( "3D/tet_1el_variant.msh" ), 0, 3, real_c( dp ? 2e-6 : 6e-5 ), true, usePetsc );
   hyteg::AgglomerationConvergenceTest(
       prependHyTeGMeshDir( "3D/pyramid_2el_variant.msh" ), 0, 3, real_c( dp ? 2e-5 : 5e-4 ), false, usePetsc );
   hyteg::AgglomerationConvergenceTest(
   ...
   hyteg::AgglomerationConvergenceTest( prependHyTeGMeshDir( "3D/tet_1el_variant.msh" ), 1, 3, real_c( dp ? 2e-6 : 6e-5 ), true, usePetsc );
   hyteg::AgglomerationConvergenceTest(
   ...
   hyteg::AgglomerationConvergenceTest( prependHyTeGMeshDir( "3D/tet_1el_variant.msh" ), 2, 3, real_c( dp ? 2e-6 : 6e-5 ), true, usePetsc );
   hyteg::AgglomerationConvergenceTest(
