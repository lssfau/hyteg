...
int main( int argc, char* argv[] )
{
  ...
  hyteg::AgglomerationMatMulTest( "../../meshes/tri_1el.msh", 0, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/quad_4el.msh", 0, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/annulus_coarse.msh", 0, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/tet_1el.msh", 0, true );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/pyramid_2el.msh", 0, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/regular_octahedron_8el.msh", 0, true );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/cube_24el.msh", 0, true );

  hyteg::AgglomerationMatMulTest( "../../meshes/tri_1el.msh", 1, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/quad_4el.msh", 1, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/annulus_coarse.msh", 1, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/tet_1el.msh", 1, true );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/pyramid_2el.msh", 1, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/regular_octahedron_8el.msh", 1, true );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/cube_24el.msh", 1, true );

  hyteg::AgglomerationMatMulTest( "../../meshes/tri_1el.msh", 3, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/quad_4el.msh", 3, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/annulus_coarse.msh", 2, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/tet_1el.msh", 3, true );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/pyramid_2el.msh", 2, false );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/regular_octahedron_8el.msh", 2, true );
  hyteg::AgglomerationMatMulTest( "../../meshes/3D/cube_24el.msh", 2, true );
}