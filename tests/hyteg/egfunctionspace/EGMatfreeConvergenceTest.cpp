...
void MatfreeLaplaceConvTest2D( const uint_t minLevel, const uint_t maxLevel, const std::shared_ptr< PrimitiveStorage >& storage, const uint_t solver );
    void MatfreeEpsilonConvTest2D( const uint_t minLevel, const uint_t maxLevel, const std::shared_ptr< PrimitiveStorage >& storage, const uint_t solver );
...
void MatfreeLaplaceConvTest2D( const uint_t minLevel, const uint_t maxLevel, const std::shared_ptr< PrimitiveStorage >& storage, const uint_t solver )
{
   ...
   if ( true )
   {
      ...
      hyteg::dg::eg::StokesConvergenceOrderTest< hyteg::dg::eg::EGP0StokesOperatorNitscheBC >(
          ...
          std::make_shared< hyteg::dg::eg::EGP0StokesOperatorNitscheBC >(
              storage,
              minLevel,
              maxLevel),
          storage,
