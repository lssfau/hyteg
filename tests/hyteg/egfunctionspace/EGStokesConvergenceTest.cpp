    ...
    namespace dg {
        namespace eg {
                ...
                if constexpr (false) {
                    ...
                    if (false) {
                        StokesConvergenceOrderTest<EGP0StokesOperatorNitscheBC>(
                                "EGP0StokesOpNitscheBC2D_tri_1el",
                                std::make_tuple(
            ...
            void Stokes3D(const uint_t minLevel, const uint_t maxLevel) {
                                ...
                                std::make_tuple(
                                        ...
                                        [](const Point3D &xx) -> real_t {
                                            ...
                                            return -x0 * x11 * x14 * std::cos(x2) - x0 * x13 -
                                                   x10 * x16 * x17 * std::cos(x7) - x12 * x17 -
                ...
                // cube_6el, simple
                if (false) {
                    MeshInfo meshInfo = MeshInfo::meshSymmetricCuboid(Point3D({-1, -1, -1}), Point3D({1, 1, 1}), 1, 1,
                                                                      1);
