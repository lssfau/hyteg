...
int main(int argc, char *argv[]) {
   ...
   */
    ...
    if (false) {
        ...
        hyteg::dg::eg::Stokes2D(minLevel, 5);
    }
            ...
            Stokes2D(const uint_t minLevel, const uint_t maxLevel) {
                ...
                if(true) {
                    ...
                    StokesConvergenceOrderTest<EGP0StokesOperator>("EGP0StokesOp2D_quad_4el_inhom",
                       ...
                       P2P1TaylorHoodStokesOperator P2P1StokesOp(storage, minLevel, maxLevel);
                    StokesConvergenceOrderTest<P2P1TaylorHoodStokesOperator>("P2P1StokesOp2D_quad_4el_inhom",
                                                                             std::make_tuple(
                                                                                     [](const Point3D &p) -> real_t {
                                                                                         const real_t x = p[0];
                                                                                         const real_t y = p[1];
                ...
                if(false) {
                    ...
                    StokesConvergenceOrderTest<EGP0IIPGStokesOperator>("EGP0IIPGStokesOp2D_quad_4el_inhom",
                                                                   std::make_tuple(
                                                                           [](const Point3D &p) -> real_t {
                                                                               const real_t x = p[0];
                                                                               const real_t y = p[1];
                ...
                if(false) {
                    ...
                    EGP0IIPGStokesOperator EGP0StokesOp(storage, minLevel, maxLevel);
                    StokesConvergenceOrderTest<EGP0IIPGStokesOperator>("EGP0IIPGStokesOp2D_quad_16el_inhom",
                                                                       std::make_tuple(
                                                                               [](const Point3D &p) -> real_t {
                                                                                   const real_t x = p[0];
                                                                                   const real_t y = p[1];
