...
int main( int argc, char* argv[] )
{
   ...
   if ( run3DTests )
   {
      // std::string           meshFileName = prependHyTeGMeshDir( "/3D/tet_tilted_1el.msh" );
      // std::string           meshFileName = prependHyTeGMeshDir( "/3D/pyramid_2el.msh" );
      // std::string           meshFileName = prependHyTeGMeshDir( "/3D/three_tets_with_two_joint_faces.msh" );
      // std::string           meshFileName = prependHyTeGMeshDir( "/3D/pyramid_4el.msh" );
      std::string meshFileName = prependHyTeGMeshDir( "/3D/regular_octahedron_8el.msh" );
      // std::string           meshFileName = prependHyTeGMeshDir( "/3D/cube_4120el.msh" )x;
      MeshInfo              meshInfo = MeshInfo::fromGmshFile( meshFileName );
