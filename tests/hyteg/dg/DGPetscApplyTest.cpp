...
int main( int argc, char* argv[] )
{
   ...
   hyteg::dgPetscApplyTest( 3, hyteg::MeshInfo::fromGmshFile( hyteg::prependHyTeGMeshDir( "quad_4el.msh" ) ), 6.0e-15 );
   hyteg::dgPetscApplyTest( 3, hyteg::MeshInfo::fromGmshFile( hyteg::prependHyTeGMeshDir( "annulus_coarse.msh" ) ), 8.0e-14 );
