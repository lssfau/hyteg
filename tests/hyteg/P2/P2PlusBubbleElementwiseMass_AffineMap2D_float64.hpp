...
class P2PlusBubbleElementwiseMass_AffineMap2D_float64
...
protected:
private:
  /// Integral: P2PlusBubbleElementwiseMass_AffineMap2D_float64
  /// - volume element:  triangle, dim: 2, vertices: 3, spacedim: 2
  /// - kernel type:     apply
  /// - loop strategy:   SAWTOOTH
  /// - quadrature rule: Griener-Schmid 1 | points: 10, degree: 6
  /// - blending map:    AffineMap2D
  /// - operations per element:
  ///   adds    muls    divs    pows    abs    assignments    function_calls
  ///   unknown_ops
  /// ------  ------  ------  ------  -----  -------------  ----------------
  /// -------------
  ///    383     653      12       0      0              0                 0 0
  void apply_P2PlusBubbleElementwiseMass_AffineMap2D_float64_macro_2D(
      ...
      walberla::float64 bMat_11, walberla::float64 macro_vertex_coord_id_0comp0,
  ...
  /// ------  ------  ------  ------  -----  -------------  ----------------
  /// -------------
  ///    334     604      12       0      0              0                 0 3
  void toMatrix_P2PlusBubbleElementwiseMass_AffineMap2D_float64_macro_2D(
