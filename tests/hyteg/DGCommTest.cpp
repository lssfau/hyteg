...
//////////////////// GRAY CELL //////////////////////
            ...
            for (; it != facedof::macroface::indexIterator(); ++it) {
                if (faceIdOnEdge == 0) {
                    ...
                    WALBERLA_CHECK_EQUAL(edgeData[facedof::macroedge::indexFaceFromVertex(maxLevel, idxCounter,
                                                                                          stencilDirection::CELL_GRAY_SE)],
                                         faceData[*it])
                    numberOfChecks++;
...
//////////////////// BLUE CELL //////////////////////
            ...
            for (; it != facedof::macroface::indexIterator(); ++it) {
                if (faceIdOnEdge == 0) {
                    WALBERLA_CHECK_EQUAL(edgeData[facedof::macroedge::indexFaceFromVertex(maxLevel, idxCounter + 1,
                                                                                          stencilDirection::CELL_BLUE_SE)],
                                         faceData[*it])
                    numberOfChecks++;
                } else if (faceIdOnEdge == 1) {
