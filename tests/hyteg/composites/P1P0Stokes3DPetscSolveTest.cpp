...
void petscSolveTest( const uint_t&   solverType,
                     const uint_t&   level,
                     ...
                     const real_t&   errEpsP )
{
   ...
   std::function< real_t( const hyteg::Point3D& ) > exactU = []( const Point3D& xx ) -> real_t { return 2 * xx[0]; };
   std::function< real_t( const hyteg::Point3D& ) > exactV = []( const Point3D& xx ) -> real_t { return -3 * xx[1]; };
   std::function< real_t( const hyteg::Point3D& ) > exactW = []( const Point3D& xx ) -> real_t { return 1 * xx[2]; };
...
void petscSolveTest2( const uint_t&   solverType,
                      const uint_t&   level,
                      const MeshInfo& meshInfo,
                      const real_t&   resEps,
                      const real_t&   errEpsUSum,
...
int main( int argc, char* argv[] )
{
   ...
   petscSolveTest2( 1, 3, hyteg::MeshInfo::fromGmshFile( prependHyTeGMeshDir( "3D/cube_6el.msh" ) ), 8.0e-15, 0.118, 2.78653 );

   /*
   petscSolveTest( 1,
                   3,
                   hyteg::MeshInfo::fromGmshFile( prependHyTeGMeshDir( "3D/cube_center_at_origin_24el.msh" ) ),
                   8.0e-15,
                   0.118,
                   2.78653 );
   petscSolveTest( 1,
   ...
   petscSolveTest( 1,
                   ...
                   0.118,
                   2.78653 );
   petscSolveTest( 1, 3, hyteg::MeshInfo::fromGmshFile( prependHyTeGMeshDir( "3D/cube_6el.msh" ) ), 8.0e-15, 0.118, 2.78653 );
   petscSolveTest( 1, 4, hyteg::MeshInfo::fromGmshFile( prependHyTeGMeshDir( "3D/cube_6el.msh" ) ), 8.0e-15, 0.118, 2.78653 );
   petscSolveTest( 1, 5, hyteg::MeshInfo::fromGmshFile( prependHyTeGMeshDir( "3D/cube_6el.msh" ) ), 8.0e-15, 0.118, 2.78653 );
   */
