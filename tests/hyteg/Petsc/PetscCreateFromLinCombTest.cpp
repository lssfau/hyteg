...
int main( int argc, char* argv[] )
{
   ...
   pM1.addValue(0, 0, 2);pM1.addValue(0, 1, 2);
   pM1.addValue(1, 0, 3);pM1.addValue(1, 1, 4); 

  
   pM2.addValue(0, 0, 2);pM2.addValue(0, 1, 4);
   pM2.addValue(1, 0, 6);pM2.addValue(1, 1, 8);
   ...
   // M3 = 2*M1 - M2
   pM3.createFromMatrixLinComb({2, -1}, {std::make_shared<PETScSparseMatrixProxy>(pM1), std::make_shared<PETScSparseMatrixProxy>(pM2)});
