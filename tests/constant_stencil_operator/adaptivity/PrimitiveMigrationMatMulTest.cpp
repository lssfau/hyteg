...
int main( int argc, char* argv[] )
{
   ...
   hyteg::PrimitiveMigrationMatMulTest( "../../data/meshes/tri_1el.msh", 3, false );
   hyteg::PrimitiveMigrationMatMulTest( "../../data/meshes/quad_4el.msh", 3, false );
   hyteg::PrimitiveMigrationMatMulTest( "../../data/meshes/annulus_coarse.msh", 2, false );
   hyteg::PrimitiveMigrationMatMulTest( "../../data/meshes/3D/tet_1el.msh", 3, true );
   hyteg::PrimitiveMigrationMatMulTest( "../../data/meshes/3D/pyramid_2el.msh", 2, false );
   hyteg::PrimitiveMigrationMatMulTest( "../../data/meshes/3D/regular_octahedron_8el.msh", 2, true );
   hyteg::PrimitiveMigrationMatMulTest( "../../data/meshes/3D/cube_24el.msh", 2, true );
}