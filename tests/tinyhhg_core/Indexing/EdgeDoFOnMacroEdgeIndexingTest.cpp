...
#include "tinyhhg_core/edgedofspace/EdgeDoFOnMacroEdgeIndex.hpp"
...
static void testEdgeDoFsOnMacroEdge()
{
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_HO_E), 3 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_HO_E), 4 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_HO_E), 5 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_HO_E), 6 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_HO_W), 2 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_HO_W), 3 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_HO_W), 4 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_HO_W), 5 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 7, sD::EDGE_HO_W), 6 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 8, sD::EDGE_HO_W), 7 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_HO_NW), 34 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_HO_SE), 10 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_HO_SE), 11 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_HO_SE), 12 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_HO_SE), 13 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_VE_S), 25 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_VE_S), 26 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_VE_S), 27 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_VE_S), 28 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 7, sD::EDGE_VE_S), 29 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 8, sD::EDGE_VE_S), 30 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_VE_N), 49 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_VE_N), 50 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_VE_N), 51 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_VE_N), 52 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_VE_NW), 48 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_VE_NW), 49 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_VE_NW), 50 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_VE_NW), 51 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 7, sD::EDGE_VE_NW), 52 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 8, sD::EDGE_VE_NW), 53 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_VE_SE), 26 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_VE_SE), 27 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_VE_SE), 28 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_VE_SE), 29 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_DI_NW), 40 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_DI_NW), 41 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_DI_NW), 42 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_DI_NW), 43 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 7, sD::EDGE_DI_NW), 44 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 8, sD::EDGE_DI_NW), 45 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_DI_NE), 41 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_DI_NE), 42 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_DI_NE), 43 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_DI_NE), 44 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 7, sD::EDGE_DI_NE), 45 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_DI_SW), 18 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_DI_SW), 19 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_DI_SW), 20 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 7, sD::EDGE_DI_SW), 21 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 2, sD::EDGE_DI_SE), 17 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_DI_SE), 18 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_DI_SE), 19 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 5, sD::EDGE_DI_SE), 20 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_DI_SE), 21 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 7, sD::EDGE_DI_SE), 22 );

  WALBERLA_LOG_INFO_ON_ROOT( "Edge DoFs on macro edge indexing (from vertex): EDGE_DI_SE correct!" );

#ifdef NDEBUG
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 3, sD::EDGE_HO_E)  ==  3 , "EDGE_HO_E  cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_HO_W)  ==  5 , "EDGE_HO_W  cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 8, sD::EDGE_VE_S)  == 30 , "EDGE_VE_S  cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_VE_N)  == 50 , "EDGE_VE_N  cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_DI_NW) == 43 , "EDGE_DI_NW cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 4, sD::EDGE_DI_NE) == 42 , "EDGE_DI_NE cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 7, sD::EDGE_DI_SW) == 21 , "EDGE_DI_SW cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 7, sD::EDGE_DI_SE) == 22 , "EDGE_DI_SE cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 8, sD::EDGE_HO_NW) == 38 , "EDGE_HO_NW cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_HO_SE) == 13 , "EDGE_HO_SE cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 1, sD::EDGE_VE_NW) == 46 , "EDGE_VE_NW cannot be statically computed by the compiler!" );
  static_assert( EdgeDoFOnMacroEdge::indexFromVertex< 3 >( 6, sD::EDGE_VE_SE) == 29 , "EDGE_VE_SE cannot be statically computed by the compiler!" );
#endif
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromHorizontalEdge< 2 >( 3, sD::EDGE_DI_N), 21 );
  ...
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromHorizontalEdge< 2 >( 0, sD::EDGE_VE_NW), 22 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromHorizontalEdge< 2 >( 1, sD::EDGE_VE_NW), 23 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromHorizontalEdge< 2 >( 2, sD::EDGE_VE_NW), 24 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromHorizontalEdge< 2 >( 3, sD::EDGE_VE_NW), 25 );

  WALBERLA_LOG_INFO_ON_ROOT( "Edge DoFs on macro edge indexing (from horizontal edge): EDGE_VE_NW correct!" );

  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromHorizontalEdge< 2 >( 0, sD::EDGE_VE_SE), 11 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromHorizontalEdge< 2 >( 1, sD::EDGE_VE_SE), 12 );
  WALBERLA_CHECK_EQUAL( EdgeDoFOnMacroEdge::indexFromHorizontalEdge< 2 >( 2, sD::EDGE_VE_SE), 13 );
