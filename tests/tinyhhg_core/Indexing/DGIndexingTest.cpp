...
int main(int argc, char* argv[]) {
  ...
  for(auto n : hhg::facedof::macroface::neighbors)
  {
  ...
  WALBERLA_CHECK_EQUAL(50, facedof::macroface::indexFaceFromGrayFace( 3, 1, 3, hhg::stencilDirection::CELL_BLUE_S ));
  WALBERLA_CHECK_EQUAL(55, facedof::macroface::indexFaceFromGrayFace( 3, 2, 3, hhg::stencilDirection::CELL_BLUE_W ));
  WALBERLA_CHECK_EQUAL(48, facedof::macroface::indexFaceFromGrayFace( 3, 5, 1, hhg::stencilDirection::CELL_BLUE_E ));


  WALBERLA_CHECK_EQUAL(27, facedof::macroface::indexFaceFromBlueFace( 3, 1, 3, hhg::stencilDirection::CELL_GRAY_N ));
  WALBERLA_CHECK_EQUAL(23, facedof::macroface::indexFaceFromBlueFace( 3, 2, 3, hhg::stencilDirection::CELL_GRAY_W ));
  WALBERLA_CHECK_EQUAL(14, facedof::macroface::indexFaceFromBlueFace( 3, 5, 1, hhg::stencilDirection::CELL_GRAY_E ));
  WALBERLA_CHECK_EQUAL(13, facedof::macroface::indexFaceFromBlueFace( 3, 5, 0, hhg::stencilDirection::CELL_GRAY_N ));
  WALBERLA_CHECK_EQUAL(14, facedof::macroface::indexFaceFromBlueFace( 3, 6, 0, hhg::stencilDirection::CELL_GRAY_N ));
  WALBERLA_CHECK_EQUAL(7 , facedof::macroface::indexFaceFromBlueFace( 3, 6, 0, hhg::stencilDirection::CELL_GRAY_E ));
  WALBERLA_CHECK_EQUAL(6 , facedof::macroface::indexFaceFromBlueFace( 3, 6, 0, hhg::stencilDirection::CELL_GRAY_W ));
