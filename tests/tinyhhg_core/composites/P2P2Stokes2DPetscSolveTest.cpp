...
void petscSolveTest( const uint_t & level, const MeshInfo & meshInfo, const real_t & resEps, const real_t & errEpsUSum, const real_t & errEpsP )
{
  ...
  uint_t localDoFs1 = hhg::numberOfLocalDoFs< P2P2StokesFunctionTag >( *storage, level );
  uint_t globalDoFs1 = hhg::numberOfGlobalDoFs< P2P2StokesFunctionTag >( *storage, level );
...
int main( int argc, char* argv[] )
{
  ...
  petscSolveTest( 5, hhg::MeshInfo::fromGmshFile( "../../data/meshes/quad_center_at_origin_4el.msh" ), 6.0e-15, 0.008, 0.13 );
