...
int main( int argc, char* argv[] )
{
   ...
   std::function< real_t( const hhg::Point3D& ) > coeff = []( const hhg::Point3D& x ) {
   ...
   auto solver =
       hhg::CGSolver< hhg::P1Function< real_t >, hhg::P1ScalarCoefficientLaplaceOperator >( storage, minLevel, maxLevel );
