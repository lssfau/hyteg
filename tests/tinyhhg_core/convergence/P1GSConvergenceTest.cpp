...
static void test( const std::string & meshFile, const uint_t & level, const uint_t & maxiter )
{
  ...
  hhg::P1Function< real_t > residuum  ("residuum",  storage, level, level);
  hhg::P1Function< real_t > rhs       ("rhs",       storage, level, level);
  hhg::P1Function< real_t > p2function("p1Function",storage, level, level);
  hhg::P1Function< real_t > Lu        ("Lu",        storage, level, level);
  hhg::P1Function< real_t > p2Exact   ("p1Exact",   storage, level, level);
