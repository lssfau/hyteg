...
int main(int argc, char* argv[])
{
  ...
  hhg::p1PetscApplyTest( 3, "../../data/meshes/3D/pyramid_4el.msh", hhg::Inner, 7.8e-17 );
  hhg::p1PetscApplyTest( 3, "../../data/meshes/3D/regular_octahedron_8el.msh", hhg::Inner, 2.3e-16 );
