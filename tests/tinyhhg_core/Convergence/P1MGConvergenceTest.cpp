...
int main(int argc, char* argv[])
{
  ...
  auto coarseGridSolver = std::make_shared< hhg::CGSolver< hhg::P1Function< real_t >, hhg::P1LaplaceOperator > >( storage, minLevel, minLevel );
  auto solver           = hhg::GMultigridSolver< hhg::P1Function< real_t >, hhg::P1LaplaceOperator >( storage, coarseGridSolver, minLevel, maxLevel );
