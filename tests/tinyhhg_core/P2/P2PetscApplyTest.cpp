...
int main( int argc, char* argv[] )
{
   ...
   succeeded &= hhg::p2PetscApplyTest( 3, "../../data/meshes/quad_4el.msh", hhg::All, 5.0e-15 );
   succeeded &= hhg::p2PetscApplyTest( 3, "../../data/meshes/annulus_coarse.msh", hhg::All, 1.7e-13 );
   succeeded &= hhg::p2PetscApplyTest( 3, "../../data/meshes/3D/tet_1el.msh", hhg::Inner, 1.0e-16 );
   succeeded &= hhg::p2PetscApplyTest( 3, "../../data/meshes/3D/pyramid_2el.msh", hhg::Inner, 9.6e-16 );
   succeeded &= hhg::p2PetscApplyTest( 3, "../../data/meshes/3D/pyramid_4el.msh", hhg::Inner, 1.5e-15 );
   succeeded &= hhg::p2PetscApplyTest( 3, "../../data/meshes/3D/regular_octahedron_8el.msh", hhg::Inner, 3.2e-15 );
   succeeded &= hhg::p2PetscApplyTest( 2, "../../data/meshes/3D/cube_24el.msh", hhg::All, 3.1e-15 );
