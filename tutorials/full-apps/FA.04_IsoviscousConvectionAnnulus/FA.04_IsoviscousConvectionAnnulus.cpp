 ...
 *
 * \snippet{trimleft} this Domain setup
 *
 ...
 *
 * \snippet{trimleft} this Function and operator typedefs
 *
 * Since we focus multigrid solvers, functions and operators are constructed over a hierarchy of levels.
 *
 * \snippet{trimleft} this Function setup
 * \snippet{trimleft} this Operator setup
 *
 ...
 *
 * \snippet{trimleft} this Initial temperature
 *
