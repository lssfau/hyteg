 ...
 *
 * \dontinclude tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp
 *
 ...
 *
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction definition
 *
 ...
 *
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction meta-information
 *
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction chType-definition
 *
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction ClassRhsAssembler
 *
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction assemble
 ...
 *
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction forms-definitions
 *
 ...
 *
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction block-form-11
 *
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction block-form-00
 *
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction lhs-assembly
 *
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction ClassCahnHilliardEvolutionOperator
 *
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction scale
 *
 * The apply method can thus be written as
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction time-evolution-apply
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction minres-solver
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardFunction CahnHilliardDiagonalPreconditioner
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardDiagonalPreconditioner block00form
 * and \f$\sqrt{\tau} \epsilon^2 K + M\f$
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardDiagonalPreconditioner block11form
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardDiagonalPreconditioner create-multigrid-solver
 *
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp CahnHilliardDiagonalPreconditioner solve
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp create_storage rectangle
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp create_storage neumann
 *
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp create_storage fun
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp main config-walberla
 *
 * We do not want to hardcode most of our parameters and hence have to read in a configuration file:
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp main config-file
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp main storage
 *
 * Next we define functions for storing the state of our CH equation at the current and previous time step
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp main functions
 *
 * Next we setup the CahnHilliardEvolutionOperator as
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp main evolution-operator
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp main initial-values
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp main time-loop
 ...
 * \snippet tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp main timing-tree
 *
 ...
 * The full code is:
 *
 * \include tutorials/full-apps/08_CahnHilliard/CahnHilliard.cpp
 *
