...
{
public:
   const walberla::unresolved_particles::Vec3& getTangentialSpringDisplacement() const {return tangentialSpringDisplacement_;}
   walberla::unresolved_particles::Vec3& getTangentialSpringDisplacementRef() {return tangentialSpringDisplacement_;}
   void setTangentialSpringDisplacement(const walberla::unresolved_particles::Vec3& v) { tangentialSpringDisplacement_ = v;}
...
private:
   walberla::unresolved_particles::Vec3 tangentialSpringDisplacement_ {};
   bool isSticking_ {};
...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const unresolved_particles::data::ContactHistory& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, unresolved_particles::data::ContactHistory& objparam )
{
