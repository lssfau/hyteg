 ...
 */
class ConvexPolyhedron : public walberla::unresolved_particles::data::BaseShape {
public:
   ...
   constexpr static int SHAPE_TYPE = 5; ///< Unique shape type identifier for convex polyhedrons.\ingroup unresolved_particles_shape
