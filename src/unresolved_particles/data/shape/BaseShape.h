...
public:
   ...
   static const int INVALID_SHAPE = -1; ///< Unique *invalid* shape type identifier.\ingroup unresolved_particles_shape
protected:
   ...
   ShapeTypeT shapeType_    = INVALID_SHAPE;   ///< \ingroup unresolved_particles_shape
};
