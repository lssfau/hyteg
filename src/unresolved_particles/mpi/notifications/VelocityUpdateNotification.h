...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const unresolved_particles::VelocityUpdateNotification& obj )
{
   // Perform the addition
   obj.p_.getLinearVelocityRef() = obj.p_.getLinearVelocity() + unresolved_particles::VelocityUpdateNotification::Parameters::relaxationParam * obj.p_.getDv();
   obj.p_.getAngularVelocityRef() = obj.p_.getAngularVelocity() + unresolved_particles::VelocityUpdateNotification::Parameters::relaxationParam * obj.p_.getDw();
   // Reset the velocity corrections dv/dw of main particle
   obj.p_.getDvRef() = unresolved_particles::Vec3();
   obj.p_.getDwRef() = unresolved_particles::Vec3();
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, unresolved_particles::VelocityUpdateNotification::Parameters& objparam )
{
...
template< >
struct BufferSizeTrait< unresolved_particles::VelocityUpdateNotification > {
