...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const unresolved_particles::ParticleRemovalNotification& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, unresolved_particles::ParticleRemovalNotification::Parameters& objparam )
{
...
template<>
struct BufferSizeTrait< unresolved_particles::ParticleRemovalNotification > {
