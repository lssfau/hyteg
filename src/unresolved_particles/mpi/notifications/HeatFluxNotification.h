...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const unresolved_particles::HeatFluxNotification& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, unresolved_particles::HeatFluxNotification::Parameters& objparam )
{
...
template< >
struct BufferSizeTrait< unresolved_particles::HeatFluxNotification > {
