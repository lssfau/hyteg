...
public:
   ...
   {
      id_t uid_;
      unresolved_particles::Vec3 hydrodynamicForce_;
      unresolved_particles::Vec3 hydrodynamicTorque_;
   };
...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const unresolved_particles::HydrodynamicForceTorqueNotification& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, unresolved_particles::HydrodynamicForceTorqueNotification::Parameters& objparam )
{
...
template< >
struct BufferSizeTrait< unresolved_particles::HydrodynamicForceTorqueNotification > {
