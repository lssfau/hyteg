...
#include <unresolved_particles/common/Contains.h>
...
#include <unresolved_particles/kernel/SingleCast.h>
...
real_t intersectionRatioBisection( const size_t particleIdx, const ParticleAccessor_T& ac,
                                   ...
                                   real_t epsilon)
{
   unresolved_particles::kernel::SingleCast singleCast;
...
struct RayParticleIntersectionRatioFunctor
{
   ...
   template<typename ParticleAccessor_T>
   real_t operator()(const size_t particleIdx, const unresolved_particles::data::Sphere& sphere, const ParticleAccessor_T& ac, const Vec3& rayOrigin, const Vec3& rayDirection, real_t /*epsilon*/ )
   {
      static_assert(std::is_base_of<unresolved_particles::data::IAccessor, ParticleAccessor_T>::value, "Provide a valid accessor as template");
   ...
   template<typename ParticleAccessor_T>
   real_t operator()(const size_t particleIdx, const unresolved_particles::data::HalfSpace& halfSpace, const ParticleAccessor_T& ac, const Vec3& rayOrigin, const Vec3& rayDirection, real_t /*epsilon*/ )
   {
      static_assert(std::is_base_of<unresolved_particles::data::IAccessor, ParticleAccessor_T>::value, "Provide a valid accessor as template");
   ...
   template<typename ParticleAccessor_T>
   real_t operator()(const size_t particleIdx, const unresolved_particles::data::Ellipsoid& ellipsoid, const ParticleAccessor_T& ac, const Vec3& rayOrigin, const Vec3& rayDirection, real_t /*epsilon*/ )
   {
      static_assert(std::is_base_of<unresolved_particles::data::IAccessor, ParticleAccessor_T>::value, "Provide a valid accessor as template");

      return rayEllipsoidIntersectionRatioBF(unresolved_particles::transformPositionFromWFtoBF(particleIdx, ac, rayOrigin), unresolved_particles::transformVectorFromWFtoBF(particleIdx, ac, rayDirection), ellipsoid.getSemiAxes() );
   }
