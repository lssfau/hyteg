...
void tesselate(const walberla::unresolved_particles::data::ConvexPolyhedron& shape,
      const walberla::unresolved_particles::data::ParticleStorage::Particle& particle,
