...
public:
   ...
   inline const walberla::unresolved_particles::Vec3& getGlobalAcceleration() const {return globalAcceleration_;}
   inline void setGlobalAcceleration(walberla::unresolved_particles::Vec3 v) { globalAcceleration_ = v;}
...
private:
   ...
   walberla::unresolved_particles::Vec3 globalAcceleration_;
