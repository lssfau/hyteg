 ...
 * \code
 * const walberla::unresolved_particles::Vec3& getPosition(const size_t p_idx) const;
 * void setPosition(const size_t p_idx, const walberla::unresolved_particles::Vec3& v);
 *
 * const walberla::unresolved_particles::Vec3& getLinearVelocity(const size_t p_idx) const;
 * void setLinearVelocity(const size_t p_idx, const walberla::unresolved_particles::Vec3& v);
 *
 * const walberla::real_t& getInvMass(const size_t p_idx) const;
 *
 * const walberla::unresolved_particles::Vec3& getForce(const size_t p_idx) const;
 * void setForce(const size_t p_idx, const walberla::unresolved_particles::Vec3& v);
 *
 * const walberla::unresolved_particles::data::particle_flags::FlagT& getFlags(const size_t p_idx) const;
 *
 * const walberla::unresolved_particles::Rot3& getRotation(const size_t p_idx) const;
 * void setRotation(const size_t p_idx, const walberla::unresolved_particles::Rot3& v);
 *
 * const walberla::unresolved_particles::Vec3& getAngularVelocity(const size_t p_idx) const;
 * void setAngularVelocity(const size_t p_idx, const walberla::unresolved_particles::Vec3& v);
 *
 * const walberla::unresolved_particles::Mat3& getInvInertiaBF(const size_t p_idx) const;
 *
 * const walberla::unresolved_particles::Mat3& getInertiaBF(const size_t p_idx) const;
 *
 * const walberla::unresolved_particles::Vec3& getTorque(const size_t p_idx) const;
 * void setTorque(const size_t p_idx, const walberla::unresolved_particles::Vec3& v);
 *
 * \endcode
 *
