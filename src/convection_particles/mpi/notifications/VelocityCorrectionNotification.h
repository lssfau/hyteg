...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const convection_particles::VelocityCorrectionNotification& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, convection_particles::VelocityCorrectionNotification::Parameters& objparam )
{
...
template< >
struct BufferSizeTrait< convection_particles::VelocityCorrectionNotification > {
