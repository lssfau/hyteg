...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const convection_particles::ParticleRemoteMigrationNotification& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, convection_particles::ParticleRemoteMigrationNotification::Parameters& objparam )
{
...
template <>
struct BufferSizeTrait< convection_particles::ParticleRemoteMigrationNotification > {
