...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const convection_particles::VelocityUpdateNotification& obj )
{
   // Perform the addition
   obj.p_.getLinearVelocityRef() = obj.p_.getLinearVelocity() + convection_particles::VelocityUpdateNotification::Parameters::relaxationParam * obj.p_.getDv();
   obj.p_.getAngularVelocityRef() = obj.p_.getAngularVelocity() + convection_particles::VelocityUpdateNotification::Parameters::relaxationParam * obj.p_.getDw();
   // Reset the velocity corrections dv/dw of main particle
   obj.p_.getDvRef() = convection_particles::Vec3();
   obj.p_.getDwRef() = convection_particles::Vec3();
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, convection_particles::VelocityUpdateNotification::Parameters& objparam )
{
...
template< >
struct BufferSizeTrait< convection_particles::VelocityUpdateNotification > {
