...
public:
   ...
   {
      id_t uid_;
      std::map<walberla::id_t, walberla::convection_particles::data::ContactHistory> contactHistory_;
   };
...
{
   p.setNewContactHistory(std::map<walberla::id_t, walberla::convection_particles::data::ContactHistory>());
}
...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const convection_particles::ContactHistoryNotification& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, convection_particles::ContactHistoryNotification::Parameters& objparam )
{
