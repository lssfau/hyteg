...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const convection_particles::ParticleRemovalNotification& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, convection_particles::ParticleRemovalNotification::Parameters& objparam )
{
...
template<>
struct BufferSizeTrait< convection_particles::ParticleRemovalNotification > {
