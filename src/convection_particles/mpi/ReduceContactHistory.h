...
#include <convection_particles/kernel/ParticleSelector.h>

#include <convection_particles/mpi/notifications/ContactHistoryNotification.h>
#include <convection_particles/mpi/ReduceProperty.h>
