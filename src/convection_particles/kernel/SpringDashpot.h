...
#include <convection_particles/common/ParticleFunctions.h>
 ...
 *
 * walberla::convection_particles::Vec3& getForceRef(const size_t p_idx);
 *
 * const walberla::convection_particles::Vec3& getAngularVelocity(const size_t p_idx) const;
 *
 * walberla::convection_particles::Vec3& getTorqueRef(const size_t p_idx);
 *
 * const uint_t& getType(const size_t p_idx) const;
 *
 * const std::map<walberla::id_t, walberla::convection_particles::Vec3>& getContactHistory(const size_t p_idx) const;
 * void setContactHistory(const size_t p_idx, const std::map<walberla::id_t, walberla::convection_particles::Vec3>& v);
 *
 * \endcode
