...
public:
   ...
   inline const walberla::convection_particles::Vec3& getGlobalAcceleration() const {return globalAcceleration_;}
   inline void setGlobalAcceleration(walberla::convection_particles::Vec3 v) { globalAcceleration_ = v;}
...
private:
   ...
   walberla::convection_particles::Vec3 globalAcceleration_;
