...
#include <convection_particles/common/Contains.h>
...
#include <convection_particles/kernel/SingleCast.h>
...
real_t intersectionRatioBisection( const size_t particleIdx, const ParticleAccessor_T& ac,
                                   ...
                                   real_t epsilon)
{
   convection_particles::kernel::SingleCast singleCast;
...
struct RayParticleIntersectionRatioFunctor
{
   ...
   {
      static_assert(std::is_base_of<convection_particles::data::IAccessor, ParticleAccessor_T>::value, "Provide a valid accessor as template");

      return intersectionRatioBisection(particleIdx, ac, rayOrigin, rayDirection, epsilon );
   }

   template<typename ParticleAccessor_T>
   real_t operator()(const size_t particleIdx, const convection_particles::data::Sphere& sphere, const ParticleAccessor_T& ac, const Vector3<real_t>& rayOrigin, const Vector3<real_t>& rayDirection, real_t /*epsilon*/ )
   {
      static_assert(std::is_base_of<convection_particles::data::IAccessor, ParticleAccessor_T>::value, "Provide a valid accessor as template");
   ...
   template<typename ParticleAccessor_T>
   real_t operator()(const size_t particleIdx, const convection_particles::data::HalfSpace& halfSpace, const ParticleAccessor_T& ac, const Vector3<real_t>& rayOrigin, const Vector3<real_t>& rayDirection, real_t /*epsilon*/ )
   {
      static_assert(std::is_base_of<convection_particles::data::IAccessor, ParticleAccessor_T>::value, "Provide a valid accessor as template");
