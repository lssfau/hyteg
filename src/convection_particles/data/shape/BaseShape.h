...
public:
   ...
   static const int INVALID_SHAPE = -1; ///< Unique *invalid* shape type identifier.\ingroup convection_particles_shape
protected:
   ...
   ShapeTypeT shapeType_    = INVALID_SHAPE;   ///< \ingroup convection_particles_shape
};
