...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const walberla::convection_particles::data::particle_flags::FlagT& flags )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, walberla::convection_particles::data::particle_flags::FlagT& flags )
{
...
template<> // value type
struct BufferSizeTrait< walberla::convection_particles::data::particle_flags::FlagT > {
   static const bool constantSize = true;
   static const uint_t size = sizeof(walberla::convection_particles::data::particle_flags::FlagT::value_type) + mpi::BUFFER_DEBUG_OVERHEAD;
};
