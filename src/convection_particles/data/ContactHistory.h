...
{
public:
   const walberla::convection_particles::Vec3& getTangentialSpringDisplacement() const {return tangentialSpringDisplacement_;}
   walberla::convection_particles::Vec3& getTangentialSpringDisplacementRef() {return tangentialSpringDisplacement_;}
   void setTangentialSpringDisplacement(const walberla::convection_particles::Vec3& v) { tangentialSpringDisplacement_ = v;}
...
private:
   walberla::convection_particles::Vec3 tangentialSpringDisplacement_ {};
   bool isSticking_ {};
...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const convection_particles::data::ContactHistory& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, convection_particles::data::ContactHistory& objparam )
{
