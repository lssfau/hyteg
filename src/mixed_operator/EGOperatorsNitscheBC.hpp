/*
* Copyright (c) 2022-2026 Andreas Wagner, Fabian Böhm, Marcus Mohr.
*
...
class EGP0EpsilonStokesPreconditionerNitscheBC : public Operator< EGP0StokesFunction< real_t >, EGP0StokesFunction< real_t > >
{
 public:
