...
///
///
/// std::function< real_t( const Point3D&, real_t ) > advection_supg_scaling = [&]( const Point3D& x, real_t u_abs ) {
///     return delta( x, u_abs );
/// };
///
/// Weak formulation:
///
...
/// Blending: True
/// Quadrature degree: 4
class p2_advection_u_p2_supg_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t >, P2Function< real_t >, P2Function< real_t > >
{
 ...
 public:
   p2_advection_u_p2_supg_blending_q4_ElementwiseOperator(
       ...
       std::function< real_t( const Point3D&, real_t ) > advection_supg_scaling )
   : p2_advection_u_p2_supg_blending_q4_ElementwiseOperator( storage,
                                                             minLevel,
                                                             maxLevel,
                                                             false,
                                                             uX,
   ...
   : P2ElementwiseDoFValueOperator< P2Function< real_t >, P2Function< real_t >, P2Function< real_t > >( storage,
                                                                                                        ...
                                                                                                        uY,
                                                                                                        uZ )
   , advection_supg_scaling_( advection_supg_scaling )
   {
 ...
 private:
   std::function< real_t( const Point3D&, real_t ) > advection_supg_scaling_;
};
