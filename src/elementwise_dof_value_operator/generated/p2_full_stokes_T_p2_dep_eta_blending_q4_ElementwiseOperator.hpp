...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_0_0_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_0_0_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                                    size_t                                            minLevel,
                                                                    size_t                                            maxLevel,
                                                                    P2Function< real_t >&                             T,
                                                                    std::function< real_t( const Point3D&, real_t ) > eta )
   : p2_full_stokes_T_p2_dep_eta_0_0_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_full_stokes_T_p2_dep_eta_0_0_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                    size_t                                     minLevel,
                                                                    size_t                                     maxLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_0_1_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_0_1_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                                    size_t                                            minLevel,
                                                                    size_t                                            maxLevel,
                                                                    P2Function< real_t >&                             T,
                                                                    std::function< real_t( const Point3D&, real_t ) > eta )
   : p2_full_stokes_T_p2_dep_eta_0_1_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_full_stokes_T_p2_dep_eta_0_1_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                    size_t                                     minLevel,
                                                                    size_t                                     maxLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_0_2_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_0_2_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                                    size_t                                            minLevel,
                                                                    size_t                                            maxLevel,
                                                                    P2Function< real_t >&                             T,
                                                                    std::function< real_t( const Point3D&, real_t ) > eta )
   : p2_full_stokes_T_p2_dep_eta_0_2_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_full_stokes_T_p2_dep_eta_0_2_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                    size_t                                     minLevel,
                                                                    size_t                                     maxLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_1_0_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_1_0_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                                    size_t                                            minLevel,
                                                                    size_t                                            maxLevel,
                                                                    P2Function< real_t >&                             T,
                                                                    std::function< real_t( const Point3D&, real_t ) > eta )
   : p2_full_stokes_T_p2_dep_eta_1_0_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_full_stokes_T_p2_dep_eta_1_0_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                    size_t                                     minLevel,
                                                                    size_t                                     maxLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_1_1_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_1_1_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                                    size_t                                            minLevel,
                                                                    size_t                                            maxLevel,
                                                                    P2Function< real_t >&                             T,
                                                                    std::function< real_t( const Point3D&, real_t ) > eta )
   : p2_full_stokes_T_p2_dep_eta_1_1_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_full_stokes_T_p2_dep_eta_1_1_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                    size_t                                     minLevel,
                                                                    size_t                                     maxLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_1_2_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_1_2_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                                    size_t                                            minLevel,
                                                                    size_t                                            maxLevel,
                                                                    P2Function< real_t >&                             T,
                                                                    std::function< real_t( const Point3D&, real_t ) > eta )
   : p2_full_stokes_T_p2_dep_eta_1_2_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_full_stokes_T_p2_dep_eta_1_2_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                    size_t                                     minLevel,
                                                                    size_t                                     maxLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_2_0_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_2_0_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                                    size_t                                            minLevel,
                                                                    size_t                                            maxLevel,
                                                                    P2Function< real_t >&                             T,
                                                                    std::function< real_t( const Point3D&, real_t ) > eta )
   : p2_full_stokes_T_p2_dep_eta_2_0_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_full_stokes_T_p2_dep_eta_2_0_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                    size_t                                     minLevel,
                                                                    size_t                                     maxLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_2_1_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_2_1_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                                    size_t                                            minLevel,
                                                                    size_t                                            maxLevel,
                                                                    P2Function< real_t >&                             T,
                                                                    std::function< real_t( const Point3D&, real_t ) > eta )
   : p2_full_stokes_T_p2_dep_eta_2_1_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_full_stokes_T_p2_dep_eta_2_1_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                    size_t                                     minLevel,
                                                                    size_t                                     maxLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_2_2_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_2_2_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                                    size_t                                            minLevel,
                                                                    size_t                                            maxLevel,
                                                                    P2Function< real_t >&                             T,
                                                                    std::function< real_t( const Point3D&, real_t ) > eta )
   : p2_full_stokes_T_p2_dep_eta_2_2_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_full_stokes_T_p2_dep_eta_2_2_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                    size_t                                     minLevel,
                                                                    size_t                                     maxLevel,
