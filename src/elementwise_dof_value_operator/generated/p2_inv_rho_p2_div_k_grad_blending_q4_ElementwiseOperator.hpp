...
/// Div_k_grad inv rho operator for the TALA. Implements quotient rule on a div_k_grad form divided by rho.
///
...
///
///     - ∫ ∇T · k (rho ∇w - w ∇rho)/(rho*rho)
///
/// Blending: True
/// Quadrature degree: 4
class p2_inv_rho_p2_div_k_grad_blending_q4_ElementwiseOperator : public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
 ...
 public:
   p2_inv_rho_p2_div_k_grad_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                             size_t                                     minLevel,
                                                             size_t                                     maxLevel,
                                                             P2Function< real_t >&                      rho,
                                                             std::function< real_t( const Point3D& ) >  k )
   : p2_inv_rho_p2_div_k_grad_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, rho, k )
   {}
   p2_inv_rho_p2_div_k_grad_blending_q4_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                             size_t                                     minLevel,
                                                             size_t                                     maxLevel,
