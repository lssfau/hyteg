...
/// Blending: True
/// Quadrature degree: 5
class p2_advection_u_p2_blending_q5_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t >, P2Function< real_t >, P2Function< real_t > >
{
 ...
 public:
   p2_advection_u_p2_blending_q5_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                      size_t                                     minLevel,
                                                      size_t                                     maxLevel,
                                                      P2Function< real_t >&                      uX,
                                                      P2Function< real_t >&                      uY,
                                                      P2Function< real_t >&                      uZ,
                                                      std::function< real_t( const Point3D& ) >  advection_scaling )
   : p2_advection_u_p2_blending_q5_ElementwiseOperator( storage, minLevel, maxLevel, false, uX, uY, uZ, advection_scaling )
   {}
   p2_advection_u_p2_blending_q5_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                      size_t                                     minLevel,
                                                      size_t                                     maxLevel,
   ...
   : P2ElementwiseDoFValueOperator< P2Function< real_t >, P2Function< real_t >, P2Function< real_t > >( storage,
                                                                                                        ...
                                                                                                        uY,
                                                                                                        uZ )
   , advection_scaling_( advection_scaling )
   {
 ...
 private:
   std::function< real_t( const Point3D& ) > advection_scaling_;
};
