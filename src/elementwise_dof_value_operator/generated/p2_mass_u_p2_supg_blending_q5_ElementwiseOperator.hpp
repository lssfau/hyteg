...
/// SUPG mass operator for the TALA. Usually used for internal heating.
///
...
///
/// In a TALA setting you can use the following definitions in HyTeG (given some space dependent function rho and internal heating constant H):
///
...
/// Blending: True
/// Quadrature degree: 5
class p2_mass_u_p2_supg_blending_q5_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t >, P2Function< real_t >, P2Function< real_t > >
{
 ...
 public:
   p2_mass_u_p2_supg_blending_q5_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                      size_t                                            minLevel,
                                                      size_t                                            maxLevel,
                                                      P2Function< real_t >&                             uX,
                                                      P2Function< real_t >&                             uY,
                                                      P2Function< real_t >&                             uZ,
                                                      std::function< real_t( const Point3D&, real_t ) > mass_supg_scaling )
   : p2_mass_u_p2_supg_blending_q5_ElementwiseOperator( storage, minLevel, maxLevel, false, uX, uY, uZ, mass_supg_scaling )
   {}
   p2_mass_u_p2_supg_blending_q5_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >&        storage,
                                                      size_t                                            minLevel,
                                                      size_t                                            maxLevel,
   ...
   : P2ElementwiseDoFValueOperator< P2Function< real_t >, P2Function< real_t >, P2Function< real_t > >( storage,
                                                                                                        ...
                                                                                                        uY,
                                                                                                        uZ )
   , mass_supg_scaling_( mass_supg_scaling )
   {
 ...
 private:
   std::function< real_t( const Point3D&, real_t ) > mass_supg_scaling_;
};
