...
/// Blending: True
/// Quadrature degree: 6
class p2_k_mass_visc_centroid_blending_q6_ElementwiseOperator : public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
 ...
 public:
   p2_k_mass_visc_centroid_blending_q6_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > k )
   : p2_k_mass_visc_centroid_blending_q6_ElementwiseOperator( storage, minLevel, maxLevel, false, T, k )
   {}
   p2_k_mass_visc_centroid_blending_q6_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
