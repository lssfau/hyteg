...
/// Implements only the divdiv term of the fully coupled viscous operator.
///
/// The strong representation of the operator is given by:
///
///    -2/dim grad[ eta div(u) ]
///
...
/// Blending: True
/// Quadrature degree: 4
class p2_divdiv_stokes_T_p2_dep_eta_centroid_0_0_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
 ...
 public:
   p2_divdiv_stokes_T_p2_dep_eta_centroid_0_0_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta )
   : p2_divdiv_stokes_T_p2_dep_eta_centroid_0_0_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_divdiv_stokes_T_p2_dep_eta_centroid_0_0_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_divdiv_stokes_T_p2_dep_eta_centroid_0_1_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_divdiv_stokes_T_p2_dep_eta_centroid_0_1_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta )
   : p2_divdiv_stokes_T_p2_dep_eta_centroid_0_1_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_divdiv_stokes_T_p2_dep_eta_centroid_0_1_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_divdiv_stokes_T_p2_dep_eta_centroid_0_2_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_divdiv_stokes_T_p2_dep_eta_centroid_0_2_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta )
   : p2_divdiv_stokes_T_p2_dep_eta_centroid_0_2_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_divdiv_stokes_T_p2_dep_eta_centroid_0_2_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_divdiv_stokes_T_p2_dep_eta_centroid_1_0_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_divdiv_stokes_T_p2_dep_eta_centroid_1_0_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta )
   : p2_divdiv_stokes_T_p2_dep_eta_centroid_1_0_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_divdiv_stokes_T_p2_dep_eta_centroid_1_0_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_divdiv_stokes_T_p2_dep_eta_centroid_1_1_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_divdiv_stokes_T_p2_dep_eta_centroid_1_1_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta )
   : p2_divdiv_stokes_T_p2_dep_eta_centroid_1_1_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_divdiv_stokes_T_p2_dep_eta_centroid_1_1_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_divdiv_stokes_T_p2_dep_eta_centroid_1_2_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_divdiv_stokes_T_p2_dep_eta_centroid_1_2_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta )
   : p2_divdiv_stokes_T_p2_dep_eta_centroid_1_2_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_divdiv_stokes_T_p2_dep_eta_centroid_1_2_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_divdiv_stokes_T_p2_dep_eta_centroid_2_0_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_divdiv_stokes_T_p2_dep_eta_centroid_2_0_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta )
   : p2_divdiv_stokes_T_p2_dep_eta_centroid_2_0_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_divdiv_stokes_T_p2_dep_eta_centroid_2_0_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_divdiv_stokes_T_p2_dep_eta_centroid_2_1_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_divdiv_stokes_T_p2_dep_eta_centroid_2_1_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta )
   : p2_divdiv_stokes_T_p2_dep_eta_centroid_2_1_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_divdiv_stokes_T_p2_dep_eta_centroid_2_1_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
...
/// Blending: True
/// Quadrature degree: 4
class p2_divdiv_stokes_T_p2_dep_eta_centroid_2_2_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_divdiv_stokes_T_p2_dep_eta_centroid_2_2_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta )
   : p2_divdiv_stokes_T_p2_dep_eta_centroid_2_2_blending_q4_ElementwiseOperator( storage, minLevel, maxLevel, false, T, eta )
   {}
   p2_divdiv_stokes_T_p2_dep_eta_centroid_2_2_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
