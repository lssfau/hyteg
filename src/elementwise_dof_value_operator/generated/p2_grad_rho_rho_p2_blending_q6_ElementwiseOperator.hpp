...
/// Blending: True
/// Quadrature degree: 6
class p2_grad_rho_rho_p2_0_blending_q6_ElementwiseOperator : public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
 ...
 public:
   p2_grad_rho_rho_p2_0_blending_q6_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         size_t                                     minLevel,
                                                         size_t                                     maxLevel,
                                                         P2Function< real_t >&                      rho )
   : p2_grad_rho_rho_p2_0_blending_q6_ElementwiseOperator( storage, minLevel, maxLevel, false, rho )
   {}
   p2_grad_rho_rho_p2_0_blending_q6_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         size_t                                     minLevel,
                                                         size_t                                     maxLevel,
                                                         ...
                                                         P2Function< real_t >&                      rho )
   : P2ElementwiseDoFValueOperator< P2Function< real_t > >( storage, minLevel, maxLevel, false, rho )
   {
...
/// Blending: True
/// Quadrature degree: 6
class p2_grad_rho_rho_p2_1_blending_q6_ElementwiseOperator : public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
   typedef P2Function< real_t >                                  dstFunctionType;
 ...
 public:
   p2_grad_rho_rho_p2_1_blending_q6_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         size_t                                     minLevel,
                                                         size_t                                     maxLevel,
                                                         P2Function< real_t >&                      rho )
   : p2_grad_rho_rho_p2_1_blending_q6_ElementwiseOperator( storage, minLevel, maxLevel, false, rho )
   {}
   p2_grad_rho_rho_p2_1_blending_q6_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         size_t                                     minLevel,
                                                         size_t                                     maxLevel,
...
/// Blending: True
/// Quadrature degree: 6
class p2_grad_rho_rho_p2_2_blending_q6_ElementwiseOperator : public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
   typedef P2Function< real_t >                                  dstFunctionType;
 ...
 public:
   p2_grad_rho_rho_p2_2_blending_q6_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         size_t                                     minLevel,
                                                         size_t                                     maxLevel,
                                                         P2Function< real_t >&                      rho )
   : p2_grad_rho_rho_p2_2_blending_q6_ElementwiseOperator( storage, minLevel, maxLevel, false, rho )
   {}
   p2_grad_rho_rho_p2_2_blending_q6_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         size_t                                     minLevel,
                                                         size_t                                     maxLevel,
