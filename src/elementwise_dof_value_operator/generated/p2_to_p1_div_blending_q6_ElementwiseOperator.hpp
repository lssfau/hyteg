...
// This operator is used to test the functionality of the P2ToP1ElementwiseDoFValueOperators. It should not be used elsewhere due to unnecessary dummy function usage. DO NOT REMOVE.
...
/// Blending: True
/// Quadrature degree: 6
class p2_to_p1_div_0_blending_q6_ElementwiseOperator : public P2ToP1ElementwiseDoFValueOperator< P2Function< real_t > >
{
 ...
 public:
   p2_to_p1_div_0_blending_q6_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                   size_t                                     minLevel,
                                                   size_t                                     maxLevel,
                                                   P2Function< real_t >&                      dummy )
   : P2ToP1ElementwiseDoFValueOperator< P2Function< real_t > >( storage, minLevel, maxLevel, dummy )
   {}
...
/// Blending: True
/// Quadrature degree: 6
class p2_to_p1_div_1_blending_q6_ElementwiseOperator : public P2ToP1ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ToP1ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                      srcFunctionType;
   typedef P1Function< real_t >                                      dstFunctionType;
 ...
 public:
   p2_to_p1_div_1_blending_q6_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                   size_t                                     minLevel,
                                                   size_t                                     maxLevel,
                                                   P2Function< real_t >&                      dummy )
   : P2ToP1ElementwiseDoFValueOperator< P2Function< real_t > >( storage, minLevel, maxLevel, dummy )
...
/// Blending: True
/// Quadrature degree: 6
class p2_to_p1_div_2_blending_q6_ElementwiseOperator : public P2ToP1ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ToP1ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                      srcFunctionType;
   typedef P1Function< real_t >                                      dstFunctionType;
 ...
 public:
   p2_to_p1_div_2_blending_q6_ElementwiseOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                   size_t                                     minLevel,
                                                   size_t                                     maxLevel,
                                                   P2Function< real_t >&                      dummy )
   : P2ToP1ElementwiseDoFValueOperator< P2Function< real_t > >( storage, minLevel, maxLevel, dummy )
