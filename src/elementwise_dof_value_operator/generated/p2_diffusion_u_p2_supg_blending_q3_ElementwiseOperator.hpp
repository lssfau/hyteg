...
/// SUPG diffusion operator. This corresponds to the SUPG bilinear form for both div_k_grad and diffusion_inv_rho.
///
...
///    };
///
///    std::function< real_t( const Point3D&, real_t ) > diffusion_supg_scaling = [&]( const Point3D& x, real_t u_abs ) {
///       return delta( x, u_abs ) * k / ( Pe * rho( x ) * C_p );
///    };
///
/// Weak formulation:
///
///    T: trial (scalar space: P2)
///    w: test (scalar space: P2)
///    u: coefficient (vector space: P2)
///    scaling: arbitrary SUPG std::function coefficient
///
///    -∫ scaling (∇ · ∇T) (u · ∇w)
///
/// Blending: True
/// Quadrature degree: 3
class p2_diffusion_u_p2_supg_blending_q3_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t >, P2Function< real_t >, P2Function< real_t > >
{
 ...
 public:
   p2_diffusion_u_p2_supg_blending_q3_ElementwiseOperator(
       ...
       std::function< real_t( const Point3D&, real_t ) > diffusion_supg_scaling )
   : p2_diffusion_u_p2_supg_blending_q3_ElementwiseOperator( storage,
                                                             minLevel,
                                                             maxLevel,
                                                             false,
                                                             uX,
   ...
   : P2ElementwiseDoFValueOperator< P2Function< real_t >, P2Function< real_t >, P2Function< real_t > >( storage,
                                                                                                        ...
                                                                                                        uY,
                                                                                                        uZ )
   , diffusion_supg_scaling_( diffusion_supg_scaling )
   {
 ...
 private:
   std::function< real_t( const Point3D&, real_t ) > diffusion_supg_scaling_;
};
