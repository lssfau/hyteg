...
/// Implements the fully coupled viscous operator of the Stokes problem with scaled divdiv term.
///
/// The strong representation of the operator is given by:
///
///    - div[ μ (grad(u)+grad(u)ᵀ) ] + k 2/dim grad[ μ div(u) ]
///
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_0_0_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
   typedef P2Function< real_t >                                  dstFunctionType;

 public:
   p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_0_0_blending_q4_ElementwiseOperator(
   ...
   : p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_0_0_blending_q4_ElementwiseOperator( storage,
                                                                                             minLevel,
                                                                                             maxLevel,
                                                                                             false,
                                                                                             T,
   ...
   p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_0_0_blending_q4_ElementwiseOperator(
       ...
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta,
       std::function< real_t( const Point3D& ) >                                         k )
   : P2ElementwiseDoFValueOperator< P2Function< real_t > >( storage, minLevel, maxLevel, false, T )
   , eta_( eta )
   , k_( k )
   {
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_0_1_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_0_1_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta,
       std::function< real_t( const Point3D& ) >                                         k )
   : p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_0_1_blending_q4_ElementwiseOperator( storage,
                                                                                             minLevel,
                                                                                             maxLevel,
                                                                                             false,
                                                                                             T,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_0_2_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_0_2_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta,
       std::function< real_t( const Point3D& ) >                                         k )
   : p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_0_2_blending_q4_ElementwiseOperator( storage,
                                                                                             minLevel,
                                                                                             maxLevel,
                                                                                             false,
                                                                                             T,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_1_0_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_1_0_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta,
       std::function< real_t( const Point3D& ) >                                         k )
   : p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_1_0_blending_q4_ElementwiseOperator( storage,
                                                                                             minLevel,
                                                                                             maxLevel,
                                                                                             false,
                                                                                             T,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_1_1_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_1_1_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta,
       std::function< real_t( const Point3D& ) >                                         k )
   : p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_1_1_blending_q4_ElementwiseOperator( storage,
                                                                                             minLevel,
                                                                                             maxLevel,
                                                                                             false,
                                                                                             T,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_1_2_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_1_2_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta,
       std::function< real_t( const Point3D& ) >                                         k )
   : p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_1_2_blending_q4_ElementwiseOperator( storage,
                                                                                             minLevel,
                                                                                             maxLevel,
                                                                                             false,
                                                                                             T,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_2_0_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_2_0_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta,
       std::function< real_t( const Point3D& ) >                                         k )
   : p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_2_0_blending_q4_ElementwiseOperator( storage,
                                                                                             minLevel,
                                                                                             maxLevel,
                                                                                             false,
                                                                                             T,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_2_1_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_2_1_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta,
       std::function< real_t( const Point3D& ) >                                         k )
   : p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_2_1_blending_q4_ElementwiseOperator( storage,
                                                                                             minLevel,
                                                                                             maxLevel,
                                                                                             false,
                                                                                             T,
...
/// Blending: True
/// Quadrature degree: 4
class p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_2_2_blending_q4_ElementwiseOperator
: public P2ElementwiseDoFValueOperator< P2Function< real_t > >
{
   typedef P2ElementwiseDoFValueOperator< P2Function< real_t > > baseClass;
   typedef P2Function< real_t >                                  srcFunctionType;
 ...
 public:
   p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_2_2_blending_q4_ElementwiseOperator(
       const std::shared_ptr< PrimitiveStorage >&                                        storage,
       size_t                                                                            minLevel,
       size_t                                                                            maxLevel,
       P2Function< real_t >&                                                             T,
       std::function< real_t( const Point3D&, real_t, real_t, real_t, real_t, real_t ) > eta,
       std::function< real_t( const Point3D& ) >                                         k )
   : p2_full_stokes_T_p2_dep_eta_centroid_scaled_divdiv_2_2_blending_q4_ElementwiseOperator( storage,
                                                                                             minLevel,
                                                                                             maxLevel,
                                                                                             false,
                                                                                             T,
