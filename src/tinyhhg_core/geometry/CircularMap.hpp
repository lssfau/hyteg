...
public:
      ...
      : FaceMap2D(face), center_(center), radius_(radius)
  {
    ...
    x2[0] = vertex.getCoordinates()[0];
    x2[1] = vertex.getCoordinates()[1];
    x3[0] = edge.getCoordinates()[1][0];
    x3[1] = edge.getCoordinates()[1][1];
