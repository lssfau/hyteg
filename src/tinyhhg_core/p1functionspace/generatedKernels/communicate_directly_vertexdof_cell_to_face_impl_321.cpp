...
static void communicate_directly_vertexdof_cell_to_face_impl_321_level_any(double const * RESTRICT const _data_p1_cell_src, double * RESTRICT _data_p1_face_dst_gl0, int64_t level)
{
   {
...
void communicate_directly_vertexdof_cell_to_face_impl_321(double const * RESTRICT const _data_p1_cell_src, double * RESTRICT _data_p1_face_dst_gl0, int64_t level)
{
    switch( level )
    {
