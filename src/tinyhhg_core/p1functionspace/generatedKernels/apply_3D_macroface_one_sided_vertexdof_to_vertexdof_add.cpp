...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_012(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_013(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_021(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_023(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
   const double xi_2 = p1FaceStencil[{ 1, -1, 0 }];
   const double xi_3 = p1FaceStencil[{ 1, 0, -1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_031(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
   const double xi_2 = p1FaceStencil[{ 0, 1, -1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_032(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
   const double xi_2 = p1FaceStencil[{ 1, 0, -1 }];
   const double xi_3 = p1FaceStencil[{ 1, -1, 0 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_102(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_103(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_120(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
   const double xi_2 = p1FaceStencil[{ 0, -1, 1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_123(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
   const double xi_2 = p1FaceStencil[{ 0, -1, 0 }];
   const double xi_3 = p1FaceStencil[{ 0, 0, -1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_130(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
   const double xi_2 = p1FaceStencil[{ 0, 1, -1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_132(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
   const double xi_2 = p1FaceStencil[{ 0, 0, -1 }];
   const double xi_3 = p1FaceStencil[{ 0, -1, 0 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_201(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
   const double xi_2 = p1FaceStencil[{ 0, 0, 1 }];
   const double xi_3 = p1FaceStencil[{ -1, 0, 1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_203(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_210(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
   const double xi_2 = p1FaceStencil[{ -1, 0, 1 }];
   const double xi_3 = p1FaceStencil[{ 0, 0, 1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_213(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
   const double xi_2 = p1FaceStencil[{ -1, 0, 0 }];
   const double xi_3 = p1FaceStencil[{ 0, 0, -1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_230(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
   const double xi_2 = p1FaceStencil[{ 1, 0, -1 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_231(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
   const double xi_2 = p1FaceStencil[{ 0, 0, -1 }];
   const double xi_3 = p1FaceStencil[{ -1, 0, 0 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_301(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
   const double xi_2 = p1FaceStencil[{ 0, 1, 0 }];
   const double xi_3 = p1FaceStencil[{ -1, 1, 0 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_302(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
   const double xi_2 = p1FaceStencil[{ 1, 0, 0 }];
   const double xi_3 = p1FaceStencil[{ 1, -1, 0 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_310(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
   const double xi_2 = p1FaceStencil[{ -1, 1, 0 }];
   const double xi_3 = p1FaceStencil[{ 0, 1, 0 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_312(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
   const double xi_2 = p1FaceStencil[{ -1, 0, 0 }];
   const double xi_3 = p1FaceStencil[{ 0, -1, 0 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_320(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ 1, -1, 1 }];
   const double xi_2 = p1FaceStencil[{ 1, -1, 0 }];
   const double xi_3 = p1FaceStencil[{ 1, 0, 0 }];
...
static void apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add_321(double * RESTRICT _data_p1FaceDst, double const * RESTRICT const _data_p1FaceSrc, double const * RESTRICT const _data_p1FaceSrc_gl0, int64_t level, std::map< hhg::indexing::IndexIncrement, double > p1FaceStencil)
{
   const double xi_1 = p1FaceStencil[{ -1, 1, -1 }];
   const double xi_2 = p1FaceStencil[{ 0, -1, 0 }];
   const double xi_3 = p1FaceStencil[{ -1, 0, 0 }];
