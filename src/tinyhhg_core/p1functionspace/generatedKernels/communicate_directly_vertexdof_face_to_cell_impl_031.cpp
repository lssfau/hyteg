...
static void communicate_directly_vertexdof_face_to_cell_impl_031_level_any(double * RESTRICT _data_p1_cell_dst, double const * RESTRICT const _data_p1_face_src, int64_t level)
{
   {
...
void communicate_directly_vertexdof_face_to_cell_impl_031(double * RESTRICT _data_p1_cell_dst, double const * RESTRICT const _data_p1_face_src, int64_t level)
{
    switch( level )
    {
