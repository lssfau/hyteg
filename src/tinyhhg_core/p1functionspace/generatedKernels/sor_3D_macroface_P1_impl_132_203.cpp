...
void sor_3D_macroface_P1_impl_132_203(double * RESTRICT _data_vertexFaceDst, double * RESTRICT _data_vertexFaceDst_gl0, double * RESTRICT _data_vertexFaceDst_gl1, double const * RESTRICT const _data_vertexFaceRhs, int64_t level, double relax, std::map< hhg::indexing::IndexIncrement, double > v2v_cell_stencil_fused_face_0, std::map< hhg::indexing::IndexIncrement, double > v2v_cell_stencil_fused_face_1)
{
    ...
    default:
        sor_3D_macroface_P1_impl_132_203_level_any(_data_vertexFaceDst, _data_vertexFaceDst_gl0, _data_vertexFaceDst_gl1, _data_vertexFaceRhs, level, relax, v2v_cell_stencil_fused_face_0, v2v_cell_stencil_fused_face_1);
        break;
    }
}
