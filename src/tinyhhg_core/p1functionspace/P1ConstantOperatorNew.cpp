#include "P1ConstantOperatorNew.hpp"
...
P1ConstantOperatorNew< P1Form, Diagonal, Lumped, InvertDiagonal >::P1ConstantOperatorNew(
...
template < class P1Form, bool Diagonal, bool Lumped, bool InvertDiagonal >
void P1ConstantOperatorNew< P1Form, Diagonal, Lumped, InvertDiagonal >::assembleStencils3D()
{
...
template < class P1Form, bool Diagonal, bool Lumped, bool InvertDiagonal >
void P1ConstantOperatorNew< P1Form, Diagonal, Lumped, InvertDiagonal >::assembleStencils()
{
   ...
   for( uint_t level = minLevel_; level <= maxLevel_; ++level )
   {
      for( auto& it : storage_->getFaces() )
      {
         ...
         vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dirW, x + dirS}, P1Elements::P1Elements2D::elementSW, face_stencil );
         vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dirS, x + dirSE}, P1Elements::P1Elements2D::elementS, face_stencil );
         vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dirSE, x + dirE}, P1Elements::P1Elements2D::elementSE, face_stencil );
         vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dirE, x + dirN}, P1Elements::P1Elements2D::elementNE, face_stencil );
         vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dirN, x + dirNW}, P1Elements::P1Elements2D::elementN, face_stencil );
         vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dirNW, x + dirW}, P1Elements::P1Elements2D::elementNW, face_stencil );
      ...
      for( auto& it : storage_->getEdges() )
      {
         ...
         vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dir_W, x + dir_S}, P1Elements::P1Elements2D::elementSW, edge_stencil );
         vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dir_S, x + dir_SE}, P1Elements::P1Elements2D::elementS, edge_stencil );
         vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dir_SE, x + dir_E}, P1Elements::P1Elements2D::elementSE, edge_stencil );

         if( edge.getNumNeighborFaces() == 2 )
         {
            form.geometryMap = faceN->getGeometryMap();
            vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dir_E, x + dir_N}, P1Elements::P1Elements2D::elementNE, edge_stencil );
            vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dir_N, x + dir_NW}, P1Elements::P1Elements2D::elementN, edge_stencil );
            vertexdof::variablestencil::assembleLocalStencil< P1Form >( form, {x, x + dir_NW, x + dir_W}, P1Elements::P1Elements2D::elementNW, edge_stencil );
         }
...
template<class P1Form, bool Diagonal, bool Lumped, bool InvertDiagonal>
void P1ConstantOperatorNew<P1Form, Diagonal, Lumped, InvertDiagonal>::apply(const P1Function<real_t> &src,
...
template<class P1Form, bool Diagonal, bool Lumped, bool InvertDiagonal>
void P1ConstantOperatorNew<P1Form, Diagonal, Lumped, InvertDiagonal>::smooth_gs(
    const P1Function<real_t> &dst,
...
template < class P1Form, bool Diagonal, bool Lumped, bool InvertDiagonal >
void P1ConstantOperatorNew< P1Form, Diagonal, Lumped, InvertDiagonal >::smooth_sor(
    const P1Function< real_t >& dst,
    const P1Function< real_t >& rhs,
    real_t                      relax,
    size_t                      level,
...
template < class P1Form, bool Diagonal, bool Lumped, bool InvertDiagonal >
void P1ConstantOperatorNew< P1Form, Diagonal, Lumped, InvertDiagonal >::smooth_jac(
    const P1Function< real_t >& dst,
    const P1Function< real_t >& rhs,
...
template<class P1Form, bool Diagonal, bool Lumped, bool InvertDiagonal>
void P1ConstantOperatorNew<P1Form, Diagonal, Lumped, InvertDiagonal>::scale(real_t scalar) {
   for( uint_t level = minLevel_; level <= maxLevel_; ++level )
   {
      for( auto& it : storage_->getFaces() )
      {
...
template class P1ConstantOperatorNew< P1FenicsForm< p1_diffusion_cell_integral_0_otherwise > >;
