...
class P2Function : public Function< P2Function< ValueType > >
{
 public:
  ...
  using FunctionType = P2Function< VType >;
   ...
   void swap( const P2Function< ValueType > & other,
                     const uint_t & level,
   ...
   void prolongateP1ToP2( const hhg::P1Function< ValueType >& p1Function,
                                 const uint_t& level,
                                 const DoFType& flag = All ) const;

   void restrictP2ToP1( const P1Function< ValueType >& p1Function,
                               const uint_t&                                     level,
                               const DoFType&                                    flag = All ) const;
