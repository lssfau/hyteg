...
//                        Edge&                                                    edge,
//                        const PrimitiveDataID< StencilMemory< double >, Edge >&  vertexDoFStencilID,
//                        const PrimitiveDataID< FunctionMemory< real_t >, Edge >& dstVertexDoFID,
//                        const PrimitiveDataID< StencilMemory< double >, Edge >&  edgeDoFStencilID,
...
//      {
//         tmp -=
//             edgeDoFStencil[edgedof::stencilIndexFromVertex( edgedof::macroedge::neighborsOnSouthFaceFromVertex[k] )] *
...
//                   dstEdgeDoF[edgedof::macroedge::indexFromVertex(
//                       Level, i, edgedof::macroedge::neighborsOnNorthFaceFromVertex[k] )];
//         }
//      }
//
...
//void smoothGSvertexDoF( const uint_t&                                            Level,
//                        Face&                                                    face,
//                        const PrimitiveDataID< StencilMemory< double >, Face >&  vertexDoFStencilID,
...
//                   dstVertexDoF[vertexdof::macroface::indexFromVertex(
//                       Level, col, row, vertexdof::macroface::neighborsWithoutCenter[k] )];
//         }
...
//         }
//         dstVertexDoF[vertexdof::macroface::indexFromVertex( Level, col, row, stencilDirection::VERTEX_C )] =
//             tmp / vertexDoFStencil[vertexdof::stencilIndexFromVertex( stencilDirection::VERTEX_C )];
//      }
//      --inner_rowsize;
//   }
...
//                   dstEdgeDoF[edgedof::macroface::indexFromHorizontalEdge(
...
//                   dstVertexDoF[vertexdof::macroface::indexFromHorizontalEdge(
...
//                   dstEdgeDoF[edgedof::macroface::indexFromDiagonalEdge(
...
//                dstVertexDoF[vertexdof::macroface::indexFromDiagonalEdge(
...
//                   dstEdgeDoF[edgedof::macroface::indexFromVerticalEdge(
...
//                dstVertexDoF[vertexdof::macroface::indexFromVerticalEdge(
