...
class UzawaSmoother : public Solver< OperatorType >
{
 public:
   ...
   UzawaSmoother( bool hasGlobalCells, real_t relaxParam, hhg::DoFType flag = hhg::Inner | hhg::NeumannBoundary )
   : flag_( flag )
 ...
 private:
                     ...
                     std::false_type /* PSPG */ )
   {
      ...
      pspg_.smooth_sor( tmp_.p, r_.p, relaxParam_, level, flag_ | DirichletBoundary );
