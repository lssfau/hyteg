...
constexpr inline uint_t indexDGFaceFromVertex( const uint_t & level, const uint_t col, const uint_t row, const stencilDirection dir ) {
...
constexpr inline uint_t indexDGFaceFromGrayDGface( const uint_t & level, const uint_t col, const uint_t row, const stencilDirection dir ) {
...
constexpr inline uint_t indexDGFaceFromBlueDGface( const uint_t & level, const uint_t col, const uint_t row, const stencilDirection dir ) {
  typedef hhg::stencilDirection sD;
  switch(dir){
    case sD::CELL_GRAY_E:
