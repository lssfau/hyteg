...
static void apply_3D_macroface_one_sided_vertexdof_to_edgedof_replace_021_level_any(double * RESTRICT _data_edgeFaceDst_X, double * RESTRICT _data_edgeFaceDst_XY, double * RESTRICT _data_edgeFaceDst_Y, double const * RESTRICT const _data_vertexFaceSrc, double const * RESTRICT const _data_vertexFaceSrc_gl0, int32_t level, std::map< hhg::edgedof::EdgeDoFOrientation, std::map< hhg::indexing::IndexIncrement, double > > v2e_cell_stencil)
{
   ...
   const double xi_95 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::X][{ 0, 0, 0 }];
   const double xi_96 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::X][{ 0, 0, 1 }];
   const double xi_97 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::X][{ 0, 1, 0 }];
   const double xi_98 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::X][{ 1, -1, 0 }];
   const double xi_99 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::X][{ 1, -1, 1 }];
   const double xi_100 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::X][{ 1, 0, 0 }];
   const double xi_143 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Y][{ -1, 1, 0 }];
   const double xi_144 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Y][{ 0, 0, 0 }];
   const double xi_145 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Y][{ 0, 0, 1 }];
   const double xi_146 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Y][{ 0, 1, 0 }];
   const double xi_147 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Y][{ 1, 0, 0 }];
   {
      ...
      for (int ctr_2 = 1; ctr_2 < (1 << (level)) - 1; ctr_2 += 1)
      {
         ...
         for (int ctr_1 = 0; ctr_1 < 1; ctr_1 += 1)
         {
            ...
            const double xi_160 = xi_147*_data_vertexFaceSrc[ctr_1 + (ctr_2 + 1)*((1 << (level)) + 2) - (((ctr_2 + 1)*(ctr_2 + 2)) / (2))];
            ...
            const double xi_165 = xi_43*_data_vertexFaceSrc_gl0[ctr_1 + (ctr_2 + 1)*((1 << (level)) + 1) - (((ctr_2 + 1)*(ctr_2 + 2)) / (2))];
         ...
         for (int ctr_1 = 1; ctr_1 < -ctr_2 + (1 << (level)) - 1; ctr_1 += 1)
         {
            ...
            const double xi_24 = xi_147*_data_vertexFaceSrc[ctr_1 + (ctr_2 + 1)*((1 << (level)) + 2) - (((ctr_2 + 1)*(ctr_2 + 2)) / (2))];
         ...
         {
            const double xi_130 = xi_143*_data_vertexFaceSrc[ctr_1 + (ctr_2 - 1)*((1 << (level)) + 2) - ((ctr_2*(ctr_2 - 1)) / (2)) + 1];
            ...
            const double xi_134 = xi_147*_data_vertexFaceSrc[ctr_1 + (ctr_2 + 1)*((1 << (level)) + 2) - (((ctr_2 + 1)*(ctr_2 + 2)) / (2))];
            const double xi_135 = xi_95*_data_vertexFaceSrc[ctr_1 + ctr_2*((1 << (level)) + 2) - ((ctr_2*(ctr_2 + 1)) / (2))];
            const double xi_136 = xi_96*_data_vertexFaceSrc_gl0[ctr_1 + ctr_2*((1 << (level)) + 1) - ((ctr_2*(ctr_2 + 1)) / (2))];
            const double xi_137 = xi_97*_data_vertexFaceSrc[ctr_1 + ctr_2*((1 << (level)) + 2) - ((ctr_2*(ctr_2 + 1)) / (2)) + 1];
            const double xi_138 = xi_98*_data_vertexFaceSrc[ctr_1 + (ctr_2 + 1)*((1 << (level)) + 2) - (((ctr_2 + 1)*(ctr_2 + 2)) / (2)) - 1];
            const double xi_139 = xi_99*_data_vertexFaceSrc_gl0[ctr_1 + (ctr_2 + 1)*((1 << (level)) + 1) - (((ctr_2 + 1)*(ctr_2 + 2)) / (2)) - 1];
            const double xi_140 = xi_100*_data_vertexFaceSrc[ctr_1 + (ctr_2 + 1)*((1 << (level)) + 2) - (((ctr_2 + 1)*(ctr_2 + 2)) / (2))];
      ...
      for (int ctr_2 = (1 << (level)) - 1; ctr_2 < (1 << (level)); ctr_2 += 1)
      {
         ...
         for (int ctr_1 = 0; ctr_1 < 1; ctr_1 += 1)
         {
            const double xi_78 = xi_143*_data_vertexFaceSrc[ctr_1 + (ctr_2 - 1)*((1 << (level)) + 2) - ((ctr_2*(ctr_2 - 1)) / (2)) + 1];
            const double xi_79 = xi_144*_data_vertexFaceSrc[ctr_1 + ctr_2*((1 << (level)) + 2) - ((ctr_2*(ctr_2 + 1)) / (2))];
            const double xi_80 = xi_145*_data_vertexFaceSrc_gl0[ctr_1 + ctr_2*((1 << (level)) + 1) - ((ctr_2*(ctr_2 + 1)) / (2))];
            const double xi_81 = xi_146*_data_vertexFaceSrc[ctr_1 + ctr_2*((1 << (level)) + 2) - ((ctr_2*(ctr_2 + 1)) / (2)) + 1];
            const double xi_82 = xi_147*_data_vertexFaceSrc[ctr_1 + (ctr_2 + 1)*((1 << (level)) + 2) - (((ctr_2 + 1)*(ctr_2 + 2)) / (2))];
