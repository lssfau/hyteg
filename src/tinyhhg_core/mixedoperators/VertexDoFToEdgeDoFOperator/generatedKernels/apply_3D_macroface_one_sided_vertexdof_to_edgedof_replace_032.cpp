...
static void apply_3D_macroface_one_sided_vertexdof_to_edgedof_replace_032_level_any(double * RESTRICT _data_edgeFaceDst_X, double * RESTRICT _data_edgeFaceDst_XY, double * RESTRICT _data_edgeFaceDst_Y, double const * RESTRICT const _data_vertexFaceSrc, double const * RESTRICT const _data_vertexFaceSrc_gl0, int32_t level, std::map< hhg::edgedof::EdgeDoFOrientation, std::map< hhg::indexing::IndexIncrement, double > > v2e_cell_stencil)
{
   ...
   const double xi_115 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Z][{ 0, -1, 1 }];
   const double xi_116 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Z][{ 0, 0, 0 }];
   const double xi_117 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Z][{ 0, 0, 1 }];
   const double xi_118 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Z][{ 0, 1, 0 }];
   const double xi_119 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Z][{ 1, -1, 1 }];
   const double xi_120 = v2e_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Z][{ 1, 0, 0 }];
   {
