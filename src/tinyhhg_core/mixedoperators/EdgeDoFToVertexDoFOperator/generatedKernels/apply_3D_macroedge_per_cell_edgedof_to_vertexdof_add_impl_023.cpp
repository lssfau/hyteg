...
static void apply_3D_macroedge_per_cell_edgedof_to_vertexdof_add_impl_023_level_any(double const * RESTRICT const _data_edgeEdgeSrc, double * RESTRICT _data_vertexEdgeDst, int64_t cell_id, std::map< hhg::edgedof::EdgeDoFOrientation, std::map< hhg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t face_id_0, int64_t face_id_1, int32_t level, int64_t num_neighbor_faces)
{
   const double xi_1 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::XYZ][{ 0, -1, 0 }];
   const double xi_2 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::XY][{ 0, -1, 0 }];
   const double xi_3 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::XY][{ 0, -1, 1 }];
   const double xi_4 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::XY][{ 0, 0, 0 }];
   const double xi_5 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::XZ][{ 0, -1, 0 }];
   const double xi_6 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::XZ][{ 0, 0, 0 }];
   const double xi_7 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::X][{ 0, -1, 0 }];
   const double xi_8 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::X][{ 0, -1, 1 }];
   const double xi_9 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::X][{ 0, 0, 0 }];
   const double xi_10 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::YZ][{ 0, -1, 0 }];
   const double xi_11 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::YZ][{ 0, 0, 0 }];
   const double xi_12 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::YZ][{ 1, -1, 0 }];
   const double xi_13 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Y][{ 0, -1, 0 }];
   const double xi_14 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Y][{ 0, -1, 1 }];
   const double xi_15 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Y][{ 0, 0, 0 }];
   const double xi_16 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Y][{ 1, -1, 0 }];
   const double xi_17 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Z][{ 0, -1, 0 }];
   const double xi_18 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Z][{ 0, 0, 0 }];
   const double xi_19 = e2v_cell_stencil[hhg::edgedof::EdgeDoFOrientation::Z][{ 1, -1, 0 }];
   // inner edge
...
void apply_3D_macroedge_per_cell_edgedof_to_vertexdof_add_impl_023(double const * RESTRICT const _data_edgeEdgeSrc, double * RESTRICT _data_vertexEdgeDst, int64_t cell_id, std::map< hhg::edgedof::EdgeDoFOrientation, std::map< hhg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t face_id_0, int64_t face_id_1, int32_t level, int64_t num_neighbor_faces)
{
    switch( level )
    {
