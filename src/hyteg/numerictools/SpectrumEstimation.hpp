                                                 ...
                                                 const uint_t                               level )
{
   ...
   itrVec.assign( { walberla::numeric_cast< ValueType >( real_c( 1.0 ) / norm ) }, { itrVec }, level, hyteg::All );
   ...
   for ( uint_t it = 1; it <= numIts; ++it )
   {
      ...
      itrVec.assign( { walberla::numeric_cast< ValueType >( real_c( 1.0 ) / norm ) }, { auxVec }, level, hyteg::All );
      op.apply( itrVec, auxVec, level, hyteg::All );
