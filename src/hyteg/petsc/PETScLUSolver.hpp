...
namespace hyteg {
    ...
    public:
        ...
        PETScLUSolver(const std::shared_ptr<PrimitiveStorage> &storage, const uint_t &level,     const typename OperatorType::srcType::template FunctionType< idx_t >& numerator)
