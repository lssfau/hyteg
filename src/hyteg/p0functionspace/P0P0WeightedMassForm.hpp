...
class P0P0WeightedMassForm : public hyteg::dg::DGForm
{
 ...
 protected:
                           ...
                           MatrixXr&                     elMat ) const override
   {
      ...
      real_t a_0_0 = 0.11169079483900572 * tmp_0 / std::pow( Scalar_Variable_Coefficient_2D_k_out0_id5, 1.0 / 2.0 ) +
                     0.054975871827660928 * tmp_0 / std::pow( Scalar_Variable_Coefficient_2D_k_out0_id4, 1.0 / 2.0 ) +
                     0.11169079483900572 * tmp_0 / std::pow( Scalar_Variable_Coefficient_2D_k_out0_id3, 1.0 / 2.0 ) +
                     0.054975871827660928 * tmp_0 / std::pow( Scalar_Variable_Coefficient_2D_k_out0_id2, 1.0 / 2.0 ) +
                     0.11169079483900572 * tmp_0 / std::pow( Scalar_Variable_Coefficient_2D_k_out0_id1, 1.0 / 2.0 ) +
                     0.054975871827660928 * tmp_0 / std::pow( Scalar_Variable_Coefficient_2D_k_out0_id0, 1.0 / 2.0 );
      elMat( 0, 0 ) = a_0_0;
   }
                           ...
                           MatrixXr&                     elMat ) const override
   {
      ...
      real_t tmp_12 =
          0.5 * std::abs( p_affine_0_0 * tmp_2 - p_affine_0_0 * tmp_9 - p_affine_0_1 * tmp_10 + p_affine_0_1 * tmp_5 -
      ...
      real_t a_0_0 = 0.012248840519393657 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id9, 1.0 / 2.0 ) +
                     0.018781320953002646 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id8, 1.0 / 2.0 ) +
                     0.012248840519393657 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id7, 1.0 / 2.0 ) +
                     0.018781320953002646 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id6, 1.0 / 2.0 ) +
                     0.0070910034628469103 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id5, 1.0 / 2.0 ) +
                     0.0070910034628469103 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id4, 1.0 / 2.0 ) +
                     0.0070910034628469103 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id3, 1.0 / 2.0 ) +
                     0.0070910034628469103 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id2, 1.0 / 2.0 ) +
                     0.0070910034628469103 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id13, 1.0 / 2.0 ) +
                     0.0070910034628469103 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id12, 1.0 / 2.0 ) +
                     0.012248840519393657 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id11, 1.0 / 2.0 ) +
                     0.018781320953002646 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id10, 1.0 / 2.0 ) +
                     0.012248840519393657 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id1, 1.0 / 2.0 ) +
                     0.018781320953002646 * tmp_12 / std::pow( Scalar_Variable_Coefficient_3D_k_out0_id0, 1.0 / 2.0 );
      elMat( 0, 0 ) = a_0_0;
   }
