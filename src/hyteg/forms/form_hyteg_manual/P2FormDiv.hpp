...
class P2Form_div : public P2FormHyTeG
{
 public:
   void integrateAll( const std::array< Point3D, 3 >& coords, Matrix6r& elMat ) const final
   {
      WALBERLA_ABORT( "P2FormDiv not implemented for requested template value (direction)!" );
   };
...
// --------
template <>
class P2Form_div< 0 > : public P2FormHyTeG
{
 public:
   void integrateAll( const std::array< Point3D, 3 >& coords, Matrix6r& elMat ) const final
   {
...
#define INTEGRATE2D( i, j )                                                                                     \
   ...
   {                                                                                                            \
      ...
      real_t aux6 = ( DPsi( 1, 1 ) * aux4 - DPsi( 1, 0 ) * aux5 ) / detDPsi;                                    \
                                                                                                                \
      elMat( i, j ) -= QUADWEIGHTS[k] * detJacPhiInv * aux6 * std::abs( detDPsi ) * SF_N##i;                    \
   }
...
// --------
template <>
class P2Form_div< 1 > : public P2FormHyTeG
{
 public:
   void integrateAll( const std::array< Point3D, 3 >& coords, Matrix6r& elMat ) const final
   {
