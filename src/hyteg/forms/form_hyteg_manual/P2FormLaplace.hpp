...
// "Load" kernel
#include "hyteg/forms/form_hyteg_manual/kernels/p2_laplace_integrateAll_2d.hpp"
   };
...
// "Load" kernel
#include "hyteg/forms/form_hyteg_manual/kernels/p2_laplace_integrateAll_3d.hpp"
   };
};
