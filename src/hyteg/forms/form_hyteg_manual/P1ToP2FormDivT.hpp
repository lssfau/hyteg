...
#define INTEGRATE3D( i, j )                          \
   ...
   {                                                 \
      ...
      elMat( i, j ) -= CUBAWEIGHTS[k] * detPfac * detQfac * diff * SF_M##j; \
   }
...
// =========
template <>
class P1ToP2Form_divt< 2 > : public P1ToP2FormHyTeG
{
 public:
   ...
   void integrateAll( const std::array< Point3D, 3 >& coords, Matrixr< 6, 3 >& elMat ) const final
   {
      WALBERLA_ABORT( "P1ToP2Form_divt<2>.integrateAll not available in 2D!" );
   };
