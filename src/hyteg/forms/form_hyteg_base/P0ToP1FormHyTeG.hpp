...
class P0ToP1FormHyTeG : public Form
{
 public:
   virtual ~P0ToP1FormHyTeG() {}

   virtual void integrateAll( const std::array< Point3D, 3 >& coords, Matrixr< 3, 1 >& elMat ) const = 0;

   virtual void integrateAll( const std::array< Point3D, 4 >& coords, Matrixr< 4, 1 >& elMat ) const = 0;
