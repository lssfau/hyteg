...
#include "hyteg/forms/form_hyteg_base/P1ToP0FormHyTeG.hpp"
...
///
/// - name:        p1_to_p0_div_0_affine_q0
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 0
///
class p1_to_p0_div_0_affine_q0 : public P1ToP0FormHyTeG
{
 ...
 public:
   ...
   ///                                               12      14       1       0      1             19                 0
   ///
   void integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 1, 3 >& elMat ) const override;
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p1_to_p0_div_1_affine_q0
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 0
///
class p1_to_p0_div_1_affine_q0 : public P1ToP0FormHyTeG
{
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p1_to_p0_div_2_affine_q0
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 0
///
class p1_to_p0_div_2_affine_q0 : public P1ToP0FormHyTeG
{
