...
///
/// - name:        p1_to_p2_divt_0_blending_q2
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 2
///
class p1_to_p2_divt_0_blending_q2 : public P1ToP2FormHyTeG
{
 ...
 public:
   ...
   /// - element matrix dimensions (rows, cols): (6, 3)
   ...
   /// - element matrix dimensions (rows, cols): (10, 4)
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p1_to_p2_divt_1_blending_q2
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 2
///
class p1_to_p2_divt_1_blending_q2 : public P1ToP2FormHyTeG
{
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p1_to_p2_divt_2_blending_q2
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 2
///
class p1_to_p2_divt_2_blending_q2 : public P1ToP2FormHyTeG
{
