...
#include "p1_to_p2_divt_0_affine_q2.hpp"

namespace hyteg {
namespace forms {

   void p1_to_p2_divt_0_affine_q2::integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 6, 3 >& elMat ) const
   {
   ...
   void p1_to_p2_divt_0_affine_q2::integrateRow0( const std::array< Point3D, 3 >& coords, Matrix< real_t, 1, 3 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      real_t p_affine_1_0 = coords[1][0];
   ...
   void p1_to_p2_divt_0_affine_q2::integrateAll( const std::array< Point3D, 4 >& coords, Matrix< real_t, 10, 4 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      ...
      real_t tmp_14 = p_affine_2_0 + tmp_10;
      real_t tmp_15 = p_affine_3_1 + tmp_1;
      real_t tmp_16 = tmp_15*tmp_7;
      real_t tmp_17 = p_affine_3_0 + tmp_10;
      real_t tmp_18 = tmp_15*tmp_4;
      real_t tmp_19 = tmp_12*tmp_2;
      real_t tmp_20 = 1.0 / (tmp_11*tmp_13 - tmp_11*tmp_18 + tmp_14*tmp_16 - tmp_14*tmp_19 + tmp_17*tmp_5 - tmp_17*tmp_8);
   ...
   void p1_to_p2_divt_0_affine_q2::integrateRow0( const std::array< Point3D, 4 >& coords, Matrix< real_t, 1, 4 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      real_t p_affine_0_2 = coords[0][2];
