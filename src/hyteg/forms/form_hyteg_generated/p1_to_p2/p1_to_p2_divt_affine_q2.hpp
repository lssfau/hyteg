...
///
/// - name:        p1_to_p2_divt_0_affine_q2
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 2
///
class p1_to_p2_divt_0_affine_q2 : public P1ToP2FormHyTeG
{
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p1_to_p2_divt_1_affine_q2
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 2
///
class p1_to_p2_divt_1_affine_q2 : public P1ToP2FormHyTeG
{
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p1_to_p2_divt_2_affine_q2
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 2
///
class p1_to_p2_divt_2_affine_q2 : public P1ToP2FormHyTeG
{
