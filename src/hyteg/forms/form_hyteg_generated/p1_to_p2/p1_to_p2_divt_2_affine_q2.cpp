...
#include "p1_to_p2_divt_2_affine_q2.hpp"

namespace hyteg {
namespace forms {

   void p1_to_p2_divt_2_affine_q2::integrateAll( const std::array< Point3D, 3 >& , Matrix< real_t, 6, 3 >&  ) const
   {
      
   }

   void p1_to_p2_divt_2_affine_q2::integrateRow0( const std::array< Point3D, 3 >& , Matrix< real_t, 1, 3 >&  ) const
   {
      
   }

   void p1_to_p2_divt_2_affine_q2::integrateAll( const std::array< Point3D, 4 >& coords, Matrix< real_t, 10, 4 >& elMat ) const
   {
      ...
      real_t tmp_20 = 1.0 / (tmp_11*tmp_5 - tmp_11*tmp_8 + tmp_12*tmp_14 - tmp_12*tmp_19 + tmp_15*tmp_17 - tmp_15*tmp_18);
      ...
      real_t tmp_25 = tmp_17 - tmp_18;
      real_t tmp_26 = tmp_14 - tmp_19;
   ...
   void p1_to_p2_divt_2_affine_q2::integrateRow0( const std::array< Point3D, 4 >& coords, Matrix< real_t, 1, 4 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      real_t p_affine_0_2 = coords[0][2];
