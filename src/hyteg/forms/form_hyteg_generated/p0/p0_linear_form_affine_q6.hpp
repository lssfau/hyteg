...
///
class p0_linear_form_affine_q6 : public P0FormHyTeG
{

 public:

   p0_linear_form_affine_q6() { WALBERLA_ABORT("Not implemented."); }

   p0_linear_form_affine_q6( std::function< real_t ( const Point3D & ) > _callback_Scalar_Variable_Coefficient_3D_k, std::function< real_t ( const Point3D & ) > _callback_Scalar_Variable_Coefficient_2D_k )
