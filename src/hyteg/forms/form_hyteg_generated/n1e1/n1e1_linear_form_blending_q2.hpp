...
///
/// - name:        n1e1_linear_form_blending_q2
/// - description: Implements a linear form of type: (k(x), psi) where psi a test function and k = k(x) a vectorial, external function.
/// - trial space: N1E1
/// - test space:  N1E1
///
class n1e1_linear_form_blending_q2 : public n1e1::N1E1Form
{

 public:

   n1e1_linear_form_blending_q2() { WALBERLA_ABORT("Not implemented."); }

   n1e1_linear_form_blending_q2( std::function< Point3D ( const Point3D & ) > _callback_Vector_Variable_Coefficient_3D_k )
 ...
 private:
   ...
   void Blending_DF_Tetrahedron_jac_blending( real_t in_0, real_t in_1, real_t in_2, real_t * out_0, real_t * out_1, real_t * out_2, real_t * out_3, real_t * out_4, real_t * out_5, real_t * out_6, real_t * out_7, real_t * out_8 ) const;
