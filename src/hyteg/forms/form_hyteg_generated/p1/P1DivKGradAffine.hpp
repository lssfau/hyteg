...
///
/// - name:        P1DivKGradAffine
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 1
///
class P1DivKGradAffine : public P1FormHyTeG
{

 public:

   P1DivKGradAffine() { WALBERLA_ABORT("Not implemented."); }

   P1DivKGradAffine( std::function< real_t ( const Point3D & ) > _callback3D, std::function< real_t ( const Point3D & ) > _callback2D )
 ...
 public:
   ...
   void integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 3, 3 >& elMat ) const override
   {
      ...
      Scalar_Variable_Coefficient_2D( p_affine_0_0 + q_p_3_0*(-p_affine_0_0 + p_affine_1_0) + q_p_3_1*(-p_affine_0_0 + p_affine_2_0), p_affine_0_1 + q_p_3_0*(-p_affine_0_1 + p_affine_1_1) + q_p_3_1*(-p_affine_0_1 + p_affine_2_1), &Scalar_Variable_Coefficient_2D_3_0 );
   ...
   void integrateAll( const std::array< Point3D, 4 >& coords, Matrix< real_t, 4, 4 >& elMat ) const override
   {
      ...
      Scalar_Variable_Coefficient_3D( p_affine_0_0 + q_p_4_0*(-p_affine_0_0 + p_affine_1_0) + q_p_4_1*(-p_affine_0_0 + p_affine_2_0) + q_p_4_2*(-p_affine_0_0 + p_affine_3_0), p_affine_0_1 + q_p_4_0*(-p_affine_0_1 + p_affine_1_1) + q_p_4_1*(-p_affine_0_1 + p_affine_2_1) + q_p_4_2*(-p_affine_0_1 + p_affine_3_1), p_affine_0_2 + q_p_4_0*(-p_affine_0_2 + p_affine_1_2) + q_p_4_1*(-p_affine_0_2 + p_affine_2_2) + q_p_4_2*(-p_affine_0_2 + p_affine_3_2), &Scalar_Variable_Coefficient_3D_4_0 );
      Scalar_Variable_Coefficient_3D( p_affine_0_0 + q_p_5_0*(-p_affine_0_0 + p_affine_1_0) + q_p_5_1*(-p_affine_0_0 + p_affine_2_0) + q_p_5_2*(-p_affine_0_0 + p_affine_3_0), p_affine_0_1 + q_p_5_0*(-p_affine_0_1 + p_affine_1_1) + q_p_5_1*(-p_affine_0_1 + p_affine_2_1) + q_p_5_2*(-p_affine_0_1 + p_affine_3_1), p_affine_0_2 + q_p_5_0*(-p_affine_0_2 + p_affine_1_2) + q_p_5_1*(-p_affine_0_2 + p_affine_2_2) + q_p_5_2*(-p_affine_0_2 + p_affine_3_2), &Scalar_Variable_Coefficient_3D_5_0 );
      real_t tmp_0 = -p_affine_0_0;
      real_t tmp_1 = p_affine_1_0 + tmp_0;
      real_t tmp_2 = -p_affine_0_1;
      real_t tmp_3 = p_affine_2_1 + tmp_2;
