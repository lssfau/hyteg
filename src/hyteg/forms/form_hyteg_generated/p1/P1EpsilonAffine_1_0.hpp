...
///
/// - name:        P1EpsilonAffine_1_0
/// - description: 
/// - trial space: Lagrange, degree: 1
/// - test space:  Lagrange, degree: 1
///
class P1EpsilonAffine_1_0 : public P1FormHyTeG
{
 ...
 public:
   ...
   void integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 3, 3 >& elMat ) const override
   {
      ...
      real_t a_1_2 = tmp_29*tmp_30 + tmp_31*w_p_1 + tmp_31*w_p_2;
      real_t a_2_0 = tmp_29*tmp_32 + tmp_33*w_p_1 + tmp_33*w_p_2;
      real_t a_2_1 = tmp_29*tmp_34 + tmp_35*w_p_1 + tmp_35*w_p_2;
      real_t a_2_2 = tmp_29*tmp_36 + tmp_37*w_p_1 + tmp_37*w_p_2;
      (elMat(0, 0)) = a_0_0;
      (elMat(0, 1)) = a_0_1;
      (elMat(0, 2)) = a_0_2;
      (elMat(1, 0)) = a_1_0;
