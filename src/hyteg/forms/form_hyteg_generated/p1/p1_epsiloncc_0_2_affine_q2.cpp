...
#include "p1_epsiloncc_0_2_affine_q2.hpp"
...
namespace forms {
   ...
   void p1_epsiloncc_0_2_affine_q2::integrateRow0( const std::array< Point3D, 3 >& , Matrix< real_t, 1, 3 >&  ) const
   {
   ...
   void p1_epsiloncc_0_2_affine_q2::integrateRow0( const std::array< Point3D, 4 >& coords, Matrix< real_t, 1, 4 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      real_t p_affine_0_2 = coords[0][2];
      ...
      real_t tmp_34 = -tmp_10*tmp_3 + tmp_13*tmp_6;
      real_t tmp_35 = 1.0*tmp_18;
      real_t tmp_36 = tmp_10*tmp_11 - tmp_6*tmp_9;
      real_t tmp_37 = -tmp_11*tmp_13 + tmp_3*tmp_9;
