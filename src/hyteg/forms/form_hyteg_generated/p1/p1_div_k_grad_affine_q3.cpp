...
namespace forms {
   ...
   void p1_div_k_grad_affine_q3::integrateAll( const std::array< Point3D, 4 >& coords, Matrix< real_t, 4, 4 >& elMat ) const
   {
      ...
      Scalar_Variable_Coefficient_3D_k( 0.64142979149569634*p_affine_0_0 + 0.16200149169852451*p_affine_1_0 + 0.18385035049209769*p_affine_2_0 + 0.012718366313681451*p_affine_3_0, 0.64142979149569634*p_affine_0_1 + 0.16200149169852451*p_affine_1_1 + 0.18385035049209769*p_affine_2_1 + 0.012718366313681451*p_affine_3_1, 0.64142979149569634*p_affine_0_2 + 0.16200149169852451*p_affine_1_2 + 0.18385035049209769*p_affine_2_2 + 0.012718366313681451*p_affine_3_2, &Scalar_Variable_Coefficient_3D_k_out0_id0 );
      Scalar_Variable_Coefficient_3D_k( 0.34544415571973075*p_affine_0_0 + 0.010905212211189241*p_affine_1_0 + 0.28152380212354622*p_affine_2_0 + 0.3621268299455338*p_affine_3_0, 0.34544415571973075*p_affine_0_1 + 0.010905212211189241*p_affine_1_1 + 0.28152380212354622*p_affine_2_1 + 0.3621268299455338*p_affine_3_1, 0.34544415571973075*p_affine_0_2 + 0.010905212211189241*p_affine_1_2 + 0.28152380212354622*p_affine_2_2 + 0.3621268299455338*p_affine_3_2, &Scalar_Variable_Coefficient_3D_k_out0_id1 );
      Scalar_Variable_Coefficient_3D_k( 0.43985894764927508*p_affine_0_0 + 0.19011700243928389*p_affine_1_0 + 0.011403329444557171*p_affine_2_0 + 0.35862072046688392*p_affine_3_0, 0.43985894764927508*p_affine_0_1 + 0.19011700243928389*p_affine_1_1 + 0.011403329444557171*p_affine_2_1 + 0.35862072046688392*p_affine_3_1, 0.43985894764927508*p_affine_0_2 + 0.19011700243928389*p_affine_1_2 + 0.011403329444557171*p_affine_2_2 + 0.35862072046688392*p_affine_3_2, &Scalar_Variable_Coefficient_3D_k_out0_id2 );
      Scalar_Variable_Coefficient_3D_k( 0.037871631782356974*p_affine_0_0 + 0.170816925164989*p_affine_1_0 + 0.15281814309092731*p_affine_2_0 + 0.63849329996172666*p_affine_3_0, 0.037871631782356974*p_affine_0_1 + 0.170816925164989*p_affine_1_1 + 0.15281814309092731*p_affine_2_1 + 0.63849329996172666*p_affine_3_1, 0.037871631782356974*p_affine_0_2 + 0.170816925164989*p_affine_1_2 + 0.15281814309092731*p_affine_2_2 + 0.63849329996172666*p_affine_3_2, &Scalar_Variable_Coefficient_3D_k_out0_id3 );
      Scalar_Variable_Coefficient_3D_k( 0.12480486216524708*p_affine_0_0 + 0.15868516322744061*p_affine_1_0 + 0.58566280565521578*p_affine_2_0 + 0.1308471689520965*p_affine_3_0, 0.12480486216524708*p_affine_0_1 + 0.15868516322744061*p_affine_1_1 + 0.58566280565521578*p_affine_2_1 + 0.1308471689520965*p_affine_3_1, 0.12480486216524708*p_affine_0_2 + 0.15868516322744061*p_affine_1_2 + 0.58566280565521578*p_affine_2_2 + 0.1308471689520965*p_affine_3_2, &Scalar_Variable_Coefficient_3D_k_out0_id4 );
      Scalar_Variable_Coefficient_3D_k( 0.14148275196950461*p_affine_0_0 + 0.57122605214911515*p_affine_1_0 + 0.14691839008716959*p_affine_2_0 + 0.14037280579421069*p_affine_3_0, 0.14148275196950461*p_affine_0_1 + 0.57122605214911515*p_affine_1_1 + 0.14691839008716959*p_affine_2_1 + 0.14037280579421069*p_affine_3_1, 0.14148275196950461*p_affine_0_2 + 0.57122605214911515*p_affine_1_2 + 0.14691839008716959*p_affine_2_2 + 0.14037280579421069*p_affine_3_2, &Scalar_Variable_Coefficient_3D_k_out0_id5 );
      real_t tmp_0 = -p_affine_0_0;
      real_t tmp_1 = p_affine_1_0 + tmp_0;
      real_t tmp_2 = -p_affine_0_1;
      real_t tmp_3 = p_affine_2_1 + tmp_2;
      ...
      real_t tmp_119 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_21;
      real_t tmp_120 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_23;
      real_t tmp_121 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_25;
      real_t tmp_122 = -tmp_119 - tmp_120 - tmp_121;
      real_t tmp_123 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_32;
      real_t tmp_124 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_34;
      real_t tmp_125 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_36;
      real_t tmp_126 = -tmp_123 - tmp_124 - tmp_125;
      real_t tmp_127 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_43;
      real_t tmp_128 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_45;
      real_t tmp_129 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_47;
      ...
      real_t tmp_134 = Scalar_Variable_Coefficient_3D_k_out0_id0*tmp_133;
      real_t tmp_135 = (tmp_35*tmp_35);
      real_t tmp_136 = (tmp_46*tmp_46);
      real_t tmp_137 = Scalar_Variable_Coefficient_3D_k_out0_id1*tmp_133;
      real_t tmp_138 = Scalar_Variable_Coefficient_3D_k_out0_id2*tmp_133;
      real_t tmp_139 = Scalar_Variable_Coefficient_3D_k_out0_id3*tmp_133;
      real_t tmp_140 = Scalar_Variable_Coefficient_3D_k_out0_id4*tmp_133;
      real_t tmp_141 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_133;
   ...
   void p1_div_k_grad_affine_q3::integrateRow0( const std::array< Point3D, 4 >& coords, Matrix< real_t, 1, 4 >& elMat ) const
   {
      ...
      real_t tmp_94 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_19;
      real_t tmp_95 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_20;
      real_t tmp_96 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_21;
      real_t tmp_97 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_26;
      real_t tmp_98 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_27;
      real_t tmp_99 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_28;
      real_t tmp_100 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_33;
      real_t tmp_101 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_34;
      real_t tmp_102 = Scalar_Variable_Coefficient_3D_k_out0_id5*tmp_35;
