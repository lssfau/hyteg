...
#include "p1_epsilonvar_2_1_affine_q2.hpp"
...
namespace forms {
   ...
   void p1_epsilonvar_2_1_affine_q2::Scalar_Variable_Coefficient_3D( real_t in_0, real_t in_1, real_t in_2, real_t * out_0 ) const
   {
