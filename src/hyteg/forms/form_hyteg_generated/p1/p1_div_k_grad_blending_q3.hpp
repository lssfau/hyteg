...
class p1_div_k_grad_blending_q3 : public P1FormHyTeG
{
 ...
 public:
   ...
   p1_div_k_grad_blending_q3( std::function< real_t ( const Point3D & ) > _callback_Scalar_Variable_Coefficient_3D_k, std::function< real_t ( const Point3D & ) > _callback_Scalar_Variable_Coefficient_2D_k )
