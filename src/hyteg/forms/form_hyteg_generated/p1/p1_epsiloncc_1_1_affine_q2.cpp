...
#include "p1_epsiloncc_1_1_affine_q2.hpp"

namespace hyteg {
namespace forms {

   void p1_epsiloncc_1_1_affine_q2::integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 3, 3 >& elMat ) const
   {
      ...
      real_t tmp_24 = tmp_21*(tmp_14*tmp_9 + tmp_23*tmp_3);
      real_t tmp_25 = tmp_21*(tmp_14*tmp_7 + tmp_16*tmp_23);
      real_t tmp_26 = tmp_21*(tmp_10*tmp_13 + tmp_15*tmp_18);
      real_t tmp_27 = 1.0 / (tmp_4*tmp_4);
      real_t tmp_28 = 2.0*tmp_27;
      real_t tmp_29 = 1.0*tmp_27;
      real_t tmp_30 = tmp_21*(tmp_28*(tmp_8*tmp_8) + tmp_29*(tmp_3*tmp_3));
      real_t tmp_31 = tmp_21*(tmp_1*tmp_28*tmp_8 + tmp_16*tmp_29*tmp_3);
      real_t tmp_32 = 0.5*tmp_31;
      real_t tmp_33 = tmp_21*(tmp_10*tmp_12 + tmp_17*tmp_18);
      real_t tmp_34 = tmp_21*((tmp_1*tmp_1)*tmp_28 + (tmp_16*tmp_16)*tmp_29);
   ...
   void p1_epsiloncc_1_1_affine_q2::integrateRow0( const std::array< Point3D, 3 >& coords, Matrix< real_t, 1, 3 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      real_t p_affine_1_0 = coords[1][0];
      ...
      real_t tmp_17 = tmp_14*(tmp_10*tmp_8 + tmp_16*tmp_3);
      real_t tmp_18 = tmp_14*(tmp_10*tmp_6 + tmp_11*tmp_16);
   ...
   void p1_epsiloncc_1_1_affine_q2::integrateAll( const std::array< Point3D, 4 >& coords, Matrix< real_t, 4, 4 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      ...
      real_t tmp_33 = -tmp_1*tmp_14 + tmp_10*tmp_5;
      real_t tmp_34 = tmp_28*tmp_33;
      real_t tmp_35 = -tmp_13*tmp_5 + tmp_14*tmp_15;
      real_t tmp_36 = tmp_28*tmp_35;
      real_t tmp_37 = tmp_1*tmp_13 - tmp_10*tmp_15;
      ...
      real_t tmp_42 = -tmp_10*tmp_3 + tmp_14*tmp_6;
      real_t tmp_43 = tmp_28*tmp_42;
      real_t tmp_44 = -tmp_11*tmp_14 + tmp_13*tmp_3;
      real_t tmp_45 = tmp_28*tmp_44;
      real_t tmp_46 = tmp_10*tmp_11 - tmp_13*tmp_6;
      ...
      real_t tmp_75 = tmp_25*tmp_72;
      real_t tmp_76 = tmp_46*tmp_71;
      real_t tmp_77 = tmp_62*(tmp_23*tmp_75 + tmp_35*tmp_74 + tmp_44*tmp_76);
      real_t tmp_78 = 0.16666666666666663*tmp_77;
      real_t tmp_79 = tmp_62*(tmp_33*tmp_74 + tmp_42*tmp_76 + tmp_75*tmp_8);
   ...
   void p1_epsiloncc_1_1_affine_q2::integrateRow0( const std::array< Point3D, 4 >& coords, Matrix< real_t, 1, 4 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      real_t p_affine_0_2 = coords[0][2];
      ...
      real_t tmp_30 = tmp_1*tmp_13 - tmp_10*tmp_15;
      real_t tmp_31 = 0.5*tmp_19;
      real_t tmp_32 = -tmp_28*tmp_31 - tmp_29*tmp_31 - tmp_30*tmp_31;
      real_t tmp_33 = -tmp_10*tmp_3 + tmp_14*tmp_6;
      real_t tmp_34 = -tmp_11*tmp_14 + tmp_13*tmp_3;
