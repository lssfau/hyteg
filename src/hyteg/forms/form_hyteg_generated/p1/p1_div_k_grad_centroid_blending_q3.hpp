...
/// Blending: True
/// Quadrature degree: 3
class p1_div_k_grad_centroid_blending_q3 : public P1FormHyTeG {
public:
   p1_div_k_grad_centroid_blending_q3() { WALBERLA_ABORT("Not implemented."); }
   p1_div_k_grad_centroid_blending_q3(std::function< real_t ( const Point3D&, real_t, real_t, real_t ) > k)
   : k_(k)
   {}
