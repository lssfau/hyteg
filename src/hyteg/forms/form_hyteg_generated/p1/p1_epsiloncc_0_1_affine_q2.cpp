...
#include "p1_epsiloncc_0_1_affine_q2.hpp"

namespace hyteg {
namespace forms {

   void p1_epsiloncc_0_1_affine_q2::integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 3, 3 >& elMat ) const
   {
      ...
      real_t tmp_20 = tmp_13*tmp_17;
      real_t tmp_21 = tmp_10*tmp_20;
      real_t tmp_22 = tmp_8*tmp_9;
      ...
      real_t tmp_27 = tmp_26*tmp_3;
      real_t tmp_28 = tmp_22*tmp_27;
      real_t tmp_29 = tmp_13*tmp_26;
      real_t tmp_30 = tmp_22*tmp_29;
      real_t tmp_31 = 0.16666666666666666*tmp_9;
      real_t tmp_32 = tmp_1*tmp_24;
      real_t tmp_33 = tmp_32*tmp_9;
      real_t tmp_34 = tmp_26*tmp_4;
      real_t tmp_35 = tmp_34*tmp_9;
      real_t tmp_36 = tmp_1*tmp_29;
      ...
      real_t a_1_2 = tmp_23*tmp_29 + 0.33333333333333331*tmp_30;
      real_t a_2_0 = tmp_31*tmp_32 + 0.33333333333333331*tmp_33;
      real_t a_2_1 = tmp_31*tmp_34 + 0.33333333333333331*tmp_35;
      real_t a_2_2 = tmp_31*tmp_36 + 0.33333333333333331*tmp_37;
      (elMat(0, 0)) = a_0_0;
      (elMat(0, 1)) = a_0_1;
      (elMat(0, 2)) = a_0_2;
      (elMat(1, 0)) = a_1_0;
   ...
   void p1_epsiloncc_0_1_affine_q2::integrateRow0( const std::array< Point3D, 3 >& coords, Matrix< real_t, 1, 3 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      real_t p_affine_1_0 = coords[1][0];
      ...
      real_t tmp_6 = (-tmp_1*tmp_5 - tmp_5*(p_affine_0_0 - p_affine_2_0))*std::abs(p_affine_0_0*p_affine_1_1 - p_affine_0_0*p_affine_2_1 - p_affine_0_1*p_affine_1_0 + p_affine_0_1*p_affine_2_0 + p_affine_1_0*p_affine_2_1 - p_affine_1_1*p_affine_2_0);
   ...
   void p1_epsiloncc_0_1_affine_q2::integrateAll( const std::array< Point3D, 4 >& coords, Matrix< real_t, 4, 4 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      ...
      real_t tmp_39 = -tmp_10*tmp_3 + tmp_14*tmp_6;
      real_t tmp_40 = 1.0*tmp_20;
      real_t tmp_41 = -tmp_11*tmp_14 + tmp_13*tmp_3;
   ...
   void p1_epsiloncc_0_1_affine_q2::integrateRow0( const std::array< Point3D, 4 >& coords, Matrix< real_t, 1, 4 >& elMat ) const
   {
      real_t p_affine_0_0 = coords[0][0];
      real_t p_affine_0_1 = coords[0][1];
      real_t p_affine_0_2 = coords[0][2];
