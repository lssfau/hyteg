...
namespace forms {
   ...
   void p1_epsiloncc_0_1_affine_q2::integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 3, 3 >& elMat ) const
   {
      ...
      real_t a_0_0 = tmp_11*tmp_15 + tmp_16*w_p_1 + tmp_16*w_p_2;
      real_t a_0_1 = tmp_11*tmp_18 + tmp_19*w_p_1 + tmp_19*w_p_2;
      real_t a_0_2 = tmp_11*tmp_20 + tmp_21*w_p_1 + tmp_21*w_p_2;
      real_t a_1_0 = tmp_23*tmp_24 + tmp_25*w_p_1 + tmp_25*w_p_2;
      real_t a_1_1 = tmp_23*tmp_27 + tmp_28*w_p_1 + tmp_28*w_p_2;
      real_t a_1_2 = tmp_23*tmp_29 + tmp_30*w_p_1 + tmp_30*w_p_2;
      real_t a_2_0 = tmp_31*tmp_32 + tmp_33*w_p_1 + tmp_33*w_p_2;
      real_t a_2_1 = tmp_31*tmp_34 + tmp_35*w_p_1 + tmp_35*w_p_2;
      real_t a_2_2 = tmp_31*tmp_36 + tmp_37*w_p_1 + tmp_37*w_p_2;
      (elMat(0, 0)) = a_0_0;
      (elMat(0, 1)) = a_0_1;
      (elMat(0, 2)) = a_0_2;
      (elMat(1, 0)) = a_1_0;
