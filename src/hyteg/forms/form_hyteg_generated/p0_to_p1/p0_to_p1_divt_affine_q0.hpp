...
#include "hyteg/forms/form_hyteg_base/P0ToP1FormHyTeG.hpp"
...
///
/// - name:        p0_to_p1_divt_0_affine_q0
/// - description: 
/// - trial space: Lagrange, degree: 0
/// - test space:  Lagrange, degree: 1
///
class p0_to_p1_divt_0_affine_q0 : public P0ToP1FormHyTeG
{
 ...
 public:
   ...
   /// - element matrix dimensions (rows, cols): (3, 1)
   ...
   ///                                               12      14       1       0      1             19                 0
   ///
   void integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 3, 1 >& elMat ) const override;
   ...
   /// - element matrix dimensions (rows, cols): (4, 1)
   ...
   ///                                               42      56       1       0      1             55                 0
   ///
   void integrateAll( const std::array< Point3D, 4 >& coords, Matrix< real_t, 4, 1 >& elMat ) const override;
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p0_to_p1_divt_1_affine_q0
/// - description: 
/// - trial space: Lagrange, degree: 0
/// - test space:  Lagrange, degree: 1
///
class p0_to_p1_divt_1_affine_q0 : public P0ToP1FormHyTeG
{
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p0_to_p1_divt_2_affine_q0
/// - description: 
/// - trial space: Lagrange, degree: 0
/// - test space:  Lagrange, degree: 1
///
class p0_to_p1_divt_2_affine_q0 : public P0ToP1FormHyTeG
{
