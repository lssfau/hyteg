...
/// Blending: True
/// Quadrature degree: 6
class p2_k_mass_centroid_blending_q6 : public P2FormHyTeG {
public:
   p2_k_mass_centroid_blending_q6() { WALBERLA_ABORT("Not implemented."); }
   p2_k_mass_centroid_blending_q6(std::function< real_t ( const Point3D&, real_t, real_t, real_t ) > k)
   : k_(k)
   {}
