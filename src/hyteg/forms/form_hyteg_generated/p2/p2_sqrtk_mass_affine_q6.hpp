...
///
class p2_sqrtk_mass_affine_q6 : public P2FormHyTeG
{

 public:

   p2_sqrtk_mass_affine_q6() { WALBERLA_ABORT("Not implemented."); }

   p2_sqrtk_mass_affine_q6( std::function< real_t ( const Point3D & ) > _callback_Scalar_Variable_Coefficient_2D_k, std::function< real_t ( const Point3D & ) > _callback_Scalar_Variable_Coefficient_3D_k )
