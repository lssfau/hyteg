...
///
/// - name:        p2_epsilonvar_0_0_blending_q2
/// - description: 
/// - trial space: Lagrange, degree: 2
/// - test space:  Lagrange, degree: 2
///
class p2_epsilonvar_0_0_blending_q2 : public P2FormHyTeG
{

 public:

   p2_epsilonvar_0_0_blending_q2() { WALBERLA_ABORT("Not implemented."); }

   p2_epsilonvar_0_0_blending_q2( std::function< real_t ( const Point3D & ) > _callback3D, std::function< real_t ( const Point3D & ) > _callback2D )
...
class p2_epsilonvar_0_1_blending_q2 : public P2FormHyTeG
{
 ...
 public:
   ...
   p2_epsilonvar_0_1_blending_q2( std::function< real_t ( const Point3D & ) > _callback3D, std::function< real_t ( const Point3D & ) > _callback2D )
   : callback3D(_callback3D)
   , callback2D(_callback2D)
   {}
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p2_epsilonvar_0_2_blending_q2
/// - description: 
/// - trial space: Lagrange, degree: 2
/// - test space:  Lagrange, degree: 2
///
class p2_epsilonvar_0_2_blending_q2 : public P2FormHyTeG
{

 public:

   p2_epsilonvar_0_2_blending_q2() { WALBERLA_ABORT("Not implemented."); }

   p2_epsilonvar_0_2_blending_q2( std::function< real_t ( const Point3D & ) > _callback3D )
   : callback3D(_callback3D)
   {}
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p2_epsilonvar_1_0_blending_q2
/// - description: 
/// - trial space: Lagrange, degree: 2
/// - test space:  Lagrange, degree: 2
///
class p2_epsilonvar_1_0_blending_q2 : public P2FormHyTeG
{

 public:

   p2_epsilonvar_1_0_blending_q2() { WALBERLA_ABORT("Not implemented."); }

   p2_epsilonvar_1_0_blending_q2( std::function< real_t ( const Point3D & ) > _callback3D, std::function< real_t ( const Point3D & ) > _callback2D )
   : callback3D(_callback3D)
   , callback2D(_callback2D)
   {}
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p2_epsilonvar_1_1_blending_q2
/// - description: 
/// - trial space: Lagrange, degree: 2
/// - test space:  Lagrange, degree: 2
///
class p2_epsilonvar_1_1_blending_q2 : public P2FormHyTeG
{

 public:

   p2_epsilonvar_1_1_blending_q2() { WALBERLA_ABORT("Not implemented."); }

   p2_epsilonvar_1_1_blending_q2( std::function< real_t ( const Point3D & ) > _callback3D, std::function< real_t ( const Point3D & ) > _callback2D )
   : callback3D(_callback3D)
   , callback2D(_callback2D)
   {}
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p2_epsilonvar_1_2_blending_q2
/// - description: 
/// - trial space: Lagrange, degree: 2
/// - test space:  Lagrange, degree: 2
///
class p2_epsilonvar_1_2_blending_q2 : public P2FormHyTeG
{

 public:

   p2_epsilonvar_1_2_blending_q2() { WALBERLA_ABORT("Not implemented."); }

   p2_epsilonvar_1_2_blending_q2( std::function< real_t ( const Point3D & ) > _callback3D )
   : callback3D(_callback3D)
   {}
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p2_epsilonvar_2_0_blending_q2
/// - description: 
/// - trial space: Lagrange, degree: 2
/// - test space:  Lagrange, degree: 2
///
class p2_epsilonvar_2_0_blending_q2 : public P2FormHyTeG
{

 public:

   p2_epsilonvar_2_0_blending_q2() { WALBERLA_ABORT("Not implemented."); }

   p2_epsilonvar_2_0_blending_q2( std::function< real_t ( const Point3D & ) > _callback3D )
   : callback3D(_callback3D)
   {}
...
/// Implementation of the integration of a weak form over an element.
///
/// - name:        p2_epsilonvar_2_1_blending_q2
/// - description: 
/// - trial space: Lagrange, degree: 2
/// - test space:  Lagrange, degree: 2
///
class p2_epsilonvar_2_1_blending_q2 : public P2FormHyTeG
{

 public:

   p2_epsilonvar_2_1_blending_q2() { WALBERLA_ABORT("Not implemented."); }

   p2_epsilonvar_2_1_blending_q2( std::function< real_t ( const Point3D & ) > _callback3D )
   : callback3D(_callback3D)
   {}
