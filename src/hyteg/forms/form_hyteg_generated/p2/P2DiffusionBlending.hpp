...
///
/// - name:        P2DiffusionBlending
/// - description: 
/// - trial space: Lagrange, degree: 2
/// - test space:  Lagrange, degree: 2
///
class P2DiffusionBlending : public P2FormHyTeG
{
 ...
 public:
   ...
   void integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 6, 6 >& elMat ) const override
   {
      ...
      real_t tmp_0 = 4*q_p_0_0;
      real_t tmp_1 = 4*q_p_0_1;
      ...
      real_t tmp_23 = tmp_22*w_p_0*std::abs(tmp_5);
      real_t tmp_24 = 4*q_p_1_0;
      real_t tmp_25 = 4*q_p_1_1;
      ...
      real_t tmp_39 = tmp_22*w_p_1*std::abs(tmp_27);
      real_t tmp_40 = 4*q_p_2_0;
      real_t tmp_41 = 4*q_p_2_1;
      ...
      real_t tmp_55 = tmp_22*w_p_2*std::abs(tmp_43);
      real_t tmp_56 = 4*q_p_3_0;
      real_t tmp_57 = 4*q_p_3_1;
      ...
      real_t tmp_71 = tmp_22*w_p_3*std::abs(tmp_59);
   ...
   void integrateAll( const std::array< Point3D, 4 >& coords, Matrix< real_t, 10, 10 >& elMat ) const override
   {
      ...
      real_t tmp_0 = 4.0*q_p_0_0;
      real_t tmp_1 = 4.0*q_p_0_1;
      real_t tmp_2 = 4.0*q_p_0_2;
      ...
      real_t tmp_74 = tmp_73*w_p_0*std::abs(tmp_19);
      real_t tmp_75 = 4.0*q_p_1_0;
      real_t tmp_76 = 4.0*q_p_1_1;
      real_t tmp_77 = 4.0*q_p_1_2;
      ...
      real_t tmp_108 = tmp_73*w_p_1*std::abs(tmp_85);
      real_t tmp_109 = 4.0*q_p_2_0;
      real_t tmp_110 = 4.0*q_p_2_1;
      real_t tmp_111 = 4.0*q_p_2_2;
      ...
      real_t tmp_142 = tmp_73*w_p_2*std::abs(tmp_119);
      real_t tmp_143 = 4.0*q_p_3_0;
      real_t tmp_144 = 4.0*q_p_3_1;
      real_t tmp_145 = 4.0*q_p_3_2;
      ...
      real_t tmp_176 = tmp_73*w_p_3*std::abs(tmp_153);
      real_t tmp_177 = 4.0*q_p_4_0;
      real_t tmp_178 = 4.0*q_p_4_1;
      real_t tmp_179 = 4.0*q_p_4_2;
      ...
      real_t tmp_210 = tmp_73*w_p_4*std::abs(tmp_187);
      real_t tmp_211 = 4.0*q_p_5_0;
      real_t tmp_212 = 4.0*q_p_5_1;
      real_t tmp_213 = 4.0*q_p_5_2;
      ...
      real_t tmp_244 = tmp_73*w_p_5*std::abs(tmp_221);
      ...
      real_t tmp_487 = -8.0*q_p_0_2 + tmp_485 + tmp_486;
      ...
      real_t tmp_496 = -8.0*q_p_1_2 + tmp_494 + tmp_495;
      ...
      real_t tmp_505 = -8.0*q_p_2_2 + tmp_503 + tmp_504;
      ...
      real_t tmp_514 = -8.0*q_p_3_2 + tmp_512 + tmp_513;
      ...
      real_t tmp_523 = -8.0*q_p_4_2 + tmp_521 + tmp_522;
      ...
      real_t tmp_532 = -8.0*q_p_5_2 + tmp_530 + tmp_531;
      ...
      real_t tmp_541 = -8.0*q_p_0_1 + tmp_486 + tmp_540;
      ...
      real_t tmp_549 = -8.0*q_p_1_1 + tmp_495 + tmp_548;
      ...
      real_t tmp_557 = -8.0*q_p_2_1 + tmp_504 + tmp_556;
      ...
      real_t tmp_565 = -8.0*q_p_3_1 + tmp_513 + tmp_564;
      ...
      real_t tmp_573 = -8.0*q_p_4_1 + tmp_522 + tmp_572;
      ...
      real_t tmp_581 = -8.0*q_p_5_1 + tmp_531 + tmp_580;
      ...
      real_t tmp_589 = -8.0*q_p_0_0 + tmp_485 + tmp_540 + 4.0;
      ...
      real_t tmp_596 = -8.0*q_p_1_0 + tmp_494 + tmp_548 + 4.0;
      ...
      real_t tmp_603 = -8.0*q_p_2_0 + tmp_503 + tmp_556 + 4.0;
      ...
      real_t tmp_610 = -8.0*q_p_3_0 + tmp_512 + tmp_564 + 4.0;
      ...
      real_t tmp_617 = -8.0*q_p_4_0 + tmp_521 + tmp_572 + 4.0;
      ...
      real_t tmp_624 = -8.0*q_p_5_0 + tmp_530 + tmp_580 + 4.0;
      ...
      real_t tmp_632 = 16.0*((q_p_0_0 - 0.25)*(q_p_0_0 - 0.25));
      real_t tmp_633 = 16.0*((q_p_1_0 - 0.25)*(q_p_1_0 - 0.25));
      real_t tmp_634 = 16.0*((q_p_2_0 - 0.25)*(q_p_2_0 - 0.25));
      real_t tmp_635 = 16.0*((q_p_3_0 - 0.25)*(q_p_3_0 - 0.25));
      real_t tmp_636 = 16.0*((q_p_4_0 - 0.25)*(q_p_4_0 - 0.25));
      real_t tmp_637 = 16.0*((q_p_5_0 - 0.25)*(q_p_5_0 - 0.25));
      ...
      real_t tmp_646 = 16.0*((q_p_0_1 - 0.25)*(q_p_0_1 - 0.25));
      real_t tmp_647 = 16.0*((q_p_1_1 - 0.25)*(q_p_1_1 - 0.25));
      real_t tmp_648 = 16.0*((q_p_2_1 - 0.25)*(q_p_2_1 - 0.25));
      real_t tmp_649 = 16.0*((q_p_3_1 - 0.25)*(q_p_3_1 - 0.25));
      real_t tmp_650 = 16.0*((q_p_4_1 - 0.25)*(q_p_4_1 - 0.25));
      real_t tmp_651 = 16.0*((q_p_5_1 - 0.25)*(q_p_5_1 - 0.25));
      ...
      real_t tmp_659 = 16.0*((q_p_0_2 - 0.25)*(q_p_0_2 - 0.25));
      real_t tmp_660 = 16.0*((q_p_1_2 - 0.25)*(q_p_1_2 - 0.25));
      real_t tmp_661 = 16.0*((q_p_2_2 - 0.25)*(q_p_2_2 - 0.25));
      real_t tmp_662 = 16.0*((q_p_3_2 - 0.25)*(q_p_3_2 - 0.25));
      real_t tmp_663 = 16.0*((q_p_4_2 - 0.25)*(q_p_4_2 - 0.25));
      real_t tmp_664 = 16.0*((q_p_5_2 - 0.25)*(q_p_5_2 - 0.25));
      ...
      real_t tmp_671 = q_p_0_1*tmp_37;
      real_t tmp_672 = q_p_0_2*tmp_41;
      real_t tmp_673 = q_p_0_1*tmp_50;
      real_t tmp_674 = q_p_0_2*tmp_51;
      real_t tmp_675 = q_p_0_1*tmp_57;
      real_t tmp_676 = q_p_0_2*tmp_58;
      real_t tmp_677 = q_p_1_1*tmp_90;
      real_t tmp_678 = q_p_1_2*tmp_91;
      real_t tmp_679 = q_p_1_1*tmp_97;
      real_t tmp_680 = q_p_1_2*tmp_98;
      real_t tmp_681 = q_p_1_1*tmp_104;
      real_t tmp_682 = q_p_1_2*tmp_105;
      real_t tmp_683 = q_p_2_1*tmp_124;
      real_t tmp_684 = q_p_2_2*tmp_125;
      real_t tmp_685 = q_p_2_1*tmp_131;
      real_t tmp_686 = q_p_2_2*tmp_132;
      real_t tmp_687 = q_p_2_1*tmp_138;
      real_t tmp_688 = q_p_2_2*tmp_139;
      real_t tmp_689 = q_p_3_1*tmp_158;
      real_t tmp_690 = q_p_3_2*tmp_159;
      real_t tmp_691 = q_p_3_1*tmp_165;
      real_t tmp_692 = q_p_3_2*tmp_166;
      real_t tmp_693 = q_p_3_1*tmp_172;
      real_t tmp_694 = q_p_3_2*tmp_173;
      real_t tmp_695 = q_p_4_1*tmp_192;
      real_t tmp_696 = q_p_4_2*tmp_193;
      real_t tmp_697 = q_p_4_1*tmp_199;
      real_t tmp_698 = q_p_4_2*tmp_200;
      real_t tmp_699 = q_p_4_1*tmp_206;
      real_t tmp_700 = q_p_4_2*tmp_207;
      real_t tmp_701 = q_p_5_1*tmp_226;
      real_t tmp_702 = q_p_5_2*tmp_227;
      real_t tmp_703 = q_p_5_1*tmp_233;
      real_t tmp_704 = q_p_5_2*tmp_234;
      real_t tmp_705 = q_p_5_1*tmp_240;
      real_t tmp_706 = q_p_5_2*tmp_241;
      ...
      real_t tmp_712 = q_p_0_0*tmp_37;
      real_t tmp_713 = q_p_0_2*tmp_45;
      real_t tmp_714 = q_p_0_0*tmp_50;
      real_t tmp_715 = q_p_0_2*tmp_52;
      real_t tmp_716 = q_p_0_0*tmp_57;
      real_t tmp_717 = q_p_0_2*tmp_59;
      real_t tmp_718 = q_p_1_0*tmp_90;
      real_t tmp_719 = q_p_1_2*tmp_92;
      real_t tmp_720 = q_p_1_0*tmp_97;
      real_t tmp_721 = q_p_1_2*tmp_99;
      real_t tmp_722 = q_p_1_0*tmp_104;
      real_t tmp_723 = q_p_1_2*tmp_106;
      real_t tmp_724 = q_p_2_0*tmp_124;
      real_t tmp_725 = q_p_2_2*tmp_126;
      real_t tmp_726 = q_p_2_0*tmp_131;
      real_t tmp_727 = q_p_2_2*tmp_133;
      real_t tmp_728 = q_p_2_0*tmp_138;
      real_t tmp_729 = q_p_2_2*tmp_140;
      real_t tmp_730 = q_p_3_0*tmp_158;
      real_t tmp_731 = q_p_3_2*tmp_160;
      real_t tmp_732 = q_p_3_0*tmp_165;
      real_t tmp_733 = q_p_3_2*tmp_167;
      real_t tmp_734 = q_p_3_0*tmp_172;
      real_t tmp_735 = q_p_3_2*tmp_174;
      real_t tmp_736 = q_p_4_0*tmp_192;
      real_t tmp_737 = q_p_4_2*tmp_194;
      real_t tmp_738 = q_p_4_0*tmp_199;
      real_t tmp_739 = q_p_4_2*tmp_201;
      real_t tmp_740 = q_p_4_0*tmp_206;
      real_t tmp_741 = q_p_4_2*tmp_208;
      real_t tmp_742 = q_p_5_0*tmp_226;
      real_t tmp_743 = q_p_5_2*tmp_228;
      real_t tmp_744 = q_p_5_0*tmp_233;
      real_t tmp_745 = q_p_5_2*tmp_235;
      real_t tmp_746 = q_p_5_0*tmp_240;
      real_t tmp_747 = q_p_5_2*tmp_242;
      ...
      real_t tmp_752 = q_p_0_0*tmp_41;
      real_t tmp_753 = q_p_0_1*tmp_45;
      real_t tmp_754 = q_p_0_0*tmp_51;
      real_t tmp_755 = q_p_0_1*tmp_52;
      real_t tmp_756 = q_p_0_0*tmp_58;
      real_t tmp_757 = q_p_0_1*tmp_59;
      real_t tmp_758 = q_p_1_0*tmp_91;
      real_t tmp_759 = q_p_1_1*tmp_92;
      real_t tmp_760 = q_p_1_0*tmp_98;
      real_t tmp_761 = q_p_1_1*tmp_99;
      real_t tmp_762 = q_p_1_0*tmp_105;
      real_t tmp_763 = q_p_1_1*tmp_106;
      real_t tmp_764 = q_p_2_0*tmp_125;
      real_t tmp_765 = q_p_2_1*tmp_126;
      real_t tmp_766 = q_p_2_0*tmp_132;
      real_t tmp_767 = q_p_2_1*tmp_133;
      real_t tmp_768 = q_p_2_0*tmp_139;
      real_t tmp_769 = q_p_2_1*tmp_140;
      real_t tmp_770 = q_p_3_0*tmp_159;
      real_t tmp_771 = q_p_3_1*tmp_160;
      real_t tmp_772 = q_p_3_0*tmp_166;
      real_t tmp_773 = q_p_3_1*tmp_167;
      real_t tmp_774 = q_p_3_0*tmp_173;
      real_t tmp_775 = q_p_3_1*tmp_174;
      real_t tmp_776 = q_p_4_0*tmp_193;
      real_t tmp_777 = q_p_4_1*tmp_194;
      real_t tmp_778 = q_p_4_0*tmp_200;
      real_t tmp_779 = q_p_4_1*tmp_201;
      real_t tmp_780 = q_p_4_0*tmp_207;
      real_t tmp_781 = q_p_4_1*tmp_208;
      real_t tmp_782 = q_p_5_0*tmp_227;
      real_t tmp_783 = q_p_5_1*tmp_228;
      real_t tmp_784 = q_p_5_0*tmp_234;
      real_t tmp_785 = q_p_5_1*tmp_235;
      real_t tmp_786 = q_p_5_0*tmp_241;
      real_t tmp_787 = q_p_5_1*tmp_242;
