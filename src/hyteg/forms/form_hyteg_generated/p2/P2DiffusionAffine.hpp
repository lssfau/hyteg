...
///
/// - name:        P2DiffusionAffine
/// - description: 
/// - trial space: Lagrange, degree: 2
/// - test space:  Lagrange, degree: 2
///
class P2DiffusionAffine : public P2FormHyTeG
{
 ...
 public:
   ...
   void integrateAll( const std::array< Point3D, 4 >& coords, Matrix< real_t, 10, 10 >& elMat ) const override
   {
      ...
      real_t tmp_65 = tmp_48*w_p_2;
      real_t tmp_66 = 4.0*q_p_3_0;
      real_t tmp_67 = 4.0*q_p_3_1;
      real_t tmp_68 = 4.0*q_p_3_2;
      ...
      real_t tmp_262 = tmp_20*(-8.0*q_p_0_2 + tmp_260 + tmp_261);
      ...
      real_t tmp_271 = tmp_20*(-8.0*q_p_1_2 + tmp_269 + tmp_270);
      ...
      real_t tmp_280 = tmp_20*(-8.0*q_p_2_2 + tmp_278 + tmp_279);
      ...
      real_t tmp_289 = tmp_20*(-8.0*q_p_3_2 + tmp_287 + tmp_288);
      ...
      real_t tmp_298 = tmp_20*(-8.0*q_p_0_1 + tmp_261 + tmp_297);
      ...
      real_t tmp_306 = tmp_20*(-8.0*q_p_1_1 + tmp_270 + tmp_305);
      ...
      real_t tmp_314 = tmp_20*(-8.0*q_p_2_1 + tmp_279 + tmp_313);
      ...
      real_t tmp_322 = tmp_20*(-8.0*q_p_3_1 + tmp_288 + tmp_321);
      ...
      real_t tmp_330 = tmp_20*(-8.0*q_p_0_0 + tmp_260 + tmp_297 + 4.0);
      ...
      real_t tmp_337 = tmp_20*(-8.0*q_p_1_0 + tmp_269 + tmp_305 + 4.0);
      ...
      real_t tmp_344 = tmp_20*(-8.0*q_p_2_0 + tmp_278 + tmp_313 + 4.0);
      ...
      real_t tmp_351 = tmp_20*(-8.0*q_p_3_0 + tmp_287 + tmp_321 + 4.0);
      ...
      real_t tmp_362 = tmp_361*((q_p_0_0 - 0.25)*(q_p_0_0 - 0.25));
      real_t tmp_363 = (tmp_30*tmp_30);
      real_t tmp_364 = (tmp_34*tmp_34);
      real_t tmp_365 = tmp_361*((q_p_1_0 - 0.25)*(q_p_1_0 - 0.25));
      real_t tmp_366 = tmp_361*((q_p_2_0 - 0.25)*(q_p_2_0 - 0.25));
      real_t tmp_367 = tmp_361*((q_p_3_0 - 0.25)*(q_p_3_0 - 0.25));
      ...
      real_t tmp_400 = tmp_361*((q_p_0_1 - 0.25)*(q_p_0_1 - 0.25));
      real_t tmp_401 = (tmp_29*tmp_29);
      real_t tmp_402 = (tmp_33*tmp_33);
      real_t tmp_403 = tmp_361*((q_p_1_1 - 0.25)*(q_p_1_1 - 0.25));
      real_t tmp_404 = tmp_361*((q_p_2_1 - 0.25)*(q_p_2_1 - 0.25));
      real_t tmp_405 = tmp_361*((q_p_3_1 - 0.25)*(q_p_3_1 - 0.25));
      ...
      real_t tmp_425 = tmp_361*((q_p_0_2 - 0.25)*(q_p_0_2 - 0.25));
      real_t tmp_426 = (tmp_28*tmp_28);
      real_t tmp_427 = (tmp_32*tmp_32);
      real_t tmp_428 = tmp_361*((q_p_1_2 - 0.25)*(q_p_1_2 - 0.25));
      real_t tmp_429 = tmp_361*((q_p_2_2 - 0.25)*(q_p_2_2 - 0.25));
      real_t tmp_430 = tmp_361*((q_p_3_2 - 0.25)*(q_p_3_2 - 0.25));
      ...
      real_t tmp_437 = q_p_0_1*tmp_20;
      real_t tmp_438 = tmp_437*tmp_8;
      real_t tmp_439 = q_p_0_2*tmp_20;
      ...
      real_t tmp_445 = q_p_1_1*tmp_20;
      real_t tmp_446 = tmp_445*tmp_8;
      real_t tmp_447 = q_p_1_2*tmp_20;
      ...
      real_t tmp_453 = q_p_2_1*tmp_20;
      real_t tmp_454 = tmp_453*tmp_8;
      real_t tmp_455 = q_p_2_2*tmp_20;
      ...
      real_t tmp_461 = q_p_3_1*tmp_20;
      real_t tmp_462 = tmp_461*tmp_8;
      real_t tmp_463 = q_p_3_2*tmp_20;
