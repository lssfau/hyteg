...
#include "p2_epsilonvar_1_1_affine_q2.hpp"
...
namespace forms {
   ...
   void p2_epsilonvar_1_1_affine_q2::integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 6, 6 >& elMat ) const
   {
      ...
      real_t tmp_18 = tmp_17*w_p_0;
      real_t tmp_19 = 4*q_p_1_0;
      real_t tmp_20 = 4*q_p_1_1;
      ...
      real_t tmp_28 = tmp_17*w_p_1;
      real_t tmp_29 = 4*q_p_2_0;
      real_t tmp_30 = 4*q_p_2_1;
      ...
      real_t tmp_73 = q_p_0_0*tmp_5;
      real_t tmp_74 = tmp_3*tmp_73;
      real_t tmp_75 = 4.0*tmp_74;
      real_t tmp_76 = q_p_0_1*tmp_5;
      ...
      real_t tmp_88 = q_p_1_0*tmp_5;
      real_t tmp_89 = tmp_3*tmp_88;
      real_t tmp_90 = 4.0*tmp_89;
      real_t tmp_91 = q_p_1_1*tmp_5;
      ...
      real_t tmp_103 = q_p_2_0*tmp_5;
      real_t tmp_104 = tmp_103*tmp_3;
      real_t tmp_105 = 4.0*tmp_104;
      real_t tmp_106 = q_p_2_1*tmp_5;
      ...
      real_t tmp_119 = tmp_5*(-8*q_p_0_1 - tmp_6 + 4);
      ...
      real_t tmp_124 = tmp_5*(-8*q_p_1_1 - tmp_19 + 4);
      real_t tmp_125 = tmp_120*tmp_124 - tmp_93;
      real_t tmp_126 = tmp_122*tmp_124 - tmp_99;
      real_t tmp_127 = tmp_5*(-8*q_p_2_1 - tmp_29 + 4);
      ...
      real_t tmp_131 = tmp_5*(-8*q_p_0_0 - tmp_7 + 4);
      ...
      real_t tmp_136 = tmp_5*(-8*q_p_1_0 - tmp_20 + 4);
      real_t tmp_137 = tmp_132*tmp_136 - tmp_90;
      real_t tmp_138 = tmp_134*tmp_136 - tmp_97;
      real_t tmp_139 = tmp_5*(-8*q_p_2_0 - tmp_30 + 4);
   ...
   void p2_epsilonvar_1_1_affine_q2::integrateAll( const std::array< Point3D, 4 >& coords, Matrix< real_t, 10, 10 >& elMat ) const
   {
      ...
      real_t tmp_56 = tmp_55*w_p_0;
      real_t tmp_57 = 4.0*q_p_1_0;
      real_t tmp_58 = 4.0*q_p_1_1;
      real_t tmp_59 = 4.0*q_p_1_2;
      ...
      real_t tmp_71 = tmp_55*w_p_1;
      real_t tmp_72 = 4.0*q_p_2_0;
      real_t tmp_73 = 4.0*q_p_2_1;
      real_t tmp_74 = 4.0*q_p_2_2;
      ...
      real_t tmp_86 = tmp_55*w_p_2;
      real_t tmp_87 = 4.0*q_p_3_0;
      real_t tmp_88 = 4.0*q_p_3_1;
      real_t tmp_89 = 4.0*q_p_3_2;
      ...
      real_t tmp_197 = q_p_0_1*tmp_20;
      real_t tmp_198 = tmp_197*tmp_6;
      real_t tmp_199 = 2.0*tmp_198;
      real_t tmp_200 = q_p_0_2*tmp_20;
      ...
      real_t tmp_216 = q_p_1_1*tmp_20;
      real_t tmp_217 = tmp_216*tmp_6;
      real_t tmp_218 = 2.0*tmp_217;
      real_t tmp_219 = q_p_1_2*tmp_20;
      ...
      real_t tmp_235 = q_p_2_1*tmp_20;
      real_t tmp_236 = tmp_235*tmp_6;
      real_t tmp_237 = 2.0*tmp_236;
      real_t tmp_238 = q_p_2_2*tmp_20;
      ...
      real_t tmp_254 = q_p_3_1*tmp_20;
      real_t tmp_255 = tmp_254*tmp_6;
      real_t tmp_256 = 2.0*tmp_255;
      real_t tmp_257 = q_p_3_2*tmp_20;
      ...
      real_t tmp_386 = -8.0*q_p_0_2 + tmp_384 + tmp_385;
      ...
      real_t tmp_395 = -8.0*q_p_1_2 + tmp_393 + tmp_394;
      ...
      real_t tmp_402 = -8.0*q_p_2_2 + tmp_400 + tmp_401;
      ...
      real_t tmp_409 = -8.0*q_p_3_2 + tmp_407 + tmp_408;
      ...
      real_t tmp_416 = -8.0*q_p_0_1 + tmp_385 + tmp_415;
      ...
      real_t tmp_423 = -8.0*q_p_1_1 + tmp_394 + tmp_422;
      ...
      real_t tmp_429 = -8.0*q_p_2_1 + tmp_401 + tmp_428;
      ...
      real_t tmp_435 = -8.0*q_p_3_1 + tmp_408 + tmp_434;
      ...
      real_t tmp_441 = -8.0*q_p_0_0 + tmp_384 + tmp_415 + 4.0;
      ...
      real_t tmp_447 = -8.0*q_p_1_0 + tmp_393 + tmp_422 + 4.0;
      ...
      real_t tmp_452 = -8.0*q_p_2_0 + tmp_400 + tmp_428 + 4.0;
      ...
      real_t tmp_457 = -8.0*q_p_3_0 + tmp_407 + tmp_434 + 4.0;
      ...
      real_t tmp_466 = tmp_465*((q_p_0_0 - 0.25)*(q_p_0_0 - 0.25));
      ...
      real_t tmp_472 = tmp_465*((q_p_1_0 - 0.25)*(q_p_1_0 - 0.25));
      ...
      real_t tmp_476 = tmp_465*((q_p_2_0 - 0.25)*(q_p_2_0 - 0.25));
      ...
      real_t tmp_480 = tmp_465*((q_p_3_0 - 0.25)*(q_p_3_0 - 0.25));
      ...
      real_t tmp_518 = tmp_465*((q_p_0_1 - 0.25)*(q_p_0_1 - 0.25));
      real_t tmp_519 = tmp_464*tmp_518;
      real_t tmp_520 = (tmp_39*tmp_39);
      real_t tmp_521 = (tmp_33*tmp_33);
      real_t tmp_522 = tmp_465*((q_p_1_1 - 0.25)*(q_p_1_1 - 0.25));
      real_t tmp_523 = tmp_471*tmp_522;
      real_t tmp_524 = tmp_465*((q_p_2_1 - 0.25)*(q_p_2_1 - 0.25));
      real_t tmp_525 = tmp_475*tmp_524;
      real_t tmp_526 = tmp_465*((q_p_3_1 - 0.25)*(q_p_3_1 - 0.25));
      ...
      real_t tmp_543 = tmp_465*((q_p_0_2 - 0.25)*(q_p_0_2 - 0.25));
      real_t tmp_544 = tmp_464*tmp_543;
      real_t tmp_545 = (tmp_37*tmp_37);
      real_t tmp_546 = (tmp_31*tmp_31);
      real_t tmp_547 = tmp_465*((q_p_1_2 - 0.25)*(q_p_1_2 - 0.25));
      real_t tmp_548 = tmp_471*tmp_547;
      real_t tmp_549 = tmp_465*((q_p_2_2 - 0.25)*(q_p_2_2 - 0.25));
      real_t tmp_550 = tmp_475*tmp_549;
      real_t tmp_551 = tmp_465*((q_p_3_2 - 0.25)*(q_p_3_2 - 0.25));
