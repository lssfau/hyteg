...
class p2_k_mass_affine_q4 : public P2FormHyTeG
{
 ...
 public:
   ...
   p2_k_mass_affine_q4( std::function< real_t ( const Point3D & ) > _callback_Scalar_Variable_Coefficient_2D_k, std::function< real_t ( const Point3D & ) > _callback_Scalar_Variable_Coefficient_3D_k )
