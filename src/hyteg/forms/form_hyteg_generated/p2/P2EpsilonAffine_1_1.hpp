...
///
/// - name:        P2EpsilonAffine_1_1
/// - description: 
/// - trial space: Lagrange, degree: 2
/// - test space:  Lagrange, degree: 2
///
class P2EpsilonAffine_1_1 : public P2FormHyTeG
{
 ...
 public:
   ...
   void integrateAll( const std::array< Point3D, 3 >& coords, Matrix< real_t, 6, 6 >& elMat ) const override
   {
      ...
      real_t tmp_156 = q_p_0_0*tmp_65;
      real_t tmp_157 = q_p_0_1*tmp_53;
      ...
      real_t tmp_166 = q_p_1_0*tmp_65;
      real_t tmp_167 = q_p_1_1*tmp_53;
      ...
      real_t tmp_173 = q_p_2_0*tmp_65;
      real_t tmp_174 = q_p_2_1*tmp_53;
