...
/// Blending: False
/// Quadrature degree: 3
class p2_div_k_grad_centroid_affine_q3 : public P2FormHyTeG {
public:
   p2_div_k_grad_centroid_affine_q3() { WALBERLA_ABORT("Not implemented."); }
   p2_div_k_grad_centroid_affine_q3(std::function< real_t ( const Point3D&, real_t, real_t, real_t ) > k)
   : k_(k)
   {}
