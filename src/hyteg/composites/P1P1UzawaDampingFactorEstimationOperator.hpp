...
/// M^-1 is the inverse of the lumped mass-matrix, and C is the PSPG operator.
///
/// A and B are the respective blocks of the P1-P1 discretized Stokes operator.
///
...
class P1P1UzawaDampingFactorEstimationOperator : public Operator< P1Function< real_t >, P1Function< real_t > >
{
 public:
   ...
   P1StokesFunction< real_t > tmp_rhs_;
   P1StokesFunction< real_t > tmp_solution_;
