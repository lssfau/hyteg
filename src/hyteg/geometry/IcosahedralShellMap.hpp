...
class IcosahedralShellMap : public GeometryMap
{
 public:
   ...
   void evalDFinvDF( const Point3D& x, Matrixr<3,9>& DFinvDFx ) const override final
   {
      ...
      const real_t tmp5 = std::pow((rayVertex_[0]*rayVertex_[0]) + (rayVertex_[1]*rayVertex_[1]) + (rayVertex_[2]*rayVertex_[2]), 1.0/2.0);
      const real_t tmp6 = -tmp5 + std::pow((refVertex_[0]*refVertex_[0]) + (refVertex_[1]*refVertex_[1]) + (refVertex_[2]*refVertex_[2]), 1.0/2.0);
      ...
      const real_t tmp10 = -tmp7 - tmp8 - tmp9 + forVertex_[0]*thrVertex_[1] + forVertex_[1]*rayVertex_[0] + rayVertex_[1]*thrVertex_[0];
      ...
      const real_t tmp23 = 1.0 / (-tmp12 - tmp13*refVertex_[1] - tmp15 - tmp16*refVertex_[0] - tmp17*refVertex_[1] - tmp19 - tmp20*refVertex_[0] - tmp21*refVertex_[0] - tmp22*refVertex_[1] - tmp7*refVertex_[2] - tmp8*refVertex_[2] - tmp9*refVertex_[2] + forVertex_[0]*rayVertex_[1]*thrVertex_[2] + forVertex_[0]*rayVertex_[2]*refVertex_[1] + forVertex_[0]*refVertex_[2]*thrVertex_[1] + forVertex_[1]*rayVertex_[0]*refVertex_[2] + forVertex_[1]*rayVertex_[2]*thrVertex_[0] + forVertex_[1]*refVertex_[0]*thrVertex_[2] + forVertex_[2]*rayVertex_[0]*thrVertex_[1] + forVertex_[2]*rayVertex_[1]*refVertex_[0] + forVertex_[2]*refVertex_[1]*thrVertex_[0] + rayVertex_[0]*refVertex_[1]*thrVertex_[2] + rayVertex_[1]*refVertex_[2]*thrVertex_[0] + rayVertex_[2]*refVertex_[0]*thrVertex_[1]);
      const real_t tmp24 = tmp23*tmp6;
      const real_t tmp25 = tmp24*(tmp11*x[1] - tmp12 + tmp13*rayVertex_[1] - tmp13*x[1] + tmp14*x[1] - tmp15 - tmp16*x[0] + tmp17*thrVertex_[1] - tmp17*x[1] + tmp18*x[1] - tmp19 - tmp20*x[0] - tmp21*x[0] + tmp22*forVertex_[1] - tmp22*x[1] - tmp7*x[2] - tmp8*x[2] - tmp9*x[2] + forVertex_[0]*thrVertex_[1]*x[2] + forVertex_[1]*rayVertex_[0]*x[2] + forVertex_[1]*thrVertex_[2]*x[0] + forVertex_[2]*rayVertex_[1]*x[0] + rayVertex_[1]*thrVertex_[0]*x[2] + rayVertex_[2]*thrVertex_[1]*x[0]) + tmp5;
      ...
      const real_t tmp42 = -tmp16 - tmp20 - tmp21 + forVertex_[1]*thrVertex_[2] + forVertex_[2]*rayVertex_[1] + rayVertex_[2]*thrVertex_[1];
      ...
      const real_t tmp86 = tmp31*tmp73*tmp76 + tmp57*tmp65*tmp84 - tmp76*tmp83 + tmp78*tmp80*tmp81 - tmp78*tmp82 - tmp84*tmp85;
      ...
      const real_t tmp104 = -tmp0*tmp93 + 2*tmp23*tmp4*tmp42*tmp6 + 3*tmp25*tmp37*(x[0]*x[0]*x[0]) - 3*tmp60;
      ...
      const real_t tmp123 = tmp89*(-tmp102*tmp103 - tmp104*tmp122 - tmp105*tmp31 - tmp106*tmp65 - tmp107*tmp57 - tmp108*tmp78 - tmp114*tmp78 - tmp115*tmp76 - tmp119*tmp76 - tmp120*tmp78 - tmp121*tmp76 - tmp46*tmp84 - tmp53*tmp84 - tmp64*tmp84 - tmp70*tmp84 - tmp76*tmp90 - tmp78*tmp92 - tmp98*tmp99);
      ...
      const real_t tmp144 = -2*tmp1*tmp34 + 2*tmp23*tmp32*tmp4*tmp6 + 3*tmp25*tmp37*(x[1]*x[1]*x[1]) - 3*tmp28;
      ...
      const real_t tmp160 = tmp89*(-tmp103*tmp69 - tmp118*tmp122 - tmp119*tmp47 - tmp126*tmp152 - tmp129*tmp151 - tmp130*tmp140 - tmp132*tmp150 - tmp133*tmp149 - tmp135*tmp142 - tmp143*tmp84 - tmp144*tmp158 - tmp148*tmp159 - tmp153*tmp154 - tmp155*tmp76 - tmp156*tmp57 - tmp157*tmp78 - tmp70*tmp72 - tmp91*tmp99);
      ...
      const real_t tmp165 = 2*tmp10*tmp23*tmp4*tmp6 - 2*tmp2*tmp48 + 3*tmp25*tmp37*(x[2]*x[2]*x[2]) - 3*tmp95;
      ...
      const real_t tmp171 = tmp89*(-tmp103*tmp52 - tmp113*tmp122 - tmp126*tmp149 - tmp129*tmp148 - tmp130*tmp147 - tmp132*tmp167 - tmp133*tmp166 - tmp135*tmp163 - tmp142*tmp158 - tmp150*tmp154 - tmp159*tmp165 - tmp161*tmp79 - tmp164*tmp84 - tmp168*tmp78 - tmp169*tmp65 - tmp170*tmp31 - tmp63*tmp99 - tmp64*tmp79);
