...
class P1ToP2SurrogateOperator : public Operator<P1Function<real_t>, P2Function<real_t>>
{
 public:
   ...
   P1ToP2SurrogateOperator(const std::shared_ptr< PrimitiveStorage >& storage, size_t minLevel, size_t maxLevel, size_t interpolationLevel)
      ...
      for (auto& it : storage_->getFaces())
      {
         ...
         for (uint_t level = minLevel_; level <= maxLevel_; ++level)
         {
            ...
            for (const auto& it : hyteg::edgedof::macroface::Iterator(interpolationLevel_, 0))
            {
               ...
               P1toP2::variablestencil::macroface::assembleStencil(form_, x, dirS, dirSE, dirE, dirN, dirNW, dirW, dirNE, vertexToVertexStencil, vertexToEdgeStencil);
              ...
              UpdateType                  updateType = Replace) const
   {
      ...
      for (auto& it : storage_->getFaces())
      {
         ...
         {
            P1toP2::variablestencil::macroface::applyPolynomial(
