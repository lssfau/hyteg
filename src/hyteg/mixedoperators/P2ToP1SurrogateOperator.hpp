...
class P2ToP1SurrogateOperator : public Operator<P2Function<real_t>, P1Function<real_t>>
{
 public:
   ...
   P2ToP1SurrogateOperator(const std::shared_ptr< PrimitiveStorage >& storage, size_t minLevel, size_t maxLevel, size_t interpolationLevel)
      ...
      for (auto& it : storage_->getFaces())
      {
         ...
         for (uint_t level = minLevel_; level <= maxLevel_; ++level)
         {
            ...
            for (const auto& it : hyteg::edgedof::macroface::Iterator(interpolationLevel_, 0))
            {
               ...
               P2toP1::variablestencil::macroface::assembleStencil(form_, x, dirS, dirSE, dirE, dirN, dirNW, dirW, vertexToVertexStencil, edgeToVertexStencil);
              ...
              UpdateType                  updateType = Replace) const
   {
      ...
      for (auto& it : storage_->getFaces())
      {
         ...
         {
            P2toP1::variablestencil::macroface::applyPolynomial(
