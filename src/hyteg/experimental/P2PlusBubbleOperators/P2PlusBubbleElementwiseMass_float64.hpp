...
class P2PlusBubbleElementwiseMass_float64
    : public Operator<P2PlusBubbleFunction<walberla::float64>,
      ...
      public OperatorWithInverseDiagonal<
          P2PlusBubbleFunction<walberla::float64>> {
public:
  P2PlusBubbleElementwiseMass_float64(
...
protected:
private:
  /// Integral: P2PlusBubbleElementwiseMass_float64
  ...
  /// ------  ------  ------  ------  -----  -------------  ----------------
  /// -------------
  ///    373     623      12       0      0              0                 0 0
  void apply_P2PlusBubbleElementwiseMass_float64_macro_2D(
  ...
  /// ------  ------  ------  ------  -----  -------------  ----------------
  /// -------------
  ///    324     574      12       0      0              0                 0 3
  void toMatrix_P2PlusBubbleElementwiseMass_float64_macro_2D(
