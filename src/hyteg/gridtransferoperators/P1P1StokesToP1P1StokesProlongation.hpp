...
class P1P1StokesToP1P1StokesProlongation : public ProlongationOperator< P1StokesFunction< real_t > >
{
 public:
   ...
   {
      prolongationOperator_.prolongate( function.uvw[0], sourceLevel, flag );
      prolongationOperator_.prolongate( function.uvw[1], sourceLevel, flag );
      prolongationOperator_.prolongate( function.uvw[2], sourceLevel, flag );
   ...
   {
      prolongationOperator_.prolongateAndAdd( function.uvw[0], sourceLevel, flag );
      prolongationOperator_.prolongateAndAdd( function.uvw[1], sourceLevel, flag );
      prolongationOperator_.prolongateAndAdd( function.uvw[2], sourceLevel, flag );
