...
class P3FunctionPackInfo : public communication::PackInfo
{
 public:
   P3FunctionPackInfo( uint_t                                                                  level,
 ...
 private:
   ...
   EdgeDoFPackInfo< ValueType >   edgeDoFPackInfoBlue_;
   EdgeDoFPackInfo< ValueType >   edgeDoFPackInfoRed_;

   // will need a FaceDoFPackInfo for 3D !
};
