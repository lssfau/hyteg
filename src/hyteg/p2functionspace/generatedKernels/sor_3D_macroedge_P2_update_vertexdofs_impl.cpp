...
static void sor_3D_macroedge_P2_update_vertexdofs_impl_021_level_any(double const * RESTRICT const _data_edgedof_macroedge_src, double * RESTRICT _data_vertexdof_macroedge_dst, double const * RESTRICT const _data_vertexdof_macroedge_src, std::map< hyteg::edgedof::EdgeDoFOrientation, std::map< hyteg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t id_cell, int64_t id_face_0, int64_t id_face_1, int32_t level, int64_t micro_edge_index_x, int64_t num_neighbor_faces, std::map< hyteg::indexing::IndexIncrement, double > v2v_cell_stencil)
{
   ...
   _data_vertexdof_macroedge_dst[0] = xi_1*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 6*(1 << (level)) - 7] + xi_10*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_11*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 7] + xi_12*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_13*_data_edgedof_macroedge_src[micro_edge_index_x - 1] + xi_14*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_15*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_16*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_17*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_18*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_19*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 2*(1 << (level)) - 3] + xi_2*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_20*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_21*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_22*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_23*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 2] + xi_24*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_25*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_26*_data_vertexdof_macroedge_src[micro_edge_index_x] + xi_3*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 4*(1 << (level)) - 5] + xi_4*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_5*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_6*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_7*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_8*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_9*_data_edgedof_macroedge_src[micro_edge_index_x];
   {
...
static void sor_3D_macroedge_P2_update_vertexdofs_impl_031_level_any(double const * RESTRICT const _data_edgedof_macroedge_src, double * RESTRICT _data_vertexdof_macroedge_dst, double const * RESTRICT const _data_vertexdof_macroedge_src, std::map< hyteg::edgedof::EdgeDoFOrientation, std::map< hyteg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t id_cell, int64_t id_face_0, int64_t id_face_1, int32_t level, int64_t micro_edge_index_x, int64_t num_neighbor_faces, std::map< hyteg::indexing::IndexIncrement, double > v2v_cell_stencil)
{
   ...
   const double xi_21 = v2v_cell_stencil[{ 1, 0, 0 }];
   _data_vertexdof_macroedge_dst[0] = xi_1*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 6*(1 << (level)) - 7] + xi_10*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_11*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 7] + xi_12*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_13*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_14*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_15*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_16*_data_vertexdof_macroedge_src[micro_edge_index_x - 1] + xi_17*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 2] + xi_18*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_19*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_2*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_20*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_21*_data_vertexdof_macroedge_src[micro_edge_index_x] + xi_3*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_4*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_5*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_6*_data_edgedof_macroedge_src[micro_edge_index_x - 1] + xi_7*_data_edgedof_macroedge_src[micro_edge_index_x] + xi_8*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_9*_data_edgedof_macroedge_src[micro_edge_index_x];
   {
...
static void sor_3D_macroedge_P2_update_vertexdofs_impl_120_level_any(double const * RESTRICT const _data_edgedof_macroedge_src, double * RESTRICT _data_vertexdof_macroedge_dst, double const * RESTRICT const _data_vertexdof_macroedge_src, std::map< hyteg::edgedof::EdgeDoFOrientation, std::map< hyteg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t id_cell, int64_t id_face_0, int64_t id_face_1, int32_t level, int64_t micro_edge_index_x, int64_t num_neighbor_faces, std::map< hyteg::indexing::IndexIncrement, double > v2v_cell_stencil)
{
   ...
   _data_vertexdof_macroedge_dst[0] = xi_1*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 6*(1 << (level)) - 7] + xi_10*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 7] + xi_11*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_12*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_13*_data_edgedof_macroedge_src[micro_edge_index_x - 1] + xi_14*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_15*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_16*_data_vertexdof_macroedge_src[micro_edge_index_x] + xi_17*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_18*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 2] + xi_19*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_2*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_20*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_21*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_3*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 4*(1 << (level)) - 5] + xi_4*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_5*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_6*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_7*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_8*_data_edgedof_macroedge_src[micro_edge_index_x] + xi_9*_data_edgedof_macroedge_src[micro_edge_index_x - 1];
   {
...
static void sor_3D_macroedge_P2_update_vertexdofs_impl_130_level_any(double const * RESTRICT const _data_edgedof_macroedge_src, double * RESTRICT _data_vertexdof_macroedge_dst, double const * RESTRICT const _data_vertexdof_macroedge_src, std::map< hyteg::edgedof::EdgeDoFOrientation, std::map< hyteg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t id_cell, int64_t id_face_0, int64_t id_face_1, int32_t level, int64_t micro_edge_index_x, int64_t num_neighbor_faces, std::map< hyteg::indexing::IndexIncrement, double > v2v_cell_stencil)
{
   ...
   _data_vertexdof_macroedge_dst[0] = xi_1*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 6*(1 << (level)) - 7] + xi_10*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_11*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_12*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_13*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_14*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_15*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_16*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_17*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_18*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 4*(1 << (level)) - 5] + xi_19*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 2*(1 << (level)) - 3] + xi_2*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_20*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_21*_data_vertexdof_macroedge_src[micro_edge_index_x + 1] + xi_22*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_23*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_24*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_25*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_26*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_3*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_4*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_5*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_6*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_7*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_8*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_9*_data_edgedof_macroedge_src[micro_edge_index_x];
   {
...
static void sor_3D_macroedge_P2_update_vertexdofs_impl_201_level_any(double const * RESTRICT const _data_edgedof_macroedge_src, double * RESTRICT _data_vertexdof_macroedge_dst, double const * RESTRICT const _data_vertexdof_macroedge_src, std::map< hyteg::edgedof::EdgeDoFOrientation, std::map< hyteg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t id_cell, int64_t id_face_0, int64_t id_face_1, int32_t level, int64_t micro_edge_index_x, int64_t num_neighbor_faces, std::map< hyteg::indexing::IndexIncrement, double > v2v_cell_stencil)
{
   ...
   const double xi_25 = v2v_cell_stencil[{ 1, -1, 1 }];
   const double xi_26 = v2v_cell_stencil[{ 1, 0, 0 }];
   _data_vertexdof_macroedge_dst[0] = xi_1*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 6*(1 << (level)) - 7] + xi_10*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 7] + xi_11*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_12*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_13*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_14*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_15*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_16*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_17*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_18*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 4*(1 << (level)) - 5] + xi_19*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 2*(1 << (level)) - 3] + xi_2*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_20*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 2] + xi_21*_data_vertexdof_macroedge_src[micro_edge_index_x] + xi_22*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_23*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_24*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_25*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_26*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_3*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 4*(1 << (level)) - 5] + xi_4*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_5*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_6*_data_edgedof_macroedge_src[micro_edge_index_x - 1] + xi_7*_data_edgedof_macroedge_src[micro_edge_index_x] + xi_8*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_9*_data_edgedof_macroedge_src[micro_edge_index_x - 1];
   {
...
static void sor_3D_macroedge_P2_update_vertexdofs_impl_210_level_any(double const * RESTRICT const _data_edgedof_macroedge_src, double * RESTRICT _data_vertexdof_macroedge_dst, double const * RESTRICT const _data_vertexdof_macroedge_src, std::map< hyteg::edgedof::EdgeDoFOrientation, std::map< hyteg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t id_cell, int64_t id_face_0, int64_t id_face_1, int32_t level, int64_t micro_edge_index_x, int64_t num_neighbor_faces, std::map< hyteg::indexing::IndexIncrement, double > v2v_cell_stencil)
{
   ...
   const double xi_20 = v2v_cell_stencil[{ 0, -1, 1 }];
   const double xi_21 = v2v_cell_stencil[{ 1, -1, 0 }];
   _data_vertexdof_macroedge_dst[0] = xi_1*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 6*(1 << (level)) - 7] + xi_10*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_11*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_12*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_13*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_14*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_15*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_16*_data_vertexdof_macroedge_src[micro_edge_index_x - 1] + xi_17*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_18*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_19*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_2*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_20*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_21*_data_vertexdof_macroedge_src[micro_edge_index_x + 1] + xi_3*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 4*(1 << (level)) - 5] + xi_4*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_5*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_6*_data_edgedof_macroedge_src[micro_edge_index_x - 1] + xi_7*_data_edgedof_macroedge_src[micro_edge_index_x] + xi_8*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_9*_data_edgedof_macroedge_src[micro_edge_index_x];
   {
...
static void sor_3D_macroedge_P2_update_vertexdofs_impl_230_level_any(double const * RESTRICT const _data_edgedof_macroedge_src, double * RESTRICT _data_vertexdof_macroedge_dst, double const * RESTRICT const _data_vertexdof_macroedge_src, std::map< hyteg::edgedof::EdgeDoFOrientation, std::map< hyteg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t id_cell, int64_t id_face_0, int64_t id_face_1, int32_t level, int64_t micro_edge_index_x, int64_t num_neighbor_faces, std::map< hyteg::indexing::IndexIncrement, double > v2v_cell_stencil)
{
   ...
   const double xi_21 = v2v_cell_stencil[{ 1, 0, -1 }];
   _data_vertexdof_macroedge_dst[0] = xi_1*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 6*(1 << (level)) - 7] + xi_10*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_11*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_12*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_13*_data_edgedof_macroedge_src[micro_edge_index_x - 1] + xi_14*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_15*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_16*_data_vertexdof_macroedge_src[micro_edge_index_x] + xi_17*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level)) + 2] + xi_18*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_19*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_2*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_20*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_21*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_3*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 4*(1 << (level)) - 5] + xi_4*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_5*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_6*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_7*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_8*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_9*_data_edgedof_macroedge_src[micro_edge_index_x];
   {
...
static void sor_3D_macroedge_P2_update_vertexdofs_impl_301_level_any(double const * RESTRICT const _data_edgedof_macroedge_src, double * RESTRICT _data_vertexdof_macroedge_dst, double const * RESTRICT const _data_vertexdof_macroedge_src, std::map< hyteg::edgedof::EdgeDoFOrientation, std::map< hyteg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t id_cell, int64_t id_face_0, int64_t id_face_1, int32_t level, int64_t micro_edge_index_x, int64_t num_neighbor_faces, std::map< hyteg::indexing::IndexIncrement, double > v2v_cell_stencil)
{
   ...
   const double xi_20 = v2v_cell_stencil[{ 1, 0, -1 }];
   const double xi_21 = v2v_cell_stencil[{ 1, 0, 0 }];
   _data_vertexdof_macroedge_dst[0] = xi_1*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 6*(1 << (level)) - 7] + xi_10*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 7] + xi_11*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_12*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_13*_data_edgedof_macroedge_src[micro_edge_index_x - 1] + xi_14*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_15*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_16*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 2] + xi_17*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_18*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level)) + 1] + xi_19*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_2*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_20*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_21*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_3*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 4*(1 << (level)) - 5] + xi_4*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_5*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_6*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_7*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_8*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_9*_data_edgedof_macroedge_src[micro_edge_index_x - 1];
   {
...
static void sor_3D_macroedge_P2_update_vertexdofs_impl_310_level_any(double const * RESTRICT const _data_edgedof_macroedge_src, double * RESTRICT _data_vertexdof_macroedge_dst, double const * RESTRICT const _data_vertexdof_macroedge_src, std::map< hyteg::edgedof::EdgeDoFOrientation, std::map< hyteg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t id_cell, int64_t id_face_0, int64_t id_face_1, int32_t level, int64_t micro_edge_index_x, int64_t num_neighbor_faces, std::map< hyteg::indexing::IndexIncrement, double > v2v_cell_stencil)
{
   ...
   const double xi_25 = v2v_cell_stencil[{ 0, 1, -1 }];
   const double xi_26 = v2v_cell_stencil[{ 1, 0, -1 }];
   _data_vertexdof_macroedge_dst[0] = xi_1*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 6*(1 << (level)) - 7] + xi_10*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_11*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_12*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_13*_data_edgedof_macroedge_src[micro_edge_index_x - 1] + xi_14*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_15*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_16*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_17*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_18*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 4*(1 << (level)) - 5] + xi_19*_data_edgedof_macroedge_src[micro_edge_index_x] + xi_2*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_20*_data_vertexdof_macroedge_src[micro_edge_index_x - 1] + xi_21*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_22*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level))] + xi_23*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_24*_data_vertexdof_macroedge_src[id_face_0*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_25*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level)) + 1] + xi_26*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 2] + xi_3*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 4*(1 << (level)) - 5] + xi_4*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_5*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_6*_data_edgedof_macroedge_src[micro_edge_index_x - 1] + xi_7*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_8*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_9*_data_edgedof_macroedge_src[micro_edge_index_x - 1];
   {
...
static void sor_3D_macroedge_P2_update_vertexdofs_impl_320_level_any(double const * RESTRICT const _data_edgedof_macroedge_src, double * RESTRICT _data_vertexdof_macroedge_dst, double const * RESTRICT const _data_vertexdof_macroedge_src, std::map< hyteg::edgedof::EdgeDoFOrientation, std::map< hyteg::indexing::IndexIncrement, double > > e2v_cell_stencil, int64_t id_cell, int64_t id_face_0, int64_t id_face_1, int32_t level, int64_t micro_edge_index_x, int64_t num_neighbor_faces, std::map< hyteg::indexing::IndexIncrement, double > v2v_cell_stencil)
{
   ...
   const double xi_20 = v2v_cell_stencil[{ 1, -1, 0 }];
   const double xi_21 = v2v_cell_stencil[{ 1, 0, -1 }];
   _data_vertexdof_macroedge_dst[0] = xi_1*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 6*(1 << (level)) - 7] + xi_10*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 7] + xi_11*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 8] + xi_12*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_13*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_14*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 2] + xi_15*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 3*(1 << (level)) - 1] + xi_16*_data_vertexdof_macroedge_src[micro_edge_index_x - 1] + xi_17*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level))] + xi_18*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level)) + 1] + xi_19*_data_vertexdof_macroedge_src[micro_edge_index_x + num_neighbor_faces*(1 << (level)) + (1 << (level)) + 2] + xi_2*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_20*_data_vertexdof_macroedge_src[micro_edge_index_x - 1] + xi_21*_data_vertexdof_macroedge_src[id_face_1*(1 << (level)) + micro_edge_index_x + (1 << (level)) + 1] + xi_3*_data_edgedof_macroedge_src[id_cell*(7*(1 << (level)) - 7) + micro_edge_index_x + num_neighbor_faces*(3*(1 << (level)) - 1) + 7*(1 << (level)) - 7] + xi_4*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 2] + xi_5*_data_edgedof_macroedge_src[id_face_1*(3*(1 << (level)) - 1) + micro_edge_index_x + 2*(1 << (level)) - 1] + xi_6*_data_edgedof_macroedge_src[micro_edge_index_x - 1] + xi_7*_data_edgedof_macroedge_src[micro_edge_index_x] + xi_8*_data_edgedof_macroedge_src[id_face_0*(3*(1 << (level)) - 1) + micro_edge_index_x + (1 << (level)) - 1] + xi_9*_data_edgedof_macroedge_src[micro_edge_index_x - 1];
   {
