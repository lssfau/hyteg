...
{
  double e2v_cell_stencil_fused_face_0_ptr[100];
  double e2v_cell_stencil_fused_face_1_ptr[100];
  double v2v_cell_stencil_fused_face_0_ptr[100];
  double v2v_cell_stencil_fused_face_1_ptr[100];
