...
///
class
    P2VectorElementwiseEpsilonRotation_IcosahedralShellMap_fused_quadloops_float64
...
public:
  P2VectorElementwiseEpsilonRotation_IcosahedralShellMap_fused_quadloops_float64(
      ...
      size_t maxLevel, const P0Function<walberla::float64> &_mu,
      ...
      walberla::float64
          c_rot_penalty_P2VectorElementwiseEpsilonRotation_IcosahedralShellMap_fused_quadloops_float64);
...
private:
  ...
  /// ------  ------  ------  ------  -----  -------------  ----------------
  /// -------------
  ///  23058   34807     206     210    155              0                 0 0
  void
  apply_P2VectorElementwiseEpsilonRotation_IcosahedralShellMap_fused_quadloops_float64_macro_3D(
      ...
      walberla::float64 c_rot_penalty, walberla::float64 forVertex_0,
      walberla::float64 forVertex_1, walberla::float64 forVertex_2,
      ...
      walberla::float64 rayVertex_2, walberla::float64 refVertex_0,
      walberla::float64 refVertex_1, walberla::float64 refVertex_2,
      walberla::float64 thrVertex_0, walberla::float64 thrVertex_1,
  ...
  /// ------  ------  ------  ------  -----  -------------  ----------------
  /// -------------
  ///  22158   33907     206     210    155              0                 0 3
  void
  toMatrix_P2VectorElementwiseEpsilonRotation_IcosahedralShellMap_fused_quadloops_float64_macro_3D(
      idx_t *RESTRICT _data_dst_edge_0, idx_t *RESTRICT _data_dst_edge_1,
      idx_t *RESTRICT _data_dst_edge_2, idx_t *RESTRICT _data_dst_vertex_0,
      idx_t *RESTRICT _data_dst_vertex_1, idx_t *RESTRICT _data_dst_vertex_2,
      walberla::float64 *RESTRICT _data_mu,
      walberla::float64 *RESTRICT _data_nx_rotationEdge,
      walberla::float64 *RESTRICT _data_nx_rotationVertex,
      walberla::float64 *RESTRICT _data_ny_rotationEdge,
      ...
      idx_t *RESTRICT _data_src_edge_2, idx_t *RESTRICT _data_src_vertex_0,
      idx_t *RESTRICT _data_src_vertex_1, idx_t *RESTRICT _data_src_vertex_2,
      walberla::float64 c_rot_penalty, walberla::float64 forVertex_0,
      walberla::float64 forVertex_1, walberla::float64 forVertex_2,
      walberla::float64 macro_vertex_coord_id_0comp0,
      walberla::float64 macro_vertex_coord_id_0comp1,
  ...
  /// ------  ------  ------  ------  -----  -------------  ----------------
  /// -------------
  ///   4763    7972     206     210    155              0                 0 0
  void
  computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonRotation_IcosahedralShellMap_fused_quadloops_float64_macro_3D(
  ...
  walberla::float64
      c_rot_penalty_P2VectorElementwiseEpsilonRotation_IcosahedralShellMap_fused_quadloops_float64_;
};
