...
///         matrix
///
class P2VectorElementwiseEpsilonRotationIcosahedralShellMapVectorizedOperator
...
public:
  P2VectorElementwiseEpsilonRotationIcosahedralShellMapVectorizedOperator(
      ...
      walberla::float64
          c_rot_penalty_P2VectorElementwiseEpsilonRotationIcosahedralShellMapVectorizedOperator);
...
private:
  ...
  /// ------  ------  ------  ------  -----  -------------  ----------------
  /// -------------
  ///  28633   36452     206     210    155              0                 0 1
  void
  apply_P2VectorElementwiseEpsilonRotationIcosahedralShellMapVectorizedOperator_macro_3D(
  ...
  /// ------  ------  ------  ------  -----  -------------  ----------------
  /// -------------
  ///   6843   10077     206     210    155              0                 0 1
  void
  computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonRotationIcosahedralShellMapVectorizedOperator_macro_3D(
  ...
  walberla::float64
      c_rot_penalty_P2VectorElementwiseEpsilonRotationIcosahedralShellMapVectorizedOperator_;
};
