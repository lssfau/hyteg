...
///
class P2VectorEpsilonRotationIcosahedralShellMapOperator
...
{
 public:
   P2VectorEpsilonRotationIcosahedralShellMapOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                       size_t                                     minLevel,
                                                       size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorEpsilonRotationIcosahedralShellMapOperator
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  19738   31662     196     210    150              0                 0              0
   void apply_P2VectorEpsilonRotationIcosahedralShellMapOperator_macro_3D( walberla::float64* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  18838   30762     196     210    150              0                 0              3
   void toMatrix_P2VectorEpsilonRotationIcosahedralShellMapOperator_macro_3D( idx_t* RESTRICT             _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4243    6912     196     210    150              0                 0              0
   void computeInverseDiagonalOperatorValues_P2VectorEpsilonRotationIcosahedralShellMapOperator_macro_3D(
