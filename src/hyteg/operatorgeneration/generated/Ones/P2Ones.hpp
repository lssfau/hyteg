...
class P2Ones : public Operator< P1Function< walberla::float64 >, P1Function< walberla::float64 > >,
               public OperatorWithInverseDiagonal< P1Function< walberla::float64 > >
{
 public:
   P2Ones( const std::shared_ptr< PrimitiveStorage >& storage, size_t minLevel, size_t maxLevel );
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     35      24      12       0      0              0                 0              0
   void apply_P2Ones_macro_2D( walberla::float64* RESTRICT _data_dst,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     32      24      12       0      0              0                 0              3
   void toMatrix_P2Ones_macro_2D( idx_t* RESTRICT                      _data_dst,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     35      24      12       0      0              0                 0              0
   void computeInverseDiagonalOperatorValues_P2Ones_macro_2D( walberla::float64* RESTRICT _data_invDiag_,
                                                              walberla::float64           macro_vertex_coord_id_0comp0,
                                                              walberla::float64           macro_vertex_coord_id_0comp1,
                                                              walberla::float64           macro_vertex_coord_id_1comp0,
                                                              walberla::float64           macro_vertex_coord_id_1comp1,
