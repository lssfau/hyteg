...
P2Ones::P2Ones( const std::shared_ptr< PrimitiveStorage >& storage, size_t minLevel, size_t maxLevel )
: Operator( storage, minLevel, maxLevel )
{}

void P2Ones::apply( const P1Function< walberla::float64 >& src,
...
void P2Ones::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
...
void P2Ones::computeInverseDiagonalOperatorValues()
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2Ones_macro_2D(
...
std::shared_ptr< P1Function< walberla::float64 > > P2Ones::getInverseDiagonalValues() const
{
   return invDiag_;
}
void P2Ones::apply_P2Ones_macro_2D( walberla::float64* RESTRICT _data_dst,
         ...
         for ( int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1 )
            for ( int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1 )
            {
               ...
               const walberla::float64 src_dof_2  = _data_src[ctr_0 + ( ctr_1 + 1 ) * ( micro_edges_per_macro_edge + 2 ) -
                                                             ( ( ( ctr_1 + 1 ) * ( ctr_1 + 2 ) ) / ( 2 ) )];
               const walberla::float64 elMatVec_0 = src_dof_0 * 1.0;
               const walberla::float64 elMatVec_1 = src_dof_1 * 1.0;
               const walberla::float64 elMatVec_2 = src_dof_2 * 1.0;
...
void P2Ones::toMatrix_P2Ones_macro_2D( idx_t* RESTRICT                      _data_dst,
...
void P2Ones::computeInverseDiagonalOperatorValues_P2Ones_macro_2D( walberla::float64* RESTRICT _data_invDiag_,
                                                                   walberla::float64           macro_vertex_coord_id_0comp0,
                                                                   walberla::float64           macro_vertex_coord_id_0comp1,
                                                                   walberla::float64           macro_vertex_coord_id_1comp0,
                                                                   walberla::float64           macro_vertex_coord_id_1comp1,
         ...
         for ( int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1 )
            for ( int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1 )
            {
               ...
               const walberla::float64 p_affine_2_1 =
                   ...
                   1.0 / ( micro_edges_per_macro_edge_float ) * ( -macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1 ) *
                       1.0 * ( ( walberla::float64 )( ctr_1 + 1 ) );
               const walberla::float64 elMatDiag_0 = 1.0;
               const walberla::float64 elMatDiag_1 = 1.0;
               const walberla::float64 elMatDiag_2 = 1.0;
