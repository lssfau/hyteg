...
class P2ElementwiseBoundaryKMassIcosahedralShellMap
...
{
 public:
   P2ElementwiseBoundaryKMassIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                  size_t                                     minLevel,
                                                  size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_0
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1232    1528      37      14      7              0                 0              0
   void apply_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_0_macro_3D(
   ...
   /// Integral: P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_1
   /// - volume element:  tetrahedron, dim: 3, vertices: 4, spacedim: 3
   /// - kernel type:     apply
   /// - loop strategy:   BOUNDARY
   /// - quadrature rule: Dunavant 5 | points: 7, degree: 5
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1229    1528      37      14      7              0                 0              0
   void apply_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_1_macro_3D(
       walberla::float64* RESTRICT _data_dstEdge,
       walberla::float64* RESTRICT _data_dstVertex,
       walberla::float64* RESTRICT _data_kEdge,
       walberla::float64* RESTRICT _data_kVertex,
   ...
   /// Integral: P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_2
   /// - volume element:  tetrahedron, dim: 3, vertices: 4, spacedim: 3
   /// - kernel type:     apply
   /// - loop strategy:   BOUNDARY
   /// - quadrature rule: Dunavant 5 | points: 7, degree: 5
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1232    1528      37      14      7              0                 0              0
   void apply_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_2_macro_3D(
       walberla::float64* RESTRICT _data_dstEdge,
       walberla::float64* RESTRICT _data_dstVertex,
       walberla::float64* RESTRICT _data_kEdge,
       walberla::float64* RESTRICT _data_kVertex,
   ...
   /// Integral: P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_3
   /// - volume element:  tetrahedron, dim: 3, vertices: 4, spacedim: 3
   /// - kernel type:     apply
   /// - loop strategy:   BOUNDARY
   /// - quadrature rule: Dunavant 5 | points: 7, degree: 5
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1235    1528      37      14      7              0                 0              0
   void apply_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_3_macro_3D(
       walberla::float64* RESTRICT _data_dstEdge,
       walberla::float64* RESTRICT _data_dstVertex,
       walberla::float64* RESTRICT _data_kEdge,
       walberla::float64* RESTRICT _data_kVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1132    1428      37      14      7              0                 0              3
   void toMatrix_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_0_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1129    1428      37      14      7              0                 0              3
   void toMatrix_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_1_macro_3D(
       idx_t* RESTRICT                      _data_dstEdge,
       idx_t* RESTRICT                      _data_dstVertex,
       walberla::float64* RESTRICT          _data_kEdge,
       walberla::float64* RESTRICT          _data_kVertex,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1132    1428      37      14      7              0                 0              3
   void toMatrix_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_2_macro_3D(
       idx_t* RESTRICT                      _data_dstEdge,
       idx_t* RESTRICT                      _data_dstVertex,
       walberla::float64* RESTRICT          _data_kEdge,
       walberla::float64* RESTRICT          _data_kVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1135    1428      37      14      7              0                 0              3
   void toMatrix_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_3_macro_3D(
       idx_t* RESTRICT                      _data_dstEdge,
       idx_t* RESTRICT                      _data_dstVertex,
       walberla::float64* RESTRICT          _data_kEdge,
       walberla::float64* RESTRICT          _data_kVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    872    1057      37      14      7              0                 0              0
   void computeInverseDiagonalOperatorValues_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_0_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    869    1057      37      14      7              0                 0              0
   void computeInverseDiagonalOperatorValues_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_1_macro_3D(
       walberla::float64* RESTRICT _data_invDiag_Edge,
       walberla::float64* RESTRICT _data_invDiag_Vertex,
       walberla::float64* RESTRICT _data_kEdge,
       walberla::float64* RESTRICT _data_kVertex,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    872    1057      37      14      7              0                 0              0
   void computeInverseDiagonalOperatorValues_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_2_macro_3D(
       walberla::float64* RESTRICT _data_invDiag_Edge,
       walberla::float64* RESTRICT _data_invDiag_Vertex,
       walberla::float64* RESTRICT _data_kEdge,
       walberla::float64* RESTRICT _data_kVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    875    1057      37      14      7              0                 0              0
   void computeInverseDiagonalOperatorValues_P2ElementwiseBoundaryKMassIcosahedralShellMap_facet_id_3_macro_3D(
       walberla::float64* RESTRICT _data_invDiag_Edge,
       walberla::float64* RESTRICT _data_invDiag_Vertex,
       walberla::float64* RESTRICT _data_kEdge,
       walberla::float64* RESTRICT _data_kVertex,
   ...
   BoundaryUID                                        P2ElementwiseBoundaryKMassIcosahedralShellMap_boundary_uid_;
};
