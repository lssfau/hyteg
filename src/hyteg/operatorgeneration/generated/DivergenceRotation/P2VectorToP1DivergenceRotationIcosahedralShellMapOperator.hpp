...
///
class P2VectorToP1DivergenceRotationIcosahedralShellMapOperator
: public Operator< P2VectorFunction< walberla::float64 >, P1Function< walberla::float64 > >
{
 public:
   P2VectorToP1DivergenceRotationIcosahedralShellMapOperator( const std::shared_ptr< PrimitiveStorage >& storage,
                                                              size_t                                     minLevel,
                                                              size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorToP1DivergenceRotationIcosahedralShellMapOperator
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3753    6412     196     210    150              0                 0              0
   void apply_P2VectorToP1DivergenceRotationIcosahedralShellMapOperator_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3633    6292     196     210    150              0                 0              3
   void toMatrix_P2VectorToP1DivergenceRotationIcosahedralShellMapOperator_macro_3D(
