...
///
class P2VectorElementwiseFullStokesRotationWithFSPenaltyIcosahedralShellMapOperator
...
{
 public:
   P2VectorElementwiseFullStokesRotationWithFSPenaltyIcosahedralShellMapOperator(
       ...
       walberla::float64 c_rot_penalty_P2VectorElementwiseFullStokesRotationWithFSPenaltyIcosahedralShellMapOperator );
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesRotationWithFSPenaltyIcosahedralShellMapOperator
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  56103   96892     388     462    330              0                 0              0
   void apply_P2VectorElementwiseFullStokesRotationWithFSPenaltyIcosahedralShellMapOperator_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  55203   95992     388     462    330              0                 0              3
   void toMatrix_P2VectorElementwiseFullStokesRotationWithFSPenaltyIcosahedralShellMapOperator_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  11178   19223     388     462    330              0                 0              0
   void
       computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesRotationWithFSPenaltyIcosahedralShellMapOperator_macro_3D(
   ...
   walberla::float64 c_rot_penalty_P2VectorElementwiseFullStokesRotationWithFSPenaltyIcosahedralShellMapOperator_;
};
