 ...
 */
#include "P1RotationOperator.hpp"
...
#include "hyteg/p1functionspace/freeslip/VertexDoFRotation.hpp"
...
void P1RotationOperator::rotate( const P1StokesFunction< real_t >& dst, size_t level, DoFType flag, bool transpose ) const
{
...
void P1RotationOperator::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
