...
static void apply_3D_macrocell_vertexdof_to_vertexdof_add_level_any(double * RESTRICT _data_p1CellDstAdd, double const * RESTRICT const _data_p1CellSrcAdd, int32_t level, std::map< hyteg::indexing::IndexIncrement, double > p1CellStencil)
{
