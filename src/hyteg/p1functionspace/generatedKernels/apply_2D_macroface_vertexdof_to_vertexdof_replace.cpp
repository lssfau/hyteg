...
static void apply_2D_macroface_vertexdof_to_vertexdof_replace_level_any(float * RESTRICT _data_p1FaceDst, float const * RESTRICT const _data_p1FaceSrc, float const * RESTRICT const _data_p1FaceStencil, int level)
{
...
void apply_2D_macroface_vertexdof_to_vertexdof_replace(float * RESTRICT _data_p1FaceDst, float const * RESTRICT const _data_p1FaceSrc, float const * RESTRICT const _data_p1FaceStencil, int level)
{
    switch( level )
    {
