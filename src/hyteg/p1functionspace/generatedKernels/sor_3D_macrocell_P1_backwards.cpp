...
static void sor_3D_macrocell_P1_backwards_level_any(double * RESTRICT _data_p1CellDst, double const * RESTRICT const _data_p1CellRhs, int level, std::map< hyteg::indexing::IndexIncrement, double > p1CellStencil, double relax)
{
...
void sor_3D_macrocell_P1_backwards(double * RESTRICT _data_p1CellDst, double const * RESTRICT const _data_p1CellRhs, int level, std::map< hyteg::indexing::IndexIncrement, double > p1CellStencil, double relax)
{
    switch( level )
    {
