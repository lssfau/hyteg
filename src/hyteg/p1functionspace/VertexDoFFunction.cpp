...
{
   if ( vertexDataID_.numRefs() == 1 )
   {
      WALBERLA_CHECK_EQUAL( vertexDataID_.numRefs(), edgeDataID_.numRefs() );
      WALBERLA_CHECK_EQUAL( vertexDataID_.numRefs(), faceDataID_.numRefs() );
