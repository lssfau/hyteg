...
void P1SurrogateOperator<P1Form, DEGREE>::smooth_sor( const P1Function< real_t >& dst,
   ...
   template < class P1Form, uint8_t DEGREE >
   void P1SurrogateOperator<P1Form, DEGREE>::assemble_diagonalOperator_edge_precomputed_2d( std::shared_ptr< hyteg::Edge > edge, uint_t lvl, real_t* diagData )
   {
      const auto  n        = levelinfo::num_microvertices_per_edge( lvl );
   ...
   template < class P1Form, uint8_t DEGREE >
   void P1SurrogateOperator<P1Form, DEGREE>::assemble_diagonalOperator_edge_precomputed_3d( std::shared_ptr< hyteg::Edge > edge, uint_t lvl, real_t* diagData )
   {
      const auto  n        = levelinfo::num_microvertices_per_edge( lvl );
      auto        diagIdx  = vertexdof::macroedge::index( lvl, 1 );
   ...
   template < class P1Form, uint8_t DEGREE >
   void P1SurrogateOperator<P1Form, DEGREE>::assemble_diagonalOperator_face_precomputed_2d( std::shared_ptr< hyteg::Face > face, uint_t lvl, real_t* diagData )
   {
      const auto  n        = levelinfo::num_microvertices_per_edge( lvl );
      const auto& stencils = stencil_face_2d_.at( face->getID() )[lvl];
   ...
   template < class P1Form, uint8_t DEGREE >
   void P1SurrogateOperator<P1Form, DEGREE>::assemble_diagonalOperator_face_precomputed_3d( std::shared_ptr< hyteg::Face > face, uint_t lvl, real_t* diagData )
   {
      const auto  n        = levelinfo::num_microvertices_per_edge( lvl );
      const auto& stencils = stencil_face_3d_.at( face->getID() )[lvl];
   ...
   template < class P1Form, uint8_t DEGREE >
   void P1SurrogateOperator<P1Form, DEGREE>::assemble_diagonalOperator_cell_precomputed_3d( std::shared_ptr< hyteg::Cell > cell, uint_t lvl, real_t* diagData )
   {
      const auto  n        = levelinfo::num_microvertices_per_edge( lvl );
      const auto& stencils = stencil_cell_3d_.at( cell->getID() )[lvl];
   ...
   template < class P1Form, uint8_t DEGREE >
   void P1SurrogateOperator<P1Form, DEGREE>::assemble_diagonalOperator_edge_surrogate_2d( std::shared_ptr< hyteg::Edge > edge, uint_t lvl, real_t* diagData )
   {
      const auto                 n         = levelinfo::num_microvertices_per_edge( lvl );
      auto                       diagIdx   = vertexdof::macroedge::index( lvl, 1 );
      const PolyStencil< 2, 1 > surrogate = surrogate_edge_2d_.at( edge->getID() )[lvl];
   ...
   template < class P1Form, uint8_t DEGREE >
   void P1SurrogateOperator<P1Form, DEGREE>::assemble_diagonalOperator_face_surrogate_2d( std::shared_ptr< hyteg::Face > face, uint_t lvl, real_t* diagData )
   {
      const auto                 n         = levelinfo::num_microvertices_per_edge( lvl );
      const PolyStencil< 2, 2 > surrogate = surrogate_face_2d_.at( face->getID() )[lvl];
      const PolyDomain           X( lvl );
   ...
   template < class P1Form, uint8_t DEGREE >
   void P1SurrogateOperator<P1Form, DEGREE>::assemble_diagonalOperator_face_surrogate_3d( std::shared_ptr< hyteg::Face > face, uint_t lvl, real_t* diagData )
   {
      const auto                 n         = levelinfo::num_microvertices_per_edge( lvl );
      const PolyStencil< 3, 2 > surrogate = surrogate_face_3d_.at( face->getID() )[lvl];
      const PolyDomain           X( lvl );
   ...
   template < class P1Form, uint8_t DEGREE >
   void P1SurrogateOperator<P1Form, DEGREE>::assemble_diagonalOperator_cell_surrogate_3d( std::shared_ptr< hyteg::Cell > cell, uint_t lvl, real_t* diagData )
   {
      const auto                 n         = levelinfo::num_microvertices_per_edge( lvl );
      const PolyStencil< 3, 3 > surrogate = surrogate_cell_3d_.at( cell->getID() )[lvl];
      const PolyDomain           X( lvl );
