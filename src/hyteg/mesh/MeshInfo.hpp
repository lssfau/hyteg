...
class MeshInfo
{
 public:
   ...
   /// Constructs a torus-like domain that shall resemble the Tokamak structure as e.g. described in
   ///
   ...
   ///
   /// A corresponding blending function is available to project meshes that are generated by this function to
   /// the ITER or JET geometry described in the article.
   ///
