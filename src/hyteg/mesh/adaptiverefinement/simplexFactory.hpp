...
class SimplexFactory
{
 public:
   ...
   */
   SimplexFactory( const std::shared_ptr< Simplex3 > parent, const std::vector< int64_t >& vertices )
   : _parent( parent )
   , _vertices( vertices )
   {}
   ...
   */
   inline void add_face( int64_t a, int64_t b, int64_t c, std::shared_ptr< Simplex2 > face ) { _faces[{ a, b, c }] = face; }
   ...
   */
   inline void add_edge( int64_t a, int64_t b, std::shared_ptr< Simplex1 > edge ) { _edges[{ a, b }] = edge; }
   ...
   */
   std::shared_ptr< Simplex1 > make_edge( int64_t a, int64_t b, Color color = RED );
   ...
   */
   std::shared_ptr< Simplex2 > make_face( int64_t a, int64_t b, int64_t c );
