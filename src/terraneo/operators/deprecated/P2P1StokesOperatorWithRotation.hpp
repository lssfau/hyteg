...
/***************************************************************************************************
NOTE: Normal Stokes operator is wrapped with a FreeSlip Rotation Wrapper
...
class P2P1FullStokesRotationFSTemplate : public Operator< P2P1TaylorHoodFunction< real_t >, P2P1TaylorHoodFunction< real_t > >
{
 public:
   ...
   class P2ViscousOperatorWithRotation : public Operator< P2VectorFunction< real_t >, P2VectorFunction< real_t > >,
                                         public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
   {
    public:
      P2ViscousOperatorWithRotation( const std::shared_ptr< PrimitiveStorage >& storage,
                                     uint_t                                     minLevel,
                                     uint_t                                     maxLevel,
                                     P2P1FullStokesRotationFSTemplate&          outerWrapper )
                     ...
                     DoFType                                     flag ) const override
      {
         ...
         outerWrapper_.rotationOperator_.toMatrix(
             matProxyProjectionPost, outerWrapper_.tmpAssembly_->uvw(), level, FreeslipBoundary, false );
         ...
         outerWrapper_.rotationOperator_.toMatrix(
             matProxyProjectionPre, outerWrapper_.tmpAssembly_->uvw(), level, FreeslipBoundary, true );
      ...
      P2P1FullStokesRotationFSTemplate& outerWrapper_;
   };

   class P1ToP2GradientOperatorWithRotation : public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
   {
    public:
      P1ToP2GradientOperatorWithRotation( const std::shared_ptr< PrimitiveStorage >& storage,
                                          uint_t                                     minLevel,
                                          uint_t                                     maxLevel,
                                          P2P1FullStokesRotationFSTemplate&          outerWrapper )
                  ...
                  const UpdateType                  updateType = Replace ) const override
      {
         ...
         outerWrapper_.rotationOperator_.rotate( outerWrapper_.tmp_->uvw(), level, FreeslipBoundary );
   ...
   class P2ToP1DivergenceOperatorWithRotation : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
   {
    public:
      P2ToP1DivergenceOperatorWithRotation( const std::shared_ptr< PrimitiveStorage >& storage,
                                            uint_t                                     minLevel,
                                            uint_t                                     maxLevel,
                                            P2P1FullStokesRotationFSTemplate&          outerWrapper )
   ...
   using ViscousOperatorRotation_T = P2ViscousOperatorWithRotation;
   using GradOperatorRotation_T    = P1ToP2GradientOperatorWithRotation;
   using DivOperatorRotation_T     = P2ToP1DivergenceOperatorWithRotation;

   using VelocityOperator_T  = ViscousOperatorRotation_T;
   using ViscousOperatorFS_T = ViscousOperatorRotation_T;

   P2P1FullStokesRotationFSTemplate( const std::shared_ptr< PrimitiveStorage >&                storage,
                                     uint_t                                                    minLevel,
                                     uint_t                                                    maxLevel,
                  ...
                  DoFType                                     flag ) const override
   {
      ...
      auto matProxyProjectionPost = mat->createCopy();
      rotationOperator_.toMatrix( matProxyProjectionPost, tmpAssembly_->uvw(), level, FreeslipBoundary, false );
      ...
      auto matProxyProjectionPre = mat->createCopy();
      rotationOperator_.toMatrix( matProxyProjectionPre, tmpAssembly_->uvw(), level, FreeslipBoundary, true );
   ...
   GradOperatorRotation_T gradRotationOperator_;
   DivOperatorRotation_T  divRotationOperator_;
   ViscousOperatorRotation_T viscousOperatorWrapped_;

   const ViscousOperatorRotation_T& getA() const { return viscousOperatorWrapped_; }
   const DivOperatorRotation_T&     getB() const { return divRotationOperator_; }
   const GradOperatorRotation_T&    getBT() const { return gradRotationOperator_; }
   ...
   ViscousOperatorRotation_T& getA() { return viscousOperatorWrapped_; }
};

using P2P1StokesFullIcosahedralShellMapOperatorWithRotation =
    P2P1FullStokesRotationFSTemplate< P2Function< real_t >,
                                      P2Function< real_t >,
                                      P1Function< real_t >,
...
using P2P1StokesP1ViscosityFullIcosahedralShellMapOperatorWithRotation =
    P2P1FullStokesRotationFSTemplate< P1Function< real_t >,
                                      P2Function< real_t >,
                                      P1Function< real_t >,
...
using P2P1StokesP0ViscosityFullIcosahedralShellMapOperatorWithRotation =
    P2P1FullStokesRotationFSTemplate< P0Function< real_t >,
                                      P2Function< real_t >,
                                      P1Function< real_t >,
