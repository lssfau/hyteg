...
class P2ViscousIcosahedralShellMapOperatorRotationTemplate
  ...
  public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 public:
   ...
   P2ViscousIcosahedralShellMapOperatorRotationTemplate( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         uint_t                                     minLevel,
                                                         uint_t                                     maxLevel,
...
using P2P0ViscousIcosahedralShellMapOperatorRotation = P2ViscousIcosahedralShellMapOperatorRotationTemplate<
    P0Function< real_t >,
    operatorgeneration::P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap >;

template < typename ViscosityFunction_T, typename VelocityOperator_T >
class P2P1StokesOpgenRotationWrapperTemplate
: public Operator< P2P1TaylorHoodFunction< real_t >, P2P1TaylorHoodFunction< real_t > >
{
 public:
   ...
   using ViscousOperatorFS_T = VelocityOperator_T;
   using SchurOperator_T     = operatorgeneration::P1ElementwiseKMassIcosahedralShellMap;

   P2P1StokesOpgenRotationWrapperTemplate( const std::shared_ptr< PrimitiveStorage >& storage,
                                           uint_t                                     minLevel,
                                           uint_t                                     maxLevel,
                                           const ViscosityFunction_T&                 mu,
               ...
               const UpdateType                        updateType = Replace ) const override
   {
      ...
      stokesViscousOperator_.viscousOperator.apply( src.uvw(), dst.uvw(), level, flag, updateType );
   ...
   ViscousOperatorFS_T stokesViscousOperator_;
   P2RotationOperator& rotationOperator_;
