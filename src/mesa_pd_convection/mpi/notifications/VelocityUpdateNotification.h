...
#include <mesa_pd_convection/mpi/notifications/NotificationType.h>
#include <mesa_pd_convection/mpi/notifications/reset.h>
...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const mesa_pd_convection::VelocityUpdateNotification& obj )
{
   // Perform the addition
   obj.p_.getLinearVelocityRef() = obj.p_.getLinearVelocity() + mesa_pd_convection::VelocityUpdateNotification::Parameters::relaxationParam * obj.p_.getDv();
   obj.p_.getAngularVelocityRef() = obj.p_.getAngularVelocity() + mesa_pd_convection::VelocityUpdateNotification::Parameters::relaxationParam * obj.p_.getDw();
   // Reset the velocity corrections dv/dw of main particle
   obj.p_.getDvRef() = mesa_pd_convection::Vec3();
   obj.p_.getDwRef() = mesa_pd_convection::Vec3();
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, mesa_pd_convection::VelocityUpdateNotification::Parameters& objparam )
{
...
template< >
struct BufferSizeTrait< mesa_pd_convection::VelocityUpdateNotification > {
   static const bool constantSize = true;
   static const uint_t size = BufferSizeTrait<id_t>::size +
                              BufferSizeTrait<mesa_pd_convection::Vec3>::size +
                              BufferSizeTrait<mesa_pd_convection::Vec3>::size +
