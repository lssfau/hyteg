...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const mesa_pd_convection::ForceTorqueNotification& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, mesa_pd_convection::ForceTorqueNotification::Parameters& objparam )
{
...
template< >
struct BufferSizeTrait< mesa_pd_convection::ForceTorqueNotification > {
