...
#include <mesa_pd_convection/mpi/ShapePackUnpack.h>
...
public:
   struct Parameters
   {
      ...
      walberla::mesa_pd_convection::Vec3 position {real_t(0)};
      walberla::real_t interactionRadius {real_t(0)};
      walberla::mesa_pd_convection::data::particle_flags::FlagT flags {};
      int owner {-1};
      walberla::mesa_pd_convection::Vec3 velocity {real_t(0)};
   };
...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const mesa_pd_convection::ParticleGhostCopyNotification& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, mesa_pd_convection::ParticleGhostCopyNotification::Parameters& objparam )
{
