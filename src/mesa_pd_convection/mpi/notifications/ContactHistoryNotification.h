...
public:
   ...
   {
      id_t uid_;
      std::map<walberla::id_t, walberla::mesa_pd_convection::data::ContactHistory> contactHistory_;
   };
...
{
   p.setNewContactHistory(std::map<walberla::id_t, walberla::mesa_pd_convection::data::ContactHistory>());
}
...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const mesa_pd_convection::ContactHistoryNotification& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, mesa_pd_convection::ContactHistoryNotification::Parameters& objparam )
{
