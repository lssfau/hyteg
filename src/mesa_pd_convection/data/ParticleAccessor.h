...
public:
   ...
   walberla::mesa_pd_convection::Vec3 const & getPosition(const size_t p_idx) const {return ps_->getPosition(p_idx);}
   walberla::mesa_pd_convection::Vec3& getPositionRef(const size_t p_idx) {return ps_->getPositionRef(p_idx);}
   void setPosition(const size_t p_idx, walberla::mesa_pd_convection::Vec3 const & v) { ps_->setPosition(p_idx, v);}
   ...
   walberla::mesa_pd_convection::data::particle_flags::FlagT const & getFlags(const size_t p_idx) const {return ps_->getFlags(p_idx);}
   walberla::mesa_pd_convection::data::particle_flags::FlagT& getFlagsRef(const size_t p_idx) {return ps_->getFlagsRef(p_idx);}
   void setFlags(const size_t p_idx, walberla::mesa_pd_convection::data::particle_flags::FlagT const & v) { ps_->setFlags(p_idx, v);}
   ...
   walberla::mesa_pd_convection::Vec3 const & getVelocity(const size_t p_idx) const {return ps_->getVelocity(p_idx);}
   walberla::mesa_pd_convection::Vec3& getVelocityRef(const size_t p_idx) {return ps_->getVelocityRef(p_idx);}
   void setVelocity(const size_t p_idx, walberla::mesa_pd_convection::Vec3 const & v) { ps_->setVelocity(p_idx, v);}
...
public:
   ...
   walberla::mesa_pd_convection::Vec3 const & getPosition(const size_t /*p_idx*/) const {return position_;}
   void setPosition(const size_t /*p_idx*/, walberla::mesa_pd_convection::Vec3 const & v) { position_ = v;}
   ...
   walberla::mesa_pd_convection::data::particle_flags::FlagT const & getFlags(const size_t /*p_idx*/) const {return flags_;}
   void setFlags(const size_t /*p_idx*/, walberla::mesa_pd_convection::data::particle_flags::FlagT const & v) { flags_ = v;}
   walberla::mesa_pd_convection::data::particle_flags::FlagT& getFlagsRef(const size_t /*p_idx*/) {return flags_;}
   ...
   walberla::mesa_pd_convection::Vec3 const & getVelocity(const size_t /*p_idx*/) const {return velocity_;}
   void setVelocity(const size_t /*p_idx*/, walberla::mesa_pd_convection::Vec3 const & v) { velocity_ = v;}
   walberla::mesa_pd_convection::Vec3& getVelocityRef(const size_t /*p_idx*/) {return velocity_;}
...
private:
   ...
   walberla::mesa_pd_convection::data::particle_flags::FlagT flags_;
   int owner_;
   std::unordered_set<walberla::mpi::MPIRank> ghostOwners_;
   walberla::mesa_pd_convection::Vec3 velocity_;
