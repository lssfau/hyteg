...
public:
   ...
   static const int INVALID_SHAPE = -1; ///< Unique *invalid* shape type identifier.\ingroup mesa_pd_convection_shape
protected:
   ...
   ShapeTypeT shapeType_    = INVALID_SHAPE;   ///< \ingroup mesa_pd_convection_shape
};
