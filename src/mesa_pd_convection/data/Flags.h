...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const walberla::mesa_pd_convection::data::particle_flags::FlagT& flags )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, walberla::mesa_pd_convection::data::particle_flags::FlagT& flags )
{
...
template<> // value type
struct BufferSizeTrait< walberla::mesa_pd_convection::data::particle_flags::FlagT > {
   static const bool constantSize = true;
   static const uint_t size = sizeof(walberla::mesa_pd_convection::data::particle_flags::FlagT::value_type) + mpi::BUFFER_DEBUG_OVERHEAD;
};
