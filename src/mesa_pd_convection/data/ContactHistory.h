...
{
public:
   const walberla::mesa_pd_convection::Vec3& getTangentialSpringDisplacement() const {return tangentialSpringDisplacement_;}
   walberla::mesa_pd_convection::Vec3& getTangentialSpringDisplacementRef() {return tangentialSpringDisplacement_;}
   void setTangentialSpringDisplacement(const walberla::mesa_pd_convection::Vec3& v) { tangentialSpringDisplacement_ = v;}
...
private:
   walberla::mesa_pd_convection::Vec3 tangentialSpringDisplacement_ {};
   bool isSticking_ {};
...
mpi::GenericSendBuffer<T,G>& operator<<( mpi::GenericSendBuffer<T,G> & buf, const mesa_pd_convection::data::ContactHistory& obj )
{
...
mpi::GenericRecvBuffer<T>& operator>>( mpi::GenericRecvBuffer<T> & buf, mesa_pd_convection::data::ContactHistory& objparam )
{
