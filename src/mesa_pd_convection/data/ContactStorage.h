...
public:
   ...
   public:
      ...
      const walberla::mesa_pd_convection::Vec3& getNormal() const {return storage_.getNormal(i_);}
      walberla::mesa_pd_convection::Vec3& getNormalRef() {return storage_.getNormalRef(i_);}
      void setNormal(const walberla::mesa_pd_convection::Vec3& v) { storage_.setNormal(i_, v);}
      
      const walberla::mesa_pd_convection::Vec3& getPosition() const {return storage_.getPosition(i_);}
      walberla::mesa_pd_convection::Vec3& getPositionRef() {return storage_.getPositionRef(i_);}
      void setPosition(const walberla::mesa_pd_convection::Vec3& v) { storage_.setPosition(i_, v);}
      
      const walberla::mesa_pd_convection::Vec3& getT() const {return storage_.getT(i_);}
      walberla::mesa_pd_convection::Vec3& getTRef() {return storage_.getTRef(i_);}
      void setT(const walberla::mesa_pd_convection::Vec3& v) { storage_.setT(i_, v);}
      
      const walberla::mesa_pd_convection::Vec3& getO() const {return storage_.getO(i_);}
      walberla::mesa_pd_convection::Vec3& getORef() {return storage_.getORef(i_);}
      void setO(const walberla::mesa_pd_convection::Vec3& v) { storage_.setO(i_, v);}
      
      const walberla::mesa_pd_convection::Vec3& getR1() const {return storage_.getR1(i_);}
      walberla::mesa_pd_convection::Vec3& getR1Ref() {return storage_.getR1Ref(i_);}
      void setR1(const walberla::mesa_pd_convection::Vec3& v) { storage_.setR1(i_, v);}
      
      const walberla::mesa_pd_convection::Vec3& getR2() const {return storage_.getR2(i_);}
      walberla::mesa_pd_convection::Vec3& getR2Ref() {return storage_.getR2Ref(i_);}
      void setR2(const walberla::mesa_pd_convection::Vec3& v) { storage_.setR2(i_, v);}
      ...
      const walberla::mesa_pd_convection::Vec3& getP() const {return storage_.getP(i_);}
      walberla::mesa_pd_convection::Vec3& getPRef() {return storage_.getPRef(i_);}
      void setP(const walberla::mesa_pd_convection::Vec3& v) { storage_.setP(i_, v);}
      
      const walberla::mesa_pd_convection::Mat3& getDiag_nto() const {return storage_.getDiag_nto(i_);}
      walberla::mesa_pd_convection::Mat3& getDiag_ntoRef() {return storage_.getDiag_ntoRef(i_);}
      void setDiag_nto(const walberla::mesa_pd_convection::Mat3& v) { storage_.setDiag_nto(i_, v);}
      
      const walberla::mesa_pd_convection::Mat3& getDiag_nto_inv() const {return storage_.getDiag_nto_inv(i_);}
      walberla::mesa_pd_convection::Mat3& getDiag_nto_invRef() {return storage_.getDiag_nto_invRef(i_);}
      void setDiag_nto_inv(const walberla::mesa_pd_convection::Mat3& v) { storage_.setDiag_nto_inv(i_, v);}
      
      const walberla::mesa_pd_convection::Mat2& getDiag_to_inv() const {return storage_.getDiag_to_inv(i_);}
      walberla::mesa_pd_convection::Mat2& getDiag_to_invRef() {return storage_.getDiag_to_invRef(i_);}
      void setDiag_to_inv(const walberla::mesa_pd_convection::Mat2& v) { storage_.setDiag_to_inv(i_, v);}
   ...
   const walberla::mesa_pd_convection::Vec3& getNormal(const size_t idx) const {return normal_[idx];}
   walberla::mesa_pd_convection::Vec3& getNormalRef(const size_t idx) {return normal_[idx];}
   void setNormal(const size_t idx, const walberla::mesa_pd_convection::Vec3& v) { normal_[idx] = v; }
   
   const walberla::mesa_pd_convection::Vec3& getPosition(const size_t idx) const {return position_[idx];}
   walberla::mesa_pd_convection::Vec3& getPositionRef(const size_t idx) {return position_[idx];}
   void setPosition(const size_t idx, const walberla::mesa_pd_convection::Vec3& v) { position_[idx] = v; }
   
   const walberla::mesa_pd_convection::Vec3& getT(const size_t idx) const {return t_[idx];}
   walberla::mesa_pd_convection::Vec3& getTRef(const size_t idx) {return t_[idx];}
   void setT(const size_t idx, const walberla::mesa_pd_convection::Vec3& v) { t_[idx] = v; }
   
   const walberla::mesa_pd_convection::Vec3& getO(const size_t idx) const {return o_[idx];}
   walberla::mesa_pd_convection::Vec3& getORef(const size_t idx) {return o_[idx];}
   void setO(const size_t idx, const walberla::mesa_pd_convection::Vec3& v) { o_[idx] = v; }
   
   const walberla::mesa_pd_convection::Vec3& getR1(const size_t idx) const {return r1_[idx];}
   walberla::mesa_pd_convection::Vec3& getR1Ref(const size_t idx) {return r1_[idx];}
   void setR1(const size_t idx, const walberla::mesa_pd_convection::Vec3& v) { r1_[idx] = v; }
   
   const walberla::mesa_pd_convection::Vec3& getR2(const size_t idx) const {return r2_[idx];}
   walberla::mesa_pd_convection::Vec3& getR2Ref(const size_t idx) {return r2_[idx];}
   void setR2(const size_t idx, const walberla::mesa_pd_convection::Vec3& v) { r2_[idx] = v; }
   ...
   const walberla::mesa_pd_convection::Vec3& getP(const size_t idx) const {return p_[idx];}
   walberla::mesa_pd_convection::Vec3& getPRef(const size_t idx) {return p_[idx];}
   void setP(const size_t idx, const walberla::mesa_pd_convection::Vec3& v) { p_[idx] = v; }
   
   const walberla::mesa_pd_convection::Mat3& getDiag_nto(const size_t idx) const {return diag_nto_[idx];}
   walberla::mesa_pd_convection::Mat3& getDiag_ntoRef(const size_t idx) {return diag_nto_[idx];}
   void setDiag_nto(const size_t idx, const walberla::mesa_pd_convection::Mat3& v) { diag_nto_[idx] = v; }
   
   const walberla::mesa_pd_convection::Mat3& getDiag_nto_inv(const size_t idx) const {return diag_nto_inv_[idx];}
   walberla::mesa_pd_convection::Mat3& getDiag_nto_invRef(const size_t idx) {return diag_nto_inv_[idx];}
   void setDiag_nto_inv(const size_t idx, const walberla::mesa_pd_convection::Mat3& v) { diag_nto_inv_[idx] = v; }
   
   const walberla::mesa_pd_convection::Mat2& getDiag_to_inv(const size_t idx) const {return diag_to_inv_[idx];}
   walberla::mesa_pd_convection::Mat2& getDiag_to_invRef(const size_t idx) {return diag_to_inv_[idx];}
   void setDiag_to_inv(const size_t idx, const walberla::mesa_pd_convection::Mat2& v) { diag_to_inv_[idx] = v; }
   ...
   std::vector<walberla::mesa_pd_convection::Vec3> normal_ {};
   std::vector<walberla::mesa_pd_convection::Vec3> position_ {};
   std::vector<walberla::mesa_pd_convection::Vec3> t_ {};
   std::vector<walberla::mesa_pd_convection::Vec3> o_ {};
   std::vector<walberla::mesa_pd_convection::Vec3> r1_ {};
   std::vector<walberla::mesa_pd_convection::Vec3> r2_ {};
   std::vector<real_t> mu_ {};
   std::vector<walberla::mesa_pd_convection::Vec3> p_ {};
   std::vector<walberla::mesa_pd_convection::Mat3> diag_nto_ {};
   std::vector<walberla::mesa_pd_convection::Mat3> diag_nto_inv_ {};
   std::vector<walberla::mesa_pd_convection::Mat2> diag_to_inv_ {};
...
public:
   ...
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact& p) const {return p.getNormalRef();}
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact&& p) const {return p.getNormalRef();}
   const walberla::mesa_pd_convection::Vec3& operator()(const data::Contact& p) const {return p.getNormal();}
};
///Predicate that selects a certain property from a Contact
...
public:
   using return_type = walberla::mesa_pd_convection::Vec3;
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact& p) const {return p.getPositionRef();}
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact&& p) const {return p.getPositionRef();}
   const walberla::mesa_pd_convection::Vec3& operator()(const data::Contact& p) const {return p.getPosition();}
};
///Predicate that selects a certain property from a Contact
...
public:
   using return_type = walberla::mesa_pd_convection::Vec3;
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact& p) const {return p.getTRef();}
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact&& p) const {return p.getTRef();}
   const walberla::mesa_pd_convection::Vec3& operator()(const data::Contact& p) const {return p.getT();}
};
///Predicate that selects a certain property from a Contact
...
public:
   using return_type = walberla::mesa_pd_convection::Vec3;
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact& p) const {return p.getORef();}
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact&& p) const {return p.getORef();}
   const walberla::mesa_pd_convection::Vec3& operator()(const data::Contact& p) const {return p.getO();}
};
///Predicate that selects a certain property from a Contact
...
public:
   using return_type = walberla::mesa_pd_convection::Vec3;
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact& p) const {return p.getR1Ref();}
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact&& p) const {return p.getR1Ref();}
   const walberla::mesa_pd_convection::Vec3& operator()(const data::Contact& p) const {return p.getR1();}
};
///Predicate that selects a certain property from a Contact
...
public:
   using return_type = walberla::mesa_pd_convection::Vec3;
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact& p) const {return p.getR2Ref();}
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact&& p) const {return p.getR2Ref();}
   const walberla::mesa_pd_convection::Vec3& operator()(const data::Contact& p) const {return p.getR2();}
};
///Predicate that selects a certain property from a Contact
...
public:
   using return_type = walberla::mesa_pd_convection::Vec3;
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact& p) const {return p.getPRef();}
   walberla::mesa_pd_convection::Vec3& operator()(data::Contact&& p) const {return p.getPRef();}
   const walberla::mesa_pd_convection::Vec3& operator()(const data::Contact& p) const {return p.getP();}
};
///Predicate that selects a certain property from a Contact
class SelectContactDiag_nto
{
public:
   using return_type = walberla::mesa_pd_convection::Mat3;
   walberla::mesa_pd_convection::Mat3& operator()(data::Contact& p) const {return p.getDiag_ntoRef();}
   walberla::mesa_pd_convection::Mat3& operator()(data::Contact&& p) const {return p.getDiag_ntoRef();}
   const walberla::mesa_pd_convection::Mat3& operator()(const data::Contact& p) const {return p.getDiag_nto();}
};
///Predicate that selects a certain property from a Contact
...
public:
   using return_type = walberla::mesa_pd_convection::Mat3;
   walberla::mesa_pd_convection::Mat3& operator()(data::Contact& p) const {return p.getDiag_nto_invRef();}
   walberla::mesa_pd_convection::Mat3& operator()(data::Contact&& p) const {return p.getDiag_nto_invRef();}
   const walberla::mesa_pd_convection::Mat3& operator()(const data::Contact& p) const {return p.getDiag_nto_inv();}
};
///Predicate that selects a certain property from a Contact
class SelectContactDiag_to_inv
{
public:
   using return_type = walberla::mesa_pd_convection::Mat2;
   walberla::mesa_pd_convection::Mat2& operator()(data::Contact& p) const {return p.getDiag_to_invRef();}
   walberla::mesa_pd_convection::Mat2& operator()(data::Contact&& p) const {return p.getDiag_to_invRef();}
   const walberla::mesa_pd_convection::Mat2& operator()(const data::Contact& p) const {return p.getDiag_to_inv();}
};
///Predicate that selects a certain property from a Contact
