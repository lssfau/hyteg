...
#include <mesa_pd_convection/common/ParticleFunctions.h>
 ...
 *
 * walberla::mesa_pd_convection::Vec3& getForceRef(const size_t p_idx);
 *
 * const walberla::mesa_pd_convection::Vec3& getAngularVelocity(const size_t p_idx) const;
 *
 * walberla::mesa_pd_convection::Vec3& getTorqueRef(const size_t p_idx);
 *
 * const uint_t& getType(const size_t p_idx) const;
 *
 * const std::map<walberla::id_t, walberla::mesa_pd_convection::Vec3>& getContactHistory(const size_t p_idx) const;
 * void setContactHistory(const size_t p_idx, const std::map<walberla::id_t, walberla::mesa_pd_convection::Vec3>& v);
 *
 * \endcode
