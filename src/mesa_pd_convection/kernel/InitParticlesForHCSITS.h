...
public:
   ...
   inline const walberla::mesa_pd_convection::Vec3& getGlobalAcceleration() const {return globalAcceleration_;}
   inline void setGlobalAcceleration(walberla::mesa_pd_convection::Vec3 v) { globalAcceleration_ = v;}
...
private:
   ...
   walberla::mesa_pd_convection::Vec3 globalAcceleration_;
