 ...
 *
 * const walberla::mesa_pd_convection::Vec3& getOldForce(const size_t p_idx) const;
 * void setOldForce(const size_t p_idx, const walberla::mesa_pd_convection::Vec3& v);
 *
 * const walberla::mesa_pd_convection::Rot3& getRotation(const size_t p_idx) const;
 * void setRotation(const size_t p_idx, const walberla::mesa_pd_convection::Rot3& v);
 *
 * const walberla::mesa_pd_convection::Vec3& getAngularVelocity(const size_t p_idx) const;
 * void setAngularVelocity(const size_t p_idx, const walberla::mesa_pd_convection::Vec3& v);
 *
 * const walberla::mesa_pd_convection::Mat3& getInvInertiaBF(const size_t p_idx) const;
 *
 * const walberla::mesa_pd_convection::Vec3& getTorque(const size_t p_idx) const;
 * void setTorque(const size_t p_idx, const walberla::mesa_pd_convection::Vec3& v);
 *
 * const walberla::mesa_pd_convection::Vec3& getOldTorque(const size_t p_idx) const;
 * void setOldTorque(const size_t p_idx, const walberla::mesa_pd_convection::Vec3& v);
 *
