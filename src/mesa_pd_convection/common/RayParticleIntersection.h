...
#include <mesa_pd_convection/common/Contains.h>
...
#include <mesa_pd_convection/kernel/SingleCast.h>
...
real_t intersectionRatioBisection( const size_t particleIdx, const ParticleAccessor_T& ac,
                                   ...
                                   real_t epsilon)
{
   mesa_pd_convection::kernel::SingleCast singleCast;
...
struct RayParticleIntersectionRatioFunctor
{
   ...
   {
      static_assert(std::is_base_of<mesa_pd_convection::data::IAccessor, ParticleAccessor_T>::value, "Provide a valid accessor as template");

      return intersectionRatioBisection(particleIdx, ac, rayOrigin, rayDirection, epsilon );
   }

   template<typename ParticleAccessor_T>
   real_t operator()(const size_t particleIdx, const mesa_pd_convection::data::Sphere& sphere, const ParticleAccessor_T& ac, const Vector3<real_t>& rayOrigin, const Vector3<real_t>& rayDirection, real_t /*epsilon*/ )
   {
      static_assert(std::is_base_of<mesa_pd_convection::data::IAccessor, ParticleAccessor_T>::value, "Provide a valid accessor as template");
   ...
   template<typename ParticleAccessor_T>
   real_t operator()(const size_t particleIdx, const mesa_pd_convection::data::HalfSpace& halfSpace, const ParticleAccessor_T& ac, const Vector3<real_t>& rayOrigin, const Vector3<real_t>& rayDirection, real_t /*epsilon*/ )
   {
      static_assert(std::is_base_of<mesa_pd_convection::data::IAccessor, ParticleAccessor_T>::value, "Provide a valid accessor as template");
