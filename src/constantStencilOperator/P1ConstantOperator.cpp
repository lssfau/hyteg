...
#include "constantStencilOperator/P1generatedKernels//apply_2D_macroface_vertexdof_to_vertexdof_add.hpp"
...
#include "constantStencilOperator/P1generatedKernels//apply_3D_macroface_one_sided_vertexdof_to_vertexdof_add.hpp"
#include "constantStencilOperator/P1generatedKernels//apply_3D_macroface_one_sided_vertexdof_to_vertexdof_replace.hpp"
#include "constantStencilOperator/P1generatedKernels//gaussseidel_3D_macrocell_P1.hpp"
#include "constantStencilOperator/P1generatedKernels//sor_2D_macroface_vertexdof_to_vertexdof.hpp"
#include "constantStencilOperator/P1generatedKernels//sor_2D_macroface_vertexdof_to_vertexdof_backwards.hpp"
#include "constantStencilOperator/P1generatedKernels//sor_3D_macrocell_P1.hpp"
#include "constantStencilOperator/P1generatedKernels//sor_3D_macrocell_P1_backwards.hpp"
#include "constantStencilOperator/P1generatedKernels//sor_3D_macroface_P1.hpp"
#include "constantStencilOperator/P1generatedKernels//sor_3D_macroface_P1_backwards.hpp"
#include "constantStencilOperator/P1generatedKernels//sor_3D_macroface_P1_one_sided.hpp"
#include "constantStencilOperator/P1generatedKernels//sor_3D_macroface_P1_one_sided_backwards.hpp"
...
template < class P1Form, bool Diagonal, bool Lumped, bool InvertDiagonal, typename ValueType >
void P1ConstantOperator< P1Form, Diagonal, Lumped, InvertDiagonal, ValueType >::apply_face3D_generated(
    Face&                                                       face,
    ...
    UpdateType                                                  update ) const
{
   ...
   {
      WALBERLA_ABORT( "Mixed precision with generated kernels is not supported in 3D" );
   }
#else
