...
static void sor_2D_macroface_vertexdof_to_vertexdof_level_any(double * RESTRICT _data_p1FaceDst, double * RESTRICT _data_p1FaceRhs, double const * RESTRICT const _data_p1FaceStencil, int level, double relax)
{
...
static void sor_2D_macroface_vertexdof_to_vertexdof_level_any(float * RESTRICT _data_p1FaceDst, float * RESTRICT _data_p1FaceRhs, float const * RESTRICT const _data_p1FaceStencil, int level, float relax)
{
