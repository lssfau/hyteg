...
int main( int argc, char** argv )
{
   ...
   auto SchurBFBTSolver_ = std::make_shared< SchurBFBTSolver< stokesType > >(
       parameters_,
       storage_,
       minLevel_,
       maxLevel_,
   ...
   auto operatorUpdater_ =
       std::make_shared< OperatorUpdaterType >( stokesOperator_, WrappedMass, ABlockSmoother, nullptr, nullptr, initSolverRes );
