...
// typedef MC_ABlock_Vec_IcosahedralShellMap_FK_SimpleVisc CombinedAType;
...
int main( int argc, char** argv )
{
   ...
   //        parameters_, storage_, minLevel_, maxLevel_, lowMemoryMode_, ABlockPETScCoarseSolver );
   ...
   auto                    operatorUpdater_ = std::make_shared< OperatorUpdaterType >(
       stokesOperator_, WrappedMass, ABlockSmoother, ABlockPETScCoarseSolver, CoarseCorrectedABlockSmoother, auxFct );
