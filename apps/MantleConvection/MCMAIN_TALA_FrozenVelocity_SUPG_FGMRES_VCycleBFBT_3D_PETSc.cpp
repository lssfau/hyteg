...
int main( int argc, char** argv )
{
   ...
   auto AdvectionOperator = std::make_shared< transportType::AdvectionOperatorTypeInternal >(
   ...
   auto MassStabOperator = std::make_shared< transportType::MassStabilisationOperatorTypeInternal >(
       storage_, minLevel_, maxLevel_, up_extra_.uvw()[0], up_extra_.uvw()[1], up_extra_.uvw()[2], const_k_ );
   ...
   auto DiffusionStabOperator = std::make_shared< transportType::DiffusionStabilisationOperatorTypeInternal >(
       storage_, minLevel_, maxLevel_, *inv_rho_extra_, up_extra_.uvw()[0], up_extra_.uvw()[1], up_extra_.uvw()[2], const_k_ );
   ...
   auto transportOperator_ = std::make_shared< transportType >( storage_,
                                                                ...
                                                                timeScheme,
                                                                MassStabOperator,
                                                                AdvectionStabOperator,
                                                                DiffusionStabOperator,
                                                                AdiabaticHeatingStabOperator,
                                                                SUPG_scaling_ * AdvectionScaling,
                                                                SUPG_scaling_ * DiffusionScaling,
                                                                SUPG_scaling_ * AdiabaticHeatingScaling );
   ...
   auto transportOperator_RHS_ = std::make_shared< transportType_RHS >( storage_,
                                                                        ...
                                                                        MassStabOperator,
                                                                        MassStabOperator,
                                                                        ShearHeatingStabOperator,
                                                                        nullptr,
                                                                        SUPG_scaling_ * InternalHeatingScaling,
                                                                        SUPG_scaling_ * ShearHeatingScaling,
                                                                        SUPG_scaling_ * AdiabaticHeatingScaling );
   ...
   auto SchurBFBTSolver_ = std::make_shared< BFBTSolverType >( parameters_,
                                                               storage_,
                                                               minLevel_,
                                                               maxLevel_,
                                                               stokesOperator_,
