...
class ConstantDensity : public TemperatureDependentDensityModel< real_t >
{
 public:
   using TemperatureDependentDensityModel< real_t >::prefix_;

   ConstantDensity( NondimensionalisationParameters& nondimensionalisation,
   ...
   std::ostream& print( std::ostream& os, uint_t offset = 0 ) const override
   {
      ...
      os << std::string( offset, ' ') << "################## Constant Density ##################"             << "\n";
      os << std::string( offset, ' ') << "######################################################"             << "\n";
...
inline std::ostream& operator<<( std::ostream& os, const ConstantDensity& cd )
{
   return cd.print( os );
}
