...
class ConstantPressure : public PressureModel< real_t >
{
 public:
   using PressureModel< real_t >::prefix_;

   ConstantPressure( NondimensionalisationParameters& nondimensionalisation,
   ...
   std::ostream& print( std::ostream& os, uint_t offset = 0 ) const override
   {
      ...
      os << std::string( offset, ' ') << "################## Constant Pressure ##################"            << "\n";
      os << std::string( offset, ' ') << "#######################################################"            << "\n";
...
inline std::ostream& operator<<( std::ostream& os, const ConstantPressure& cp )
{
   return cp.print( os );
}
