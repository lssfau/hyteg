...
class TemperatureDependentViscosityModel
{
 public:
   virtual ~TemperatureDependentViscosityModel() = default;

   TemperatureDependentViscosityModel( std::string prefix = "" )
   : prefix_( prefix )
   {}
   ...
   virtual ValueType evaluate( const hyteg::Point3D& x, ValueType temp )
   {
      ...
      WALBERLA_ABORT( "evaluate not implemented for TemperatureDependentViscosityModel abstract base class!" );
      return ValueType();
   }

   virtual std::function< real_t( const hyteg::Point3D&, const std::vector< real_t >& ) > getViscosityFct()
   {
   ...
   virtual std::ostream& print( std::ostream& os, uint_t offset = 0 ) const
   {
      ...
      WALBERLA_ABORT( "print not implemented for TemperatureDependentViscosityModel abstract base class!" );
      return os;
   }
   ...
   void interpolate( FunctionType&                                                      f,
                     ...
                     hyteg::DoFType                                                     flag )
   {
      f.interpolate( getViscosityFct(), srcFunctions, level, flag );
   }
