...
class LinearViscosityInterpolation : public TemperatureDependentViscosityModel< real_t >
{
 public:
   using TemperatureDependentViscosityModel< real_t >::prefix_;

   LinearViscosityInterpolation( NondimensionalisationParameters& nondimensionalisation,
   ...
   , values_( values )
   {
      ...
      {
         WALBERLA_LOG_WARNING( "The values and range vectors of LinearViscosityInterpolation should be of the same size!" )
      }
   }
   ...
   std::ostream& print( std::ostream& os, uint_t offset = 0 ) const override
   {
      ...
      os << std::string( offset, ' ') << "########### Linear Viscosity Interpolation ###########"                                    << "\n";
      os << std::string( offset, ' ') << "######################################################"                                    << "\n";
...
inline std::ostream& operator<<( std::ostream& os, const LinearViscosityInterpolation& lvi )
{
   return lvi.print( os );
}
} // namespace MantleConvection