...
class SaddlePointInexactUzawaSmoother : public SaddlePointSolver< OperatorType >
{
 public:
   ...
   SaddlePointInexactUzawaSmoother(
   ...
   {
      VelocityIterations_ =
          parameters.getParameter< uint_t >( prefix + std::string( "SaddlePointInexactUzawaSmootherVelocityIterations" ) );
      relaxParamA_ = parameters.getParameter< real_t >( prefix + std::string( "SaddlePointInexactUzawaSmootherRelaxParamA" ) );
      relaxParamSchur_ =
          parameters.getParameter< real_t >( prefix + std::string( "SaddlePointInexactUzawaSmootherRelaxParamSchur" ) );

      uzawaSmoother_ =
          std::make_shared< MantleConvection::InexactUzawaPreconditioner< OperatorType,
                                                                          projectASolverRHS_,
   ...
   std::shared_ptr< MantleConvection::InexactUzawaPreconditioner< OperatorType,
                                                                  projectASolverRHS_,
                                                                  projectSchurSolverRHS_,
                                                                  postProjectPressure_,
   ...
   std::ostream& print( std::ostream& os, uint_t offset = 0 ) const override
   {
      ...
      os << std::string( offset, ' ') << "######## Saddle Point Inexact Uzawa Smoother ########"                                                   << "\n";
      os << std::string( offset, ' ') << "#####################################################"                                                   << "\n";
...
template < class OperatorType >
inline std::ostream& operator<<( std::ostream& os, const SaddlePointInexactUzawaSmoother< OperatorType >& spius )
{
   return spius.print( os );
}
