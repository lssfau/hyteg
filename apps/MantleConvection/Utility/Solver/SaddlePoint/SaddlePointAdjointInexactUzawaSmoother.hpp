...
class SaddlePointAdjointInexactUzawaSmoother : public SaddlePointSolver< OperatorType >
{
 public:
   ...
   SaddlePointAdjointInexactUzawaSmoother(
   ...
   {
      VelocityIterations_ =
          parameters.getParameter< uint_t >( prefix + std::string( "SaddlePointAdjointInexactUzawaSmootherVelocityIterations" ) );
      relaxParamA_ =
          parameters.getParameter< real_t >( prefix + std::string( "SaddlePointAdjointInexactUzawaSmootherRelaxParamA" ) );
      relaxParamSchur_ =
          parameters.getParameter< real_t >( prefix + std::string( "SaddlePointAdjointInexactUzawaSmootherRelaxParamSchur" ) );

      uzawaSmoother_ =
          std::make_shared< MantleConvection::AdjointInexactUzawaPreconditioner< OperatorType,
                                                                                 projectASolverRHS_,
                                                                                 projectSchurSolverRHS_,
                                                                                 postProjectPressure_,
                                                                                 postProjectVelocity_ > >( storage,
                                                                                                           minLevel,
                                                                                                           maxLevel,
                                                                                                           SaddleOp,
                                                                                                           ABlockSolver_,
   ...
   std::shared_ptr< MantleConvection::AdjointInexactUzawaPreconditioner< OperatorType,
                                                                         projectASolverRHS_,
                                                                         projectSchurSolverRHS_,
                                                                         postProjectPressure_,
   ...
   std::ostream& print( std::ostream& os, uint_t offset = 0 ) const override
   {
      ...
      os << std::string( offset, ' ') << "####### Saddle Point Adjoint Inexact Uzawa Smoother #######"                                             << "\n";
      os << std::string( offset, ' ') << "###########################################################"                                             << "\n";
...
template < class OperatorType >
inline std::ostream& operator<<( std::ostream& os, const SaddlePointAdjointInexactUzawaSmoother< OperatorType >& spaius )
{
   return spaius.print( os );
}
