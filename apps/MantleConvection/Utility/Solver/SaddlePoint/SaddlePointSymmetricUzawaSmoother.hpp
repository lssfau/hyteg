...
class SaddlePointSymmetricUzawaSmoother : public SaddlePointSolver< OperatorType >
{
 public:
   ...
   SaddlePointSymmetricUzawaSmoother(
   ...
   {
      VelocityIterations_ =
          parameters.getParameter< uint_t >( prefix + std::string( "SaddlePointSymmetricUzawaSmootherVelocityIterations" ) );
      relaxParamA_ = parameters.getParameter< real_t >( prefix + std::string( "SaddlePointSymmetricUzawaSmootherRelaxParamA" ) );
      relaxParamSchur_ =
          parameters.getParameter< real_t >( prefix + std::string( "SaddlePointSymmetricUzawaSmootherRelaxParamSchur" ) );

      uzawaSmoother_ =
          std::make_shared< MantleConvection::SymmetricUzawaPreconditioner< OperatorType,
                                                                            projectASolverRHS_,
   ...
   std::shared_ptr< MantleConvection::SymmetricUzawaPreconditioner< OperatorType,
                                                                    projectASolverRHS_,
                                                                    projectSchurSolverRHS_,
                                                                    postProjectPressure_,
   ...
   std::ostream& print( std::ostream& os, uint_t offset = 0 ) const override
   {
      ...
      os << std::string( offset, ' ') << "####### Saddle Point Symmetric Uzawa Smoother #######"                                                   << "\n";
      os << std::string( offset, ' ') << "#####################################################"                                                   << "\n";
...
template < class OperatorType >
inline std::ostream& operator<<( std::ostream& os, const SaddlePointSymmetricUzawaSmoother< OperatorType >& spsus )
{
   return spsus.print( os );
}
