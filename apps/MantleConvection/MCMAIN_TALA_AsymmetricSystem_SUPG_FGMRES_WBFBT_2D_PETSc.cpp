...
typedef MantleConvection::
    SaddlePointOperator< CombinedAType, MC_BTBlock_AnnulusMap, MC_GradRhoRhoDivergence_AnnulusMap, MC_Projection, MC_NoOp >
        stokesLHSType;
...
// WBFBT typedefs
typedef MC_P2KP1Mass_AnnulusMap                                                                       ViscSqrtMassType;
...
typedef MC_P1DivKGrad_AnnulusMap                              InvSqrtViscMassType;
