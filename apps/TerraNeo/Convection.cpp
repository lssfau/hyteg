...
void ConvectionSimulation::solveDiffusion()
{
   WALBERLA_LOG_INFO_ON_ROOT( "" );
   WALBERLA_LOG_INFO_ON_ROOT( "------------------------------" );
   WALBERLA_LOG_INFO_ON_ROOT( "------- Diffusion Solve ------" );
   WALBERLA_LOG_INFO_ON_ROOT( "------------------------------" );
   WALBERLA_LOG_INFO_ON_ROOT( "" );
   ...
   // for ( uint_t l = TN.domainParameters.minLevel; l <= TN.domainParameters.maxLevel; l++ )
   // {
   //    P2MassOperator->apply( *temperature, *temperatureTmp, l, All );
   // }
...
void ConvectionSimulation::setupStokesRHS()
{
   for ( uint_t l = TN.domainParameters.minLevel; l <= TN.domainParameters.maxLevel; l++ )
   {
      ...
      //           retVal = ( T[0] - temperatureProfiles->mean.at( shell ) );
      //        }
      //        else
      //        {
      //           retVal = ( T[0] - referenceTemperatureFct( x ) );
      //        }
