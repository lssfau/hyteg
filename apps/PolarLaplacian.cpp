/*
 * Copyright (c) 2017-2023 Christoph Schwarzmeier, Daniel Drzisga,
 * Dominik Thoennes, Marcus Mohr.
 *
...
int main( int argc, char* argv[] )
{
   ...
   {
      auto defaultFile = "../data/param/PolarLaplacian.prm";
   ...
   Point2D cornerLL( rmin, real_c( 0 ) );
   Point2D cornerUR( rmax, real_c( 2 ) * pi );
...
void solve_using_geometry_map( MeshInfo& meshInfo, walberla::Config::BlockHandle& parameters )
{
   ...
   u.interpolate( real_c( 0 ), maxLevel, Inner );
   ...
   rhs.interpolate( real_c( 0 ), maxLevel, All );
