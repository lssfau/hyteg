...
int main(int argc, char* argv[])
{
  ...
  typedef hhg::UzawaSolver<hhg::P1StokesFunction<real_t>, hhg::P1StokesOperator, hhg::P1toP1LinearRestriction, false> Solver;
  ...
  for (outer = 0; outer < maxOuterIter; ++outer) {
    ...
    solver.solve(L, *u, *f, *r, restrictionOperator, maxLevel,
