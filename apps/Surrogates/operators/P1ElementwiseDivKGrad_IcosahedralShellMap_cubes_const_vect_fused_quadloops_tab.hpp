...
class P1ElementwiseDivKGrad_IcosahedralShellMap_cubes_const_vect_fused_quadloops_tab
: public Operator< P1Function< double >, P1Function< double > >,
  public OperatorWithInverseDiagonal< P1Function< double > >
{
 public:
   P1ElementwiseDivKGrad_IcosahedralShellMap_cubes_const_vect_fused_quadloops_tab(
 ...
 protected:
 private:
   /// Integral: P1ElementwiseDivKGrad_IcosahedralShellMap_cubes_const_vect_fused_quadloops_tab
   ...
   /// ------------  ------------  ------------  ----------  ----------  ----------  -------  ----------  ---------------------------
   ///         1596          2940           234        1932         918         288       48           0                            0
   void apply_P1ElementwiseDivKGrad_IcosahedralShellMap_cubes_const_vect_fused_quadloops_tab_macro_3D(
       double* RESTRICT const _data_dst,
       double* RESTRICT const _data_k,
   ...
   ///   float_adds    float_muls    float_divs    int_adds    int_muls    int_divs    calls    branches    loops_with_dynamic_bounds
   /// ------------  ------------  ------------  ----------  ----------  ----------  -------  ----------  ---------------------------
   ///         1560          2916           234        1686         966         216       48           0                            0
   void
       computeInverseDiagonalOperatorValues_P1ElementwiseDivKGrad_IcosahedralShellMap_cubes_const_vect_fused_quadloops_tab_macro_3D(
