...
class P1ElementwiseDiffusion_IcosahedralShellMap_cubes_const_vect_vect512_fused_quadloops_tab
: public Operator< P1Function< double >, P1Function< double > >,
  public OperatorWithInverseDiagonal< P1Function< double > >
{
 public:
   P1ElementwiseDiffusion_IcosahedralShellMap_cubes_const_vect_vect512_fused_quadloops_tab(
 ...
 protected:
 private:
   /// Integral: P1ElementwiseDiffusion_IcosahedralShellMap_cubes_const_vect_vect512_fused_quadloops_tab
   ...
   void apply_P1ElementwiseDiffusion_IcosahedralShellMap_cubes_const_vect_vect512_fused_quadloops_tab_macro_3D(
   ...
   void
       computeInverseDiagonalOperatorValues_P1ElementwiseDiffusion_IcosahedralShellMap_cubes_const_vect_vect512_fused_quadloops_tab_macro_3D(
