...
class P1ElementwiseDiffusion_cubes_const_vect_polycse : public Operator< P1Function< double >, P1Function< double > >,
                                                        public OperatorWithInverseDiagonal< P1Function< double > >
{
 public:
   P1ElementwiseDiffusion_cubes_const_vect_polycse( const std::shared_ptr< PrimitiveStorage >& storage,
                                                    size_t                                     minLevel,
                                                    size_t                                     maxLevel );
 ...
 protected:
 private:
   /// Integral: P1ElementwiseDiffusion_cubes_const_vect_polycse
   ...
   /// ------------  ------------  ------------  ----------  ----------  ----------  -------  ----------  ---------------------------
   ///          564           882           216        1332         504         216        0           0                            0
   void apply_P1ElementwiseDiffusion_cubes_const_vect_polycse_macro_3D( double* RESTRICT const _data_dst,
   ...
   ///   float_adds    float_muls    float_divs    int_adds    int_muls    int_divs    calls    branches    loops_with_dynamic_bounds
   /// ------------  ------------  ------------  ----------  ----------  ----------  -------  ----------  ---------------------------
   ///           66           110            24         111          45          18        0           0                            0
   void apply_P1ElementwiseDiffusion_cubes_const_vect_polycse_macro_2D( double* RESTRICT const _data_dst,
                                                                        double* RESTRICT const _data_src,
                                                                        const double           macro_vertex_coord_id_0comp0,
                                                                        const double           macro_vertex_coord_id_0comp1,
                                                                        const double           macro_vertex_coord_id_1comp0,
   ...
   ///   float_adds    float_muls    float_divs    int_adds    int_muls    int_divs    calls    branches    loops_with_dynamic_bounds
   /// ------------  ------------  ------------  ----------  ----------  ----------  -------  ----------  ---------------------------
   ///          456           648           216         924         336         144        0           0                            0
   void computeInverseDiagonalOperatorValues_P1ElementwiseDiffusion_cubes_const_vect_polycse_macro_3D(
   ...
   ///   float_adds    float_muls    float_divs    int_adds    int_muls    int_divs    calls    branches    loops_with_dynamic_bounds
   /// ------------  ------------  ------------  ----------  ----------  ----------  -------  ----------  ---------------------------
   ///           54            72            24          78          30          12        0           0                            0
   void computeInverseDiagonalOperatorValues_P1ElementwiseDiffusion_cubes_const_vect_polycse_macro_2D(
       double* RESTRICT const _data_invDiag_,
       const double           macro_vertex_coord_id_0comp0,
       const double           macro_vertex_coord_id_0comp1,
       const double           macro_vertex_coord_id_1comp0,
