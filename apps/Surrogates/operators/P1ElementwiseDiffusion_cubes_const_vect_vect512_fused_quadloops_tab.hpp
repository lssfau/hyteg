...
class P1ElementwiseDiffusion_cubes_const_vect_vect512_fused_quadloops_tab
: public Operator< P1Function< double >, P1Function< double > >,
  public OperatorWithInverseDiagonal< P1Function< double > >
{
 public:
   P1ElementwiseDiffusion_cubes_const_vect_vect512_fused_quadloops_tab( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                        size_t                                     minLevel,
                                                                        size_t                                     maxLevel );
 ...
 protected:
 private:
   /// Integral: P1ElementwiseDiffusion_cubes_const_vect_vect512_fused_quadloops_tab
   ...
   void apply_P1ElementwiseDiffusion_cubes_const_vect_vect512_fused_quadloops_tab_macro_3D(
   ...
   void apply_P1ElementwiseDiffusion_cubes_const_vect_vect512_fused_quadloops_tab_macro_2D(
       double* RESTRICT const _data_dst,
       double* RESTRICT const _data_src,
       const double           macro_vertex_coord_id_0comp0,
       const double           macro_vertex_coord_id_0comp1,
   ...
   void computeInverseDiagonalOperatorValues_P1ElementwiseDiffusion_cubes_const_vect_vect512_fused_quadloops_tab_macro_3D(
   ...
   void computeInverseDiagonalOperatorValues_P1ElementwiseDiffusion_cubes_const_vect_vect512_fused_quadloops_tab_macro_2D(
       double* RESTRICT const _data_invDiag_,
       const double           macro_vertex_coord_id_0comp0,
       const double           macro_vertex_coord_id_0comp1,
       const double           macro_vertex_coord_id_1comp0,
