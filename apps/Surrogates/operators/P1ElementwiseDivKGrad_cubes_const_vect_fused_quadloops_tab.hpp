...
class P1ElementwiseDivKGrad_cubes_const_vect_fused_quadloops_tab
...
public:
  ...
  void apply(const P1Function<double> &src, const P1Function<double> &dst,
             uint_t level, DoFType flag, UpdateType updateType = Replace) const;
...
protected:
private:
  /// Integral: P1ElementwiseDivKGrad_cubes_const_vect_fused_quadloops_tab
  ...
  ///   float_adds    float_muls    float_divs    int_adds    int_muls int_divs
  ///   calls    branches    loops_with_dynamic_bounds
  /// ------------  ------------  ------------  ----------  ----------
  /// ----------  -------  ----------  ---------------------------
  ///          606           834           216        1818         756 288 0 0 0
  void
  ...
  /// ------------  ------------  ------------  ----------  ----------
  /// ----------  -------  ----------  ---------------------------
  ///          498           702           216        1374         552 216 0 0 0
  void
