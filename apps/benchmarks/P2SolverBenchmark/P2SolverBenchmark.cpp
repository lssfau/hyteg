...
int main( int argc, char** argv )
{
   ...
   WALBERLA_LOG_INFO_ON_ROOT( "MG smoothing (pre/post):  " << "(" << preSmoothingSteps << ", " << postSmoothingSteps << ")" );
   ...
   GeometricMultigridSolver< P2ConstantLaplaceOperator > gmgSolver( storage, smoother, coarseGridSolver,
                                                                    restrictionOperator, prolongationOperator,
                                                                    minLevel, level, preSmoothingSteps, postSmoothingSteps, 0 );
