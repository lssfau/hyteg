...
int main( int argc, char* argv[] )
{
  ...
  typedef hhg::MinResSolver< hhg::P1StokesFunction< real_t >, hhg::P1StokesOperator, PressurePreconditioner_T > PressurePreconditionedMinRes_T;
  ...
  typedef UzawaSolver< hhg::P1StokesFunction< real_t >, hhg::P1StokesOperator, PressurePreconditionedMinRes_T, P1P1StokesToP1P1StokesRestriction, P1P1StokesToP1P1StokesProlongation, false > UzawaSolver_T;
  P1P1StokesToP1P1StokesRestriction stokesRestriction;
  P1P1StokesToP1P1StokesProlongation stokesProlongation;
  UzawaSolver_T uzawaSolver( storage, pressurePreconditionedMinResSolver, stokesRestriction, stokesProlongation, minLevel, maxLevel, 2, 2, 2 );

  for ( uint_t i = 0; i < numVCycles; i++ )
  {
    uzawaSolver.solve( L, u, f, r, maxLevel, tolerance, 10000, hhg::Inner | hhg::NeumannBoundary, UzawaSolver_T::CycleType::VCYCLE, false );
    L.apply( u, r, maxLevel, hhg::Inner | hhg::NeumannBoundary );
    real_t residualMG = r.dot( r, maxLevel, hhg::Inner ) / real_c( hhg::numberOfGlobalDoFs< hhg::P1StokesFunctionTag >( *storage, maxLevel ) );
