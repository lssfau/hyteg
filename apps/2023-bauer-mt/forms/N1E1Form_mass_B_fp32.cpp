                                         ...
                                         Matrix< float, 6, 6 >&                      elMat ) const
{
   ...
   float tmp_32 = ( edgeDirections[0] * edgeDirections[0] ) * tmp_31;
   ...
   float tmp_46 = edgeDirections[0] * tmp_7;
   float tmp_47 = ( 1.0f / 120.0f ) * tmp_30;
   float tmp_48 = edgeDirections[1] * tmp_47;
   float tmp_49 = edgeDirections[0] * tmp_48;
   float tmp_50 = -tmp_1 * tmp_11 + tmp_3 * tmp_9;
   float tmp_51 = tmp_50 * tmp_6;
   float tmp_52 = tmp_33 * tmp_50;
   float tmp_53 = edgeDirections[0] * tmp_31;
   float tmp_54 = edgeDirections[1] * tmp_53;
   float tmp_55 = tmp_11 * tmp_12 - tmp_3 * tmp_8;
   float tmp_56 = tmp_35 * tmp_55;
   float tmp_57 = tmp_37 * tmp_55;
   float tmp_58 = edgeDirections[1] * tmp_57;
   ...
   float tmp_63 = edgeDirections[2] * tmp_47;
   float tmp_64 = edgeDirections[0] * tmp_63;
   float tmp_65 = edgeDirections[0] * tmp_38;
   float tmp_66 = edgeDirections[2] * tmp_53;
   ...
   float tmp_68 = edgeDirections[3] * tmp_31;
   float tmp_69 = edgeDirections[0] * tmp_68;
   float tmp_70 = ( 1.0f / 120.0f ) * edgeDirections[0] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_35 * tmp_55 +
                  ( 1.0f / 60.0f ) * edgeDirections[0] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_36 +
                  ( 1.0f / 120.0f ) * edgeDirections[0] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_39 * tmp_59 +
                  ( 1.0f / 60.0f ) * edgeDirections[0] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_40 +
                  ( 1.0f / 120.0f ) * edgeDirections[0] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_50 * tmp_6 +
                  ( 1.0f / 60.0f ) * edgeDirections[0] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_7 - tmp_34 * tmp_69 -
                  tmp_42 * tmp_69 - tmp_43 * tmp_69 - tmp_44 * tmp_69 - tmp_45 * tmp_69 - tmp_52 * tmp_69 - tmp_57 * tmp_69 -
                  tmp_61 * tmp_69 - tmp_65 * tmp_68;
   float tmp_71 = edgeDirections[4] * tmp_31;
   float tmp_72 = edgeDirections[0] * tmp_71;
   float tmp_73 = edgeDirections[4] * tmp_47;
   float tmp_74 = edgeDirections[0] * tmp_73;
   float tmp_75 = edgeDirections[0] * tmp_57;
   ...
   float tmp_77 = edgeDirections[5] * tmp_47;
   float tmp_78 = edgeDirections[0] * tmp_77;
   float tmp_79 = edgeDirections[5] * tmp_31;
   float tmp_80 = edgeDirections[0] * tmp_79;
   ...
   float tmp_82 = ( edgeDirections[1] * edgeDirections[1] ) * tmp_31;
   float tmp_83 = ( tmp_50 * tmp_50 );
   float tmp_84 = ( tmp_55 * tmp_55 );
   float tmp_85 = ( tmp_59 * tmp_59 );
   float tmp_86 = edgeDirections[2] * tmp_48;
   float tmp_87 = edgeDirections[1] * tmp_43;
   float tmp_88 = edgeDirections[2] * tmp_31;
   float tmp_89 = edgeDirections[1] * tmp_88;
   ...
   float tmp_91 = edgeDirections[1] * tmp_68;
   float tmp_92 = ( 1.0f / 120.0f ) * edgeDirections[1] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_33 * tmp_6 +
                  ( 1.0f / 120.0f ) * edgeDirections[1] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_35 * tmp_37 +
                  ( 1.0f / 60.0f ) * edgeDirections[1] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_36 +
                  ( 1.0f / 120.0f ) * edgeDirections[1] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_39 * tmp_41 +
                  ( 1.0f / 60.0f ) * edgeDirections[1] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_40 +
                  ( 1.0f / 60.0f ) * edgeDirections[1] * edgeDirections[3] * tmp_16 * tmp_29 * tmp_7 - tmp_51 * tmp_91 -
                  tmp_52 * tmp_91 - tmp_56 * tmp_91 - tmp_57 * tmp_91 - tmp_60 * tmp_91 - tmp_61 * tmp_91 - tmp_83 * tmp_91 -
                  tmp_84 * tmp_91 - tmp_85 * tmp_91;
   float tmp_93 = edgeDirections[4] * tmp_48;
   float tmp_94 = edgeDirections[1] * tmp_71;
   ...
   float tmp_96 = edgeDirections[1] * tmp_79;
   float tmp_97 = edgeDirections[5] * tmp_48;
   ...
   float tmp_99  = ( edgeDirections[2] * edgeDirections[2] ) * tmp_31;
   float tmp_100 = edgeDirections[3] * tmp_63;
   float tmp_101 = edgeDirections[2] * tmp_68;
   ...
   float tmp_103 = edgeDirections[2] * tmp_71;
   float tmp_104 = ( 1.0f / 120.0f ) * edgeDirections[2] * edgeDirections[4] * tmp_16 * tmp_29 * tmp_33 * tmp_6 +
                   ( 1.0f / 60.0f ) * edgeDirections[2] * edgeDirections[4] * tmp_16 * tmp_29 * tmp_34 +
                   ( 1.0f / 120.0f ) * edgeDirections[2] * edgeDirections[4] * tmp_16 * tmp_29 * tmp_35 * tmp_37 +
                   ( 1.0f / 60.0f ) * edgeDirections[2] * edgeDirections[4] * tmp_16 * tmp_29 * tmp_38 +
                   ( 1.0f / 120.0f ) * edgeDirections[2] * edgeDirections[4] * tmp_16 * tmp_29 * tmp_39 * tmp_41 +
                   ( 1.0f / 60.0f ) * edgeDirections[2] * edgeDirections[4] * tmp_16 * tmp_29 * tmp_42 - tmp_103 * tmp_51 -
                   tmp_103 * tmp_52 - tmp_103 * tmp_56 - tmp_103 * tmp_57 - tmp_103 * tmp_60 - tmp_103 * tmp_61 -
                   tmp_103 * tmp_83 - tmp_103 * tmp_84 - tmp_103 * tmp_85;
   float tmp_105 = edgeDirections[2] * tmp_79;
   float tmp_106 = edgeDirections[5] * tmp_63;
   ...
   float tmp_108 = ( edgeDirections[3] * edgeDirections[3] );
   ...
   float tmp_114 = edgeDirections[4] * tmp_68;
   float tmp_115 = edgeDirections[3] * edgeDirections[4] * tmp_47;
   float tmp_116 = edgeDirections[3] * edgeDirections[4];
   ...
   float tmp_121 = edgeDirections[5] * tmp_68;
   float tmp_122 = edgeDirections[3] * tmp_77;
   float tmp_123 = edgeDirections[3] * edgeDirections[5];
   ...
   float tmp_127 = ( edgeDirections[4] * edgeDirections[4] );
   float tmp_128 = tmp_127 * tmp_31;
   float tmp_129 = tmp_109 * tmp_127;
   float tmp_130 = tmp_112 * tmp_127;
   float tmp_131 = edgeDirections[4] * tmp_77;
   float tmp_132 = edgeDirections[5] * tmp_71;
   float tmp_133 = edgeDirections[4] * edgeDirections[5];
   ...
   float tmp_137 = ( edgeDirections[5] * edgeDirections[5] );
