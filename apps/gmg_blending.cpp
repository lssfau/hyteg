...
//  loadbalancing::distributed::parmetis( *storage );
   ...
   auto coarseLaplaceSolverPoly = std::make_shared< hyteg::CGSolver< SolveOperatorPoly > >(
       storage, minLevel, minLevel, max_cg_iter, real_c( 0 ), coarse_tolerance );
   auto coarseLaplaceSolverNodal = std::make_shared< hyteg::CGSolver< SolveOperatorNodal > >(
       storage, minLevel, minLevel, max_cg_iter, real_c( 0 ), coarse_tolerance );
   ...
   GeometricMultigridSolver< SolveOperatorPoly >  laplaceSolverPoly( storage,
                                                                    smootherPoly,
                                                                    coarseLaplaceSolverPoly,
                                                                    restrictionOperator,
   ...
   WALBERLA_LOG_INFO_ON_ROOT( walberla::format( "%6d|%10.3e|%10.3e|%10.3e|%10.3e|%10.3e|%10.3e",
                                                0,
                                                begin_res,
                                                rel_res,
