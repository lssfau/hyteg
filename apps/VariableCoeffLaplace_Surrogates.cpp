           ...
           , c_function& exact, c_function& boundary, c_function& rhs, const uint_t minPolyDegree = 0, const uint_t maxPolyDegree = 0)
{
  ...
  GeometricMultigridSolver<typename FE::divKgrad> GMGSolver(storage, smoother, coarseGridSolver, restrictionOperator, prolongationOperator, minLevel, maxLevel, 2, 2);
...
int main(int argc, char* argv[])
{
  ...
  const bool vtk = parameters.getParameter<bool>("vtkOutput");
   ...
   // define functions and domain (= single macro-element)
