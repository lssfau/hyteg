...
#include "P1ElementwiseDiffusion_cubes_const_float32.hpp"
...
P1ElementwiseDiffusion_cubes_const_float32::
    P1ElementwiseDiffusion_cubes_const_float32(
        const std::shared_ptr<PrimitiveStorage> &storage, size_t minLevel,
        size_t maxLevel)
    : Operator(storage, minLevel, maxLevel) {}

void P1ElementwiseDiffusion_cubes_const_float32::apply(
    const P1Function<walberla::float32> &src,
    const P1Function<walberla::float32> &dst, uint_t level, DoFType flag,
  ...
  if (updateType == Replace) {
    ...
    dst.interpolate(walberla::numeric_cast<walberla::float32>(0), level, flag);
  }
  ...
  if (storage_->hasGlobalCells()) {
    for (auto &it : storage_->getCells()) {
      ...
      walberla::float32 *_data_src =
          cell.getData(src.getCellDataID())->getPointer(level);
      walberla::float32 *_data_dst =
      ...
      for (const auto &idx : vertexdof::macrocell::Iterator(level)) {
        if (!vertexdof::macrocell::isOnCellFace(idx, level).empty()) {
          ...
          _data_dst[arrayIdx] = walberla::float32(0);
        }
      }
      ...
      const auto micro_edges_per_macro_edge_float =
          (walberla::float32)levelinfo::num_microedges_per_edge(level);
      const walberla::float32 macro_vertex_coord_id_0comp0 =
          (walberla::float32)cell.getCoordinates()[0][0];
      const walberla::float32 macro_vertex_coord_id_0comp1 =
          (walberla::float32)cell.getCoordinates()[0][1];
      const walberla::float32 macro_vertex_coord_id_0comp2 =
          (walberla::float32)cell.getCoordinates()[0][2];
      const walberla::float32 macro_vertex_coord_id_1comp0 =
          (walberla::float32)cell.getCoordinates()[1][0];
      const walberla::float32 macro_vertex_coord_id_1comp1 =
          (walberla::float32)cell.getCoordinates()[1][1];
      const walberla::float32 macro_vertex_coord_id_1comp2 =
          (walberla::float32)cell.getCoordinates()[1][2];
      const walberla::float32 macro_vertex_coord_id_2comp0 =
          (walberla::float32)cell.getCoordinates()[2][0];
      const walberla::float32 macro_vertex_coord_id_2comp1 =
          (walberla::float32)cell.getCoordinates()[2][1];
      const walberla::float32 macro_vertex_coord_id_2comp2 =
          (walberla::float32)cell.getCoordinates()[2][2];
      const walberla::float32 macro_vertex_coord_id_3comp0 =
          (walberla::float32)cell.getCoordinates()[3][0];
      const walberla::float32 macro_vertex_coord_id_3comp1 =
          (walberla::float32)cell.getCoordinates()[3][1];
      const walberla::float32 macro_vertex_coord_id_3comp2 =
          (walberla::float32)cell.getCoordinates()[3][2];
    ...
    for (auto &it : storage_->getFaces()) {
      ...
      const auto micro_edges_per_macro_edge_float =
          (walberla::float32)levelinfo::num_microedges_per_edge(level);
      const walberla::float32 macro_vertex_coord_id_0comp0 =
          (walberla::float32)face.getCoordinates()[0][0];
      const walberla::float32 macro_vertex_coord_id_0comp1 =
          (walberla::float32)face.getCoordinates()[0][1];
      const walberla::float32 macro_vertex_coord_id_1comp0 =
          (walberla::float32)face.getCoordinates()[1][0];
      const walberla::float32 macro_vertex_coord_id_1comp1 =
          (walberla::float32)face.getCoordinates()[1][1];
      const walberla::float32 macro_vertex_coord_id_2comp0 =
          (walberla::float32)face.getCoordinates()[2][0];
      const walberla::float32 macro_vertex_coord_id_2comp1 =
          (walberla::float32)face.getCoordinates()[2][1];
...
void P1ElementwiseDiffusion_cubes_const_float32::toMatrix(
...
void P1ElementwiseDiffusion_cubes_const_float32::
    computeInverseDiagonalOperatorValues() {
  this->startTiming("computeInverseDiagonalOperatorValues");

  if (invDiag_ == nullptr) {
    invDiag_ = std::make_shared<P1Function<walberla::float32>>(
  ...
  for (uint_t level = minLevel_; level <= maxLevel_; level++) {
    ...
    if (storage_->hasGlobalCells()) {
      ...
      for (auto &it : storage_->getCells()) {
        ...
        // get hold of the actual numerical data
        walberla::float32 *_data_invDiag_ =
...
std::shared_ptr<P1Function<walberla::float32>>
P1ElementwiseDiffusion_cubes_const_float32::getInverseDiagonalValues() const {
  return invDiag_;
}
void P1ElementwiseDiffusion_cubes_const_float32::apply_macro_2D(
    walberla::float32 *RESTRICT _data_dst,
    walberla::float32 *RESTRICT _data_src,
    walberla::float32 macro_vertex_coord_id_0comp0,
    walberla::float32 macro_vertex_coord_id_0comp1,
    walberla::float32 macro_vertex_coord_id_1comp0,
    walberla::float32 macro_vertex_coord_id_1comp1,
    walberla::float32 macro_vertex_coord_id_2comp0,
    walberla::float32 macro_vertex_coord_id_2comp1,
    int64_t micro_edges_per_macro_edge,
    walberla::float32 micro_edges_per_macro_edge_float) const {
  {
    const walberla::float32 tmp_coords_jac_0_BLUE =
        1.0f * ((walberla::float32)(1.0f / (micro_edges_per_macro_edge_float)));
    const walberla::float32 tmp_coords_jac_1_BLUE =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_BLUE *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0);
    const walberla::float32 tmp_coords_jac_2_BLUE =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_BLUE *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1);
    const walberla::float32 tmp_coords_jac_3_BLUE =
        tmp_coords_jac_0_BLUE *
        (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0);
    const walberla::float32 tmp_coords_jac_4_BLUE =
        tmp_coords_jac_0_BLUE *
        (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1);
    const walberla::float32 p_affine_const_0_0_BLUE = tmp_coords_jac_1_BLUE;
    const walberla::float32 p_affine_const_0_1_BLUE = tmp_coords_jac_2_BLUE;
    const walberla::float32 p_affine_const_1_0_BLUE =
        macro_vertex_coord_id_0comp0 + tmp_coords_jac_3_BLUE;
    const walberla::float32 p_affine_const_1_1_BLUE =
        macro_vertex_coord_id_0comp1 + tmp_coords_jac_4_BLUE;
    const walberla::float32 p_affine_const_2_0_BLUE =
        tmp_coords_jac_1_BLUE + tmp_coords_jac_3_BLUE;
    const walberla::float32 p_affine_const_2_1_BLUE =
        tmp_coords_jac_2_BLUE + tmp_coords_jac_4_BLUE;
    const walberla::float32 jac_affine_0_0_BLUE =
        -p_affine_const_0_0_BLUE + p_affine_const_1_0_BLUE;
    const walberla::float32 jac_affine_0_1_BLUE =
        -p_affine_const_0_0_BLUE + p_affine_const_2_0_BLUE;
    const walberla::float32 jac_affine_1_0_BLUE =
        -p_affine_const_0_1_BLUE + p_affine_const_1_1_BLUE;
    const walberla::float32 jac_affine_1_1_BLUE =
        -p_affine_const_0_1_BLUE + p_affine_const_2_1_BLUE;
    const walberla::float32 tmp_coords_jac_5_BLUE =
        jac_affine_0_0_BLUE * jac_affine_1_1_BLUE -
        jac_affine_0_1_BLUE * jac_affine_1_0_BLUE;
    const walberla::float32 tmp_coords_jac_6_BLUE =
        ((walberla::float32)(1.0f / (tmp_coords_jac_5_BLUE)));
    const walberla::float32 jac_affine_inv_0_0_BLUE =
        jac_affine_1_1_BLUE * tmp_coords_jac_6_BLUE;
    const walberla::float32 jac_affine_inv_0_1_BLUE =
        -jac_affine_0_1_BLUE * tmp_coords_jac_6_BLUE;
    const walberla::float32 jac_affine_inv_1_0_BLUE =
        -jac_affine_1_0_BLUE * tmp_coords_jac_6_BLUE;
    const walberla::float32 jac_affine_inv_1_1_BLUE =
        jac_affine_0_0_BLUE * tmp_coords_jac_6_BLUE;
    const walberla::float32 abs_det_jac_affine_BLUE =
        abs(tmp_coords_jac_5_BLUE);
    const walberla::float32 tmp_coords_jac_0_GRAY =
        1.0f * ((walberla::float32)(1.0f / (micro_edges_per_macro_edge_float)));
    const walberla::float32 p_affine_const_0_0_GRAY =
        macro_vertex_coord_id_0comp0;
    const walberla::float32 p_affine_const_0_1_GRAY =
        macro_vertex_coord_id_0comp1;
    const walberla::float32 p_affine_const_1_0_GRAY =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_GRAY *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0);
    const walberla::float32 p_affine_const_1_1_GRAY =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_GRAY *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1);
    const walberla::float32 p_affine_const_2_0_GRAY =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_GRAY *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0);
    const walberla::float32 p_affine_const_2_1_GRAY =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_GRAY *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1);
    const walberla::float32 jac_affine_0_0_GRAY =
        -p_affine_const_0_0_GRAY + p_affine_const_1_0_GRAY;
    const walberla::float32 jac_affine_0_1_GRAY =
        -p_affine_const_0_0_GRAY + p_affine_const_2_0_GRAY;
    const walberla::float32 jac_affine_1_0_GRAY =
        -p_affine_const_0_1_GRAY + p_affine_const_1_1_GRAY;
    const walberla::float32 jac_affine_1_1_GRAY =
        -p_affine_const_0_1_GRAY + p_affine_const_2_1_GRAY;
    const walberla::float32 tmp_coords_jac_1_GRAY =
        jac_affine_0_0_GRAY * jac_affine_1_1_GRAY -
        jac_affine_0_1_GRAY * jac_affine_1_0_GRAY;
    const walberla::float32 tmp_coords_jac_2_GRAY =
        ((walberla::float32)(1.0f / (tmp_coords_jac_1_GRAY)));
    const walberla::float32 jac_affine_inv_0_0_GRAY =
        jac_affine_1_1_GRAY * tmp_coords_jac_2_GRAY;
    const walberla::float32 jac_affine_inv_0_1_GRAY =
        -jac_affine_0_1_GRAY * tmp_coords_jac_2_GRAY;
    const walberla::float32 jac_affine_inv_1_0_GRAY =
        -jac_affine_1_0_GRAY * tmp_coords_jac_2_GRAY;
    const walberla::float32 jac_affine_inv_1_1_GRAY =
        jac_affine_0_0_GRAY * tmp_coords_jac_2_GRAY;
    const walberla::float32 abs_det_jac_affine_GRAY =
        abs(tmp_coords_jac_1_GRAY);
    const walberla::float32 tmp_kernel_op_0 =
        -jac_affine_inv_0_0_GRAY - jac_affine_inv_1_0_GRAY;
    const walberla::float32 tmp_kernel_op_1 =
        -jac_affine_inv_0_1_GRAY - jac_affine_inv_1_1_GRAY;
    const walberla::float32 tmp_kernel_op_2 = abs_det_jac_affine_GRAY * 0.5f;
    const walberla::float32 tmp_kernel_op_4 =
        jac_affine_inv_0_0_GRAY * tmp_kernel_op_0 +
        jac_affine_inv_0_1_GRAY * tmp_kernel_op_1;
    const walberla::float32 tmp_kernel_op_6 =
        jac_affine_inv_1_0_GRAY * tmp_kernel_op_0 +
        jac_affine_inv_1_1_GRAY * tmp_kernel_op_1;
    const walberla::float32 tmp_kernel_op_8 =
        jac_affine_inv_0_0_GRAY * jac_affine_inv_1_0_GRAY +
        jac_affine_inv_0_1_GRAY * jac_affine_inv_1_1_GRAY;
    const walberla::float32 tmp_moved_constant_3 =
        -jac_affine_inv_0_0_BLUE - jac_affine_inv_1_0_BLUE;
    const walberla::float32 tmp_moved_constant_4 =
        -jac_affine_inv_0_1_BLUE - jac_affine_inv_1_1_BLUE;
    const walberla::float32 tmp_moved_constant_5 =
        abs_det_jac_affine_BLUE * 0.5f;
    const walberla::float32 tmp_moved_constant_7 =
        jac_affine_inv_0_0_BLUE * tmp_moved_constant_3 +
        jac_affine_inv_0_1_BLUE * tmp_moved_constant_4;
    const walberla::float32 tmp_moved_constant_9 =
        jac_affine_inv_1_0_BLUE * tmp_moved_constant_3 +
        jac_affine_inv_1_1_BLUE * tmp_moved_constant_4;
    const walberla::float32 tmp_moved_constant_11 =
        jac_affine_inv_0_0_BLUE * jac_affine_inv_1_0_BLUE +
        jac_affine_inv_0_1_BLUE * jac_affine_inv_1_1_BLUE;
    for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1) {
      for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1;
           ctr_0 += 1) {
        const walberla::float32 src_dof_0 =
            _data_src[ctr_0 + ctr_1 * (micro_edges_per_macro_edge + 2) -
                      ((ctr_1 * (ctr_1 + 1)) / (2))];
        const walberla::float32 src_dof_1 =
            _data_src[ctr_0 + ctr_1 * (micro_edges_per_macro_edge + 2) -
                      ((ctr_1 * (ctr_1 + 1)) / (2)) + 1];
        const walberla::float32 src_dof_2 =
            _data_src[ctr_0 + (ctr_1 + 1) * (micro_edges_per_macro_edge + 2) -
                      (((ctr_1 + 1) * (ctr_1 + 2)) / (2))];
        const walberla::float32 tmp_kernel_op_3 = src_dof_0 * tmp_kernel_op_2;
        const walberla::float32 tmp_kernel_op_5 = src_dof_1 * tmp_kernel_op_2;
        const walberla::float32 tmp_kernel_op_7 = src_dof_2 * tmp_kernel_op_2;
        const walberla::float32 elMatVec_0 =
            tmp_kernel_op_3 *
                (((walberla::float32)((tmp_kernel_op_0 * tmp_kernel_op_0))) +
                 ((walberla::float32)((tmp_kernel_op_1 * tmp_kernel_op_1)))) +
            tmp_kernel_op_4 * tmp_kernel_op_5 +
            tmp_kernel_op_6 * tmp_kernel_op_7;
        const walberla::float32 elMatVec_1 =
        ...
        const walberla::float32 elMatVec_2 =
        ...
        const walberla::float32 tmp_moved_constant_0 =
            _data_src[ctr_0 + ctr_1 * (micro_edges_per_macro_edge + 2) -
                      ((ctr_1 * (ctr_1 + 1)) / (2)) + 1];
        const walberla::float32 tmp_moved_constant_1 =
            _data_src[ctr_0 + (ctr_1 + 1) * (micro_edges_per_macro_edge + 2) -
                      (((ctr_1 + 1) * (ctr_1 + 2)) / (2))];
        const walberla::float32 tmp_moved_constant_2 =
            _data_src[ctr_0 + (ctr_1 + 1) * (micro_edges_per_macro_edge + 2) -
                      (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) + 1];
        const walberla::float32 tmp_moved_constant_6 =
            tmp_moved_constant_0 * tmp_moved_constant_5;
        const walberla::float32 tmp_moved_constant_8 =
            tmp_moved_constant_1 * tmp_moved_constant_5;
        const walberla::float32 tmp_moved_constant_10 =
            tmp_moved_constant_2 * tmp_moved_constant_5;
        const walberla::float32 tmp_moved_constant_12 =
        ...
        const walberla::float32 tmp_moved_constant_13 =
        ...
        const walberla::float32 tmp_moved_constant_14 =
      ...
      const walberla::float32 elMatVec_1 =
          tmp_kernel_op_3 * tmp_kernel_op_4 +
          tmp_kernel_op_5 * (((walberla::float32)((jac_affine_inv_0_0_GRAY *
                                                   jac_affine_inv_0_0_GRAY))) +
                             ((walberla::float32)((jac_affine_inv_0_1_GRAY *
                                                   jac_affine_inv_0_1_GRAY)))) +
          tmp_kernel_op_7 * tmp_kernel_op_8;
      const walberla::float32 elMatVec_2 =
          tmp_kernel_op_3 * tmp_kernel_op_6 +
          tmp_kernel_op_5 * tmp_kernel_op_8 +
          tmp_kernel_op_7 * (((walberla::float32)((jac_affine_inv_1_0_GRAY *
                                                   jac_affine_inv_1_0_GRAY))) +
                             ((walberla::float32)((jac_affine_inv_1_1_GRAY *
...
void P1ElementwiseDiffusion_cubes_const_float32::apply_macro_3D(
    walberla::float32 *RESTRICT _data_dst,
    walberla::float32 *RESTRICT _data_src,
    walberla::float32 macro_vertex_coord_id_0comp0,
    walberla::float32 macro_vertex_coord_id_0comp1,
    walberla::float32 macro_vertex_coord_id_0comp2,
    walberla::float32 macro_vertex_coord_id_1comp0,
    walberla::float32 macro_vertex_coord_id_1comp1,
    walberla::float32 macro_vertex_coord_id_1comp2,
    walberla::float32 macro_vertex_coord_id_2comp0,
    walberla::float32 macro_vertex_coord_id_2comp1,
    walberla::float32 macro_vertex_coord_id_2comp2,
    walberla::float32 macro_vertex_coord_id_3comp0,
    walberla::float32 macro_vertex_coord_id_3comp1,
    walberla::float32 macro_vertex_coord_id_3comp2,
    int64_t micro_edges_per_macro_edge,
    walberla::float32 micro_edges_per_macro_edge_float) const {
  {
    const walberla::float32 tmp_coords_jac_0_GREEN_DOWN =
        1.0f * ((walberla::float32)(1.0f / (micro_edges_per_macro_edge_float)));
    const walberla::float32 tmp_coords_jac_1_GREEN_DOWN =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_GREEN_DOWN *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0);
    const walberla::float32 tmp_coords_jac_2_GREEN_DOWN =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_GREEN_DOWN *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1);
    const walberla::float32 tmp_coords_jac_3_GREEN_DOWN =
        macro_vertex_coord_id_0comp2 +
        tmp_coords_jac_0_GREEN_DOWN *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_2comp2);
    const walberla::float32 tmp_coords_jac_4_GREEN_DOWN =
        tmp_coords_jac_0_GREEN_DOWN *
        (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0);
    const walberla::float32 tmp_coords_jac_5_GREEN_DOWN =
        tmp_coords_jac_0_GREEN_DOWN *
        (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1);
    const walberla::float32 tmp_coords_jac_6_GREEN_DOWN =
        tmp_coords_jac_0_GREEN_DOWN *
        (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_1comp2);
    const walberla::float32 tmp_coords_jac_7_GREEN_DOWN =
        tmp_coords_jac_0_GREEN_DOWN *
        (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_3comp0);
    const walberla::float32 tmp_coords_jac_8_GREEN_DOWN =
        tmp_coords_jac_0_GREEN_DOWN *
        (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_3comp1);
    const walberla::float32 tmp_coords_jac_9_GREEN_DOWN =
        tmp_coords_jac_0_GREEN_DOWN *
        (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_3comp2);
    const walberla::float32 p_affine_const_0_0_GREEN_DOWN =
        tmp_coords_jac_1_GREEN_DOWN;
    const walberla::float32 p_affine_const_0_1_GREEN_DOWN =
        tmp_coords_jac_2_GREEN_DOWN;
    const walberla::float32 p_affine_const_0_2_GREEN_DOWN =
        tmp_coords_jac_3_GREEN_DOWN;
    const walberla::float32 p_affine_const_1_0_GREEN_DOWN =
        tmp_coords_jac_1_GREEN_DOWN + tmp_coords_jac_4_GREEN_DOWN;
    const walberla::float32 p_affine_const_1_1_GREEN_DOWN =
        tmp_coords_jac_2_GREEN_DOWN + tmp_coords_jac_5_GREEN_DOWN;
    const walberla::float32 p_affine_const_1_2_GREEN_DOWN =
        tmp_coords_jac_3_GREEN_DOWN + tmp_coords_jac_6_GREEN_DOWN;
    const walberla::float32 p_affine_const_2_0_GREEN_DOWN =
        macro_vertex_coord_id_0comp0 + tmp_coords_jac_4_GREEN_DOWN +
        tmp_coords_jac_7_GREEN_DOWN;
    const walberla::float32 p_affine_const_2_1_GREEN_DOWN =
        macro_vertex_coord_id_0comp1 + tmp_coords_jac_5_GREEN_DOWN +
        tmp_coords_jac_8_GREEN_DOWN;
    const walberla::float32 p_affine_const_2_2_GREEN_DOWN =
        macro_vertex_coord_id_0comp2 + tmp_coords_jac_6_GREEN_DOWN +
        tmp_coords_jac_9_GREEN_DOWN;
    const walberla::float32 p_affine_const_3_0_GREEN_DOWN =
        tmp_coords_jac_1_GREEN_DOWN + tmp_coords_jac_7_GREEN_DOWN;
    const walberla::float32 p_affine_const_3_1_GREEN_DOWN =
        tmp_coords_jac_2_GREEN_DOWN + tmp_coords_jac_8_GREEN_DOWN;
    const walberla::float32 p_affine_const_3_2_GREEN_DOWN =
        tmp_coords_jac_3_GREEN_DOWN + tmp_coords_jac_9_GREEN_DOWN;
    const walberla::float32 jac_affine_0_0_GREEN_DOWN =
        -p_affine_const_0_0_GREEN_DOWN + p_affine_const_1_0_GREEN_DOWN;
    const walberla::float32 jac_affine_0_1_GREEN_DOWN =
        -p_affine_const_0_0_GREEN_DOWN + p_affine_const_2_0_GREEN_DOWN;
    const walberla::float32 jac_affine_0_2_GREEN_DOWN =
        -p_affine_const_0_0_GREEN_DOWN + p_affine_const_3_0_GREEN_DOWN;
    const walberla::float32 jac_affine_1_0_GREEN_DOWN =
        -p_affine_const_0_1_GREEN_DOWN + p_affine_const_1_1_GREEN_DOWN;
    const walberla::float32 jac_affine_1_1_GREEN_DOWN =
        -p_affine_const_0_1_GREEN_DOWN + p_affine_const_2_1_GREEN_DOWN;
    const walberla::float32 tmp_coords_jac_14_GREEN_DOWN =
        jac_affine_0_2_GREEN_DOWN * jac_affine_1_1_GREEN_DOWN;
    const walberla::float32 jac_affine_1_2_GREEN_DOWN =
        -p_affine_const_0_1_GREEN_DOWN + p_affine_const_3_1_GREEN_DOWN;
    const walberla::float32 tmp_coords_jac_12_GREEN_DOWN =
        jac_affine_0_1_GREEN_DOWN * jac_affine_1_2_GREEN_DOWN;
    const walberla::float32 jac_affine_2_0_GREEN_DOWN =
        -p_affine_const_0_2_GREEN_DOWN + p_affine_const_1_2_GREEN_DOWN;
    const walberla::float32 jac_affine_2_1_GREEN_DOWN =
        -p_affine_const_0_2_GREEN_DOWN + p_affine_const_2_2_GREEN_DOWN;
    const walberla::float32 tmp_coords_jac_11_GREEN_DOWN =
        jac_affine_1_2_GREEN_DOWN * jac_affine_2_1_GREEN_DOWN;
    const walberla::float32 jac_affine_2_2_GREEN_DOWN =
        -p_affine_const_0_2_GREEN_DOWN + p_affine_const_3_2_GREEN_DOWN;
    const walberla::float32 tmp_coords_jac_10_GREEN_DOWN =
        jac_affine_1_1_GREEN_DOWN * jac_affine_2_2_GREEN_DOWN;
    const walberla::float32 tmp_coords_jac_13_GREEN_DOWN =
        jac_affine_0_1_GREEN_DOWN * jac_affine_2_2_GREEN_DOWN;
    const walberla::float32 tmp_coords_jac_15_GREEN_DOWN =
    ...
    const walberla::float32 tmp_coords_jac_16_GREEN_DOWN =
        ((walberla::float32)(1.0f / (tmp_coords_jac_15_GREEN_DOWN)));
    const walberla::float32 jac_affine_inv_0_0_GREEN_DOWN =
        tmp_coords_jac_16_GREEN_DOWN *
        (tmp_coords_jac_10_GREEN_DOWN - tmp_coords_jac_11_GREEN_DOWN);
    const walberla::float32 jac_affine_inv_0_1_GREEN_DOWN =
        tmp_coords_jac_16_GREEN_DOWN *
        (jac_affine_0_2_GREEN_DOWN * jac_affine_2_1_GREEN_DOWN -
         tmp_coords_jac_13_GREEN_DOWN);
    const walberla::float32 jac_affine_inv_0_2_GREEN_DOWN =
        tmp_coords_jac_16_GREEN_DOWN *
        (tmp_coords_jac_12_GREEN_DOWN - tmp_coords_jac_14_GREEN_DOWN);
    const walberla::float32 jac_affine_inv_1_0_GREEN_DOWN =
        tmp_coords_jac_16_GREEN_DOWN *
        (-jac_affine_1_0_GREEN_DOWN * jac_affine_2_2_GREEN_DOWN +
         jac_affine_1_2_GREEN_DOWN * jac_affine_2_0_GREEN_DOWN);
    const walberla::float32 jac_affine_inv_1_1_GREEN_DOWN =
        tmp_coords_jac_16_GREEN_DOWN *
        (jac_affine_0_0_GREEN_DOWN * jac_affine_2_2_GREEN_DOWN -
         jac_affine_0_2_GREEN_DOWN * jac_affine_2_0_GREEN_DOWN);
    const walberla::float32 jac_affine_inv_1_2_GREEN_DOWN =
        tmp_coords_jac_16_GREEN_DOWN *
        (-jac_affine_0_0_GREEN_DOWN * jac_affine_1_2_GREEN_DOWN +
         jac_affine_0_2_GREEN_DOWN * jac_affine_1_0_GREEN_DOWN);
    const walberla::float32 jac_affine_inv_2_0_GREEN_DOWN =
        tmp_coords_jac_16_GREEN_DOWN *
        (jac_affine_1_0_GREEN_DOWN * jac_affine_2_1_GREEN_DOWN -
         jac_affine_1_1_GREEN_DOWN * jac_affine_2_0_GREEN_DOWN);
    const walberla::float32 jac_affine_inv_2_1_GREEN_DOWN =
        tmp_coords_jac_16_GREEN_DOWN *
        (-jac_affine_0_0_GREEN_DOWN * jac_affine_2_1_GREEN_DOWN +
         jac_affine_0_1_GREEN_DOWN * jac_affine_2_0_GREEN_DOWN);
    const walberla::float32 jac_affine_inv_2_2_GREEN_DOWN =
        tmp_coords_jac_16_GREEN_DOWN *
        (jac_affine_0_0_GREEN_DOWN * jac_affine_1_1_GREEN_DOWN -
         jac_affine_0_1_GREEN_DOWN * jac_affine_1_0_GREEN_DOWN);
    const walberla::float32 abs_det_jac_affine_GREEN_DOWN =
        abs(tmp_coords_jac_15_GREEN_DOWN);
    const walberla::float32 tmp_coords_jac_0_GREEN_UP =
        1.0f * ((walberla::float32)(1.0f / (micro_edges_per_macro_edge_float)));
    const walberla::float32 tmp_coords_jac_1_GREEN_UP =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_GREEN_UP *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0);
    const walberla::float32 tmp_coords_jac_2_GREEN_UP =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_GREEN_UP *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1);
    const walberla::float32 tmp_coords_jac_3_GREEN_UP =
        macro_vertex_coord_id_0comp2 +
        tmp_coords_jac_0_GREEN_UP *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_1comp2);
    const walberla::float32 tmp_coords_jac_4_GREEN_UP =
        tmp_coords_jac_0_GREEN_UP *
        (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_3comp0);
    const walberla::float32 tmp_coords_jac_5_GREEN_UP =
        tmp_coords_jac_0_GREEN_UP *
        (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_3comp1);
    const walberla::float32 tmp_coords_jac_6_GREEN_UP =
        tmp_coords_jac_0_GREEN_UP *
        (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_3comp2);
    const walberla::float32 p_affine_const_0_0_GREEN_UP =
        tmp_coords_jac_1_GREEN_UP;
    const walberla::float32 p_affine_const_0_1_GREEN_UP =
        tmp_coords_jac_2_GREEN_UP;
    const walberla::float32 p_affine_const_0_2_GREEN_UP =
        tmp_coords_jac_3_GREEN_UP;
    const walberla::float32 p_affine_const_1_0_GREEN_UP =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_GREEN_UP *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0);
    const walberla::float32 p_affine_const_1_1_GREEN_UP =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_GREEN_UP *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1);
    const walberla::float32 p_affine_const_1_2_GREEN_UP =
        macro_vertex_coord_id_0comp2 +
        tmp_coords_jac_0_GREEN_UP *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_2comp2);
    const walberla::float32 p_affine_const_2_0_GREEN_UP =
        macro_vertex_coord_id_0comp0 + tmp_coords_jac_4_GREEN_UP;
    const walberla::float32 p_affine_const_2_1_GREEN_UP =
        macro_vertex_coord_id_0comp1 + tmp_coords_jac_5_GREEN_UP;
    const walberla::float32 p_affine_const_2_2_GREEN_UP =
        macro_vertex_coord_id_0comp2 + tmp_coords_jac_6_GREEN_UP;
    const walberla::float32 p_affine_const_3_0_GREEN_UP =
        tmp_coords_jac_1_GREEN_UP + tmp_coords_jac_4_GREEN_UP;
    const walberla::float32 p_affine_const_3_1_GREEN_UP =
        tmp_coords_jac_2_GREEN_UP + tmp_coords_jac_5_GREEN_UP;
    const walberla::float32 p_affine_const_3_2_GREEN_UP =
        tmp_coords_jac_3_GREEN_UP + tmp_coords_jac_6_GREEN_UP;
    const walberla::float32 jac_affine_0_0_GREEN_UP =
        -p_affine_const_0_0_GREEN_UP + p_affine_const_1_0_GREEN_UP;
    const walberla::float32 jac_affine_0_1_GREEN_UP =
        -p_affine_const_0_0_GREEN_UP + p_affine_const_2_0_GREEN_UP;
    const walberla::float32 jac_affine_0_2_GREEN_UP =
        -p_affine_const_0_0_GREEN_UP + p_affine_const_3_0_GREEN_UP;
    const walberla::float32 jac_affine_1_0_GREEN_UP =
        -p_affine_const_0_1_GREEN_UP + p_affine_const_1_1_GREEN_UP;
    const walberla::float32 jac_affine_1_1_GREEN_UP =
        -p_affine_const_0_1_GREEN_UP + p_affine_const_2_1_GREEN_UP;
    const walberla::float32 tmp_coords_jac_11_GREEN_UP =
        jac_affine_0_2_GREEN_UP * jac_affine_1_1_GREEN_UP;
    const walberla::float32 jac_affine_1_2_GREEN_UP =
        -p_affine_const_0_1_GREEN_UP + p_affine_const_3_1_GREEN_UP;
    const walberla::float32 tmp_coords_jac_9_GREEN_UP =
        jac_affine_0_1_GREEN_UP * jac_affine_1_2_GREEN_UP;
    const walberla::float32 jac_affine_2_0_GREEN_UP =
        -p_affine_const_0_2_GREEN_UP + p_affine_const_1_2_GREEN_UP;
    const walberla::float32 jac_affine_2_1_GREEN_UP =
        -p_affine_const_0_2_GREEN_UP + p_affine_const_2_2_GREEN_UP;
    const walberla::float32 tmp_coords_jac_8_GREEN_UP =
        jac_affine_1_2_GREEN_UP * jac_affine_2_1_GREEN_UP;
    const walberla::float32 jac_affine_2_2_GREEN_UP =
        -p_affine_const_0_2_GREEN_UP + p_affine_const_3_2_GREEN_UP;
    const walberla::float32 tmp_coords_jac_7_GREEN_UP =
        jac_affine_1_1_GREEN_UP * jac_affine_2_2_GREEN_UP;
    const walberla::float32 tmp_coords_jac_10_GREEN_UP =
        jac_affine_0_1_GREEN_UP * jac_affine_2_2_GREEN_UP;
    const walberla::float32 tmp_coords_jac_12_GREEN_UP =
    ...
    const walberla::float32 tmp_coords_jac_13_GREEN_UP =
        ((walberla::float32)(1.0f / (tmp_coords_jac_12_GREEN_UP)));
    const walberla::float32 jac_affine_inv_0_0_GREEN_UP =
        tmp_coords_jac_13_GREEN_UP *
        (tmp_coords_jac_7_GREEN_UP - tmp_coords_jac_8_GREEN_UP);
    const walberla::float32 jac_affine_inv_0_1_GREEN_UP =
        tmp_coords_jac_13_GREEN_UP *
        (jac_affine_0_2_GREEN_UP * jac_affine_2_1_GREEN_UP -
         tmp_coords_jac_10_GREEN_UP);
    const walberla::float32 jac_affine_inv_0_2_GREEN_UP =
        tmp_coords_jac_13_GREEN_UP *
        (-tmp_coords_jac_11_GREEN_UP + tmp_coords_jac_9_GREEN_UP);
    const walberla::float32 jac_affine_inv_1_0_GREEN_UP =
        tmp_coords_jac_13_GREEN_UP *
        (-jac_affine_1_0_GREEN_UP * jac_affine_2_2_GREEN_UP +
         jac_affine_1_2_GREEN_UP * jac_affine_2_0_GREEN_UP);
    const walberla::float32 jac_affine_inv_1_1_GREEN_UP =
        tmp_coords_jac_13_GREEN_UP *
        (jac_affine_0_0_GREEN_UP * jac_affine_2_2_GREEN_UP -
         jac_affine_0_2_GREEN_UP * jac_affine_2_0_GREEN_UP);
    const walberla::float32 jac_affine_inv_1_2_GREEN_UP =
        tmp_coords_jac_13_GREEN_UP *
        (-jac_affine_0_0_GREEN_UP * jac_affine_1_2_GREEN_UP +
         jac_affine_0_2_GREEN_UP * jac_affine_1_0_GREEN_UP);
    const walberla::float32 jac_affine_inv_2_0_GREEN_UP =
        tmp_coords_jac_13_GREEN_UP *
        (jac_affine_1_0_GREEN_UP * jac_affine_2_1_GREEN_UP -
         jac_affine_1_1_GREEN_UP * jac_affine_2_0_GREEN_UP);
    const walberla::float32 jac_affine_inv_2_1_GREEN_UP =
        tmp_coords_jac_13_GREEN_UP *
        (-jac_affine_0_0_GREEN_UP * jac_affine_2_1_GREEN_UP +
         jac_affine_0_1_GREEN_UP * jac_affine_2_0_GREEN_UP);
    const walberla::float32 jac_affine_inv_2_2_GREEN_UP =
        tmp_coords_jac_13_GREEN_UP *
        (jac_affine_0_0_GREEN_UP * jac_affine_1_1_GREEN_UP -
         jac_affine_0_1_GREEN_UP * jac_affine_1_0_GREEN_UP);
    const walberla::float32 abs_det_jac_affine_GREEN_UP =
        abs(tmp_coords_jac_12_GREEN_UP);
    const walberla::float32 tmp_coords_jac_0_BLUE_DOWN =
        1.0f * ((walberla::float32)(1.0f / (micro_edges_per_macro_edge_float)));
    const walberla::float32 tmp_coords_jac_1_BLUE_DOWN =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_BLUE_DOWN *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0);
    const walberla::float32 tmp_coords_jac_2_BLUE_DOWN =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_BLUE_DOWN *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1);
    const walberla::float32 tmp_coords_jac_3_BLUE_DOWN =
        macro_vertex_coord_id_0comp2 +
        tmp_coords_jac_0_BLUE_DOWN *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_2comp2);
    const walberla::float32 tmp_coords_jac_4_BLUE_DOWN =
        tmp_coords_jac_0_BLUE_DOWN *
        (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_3comp0);
    const walberla::float32 tmp_coords_jac_5_BLUE_DOWN =
        macro_vertex_coord_id_0comp0 + tmp_coords_jac_4_BLUE_DOWN;
    const walberla::float32 tmp_coords_jac_6_BLUE_DOWN =
        tmp_coords_jac_0_BLUE_DOWN *
        (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_3comp1);
    const walberla::float32 tmp_coords_jac_7_BLUE_DOWN =
        macro_vertex_coord_id_0comp1 + tmp_coords_jac_6_BLUE_DOWN;
    const walberla::float32 tmp_coords_jac_8_BLUE_DOWN =
        tmp_coords_jac_0_BLUE_DOWN *
        (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_3comp2);
    const walberla::float32 tmp_coords_jac_9_BLUE_DOWN =
        macro_vertex_coord_id_0comp2 + tmp_coords_jac_8_BLUE_DOWN;
    const walberla::float32 p_affine_const_0_0_BLUE_DOWN =
        tmp_coords_jac_1_BLUE_DOWN;
    const walberla::float32 p_affine_const_0_1_BLUE_DOWN =
        tmp_coords_jac_2_BLUE_DOWN;
    const walberla::float32 p_affine_const_0_2_BLUE_DOWN =
        tmp_coords_jac_3_BLUE_DOWN;
    const walberla::float32 p_affine_const_1_0_BLUE_DOWN =
        tmp_coords_jac_5_BLUE_DOWN;
    const walberla::float32 p_affine_const_1_1_BLUE_DOWN =
        tmp_coords_jac_7_BLUE_DOWN;
    const walberla::float32 p_affine_const_1_2_BLUE_DOWN =
        tmp_coords_jac_9_BLUE_DOWN;
    const walberla::float32 p_affine_const_2_0_BLUE_DOWN =
        tmp_coords_jac_0_BLUE_DOWN *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0) +
        tmp_coords_jac_5_BLUE_DOWN;
    const walberla::float32 p_affine_const_2_1_BLUE_DOWN =
        tmp_coords_jac_0_BLUE_DOWN *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1) +
        tmp_coords_jac_7_BLUE_DOWN;
    const walberla::float32 p_affine_const_2_2_BLUE_DOWN =
        tmp_coords_jac_0_BLUE_DOWN *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_1comp2) +
        tmp_coords_jac_9_BLUE_DOWN;
    const walberla::float32 p_affine_const_3_0_BLUE_DOWN =
        tmp_coords_jac_1_BLUE_DOWN + tmp_coords_jac_4_BLUE_DOWN;
    const walberla::float32 p_affine_const_3_1_BLUE_DOWN =
        tmp_coords_jac_2_BLUE_DOWN + tmp_coords_jac_6_BLUE_DOWN;
    const walberla::float32 p_affine_const_3_2_BLUE_DOWN =
        tmp_coords_jac_3_BLUE_DOWN + tmp_coords_jac_8_BLUE_DOWN;
    const walberla::float32 jac_affine_0_0_BLUE_DOWN =
        -p_affine_const_0_0_BLUE_DOWN + p_affine_const_1_0_BLUE_DOWN;
    const walberla::float32 jac_affine_0_1_BLUE_DOWN =
        -p_affine_const_0_0_BLUE_DOWN + p_affine_const_2_0_BLUE_DOWN;
    const walberla::float32 jac_affine_0_2_BLUE_DOWN =
        -p_affine_const_0_0_BLUE_DOWN + p_affine_const_3_0_BLUE_DOWN;
    const walberla::float32 jac_affine_1_0_BLUE_DOWN =
        -p_affine_const_0_1_BLUE_DOWN + p_affine_const_1_1_BLUE_DOWN;
    const walberla::float32 jac_affine_1_1_BLUE_DOWN =
        -p_affine_const_0_1_BLUE_DOWN + p_affine_const_2_1_BLUE_DOWN;
    const walberla::float32 tmp_coords_jac_14_BLUE_DOWN =
        jac_affine_0_2_BLUE_DOWN * jac_affine_1_1_BLUE_DOWN;
    const walberla::float32 jac_affine_1_2_BLUE_DOWN =
        -p_affine_const_0_1_BLUE_DOWN + p_affine_const_3_1_BLUE_DOWN;
    const walberla::float32 tmp_coords_jac_12_BLUE_DOWN =
        jac_affine_0_1_BLUE_DOWN * jac_affine_1_2_BLUE_DOWN;
    const walberla::float32 jac_affine_2_0_BLUE_DOWN =
        -p_affine_const_0_2_BLUE_DOWN + p_affine_const_1_2_BLUE_DOWN;
    const walberla::float32 jac_affine_2_1_BLUE_DOWN =
        -p_affine_const_0_2_BLUE_DOWN + p_affine_const_2_2_BLUE_DOWN;
    const walberla::float32 tmp_coords_jac_11_BLUE_DOWN =
        jac_affine_1_2_BLUE_DOWN * jac_affine_2_1_BLUE_DOWN;
    const walberla::float32 jac_affine_2_2_BLUE_DOWN =
        -p_affine_const_0_2_BLUE_DOWN + p_affine_const_3_2_BLUE_DOWN;
    const walberla::float32 tmp_coords_jac_10_BLUE_DOWN =
        jac_affine_1_1_BLUE_DOWN * jac_affine_2_2_BLUE_DOWN;
    const walberla::float32 tmp_coords_jac_13_BLUE_DOWN =
        jac_affine_0_1_BLUE_DOWN * jac_affine_2_2_BLUE_DOWN;
    const walberla::float32 tmp_coords_jac_15_BLUE_DOWN =
    ...
    const walberla::float32 tmp_coords_jac_16_BLUE_DOWN =
        ((walberla::float32)(1.0f / (tmp_coords_jac_15_BLUE_DOWN)));
    const walberla::float32 jac_affine_inv_0_0_BLUE_DOWN =
        tmp_coords_jac_16_BLUE_DOWN *
        (tmp_coords_jac_10_BLUE_DOWN - tmp_coords_jac_11_BLUE_DOWN);
    const walberla::float32 jac_affine_inv_0_1_BLUE_DOWN =
        tmp_coords_jac_16_BLUE_DOWN *
        (jac_affine_0_2_BLUE_DOWN * jac_affine_2_1_BLUE_DOWN -
         tmp_coords_jac_13_BLUE_DOWN);
    const walberla::float32 jac_affine_inv_0_2_BLUE_DOWN =
        tmp_coords_jac_16_BLUE_DOWN *
        (tmp_coords_jac_12_BLUE_DOWN - tmp_coords_jac_14_BLUE_DOWN);
    const walberla::float32 jac_affine_inv_1_0_BLUE_DOWN =
        tmp_coords_jac_16_BLUE_DOWN *
        (-jac_affine_1_0_BLUE_DOWN * jac_affine_2_2_BLUE_DOWN +
         jac_affine_1_2_BLUE_DOWN * jac_affine_2_0_BLUE_DOWN);
    const walberla::float32 jac_affine_inv_1_1_BLUE_DOWN =
        tmp_coords_jac_16_BLUE_DOWN *
        (jac_affine_0_0_BLUE_DOWN * jac_affine_2_2_BLUE_DOWN -
         jac_affine_0_2_BLUE_DOWN * jac_affine_2_0_BLUE_DOWN);
    const walberla::float32 jac_affine_inv_1_2_BLUE_DOWN =
        tmp_coords_jac_16_BLUE_DOWN *
        (-jac_affine_0_0_BLUE_DOWN * jac_affine_1_2_BLUE_DOWN +
         jac_affine_0_2_BLUE_DOWN * jac_affine_1_0_BLUE_DOWN);
    const walberla::float32 jac_affine_inv_2_0_BLUE_DOWN =
        tmp_coords_jac_16_BLUE_DOWN *
        (jac_affine_1_0_BLUE_DOWN * jac_affine_2_1_BLUE_DOWN -
         jac_affine_1_1_BLUE_DOWN * jac_affine_2_0_BLUE_DOWN);
    const walberla::float32 jac_affine_inv_2_1_BLUE_DOWN =
        tmp_coords_jac_16_BLUE_DOWN *
        (-jac_affine_0_0_BLUE_DOWN * jac_affine_2_1_BLUE_DOWN +
         jac_affine_0_1_BLUE_DOWN * jac_affine_2_0_BLUE_DOWN);
    const walberla::float32 jac_affine_inv_2_2_BLUE_DOWN =
        tmp_coords_jac_16_BLUE_DOWN *
        (jac_affine_0_0_BLUE_DOWN * jac_affine_1_1_BLUE_DOWN -
         jac_affine_0_1_BLUE_DOWN * jac_affine_1_0_BLUE_DOWN);
    const walberla::float32 abs_det_jac_affine_BLUE_DOWN =
        abs(tmp_coords_jac_15_BLUE_DOWN);
    const walberla::float32 tmp_coords_jac_0_BLUE_UP =
        1.0f * ((walberla::float32)(1.0f / (micro_edges_per_macro_edge_float)));
    const walberla::float32 tmp_coords_jac_1_BLUE_UP =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_BLUE_UP *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0);
    const walberla::float32 tmp_coords_jac_2_BLUE_UP =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_BLUE_UP *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1);
    const walberla::float32 tmp_coords_jac_3_BLUE_UP =
        macro_vertex_coord_id_0comp2 +
        tmp_coords_jac_0_BLUE_UP *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_1comp2);
    const walberla::float32 tmp_coords_jac_4_BLUE_UP =
        tmp_coords_jac_0_BLUE_UP *
        (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0);
    const walberla::float32 tmp_coords_jac_5_BLUE_UP =
        tmp_coords_jac_0_BLUE_UP *
        (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1);
    const walberla::float32 tmp_coords_jac_6_BLUE_UP =
        tmp_coords_jac_0_BLUE_UP *
        (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_2comp2);
    const walberla::float32 p_affine_const_0_0_BLUE_UP =
        tmp_coords_jac_1_BLUE_UP;
    const walberla::float32 p_affine_const_0_1_BLUE_UP =
        tmp_coords_jac_2_BLUE_UP;
    const walberla::float32 p_affine_const_0_2_BLUE_UP =
        tmp_coords_jac_3_BLUE_UP;
    const walberla::float32 p_affine_const_1_0_BLUE_UP =
        macro_vertex_coord_id_0comp0 + tmp_coords_jac_4_BLUE_UP;
    const walberla::float32 p_affine_const_1_1_BLUE_UP =
        macro_vertex_coord_id_0comp1 + tmp_coords_jac_5_BLUE_UP;
    const walberla::float32 p_affine_const_1_2_BLUE_UP =
        macro_vertex_coord_id_0comp2 + tmp_coords_jac_6_BLUE_UP;
    const walberla::float32 p_affine_const_2_0_BLUE_UP =
        tmp_coords_jac_1_BLUE_UP + tmp_coords_jac_4_BLUE_UP;
    const walberla::float32 p_affine_const_2_1_BLUE_UP =
        tmp_coords_jac_2_BLUE_UP + tmp_coords_jac_5_BLUE_UP;
    const walberla::float32 p_affine_const_2_2_BLUE_UP =
        tmp_coords_jac_3_BLUE_UP + tmp_coords_jac_6_BLUE_UP;
    const walberla::float32 p_affine_const_3_0_BLUE_UP =
        tmp_coords_jac_0_BLUE_UP *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_3comp0) +
        tmp_coords_jac_1_BLUE_UP;
    const walberla::float32 p_affine_const_3_1_BLUE_UP =
        tmp_coords_jac_0_BLUE_UP *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_3comp1) +
        tmp_coords_jac_2_BLUE_UP;
    const walberla::float32 p_affine_const_3_2_BLUE_UP =
        tmp_coords_jac_0_BLUE_UP *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_3comp2) +
        tmp_coords_jac_3_BLUE_UP;
    const walberla::float32 jac_affine_0_0_BLUE_UP =
        -p_affine_const_0_0_BLUE_UP + p_affine_const_1_0_BLUE_UP;
    const walberla::float32 jac_affine_0_1_BLUE_UP =
        -p_affine_const_0_0_BLUE_UP + p_affine_const_2_0_BLUE_UP;
    const walberla::float32 jac_affine_0_2_BLUE_UP =
        -p_affine_const_0_0_BLUE_UP + p_affine_const_3_0_BLUE_UP;
    const walberla::float32 jac_affine_1_0_BLUE_UP =
        -p_affine_const_0_1_BLUE_UP + p_affine_const_1_1_BLUE_UP;
    const walberla::float32 jac_affine_1_1_BLUE_UP =
        -p_affine_const_0_1_BLUE_UP + p_affine_const_2_1_BLUE_UP;
    const walberla::float32 tmp_coords_jac_11_BLUE_UP =
        jac_affine_0_2_BLUE_UP * jac_affine_1_1_BLUE_UP;
    const walberla::float32 jac_affine_1_2_BLUE_UP =
        -p_affine_const_0_1_BLUE_UP + p_affine_const_3_1_BLUE_UP;
    const walberla::float32 tmp_coords_jac_9_BLUE_UP =
        jac_affine_0_1_BLUE_UP * jac_affine_1_2_BLUE_UP;
    const walberla::float32 jac_affine_2_0_BLUE_UP =
        -p_affine_const_0_2_BLUE_UP + p_affine_const_1_2_BLUE_UP;
    const walberla::float32 jac_affine_2_1_BLUE_UP =
        -p_affine_const_0_2_BLUE_UP + p_affine_const_2_2_BLUE_UP;
    const walberla::float32 tmp_coords_jac_8_BLUE_UP =
        jac_affine_1_2_BLUE_UP * jac_affine_2_1_BLUE_UP;
    const walberla::float32 jac_affine_2_2_BLUE_UP =
        -p_affine_const_0_2_BLUE_UP + p_affine_const_3_2_BLUE_UP;
    const walberla::float32 tmp_coords_jac_7_BLUE_UP =
        jac_affine_1_1_BLUE_UP * jac_affine_2_2_BLUE_UP;
    const walberla::float32 tmp_coords_jac_10_BLUE_UP =
        jac_affine_0_1_BLUE_UP * jac_affine_2_2_BLUE_UP;
    const walberla::float32 tmp_coords_jac_12_BLUE_UP =
    ...
    const walberla::float32 tmp_coords_jac_13_BLUE_UP =
        ((walberla::float32)(1.0f / (tmp_coords_jac_12_BLUE_UP)));
    const walberla::float32 jac_affine_inv_0_0_BLUE_UP =
        tmp_coords_jac_13_BLUE_UP *
        (tmp_coords_jac_7_BLUE_UP - tmp_coords_jac_8_BLUE_UP);
    const walberla::float32 jac_affine_inv_0_1_BLUE_UP =
        tmp_coords_jac_13_BLUE_UP *
        (jac_affine_0_2_BLUE_UP * jac_affine_2_1_BLUE_UP -
         tmp_coords_jac_10_BLUE_UP);
    const walberla::float32 jac_affine_inv_0_2_BLUE_UP =
        tmp_coords_jac_13_BLUE_UP *
        (-tmp_coords_jac_11_BLUE_UP + tmp_coords_jac_9_BLUE_UP);
    const walberla::float32 jac_affine_inv_1_0_BLUE_UP =
        tmp_coords_jac_13_BLUE_UP *
        (-jac_affine_1_0_BLUE_UP * jac_affine_2_2_BLUE_UP +
         jac_affine_1_2_BLUE_UP * jac_affine_2_0_BLUE_UP);
    const walberla::float32 jac_affine_inv_1_1_BLUE_UP =
        tmp_coords_jac_13_BLUE_UP *
        (jac_affine_0_0_BLUE_UP * jac_affine_2_2_BLUE_UP -
         jac_affine_0_2_BLUE_UP * jac_affine_2_0_BLUE_UP);
    const walberla::float32 jac_affine_inv_1_2_BLUE_UP =
        tmp_coords_jac_13_BLUE_UP *
        (-jac_affine_0_0_BLUE_UP * jac_affine_1_2_BLUE_UP +
         jac_affine_0_2_BLUE_UP * jac_affine_1_0_BLUE_UP);
    const walberla::float32 jac_affine_inv_2_0_BLUE_UP =
        tmp_coords_jac_13_BLUE_UP *
        (jac_affine_1_0_BLUE_UP * jac_affine_2_1_BLUE_UP -
         jac_affine_1_1_BLUE_UP * jac_affine_2_0_BLUE_UP);
    const walberla::float32 jac_affine_inv_2_1_BLUE_UP =
        tmp_coords_jac_13_BLUE_UP *
        (-jac_affine_0_0_BLUE_UP * jac_affine_2_1_BLUE_UP +
         jac_affine_0_1_BLUE_UP * jac_affine_2_0_BLUE_UP);
    const walberla::float32 jac_affine_inv_2_2_BLUE_UP =
        tmp_coords_jac_13_BLUE_UP *
        (jac_affine_0_0_BLUE_UP * jac_affine_1_1_BLUE_UP -
         jac_affine_0_1_BLUE_UP * jac_affine_1_0_BLUE_UP);
    const walberla::float32 abs_det_jac_affine_BLUE_UP =
        abs(tmp_coords_jac_12_BLUE_UP);
    const walberla::float32 tmp_coords_jac_0_WHITE_DOWN =
        1.0f * ((walberla::float32)(1.0f / (micro_edges_per_macro_edge_float)));
    const walberla::float32 tmp_coords_jac_1_WHITE_DOWN =
        tmp_coords_jac_0_WHITE_DOWN *
        (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0);
    const walberla::float32 tmp_coords_jac_2_WHITE_DOWN =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_WHITE_DOWN *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0);
    const walberla::float32 tmp_coords_jac_3_WHITE_DOWN =
        tmp_coords_jac_1_WHITE_DOWN + tmp_coords_jac_2_WHITE_DOWN;
    const walberla::float32 tmp_coords_jac_4_WHITE_DOWN =
        tmp_coords_jac_0_WHITE_DOWN *
        (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1);
    const walberla::float32 tmp_coords_jac_5_WHITE_DOWN =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_WHITE_DOWN *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1);
    const walberla::float32 tmp_coords_jac_6_WHITE_DOWN =
        tmp_coords_jac_4_WHITE_DOWN + tmp_coords_jac_5_WHITE_DOWN;
    const walberla::float32 tmp_coords_jac_7_WHITE_DOWN =
        tmp_coords_jac_0_WHITE_DOWN *
        (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_2comp2);
    const walberla::float32 tmp_coords_jac_8_WHITE_DOWN =
        macro_vertex_coord_id_0comp2 +
        tmp_coords_jac_0_WHITE_DOWN *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_1comp2);
    const walberla::float32 tmp_coords_jac_9_WHITE_DOWN =
        tmp_coords_jac_7_WHITE_DOWN + tmp_coords_jac_8_WHITE_DOWN;
    const walberla::float32 tmp_coords_jac_10_WHITE_DOWN =
        tmp_coords_jac_0_WHITE_DOWN *
        (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_3comp0);
    const walberla::float32 tmp_coords_jac_11_WHITE_DOWN =
        tmp_coords_jac_0_WHITE_DOWN *
        (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_3comp1);
    const walberla::float32 tmp_coords_jac_12_WHITE_DOWN =
        tmp_coords_jac_0_WHITE_DOWN *
        (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_3comp2);
    const walberla::float32 p_affine_const_0_0_WHITE_DOWN =
        tmp_coords_jac_3_WHITE_DOWN;
    const walberla::float32 p_affine_const_0_1_WHITE_DOWN =
        tmp_coords_jac_6_WHITE_DOWN;
    const walberla::float32 p_affine_const_0_2_WHITE_DOWN =
        tmp_coords_jac_9_WHITE_DOWN;
    const walberla::float32 p_affine_const_1_0_WHITE_DOWN =
        tmp_coords_jac_10_WHITE_DOWN + tmp_coords_jac_2_WHITE_DOWN;
    const walberla::float32 p_affine_const_1_1_WHITE_DOWN =
        tmp_coords_jac_11_WHITE_DOWN + tmp_coords_jac_5_WHITE_DOWN;
    const walberla::float32 p_affine_const_1_2_WHITE_DOWN =
        tmp_coords_jac_12_WHITE_DOWN + tmp_coords_jac_8_WHITE_DOWN;
    const walberla::float32 p_affine_const_2_0_WHITE_DOWN =
        macro_vertex_coord_id_0comp0 + tmp_coords_jac_10_WHITE_DOWN +
        tmp_coords_jac_1_WHITE_DOWN;
    const walberla::float32 p_affine_const_2_1_WHITE_DOWN =
        macro_vertex_coord_id_0comp1 + tmp_coords_jac_11_WHITE_DOWN +
        tmp_coords_jac_4_WHITE_DOWN;
    const walberla::float32 p_affine_const_2_2_WHITE_DOWN =
        macro_vertex_coord_id_0comp2 + tmp_coords_jac_12_WHITE_DOWN +
        tmp_coords_jac_7_WHITE_DOWN;
    const walberla::float32 p_affine_const_3_0_WHITE_DOWN =
        tmp_coords_jac_10_WHITE_DOWN + tmp_coords_jac_3_WHITE_DOWN;
    const walberla::float32 p_affine_const_3_1_WHITE_DOWN =
        tmp_coords_jac_11_WHITE_DOWN + tmp_coords_jac_6_WHITE_DOWN;
    const walberla::float32 p_affine_const_3_2_WHITE_DOWN =
        tmp_coords_jac_12_WHITE_DOWN + tmp_coords_jac_9_WHITE_DOWN;
    const walberla::float32 jac_affine_0_0_WHITE_DOWN =
        -p_affine_const_0_0_WHITE_DOWN + p_affine_const_1_0_WHITE_DOWN;
    const walberla::float32 jac_affine_0_1_WHITE_DOWN =
        -p_affine_const_0_0_WHITE_DOWN + p_affine_const_2_0_WHITE_DOWN;
    const walberla::float32 jac_affine_0_2_WHITE_DOWN =
        -p_affine_const_0_0_WHITE_DOWN + p_affine_const_3_0_WHITE_DOWN;
    const walberla::float32 jac_affine_1_0_WHITE_DOWN =
        -p_affine_const_0_1_WHITE_DOWN + p_affine_const_1_1_WHITE_DOWN;
    const walberla::float32 jac_affine_1_1_WHITE_DOWN =
        -p_affine_const_0_1_WHITE_DOWN + p_affine_const_2_1_WHITE_DOWN;
    const walberla::float32 tmp_coords_jac_17_WHITE_DOWN =
        jac_affine_0_2_WHITE_DOWN * jac_affine_1_1_WHITE_DOWN;
    const walberla::float32 jac_affine_1_2_WHITE_DOWN =
        -p_affine_const_0_1_WHITE_DOWN + p_affine_const_3_1_WHITE_DOWN;
    const walberla::float32 tmp_coords_jac_15_WHITE_DOWN =
        jac_affine_0_1_WHITE_DOWN * jac_affine_1_2_WHITE_DOWN;
    const walberla::float32 jac_affine_2_0_WHITE_DOWN =
        -p_affine_const_0_2_WHITE_DOWN + p_affine_const_1_2_WHITE_DOWN;
    const walberla::float32 jac_affine_2_1_WHITE_DOWN =
        -p_affine_const_0_2_WHITE_DOWN + p_affine_const_2_2_WHITE_DOWN;
    const walberla::float32 tmp_coords_jac_14_WHITE_DOWN =
        jac_affine_1_2_WHITE_DOWN * jac_affine_2_1_WHITE_DOWN;
    const walberla::float32 jac_affine_2_2_WHITE_DOWN =
        -p_affine_const_0_2_WHITE_DOWN + p_affine_const_3_2_WHITE_DOWN;
    const walberla::float32 tmp_coords_jac_13_WHITE_DOWN =
        jac_affine_1_1_WHITE_DOWN * jac_affine_2_2_WHITE_DOWN;
    const walberla::float32 tmp_coords_jac_16_WHITE_DOWN =
        jac_affine_0_1_WHITE_DOWN * jac_affine_2_2_WHITE_DOWN;
    const walberla::float32 tmp_coords_jac_18_WHITE_DOWN =
    ...
    const walberla::float32 tmp_coords_jac_19_WHITE_DOWN =
        ((walberla::float32)(1.0f / (tmp_coords_jac_18_WHITE_DOWN)));
    const walberla::float32 jac_affine_inv_0_0_WHITE_DOWN =
        tmp_coords_jac_19_WHITE_DOWN *
        (tmp_coords_jac_13_WHITE_DOWN - tmp_coords_jac_14_WHITE_DOWN);
    const walberla::float32 jac_affine_inv_0_1_WHITE_DOWN =
        tmp_coords_jac_19_WHITE_DOWN *
        (jac_affine_0_2_WHITE_DOWN * jac_affine_2_1_WHITE_DOWN -
         tmp_coords_jac_16_WHITE_DOWN);
    const walberla::float32 jac_affine_inv_0_2_WHITE_DOWN =
        tmp_coords_jac_19_WHITE_DOWN *
        (tmp_coords_jac_15_WHITE_DOWN - tmp_coords_jac_17_WHITE_DOWN);
    const walberla::float32 jac_affine_inv_1_0_WHITE_DOWN =
        tmp_coords_jac_19_WHITE_DOWN *
        (-jac_affine_1_0_WHITE_DOWN * jac_affine_2_2_WHITE_DOWN +
         jac_affine_1_2_WHITE_DOWN * jac_affine_2_0_WHITE_DOWN);
    const walberla::float32 jac_affine_inv_1_1_WHITE_DOWN =
        tmp_coords_jac_19_WHITE_DOWN *
        (jac_affine_0_0_WHITE_DOWN * jac_affine_2_2_WHITE_DOWN -
         jac_affine_0_2_WHITE_DOWN * jac_affine_2_0_WHITE_DOWN);
    const walberla::float32 jac_affine_inv_1_2_WHITE_DOWN =
        tmp_coords_jac_19_WHITE_DOWN *
        (-jac_affine_0_0_WHITE_DOWN * jac_affine_1_2_WHITE_DOWN +
         jac_affine_0_2_WHITE_DOWN * jac_affine_1_0_WHITE_DOWN);
    const walberla::float32 jac_affine_inv_2_0_WHITE_DOWN =
        tmp_coords_jac_19_WHITE_DOWN *
        (jac_affine_1_0_WHITE_DOWN * jac_affine_2_1_WHITE_DOWN -
         jac_affine_1_1_WHITE_DOWN * jac_affine_2_0_WHITE_DOWN);
    const walberla::float32 jac_affine_inv_2_1_WHITE_DOWN =
        tmp_coords_jac_19_WHITE_DOWN *
        (-jac_affine_0_0_WHITE_DOWN * jac_affine_2_1_WHITE_DOWN +
         jac_affine_0_1_WHITE_DOWN * jac_affine_2_0_WHITE_DOWN);
    const walberla::float32 jac_affine_inv_2_2_WHITE_DOWN =
        tmp_coords_jac_19_WHITE_DOWN *
        (jac_affine_0_0_WHITE_DOWN * jac_affine_1_1_WHITE_DOWN -
         jac_affine_0_1_WHITE_DOWN * jac_affine_1_0_WHITE_DOWN);
    const walberla::float32 abs_det_jac_affine_WHITE_DOWN =
        abs(tmp_coords_jac_18_WHITE_DOWN);
    const walberla::float32 tmp_coords_jac_0_WHITE_UP =
        1.0f * ((walberla::float32)(1.0f / (micro_edges_per_macro_edge_float)));
    const walberla::float32 p_affine_const_0_0_WHITE_UP =
        macro_vertex_coord_id_0comp0;
    const walberla::float32 p_affine_const_0_1_WHITE_UP =
        macro_vertex_coord_id_0comp1;
    const walberla::float32 p_affine_const_0_2_WHITE_UP =
        macro_vertex_coord_id_0comp2;
    const walberla::float32 p_affine_const_1_0_WHITE_UP =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_WHITE_UP *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0);
    const walberla::float32 p_affine_const_1_1_WHITE_UP =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_WHITE_UP *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1);
    const walberla::float32 p_affine_const_1_2_WHITE_UP =
        macro_vertex_coord_id_0comp2 +
        tmp_coords_jac_0_WHITE_UP *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_1comp2);
    const walberla::float32 p_affine_const_2_0_WHITE_UP =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_WHITE_UP *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0);
    const walberla::float32 p_affine_const_2_1_WHITE_UP =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_WHITE_UP *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1);
    const walberla::float32 p_affine_const_2_2_WHITE_UP =
        macro_vertex_coord_id_0comp2 +
        tmp_coords_jac_0_WHITE_UP *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_2comp2);
    const walberla::float32 p_affine_const_3_0_WHITE_UP =
        macro_vertex_coord_id_0comp0 +
        tmp_coords_jac_0_WHITE_UP *
            (-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_3comp0);
    const walberla::float32 p_affine_const_3_1_WHITE_UP =
        macro_vertex_coord_id_0comp1 +
        tmp_coords_jac_0_WHITE_UP *
            (-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_3comp1);
    const walberla::float32 p_affine_const_3_2_WHITE_UP =
        macro_vertex_coord_id_0comp2 +
        tmp_coords_jac_0_WHITE_UP *
            (-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_3comp2);
    const walberla::float32 jac_affine_0_0_WHITE_UP =
        -p_affine_const_0_0_WHITE_UP + p_affine_const_1_0_WHITE_UP;
    const walberla::float32 jac_affine_0_1_WHITE_UP =
        -p_affine_const_0_0_WHITE_UP + p_affine_const_2_0_WHITE_UP;
    const walberla::float32 jac_affine_0_2_WHITE_UP =
        -p_affine_const_0_0_WHITE_UP + p_affine_const_3_0_WHITE_UP;
    const walberla::float32 jac_affine_1_0_WHITE_UP =
        -p_affine_const_0_1_WHITE_UP + p_affine_const_1_1_WHITE_UP;
    const walberla::float32 jac_affine_1_1_WHITE_UP =
        -p_affine_const_0_1_WHITE_UP + p_affine_const_2_1_WHITE_UP;
    const walberla::float32 tmp_coords_jac_5_WHITE_UP =
        jac_affine_0_2_WHITE_UP * jac_affine_1_1_WHITE_UP;
    const walberla::float32 jac_affine_1_2_WHITE_UP =
        -p_affine_const_0_1_WHITE_UP + p_affine_const_3_1_WHITE_UP;
    const walberla::float32 tmp_coords_jac_3_WHITE_UP =
        jac_affine_0_1_WHITE_UP * jac_affine_1_2_WHITE_UP;
    const walberla::float32 jac_affine_2_0_WHITE_UP =
        -p_affine_const_0_2_WHITE_UP + p_affine_const_1_2_WHITE_UP;
    const walberla::float32 jac_affine_2_1_WHITE_UP =
        -p_affine_const_0_2_WHITE_UP + p_affine_const_2_2_WHITE_UP;
    const walberla::float32 tmp_coords_jac_2_WHITE_UP =
        jac_affine_1_2_WHITE_UP * jac_affine_2_1_WHITE_UP;
    const walberla::float32 jac_affine_2_2_WHITE_UP =
        -p_affine_const_0_2_WHITE_UP + p_affine_const_3_2_WHITE_UP;
    const walberla::float32 tmp_coords_jac_1_WHITE_UP =
        jac_affine_1_1_WHITE_UP * jac_affine_2_2_WHITE_UP;
    const walberla::float32 tmp_coords_jac_4_WHITE_UP =
        jac_affine_0_1_WHITE_UP * jac_affine_2_2_WHITE_UP;
    const walberla::float32 tmp_coords_jac_6_WHITE_UP =
    ...
    const walberla::float32 tmp_coords_jac_7_WHITE_UP =
        ((walberla::float32)(1.0f / (tmp_coords_jac_6_WHITE_UP)));
    const walberla::float32 jac_affine_inv_0_0_WHITE_UP =
        tmp_coords_jac_7_WHITE_UP *
        (tmp_coords_jac_1_WHITE_UP - tmp_coords_jac_2_WHITE_UP);
    const walberla::float32 jac_affine_inv_0_1_WHITE_UP =
        tmp_coords_jac_7_WHITE_UP *
        (jac_affine_0_2_WHITE_UP * jac_affine_2_1_WHITE_UP -
         tmp_coords_jac_4_WHITE_UP);
    const walberla::float32 jac_affine_inv_0_2_WHITE_UP =
        tmp_coords_jac_7_WHITE_UP *
        (tmp_coords_jac_3_WHITE_UP - tmp_coords_jac_5_WHITE_UP);
    const walberla::float32 jac_affine_inv_1_0_WHITE_UP =
        tmp_coords_jac_7_WHITE_UP *
        (-jac_affine_1_0_WHITE_UP * jac_affine_2_2_WHITE_UP +
         jac_affine_1_2_WHITE_UP * jac_affine_2_0_WHITE_UP);
    const walberla::float32 jac_affine_inv_1_1_WHITE_UP =
        tmp_coords_jac_7_WHITE_UP *
        (jac_affine_0_0_WHITE_UP * jac_affine_2_2_WHITE_UP -
         jac_affine_0_2_WHITE_UP * jac_affine_2_0_WHITE_UP);
    const walberla::float32 jac_affine_inv_1_2_WHITE_UP =
        tmp_coords_jac_7_WHITE_UP *
        (-jac_affine_0_0_WHITE_UP * jac_affine_1_2_WHITE_UP +
         jac_affine_0_2_WHITE_UP * jac_affine_1_0_WHITE_UP);
    const walberla::float32 jac_affine_inv_2_0_WHITE_UP =
        tmp_coords_jac_7_WHITE_UP *
        (jac_affine_1_0_WHITE_UP * jac_affine_2_1_WHITE_UP -
         jac_affine_1_1_WHITE_UP * jac_affine_2_0_WHITE_UP);
    const walberla::float32 jac_affine_inv_2_1_WHITE_UP =
        tmp_coords_jac_7_WHITE_UP *
        (-jac_affine_0_0_WHITE_UP * jac_affine_2_1_WHITE_UP +
         jac_affine_0_1_WHITE_UP * jac_affine_2_0_WHITE_UP);
    const walberla::float32 jac_affine_inv_2_2_WHITE_UP =
        tmp_coords_jac_7_WHITE_UP *
        (jac_affine_0_0_WHITE_UP * jac_affine_1_1_WHITE_UP -
         jac_affine_0_1_WHITE_UP * jac_affine_1_0_WHITE_UP);
    const walberla::float32 abs_det_jac_affine_WHITE_UP =
        abs(tmp_coords_jac_6_WHITE_UP);
    const walberla::float32 tmp_kernel_op_0 = -jac_affine_inv_0_0_WHITE_UP -
                                              jac_affine_inv_1_0_WHITE_UP -
                                              jac_affine_inv_2_0_WHITE_UP;
    const walberla::float32 tmp_kernel_op_1 = -jac_affine_inv_0_1_WHITE_UP -
                                              jac_affine_inv_1_1_WHITE_UP -
                                              jac_affine_inv_2_1_WHITE_UP;
    const walberla::float32 tmp_kernel_op_2 = -jac_affine_inv_0_2_WHITE_UP -
                                              jac_affine_inv_1_2_WHITE_UP -
                                              jac_affine_inv_2_2_WHITE_UP;
    const walberla::float32 tmp_kernel_op_3 =
        abs_det_jac_affine_WHITE_UP * 0.16666666666666663f;
    const walberla::float32 tmp_kernel_op_5 =
    ...
    const walberla::float32 tmp_kernel_op_7 =
    ...
    const walberla::float32 tmp_kernel_op_9 =
    ...
    const walberla::float32 tmp_kernel_op_11 =
    ...
    const walberla::float32 tmp_kernel_op_12 =
    ...
    const walberla::float32 tmp_kernel_op_13 =
    ...
    const walberla::float32 tmp_moved_constant_7 =
        abs_det_jac_affine_WHITE_DOWN * 0.16666666666666663f;
    const walberla::float32 tmp_moved_constant_9 =
    ...
    const walberla::float32 tmp_moved_constant_15 =
        jac_affine_inv_0_0_WHITE_DOWN * jac_affine_inv_1_0_WHITE_DOWN +
        jac_affine_inv_0_1_WHITE_DOWN * jac_affine_inv_1_1_WHITE_DOWN +
        jac_affine_inv_0_2_WHITE_DOWN * jac_affine_inv_1_2_WHITE_DOWN;
    const walberla::float32 tmp_moved_constant_16 =
    ...
    const walberla::float32 tmp_moved_constant_17 =
    ...
    const walberla::float32 tmp_moved_constant_26 =
        -jac_affine_inv_0_0_BLUE_UP - jac_affine_inv_1_0_BLUE_UP -
        jac_affine_inv_2_0_BLUE_UP;
    const walberla::float32 tmp_moved_constant_27 =
        -jac_affine_inv_0_1_BLUE_UP - jac_affine_inv_1_1_BLUE_UP -
        jac_affine_inv_2_1_BLUE_UP;
    const walberla::float32 tmp_moved_constant_28 =
        -jac_affine_inv_0_2_BLUE_UP - jac_affine_inv_1_2_BLUE_UP -
        jac_affine_inv_2_2_BLUE_UP;
    const walberla::float32 tmp_moved_constant_29 =
        abs_det_jac_affine_BLUE_UP * 0.16666666666666663f;
    const walberla::float32 tmp_moved_constant_31 =
    ...
    const walberla::float32 tmp_moved_constant_33 =
    ...
    const walberla::float32 tmp_moved_constant_35 =
    ...
    const walberla::float32 tmp_moved_constant_37 =
        jac_affine_inv_0_0_BLUE_UP * jac_affine_inv_1_0_BLUE_UP +
        jac_affine_inv_0_1_BLUE_UP * jac_affine_inv_1_1_BLUE_UP +
        jac_affine_inv_0_2_BLUE_UP * jac_affine_inv_1_2_BLUE_UP;
    const walberla::float32 tmp_moved_constant_38 =
    ...
    const walberla::float32 tmp_moved_constant_39 =
    ...
    const walberla::float32 tmp_moved_constant_48 =
        -jac_affine_inv_0_0_BLUE_DOWN - jac_affine_inv_1_0_BLUE_DOWN -
        jac_affine_inv_2_0_BLUE_DOWN;
    const walberla::float32 tmp_moved_constant_49 =
        -jac_affine_inv_0_1_BLUE_DOWN - jac_affine_inv_1_1_BLUE_DOWN -
        jac_affine_inv_2_1_BLUE_DOWN;
    const walberla::float32 tmp_moved_constant_50 =
        -jac_affine_inv_0_2_BLUE_DOWN - jac_affine_inv_1_2_BLUE_DOWN -
        jac_affine_inv_2_2_BLUE_DOWN;
    const walberla::float32 tmp_moved_constant_51 =
        abs_det_jac_affine_BLUE_DOWN * 0.16666666666666663f;
    const walberla::float32 tmp_moved_constant_53 =
    ...
    const walberla::float32 tmp_moved_constant_55 =
    ...
    const walberla::float32 tmp_moved_constant_57 =
    ...
    const walberla::float32 tmp_moved_constant_59 =
        jac_affine_inv_0_0_BLUE_DOWN * jac_affine_inv_1_0_BLUE_DOWN +
        jac_affine_inv_0_1_BLUE_DOWN * jac_affine_inv_1_1_BLUE_DOWN +
        jac_affine_inv_0_2_BLUE_DOWN * jac_affine_inv_1_2_BLUE_DOWN;
    const walberla::float32 tmp_moved_constant_60 =
    ...
    const walberla::float32 tmp_moved_constant_61 =
    ...
    const walberla::float32 tmp_moved_constant_70 =
        -jac_affine_inv_0_0_GREEN_UP - jac_affine_inv_1_0_GREEN_UP -
        jac_affine_inv_2_0_GREEN_UP;
    const walberla::float32 tmp_moved_constant_71 =
        -jac_affine_inv_0_1_GREEN_UP - jac_affine_inv_1_1_GREEN_UP -
        jac_affine_inv_2_1_GREEN_UP;
    const walberla::float32 tmp_moved_constant_72 =
        -jac_affine_inv_0_2_GREEN_UP - jac_affine_inv_1_2_GREEN_UP -
        jac_affine_inv_2_2_GREEN_UP;
    const walberla::float32 tmp_moved_constant_73 =
        abs_det_jac_affine_GREEN_UP * 0.16666666666666663f;
    const walberla::float32 tmp_moved_constant_75 =
    ...
    const walberla::float32 tmp_moved_constant_77 =
    ...
    const walberla::float32 tmp_moved_constant_79 =
    ...
    const walberla::float32 tmp_moved_constant_81 =
        jac_affine_inv_0_0_GREEN_UP * jac_affine_inv_1_0_GREEN_UP +
        jac_affine_inv_0_1_GREEN_UP * jac_affine_inv_1_1_GREEN_UP +
        jac_affine_inv_0_2_GREEN_UP * jac_affine_inv_1_2_GREEN_UP;
    const walberla::float32 tmp_moved_constant_82 =
    ...
    const walberla::float32 tmp_moved_constant_83 =
    ...
    const walberla::float32 tmp_moved_constant_92 =
        -jac_affine_inv_0_0_GREEN_DOWN - jac_affine_inv_1_0_GREEN_DOWN -
        jac_affine_inv_2_0_GREEN_DOWN;
    const walberla::float32 tmp_moved_constant_93 =
        -jac_affine_inv_0_1_GREEN_DOWN - jac_affine_inv_1_1_GREEN_DOWN -
        jac_affine_inv_2_1_GREEN_DOWN;
    const walberla::float32 tmp_moved_constant_94 =
        -jac_affine_inv_0_2_GREEN_DOWN - jac_affine_inv_1_2_GREEN_DOWN -
        jac_affine_inv_2_2_GREEN_DOWN;
    const walberla::float32 tmp_moved_constant_95 =
        abs_det_jac_affine_GREEN_DOWN * 0.16666666666666663f;
    const walberla::float32 tmp_moved_constant_97 =
    ...
    const walberla::float32 tmp_moved_constant_99 =
    ...
    const walberla::float32 tmp_moved_constant_101 =
    ...
    const walberla::float32 tmp_moved_constant_103 =
        jac_affine_inv_0_0_GREEN_DOWN * jac_affine_inv_1_0_GREEN_DOWN +
        jac_affine_inv_0_1_GREEN_DOWN * jac_affine_inv_1_1_GREEN_DOWN +
        jac_affine_inv_0_2_GREEN_DOWN * jac_affine_inv_1_2_GREEN_DOWN;
    const walberla::float32 tmp_moved_constant_104 =
    ...
    const walberla::float32 tmp_moved_constant_105 =
      ...
      for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge;
        ...
        for (int64_t ctr_0 = 0;
          ...
          const walberla::float32 src_dof_2 =
              _data_src[ctr_0 +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                          ...
                          (-ctr_2 + micro_edges_per_macro_edge + 3)) /
                         (6))];
          const walberla::float32 src_dof_3 =
              _data_src[ctr_0 +
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                          ...
                          (micro_edges_per_macro_edge + 3)) /
                         (6))];
          const walberla::float32 tmp_kernel_op_4 = src_dof_0 * tmp_kernel_op_3;
          const walberla::float32 tmp_kernel_op_6 = src_dof_1 * tmp_kernel_op_3;
          const walberla::float32 tmp_kernel_op_8 = src_dof_2 * tmp_kernel_op_3;
          const walberla::float32 tmp_kernel_op_10 =
          ...
          const walberla::float32 elMatVec_0 =
              ...
              tmp_kernel_op_4 *
                  (((walberla::float32)((tmp_kernel_op_0 * tmp_kernel_op_0))) +
                   ((walberla::float32)((tmp_kernel_op_1 * tmp_kernel_op_1))) +
                   ((walberla::float32)((tmp_kernel_op_2 * tmp_kernel_op_2)))) +
          ...
          const walberla::float32 elMatVec_1 =
              ...
              tmp_kernel_op_4 * tmp_kernel_op_5 +
              tmp_kernel_op_6 *
                  (((walberla::float32)((jac_affine_inv_0_0_WHITE_UP *
                                         jac_affine_inv_0_0_WHITE_UP))) +
                   ((walberla::float32)((jac_affine_inv_0_1_WHITE_UP *
                                         jac_affine_inv_0_1_WHITE_UP))) +
                   ((walberla::float32)((jac_affine_inv_0_2_WHITE_UP *
          ...
          const walberla::float32 elMatVec_2 =
              ...
              tmp_kernel_op_8 *
                  (((walberla::float32)((jac_affine_inv_1_0_WHITE_UP *
                                         jac_affine_inv_1_0_WHITE_UP))) +
                   ((walberla::float32)((jac_affine_inv_1_1_WHITE_UP *
                                         jac_affine_inv_1_1_WHITE_UP))) +
                   ((walberla::float32)((jac_affine_inv_1_2_WHITE_UP *
                                         jac_affine_inv_1_2_WHITE_UP))));
          const walberla::float32 elMatVec_3 =
              tmp_kernel_op_10 *
                  (((walberla::float32)((jac_affine_inv_2_0_WHITE_UP *
                                         jac_affine_inv_2_0_WHITE_UP))) +
                   ((walberla::float32)((jac_affine_inv_2_1_WHITE_UP *
                                         jac_affine_inv_2_1_WHITE_UP))) +
                   ((walberla::float32)((jac_affine_inv_2_2_WHITE_UP *
                                         jac_affine_inv_2_2_WHITE_UP)))) +
          ...
          const walberla::float32 tmp_moved_constant_18 =
              tmp_moved_constant_10 * tmp_moved_constant_9 +
          ...
          const walberla::float32 tmp_moved_constant_19 =
              tmp_moved_constant_10 *
                  (((walberla::float32)((jac_affine_inv_0_0_WHITE_DOWN *
                                         jac_affine_inv_0_0_WHITE_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_0_1_WHITE_DOWN *
                                         jac_affine_inv_0_1_WHITE_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_0_2_WHITE_DOWN *
          ...
          const walberla::float32 tmp_moved_constant_20 =
              tmp_moved_constant_10 * tmp_moved_constant_15 +
              tmp_moved_constant_11 * tmp_moved_constant_8 +
              tmp_moved_constant_12 *
                  (((walberla::float32)((jac_affine_inv_1_0_WHITE_DOWN *
                                         jac_affine_inv_1_0_WHITE_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_1_1_WHITE_DOWN *
                                         jac_affine_inv_1_1_WHITE_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_1_2_WHITE_DOWN *
                                         jac_affine_inv_1_2_WHITE_DOWN)))) +
              tmp_moved_constant_14 * tmp_moved_constant_17;
          const walberla::float32 tmp_moved_constant_21 =
              ...
              tmp_moved_constant_14 *
                  (((walberla::float32)((jac_affine_inv_2_0_WHITE_DOWN *
                                         jac_affine_inv_2_0_WHITE_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_2_1_WHITE_DOWN *
                                         jac_affine_inv_2_1_WHITE_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_2_2_WHITE_DOWN *
                                         jac_affine_inv_2_2_WHITE_DOWN))));
          {
            {
              _data_dst[ctr_0 +
          ...
          const walberla::float32 tmp_moved_constant_22 =
              _data_src[ctr_0 +
                        ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) +
                        (((micro_edges_per_macro_edge + 1) *
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) +
                        1];
          const walberla::float32 tmp_moved_constant_23 =
              _data_src[ctr_0 +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                          ...
                          (-ctr_2 + micro_edges_per_macro_edge + 3)) /
                         (6))];
          const walberla::float32 tmp_moved_constant_24 =
              _data_src[ctr_0 +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) +
                        1];
          const walberla::float32 tmp_moved_constant_25 =
              _data_src[ctr_0 +
                        ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) +
                        1];
          const walberla::float32 tmp_moved_constant_30 =
              tmp_moved_constant_22 * tmp_moved_constant_29;
          const walberla::float32 tmp_moved_constant_32 =
              tmp_moved_constant_23 * tmp_moved_constant_29;
          const walberla::float32 tmp_moved_constant_34 =
              tmp_moved_constant_24 * tmp_moved_constant_29;
          const walberla::float32 tmp_moved_constant_36 =
              tmp_moved_constant_25 * tmp_moved_constant_29;
          const walberla::float32 tmp_moved_constant_40 =
          ...
          const walberla::float32 tmp_moved_constant_43 =
              ...
              tmp_moved_constant_36 *
                  (((walberla::float32)((jac_affine_inv_2_0_BLUE_UP *
                                         jac_affine_inv_2_0_BLUE_UP))) +
                   ((walberla::float32)((jac_affine_inv_2_1_BLUE_UP *
                                         jac_affine_inv_2_1_BLUE_UP))) +
                   ((walberla::float32)((jac_affine_inv_2_2_BLUE_UP *
                                         jac_affine_inv_2_2_BLUE_UP))));
          {
            {
              _data_dst[ctr_0 +
          ...
          const walberla::float32 tmp_moved_constant_44 =
              _data_src[ctr_0 +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                          ...
                          (-ctr_2 + micro_edges_per_macro_edge + 3)) /
                         (6))];
          const walberla::float32 tmp_moved_constant_45 =
              _data_src[ctr_0 +
                        ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                          ...
                          (micro_edges_per_macro_edge + 3)) /
                         (6))];
          const walberla::float32 tmp_moved_constant_46 =
              _data_src[ctr_0 +
                        ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) +
                        1];
          const walberla::float32 tmp_moved_constant_47 =
              _data_src[ctr_0 +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) -
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                          ...
                          (micro_edges_per_macro_edge + 3)) /
                         (6))];
          const walberla::float32 tmp_moved_constant_52 =
              tmp_moved_constant_44 * tmp_moved_constant_51;
          const walberla::float32 tmp_moved_constant_54 =
              tmp_moved_constant_45 * tmp_moved_constant_51;
          const walberla::float32 tmp_moved_constant_56 =
              tmp_moved_constant_46 * tmp_moved_constant_51;
          const walberla::float32 tmp_moved_constant_58 =
              tmp_moved_constant_47 * tmp_moved_constant_51;
          const walberla::float32 tmp_moved_constant_62 =
          ...
          const walberla::float32 tmp_moved_constant_65 =
              ...
              tmp_moved_constant_58 *
                  (((walberla::float32)((jac_affine_inv_2_0_BLUE_DOWN *
                                         jac_affine_inv_2_0_BLUE_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_2_1_BLUE_DOWN *
                                         jac_affine_inv_2_1_BLUE_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_2_2_BLUE_DOWN *
                                         jac_affine_inv_2_2_BLUE_DOWN))));
          {
            {
              _data_dst[ctr_0 +
          ...
          const walberla::float32 tmp_moved_constant_66 =
              _data_src[ctr_0 +
                        ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) +
                        (((micro_edges_per_macro_edge + 1) *
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) +
                        1];
          const walberla::float32 tmp_moved_constant_67 =
              _data_src[ctr_0 +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                          ...
                          (-ctr_2 + micro_edges_per_macro_edge + 3)) /
                         (6))];
          const walberla::float32 tmp_moved_constant_68 =
              _data_src[ctr_0 +
                        ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                          ...
                          (micro_edges_per_macro_edge + 3)) /
                         (6))];
          const walberla::float32 tmp_moved_constant_69 =
              _data_src[ctr_0 +
                        ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) +
                        1];
          const walberla::float32 tmp_moved_constant_74 =
              tmp_moved_constant_66 * tmp_moved_constant_73;
          const walberla::float32 tmp_moved_constant_76 =
              tmp_moved_constant_67 * tmp_moved_constant_73;
          const walberla::float32 tmp_moved_constant_78 =
              tmp_moved_constant_68 * tmp_moved_constant_73;
          const walberla::float32 tmp_moved_constant_80 =
              tmp_moved_constant_69 * tmp_moved_constant_73;
          const walberla::float32 tmp_moved_constant_84 =
          ...
          const walberla::float32 tmp_moved_constant_87 =
              ...
              tmp_moved_constant_80 *
                  (((walberla::float32)((jac_affine_inv_2_0_GREEN_UP *
                                         jac_affine_inv_2_0_GREEN_UP))) +
                   ((walberla::float32)((jac_affine_inv_2_1_GREEN_UP *
                                         jac_affine_inv_2_1_GREEN_UP))) +
                   ((walberla::float32)((jac_affine_inv_2_2_GREEN_UP *
                                         jac_affine_inv_2_2_GREEN_UP))));
          {
            {
              _data_dst[ctr_0 +
          ...
          const walberla::float32 tmp_moved_constant_88 =
              _data_src[ctr_0 +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                          ...
                          (-ctr_2 + micro_edges_per_macro_edge + 3)) /
                         (6))];
          const walberla::float32 tmp_moved_constant_89 =
              _data_src[ctr_0 +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) +
                        1];
          const walberla::float32 tmp_moved_constant_90 =
              _data_src[ctr_0 +
                        ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) +
                        1];
          const walberla::float32 tmp_moved_constant_91 =
              _data_src[ctr_0 +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) -
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                          ...
                          (micro_edges_per_macro_edge + 3)) /
                         (6))];
          const walberla::float32 tmp_moved_constant_96 =
              tmp_moved_constant_88 * tmp_moved_constant_95;
          const walberla::float32 tmp_moved_constant_98 =
              tmp_moved_constant_89 * tmp_moved_constant_95;
          const walberla::float32 tmp_moved_constant_100 =
              tmp_moved_constant_90 * tmp_moved_constant_95;
          const walberla::float32 tmp_moved_constant_102 =
              tmp_moved_constant_91 * tmp_moved_constant_95;
          const walberla::float32 tmp_moved_constant_106 =
          ...
          const walberla::float32 tmp_moved_constant_107 =
              ...
              tmp_moved_constant_98 *
                  (((walberla::float32)((jac_affine_inv_0_0_GREEN_DOWN *
                                         jac_affine_inv_0_0_GREEN_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_0_1_GREEN_DOWN *
                                         jac_affine_inv_0_1_GREEN_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_0_2_GREEN_DOWN *
                                         jac_affine_inv_0_2_GREEN_DOWN))));
          const walberla::float32 tmp_moved_constant_108 =
              tmp_moved_constant_100 *
                  (((walberla::float32)((jac_affine_inv_1_0_GREEN_DOWN *
                                         jac_affine_inv_1_0_GREEN_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_1_1_GREEN_DOWN *
                                         jac_affine_inv_1_1_GREEN_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_1_2_GREEN_DOWN *
          ...
          const walberla::float32 tmp_moved_constant_109 =
              tmp_moved_constant_100 * tmp_moved_constant_105 +
              tmp_moved_constant_101 * tmp_moved_constant_96 +
              tmp_moved_constant_102 *
                  (((walberla::float32)((jac_affine_inv_2_0_GREEN_DOWN *
                                         jac_affine_inv_2_0_GREEN_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_2_1_GREEN_DOWN *
                                         jac_affine_inv_2_1_GREEN_DOWN))) +
                   ((walberla::float32)((jac_affine_inv_2_2_GREEN_DOWN *
                                         jac_affine_inv_2_2_GREEN_DOWN)))) +
        ...
        if (-ctr_1 - ctr_2 + micro_edges_per_macro_edge - 2 >= 0) {
          ...
          const walberla::float32 tmp_kernel_op_1 =
              -jac_affine_inv_0_1_WHITE_UP - jac_affine_inv_1_1_WHITE_UP -
              jac_affine_inv_2_1_WHITE_UP;
          const walberla::float32 tmp_kernel_op_2 =
              -jac_affine_inv_0_2_WHITE_UP - jac_affine_inv_1_2_WHITE_UP -
              jac_affine_inv_2_2_WHITE_UP;
          const walberla::float32 tmp_kernel_op_3 =
              abs_det_jac_affine_WHITE_UP * 0.16666666666666663f;
          ...
          const walberla::float32 tmp_moved_constant_110 =
              _data_src[ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        ctr_1 - ctr_2 + micro_edges_per_macro_edge -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) +
                        (((micro_edges_per_macro_edge + 1) *
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        1];
          const walberla::float32 tmp_moved_constant_111 =
              _data_src[-ctr_1 - ctr_2 + micro_edges_per_macro_edge +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        2];
          const walberla::float32 tmp_moved_constant_112 =
              _data_src[-ctr_1 - ctr_2 + micro_edges_per_macro_edge +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        1];
          const walberla::float32 tmp_moved_constant_113 =
              _data_src[ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ctr_1 - ctr_2 + micro_edges_per_macro_edge -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        1];
          const walberla::float32 tmp_moved_constant_114 =
              -jac_affine_inv_0_0_BLUE_UP - jac_affine_inv_1_0_BLUE_UP -
              jac_affine_inv_2_0_BLUE_UP;
          const walberla::float32 tmp_moved_constant_115 =
              -jac_affine_inv_0_1_BLUE_UP - jac_affine_inv_1_1_BLUE_UP -
              jac_affine_inv_2_1_BLUE_UP;
          const walberla::float32 tmp_moved_constant_116 =
              -jac_affine_inv_0_2_BLUE_UP - jac_affine_inv_1_2_BLUE_UP -
              jac_affine_inv_2_2_BLUE_UP;
          const walberla::float32 tmp_moved_constant_117 =
              abs_det_jac_affine_BLUE_UP * 0.16666666666666663f;
          const walberla::float32 tmp_moved_constant_118 =
              tmp_moved_constant_110 * tmp_moved_constant_117;
          const walberla::float32 tmp_moved_constant_119 =
          ...
          const walberla::float32 tmp_moved_constant_120 =
              tmp_moved_constant_111 * tmp_moved_constant_117;
          const walberla::float32 tmp_moved_constant_121 =
          ...
          const walberla::float32 tmp_moved_constant_122 =
              tmp_moved_constant_112 * tmp_moved_constant_117;
          const walberla::float32 tmp_moved_constant_123 =
          ...
          const walberla::float32 tmp_moved_constant_124 =
              tmp_moved_constant_113 * tmp_moved_constant_117;
          const walberla::float32 tmp_moved_constant_125 =
              jac_affine_inv_0_0_BLUE_UP * jac_affine_inv_1_0_BLUE_UP +
              jac_affine_inv_0_1_BLUE_UP * jac_affine_inv_1_1_BLUE_UP +
              jac_affine_inv_0_2_BLUE_UP * jac_affine_inv_1_2_BLUE_UP;
          const walberla::float32 tmp_moved_constant_126 =
              jac_affine_inv_0_0_BLUE_UP * jac_affine_inv_2_0_BLUE_UP +
              jac_affine_inv_0_1_BLUE_UP * jac_affine_inv_2_1_BLUE_UP +
              jac_affine_inv_0_2_BLUE_UP * jac_affine_inv_2_2_BLUE_UP;
          const walberla::float32 tmp_moved_constant_127 =
              jac_affine_inv_1_0_BLUE_UP * jac_affine_inv_2_0_BLUE_UP +
              jac_affine_inv_1_1_BLUE_UP * jac_affine_inv_2_1_BLUE_UP +
              jac_affine_inv_1_2_BLUE_UP * jac_affine_inv_2_2_BLUE_UP;
          const walberla::float32 tmp_moved_constant_128 =
          ...
          const walberla::float32 tmp_moved_constant_129 =
          ...
          const walberla::float32 tmp_moved_constant_130 =
          ...
          const walberla::float32 tmp_moved_constant_131 =
          ...
          const walberla::float32 tmp_moved_constant_132 =
              _data_src[-ctr_1 - ctr_2 + micro_edges_per_macro_edge +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        2];
          const walberla::float32 tmp_moved_constant_133 =
              _data_src[ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ctr_1 - ctr_2 + micro_edges_per_macro_edge -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        2];
          const walberla::float32 tmp_moved_constant_134 =
              _data_src[ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ctr_1 - ctr_2 + micro_edges_per_macro_edge -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        1];
          const walberla::float32 tmp_moved_constant_135 =
              _data_src[-ctr_1 - ctr_2 + micro_edges_per_macro_edge +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) -
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        2];
          const walberla::float32 tmp_moved_constant_136 =
              -jac_affine_inv_0_0_BLUE_DOWN - jac_affine_inv_1_0_BLUE_DOWN -
              jac_affine_inv_2_0_BLUE_DOWN;
          const walberla::float32 tmp_moved_constant_137 =
              -jac_affine_inv_0_1_BLUE_DOWN - jac_affine_inv_1_1_BLUE_DOWN -
              jac_affine_inv_2_1_BLUE_DOWN;
          const walberla::float32 tmp_moved_constant_138 =
              -jac_affine_inv_0_2_BLUE_DOWN - jac_affine_inv_1_2_BLUE_DOWN -
              jac_affine_inv_2_2_BLUE_DOWN;
          const walberla::float32 tmp_moved_constant_139 =
              abs_det_jac_affine_BLUE_DOWN * 0.16666666666666663f;
          const walberla::float32 tmp_moved_constant_140 =
              tmp_moved_constant_132 * tmp_moved_constant_139;
          const walberla::float32 tmp_moved_constant_141 =
          ...
          const walberla::float32 tmp_moved_constant_142 =
              tmp_moved_constant_133 * tmp_moved_constant_139;
          const walberla::float32 tmp_moved_constant_143 =
          ...
          const walberla::float32 tmp_moved_constant_144 =
              tmp_moved_constant_134 * tmp_moved_constant_139;
          const walberla::float32 tmp_moved_constant_145 =
          ...
          const walberla::float32 tmp_moved_constant_146 =
              tmp_moved_constant_135 * tmp_moved_constant_139;
          const walberla::float32 tmp_moved_constant_147 =
              jac_affine_inv_0_0_BLUE_DOWN * jac_affine_inv_1_0_BLUE_DOWN +
              jac_affine_inv_0_1_BLUE_DOWN * jac_affine_inv_1_1_BLUE_DOWN +
              jac_affine_inv_0_2_BLUE_DOWN * jac_affine_inv_1_2_BLUE_DOWN;
          const walberla::float32 tmp_moved_constant_148 =
              jac_affine_inv_0_0_BLUE_DOWN * jac_affine_inv_2_0_BLUE_DOWN +
              jac_affine_inv_0_1_BLUE_DOWN * jac_affine_inv_2_1_BLUE_DOWN +
              jac_affine_inv_0_2_BLUE_DOWN * jac_affine_inv_2_2_BLUE_DOWN;
          const walberla::float32 tmp_moved_constant_149 =
              jac_affine_inv_1_0_BLUE_DOWN * jac_affine_inv_2_0_BLUE_DOWN +
              jac_affine_inv_1_1_BLUE_DOWN * jac_affine_inv_2_1_BLUE_DOWN +
              jac_affine_inv_1_2_BLUE_DOWN * jac_affine_inv_2_2_BLUE_DOWN;
          const walberla::float32 tmp_moved_constant_150 =
          ...
          const walberla::float32 tmp_moved_constant_151 =
          ...
          const walberla::float32 tmp_moved_constant_152 =
          ...
          const walberla::float32 tmp_moved_constant_153 =
          ...
          const walberla::float32 tmp_moved_constant_154 =
              _data_src[ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        ctr_1 - ctr_2 + micro_edges_per_macro_edge -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) +
                        (((micro_edges_per_macro_edge + 1) *
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        1];
          const walberla::float32 tmp_moved_constant_155 =
              _data_src[-ctr_1 - ctr_2 + micro_edges_per_macro_edge +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        2];
          const walberla::float32 tmp_moved_constant_156 =
              _data_src[ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ctr_1 - ctr_2 + micro_edges_per_macro_edge -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        2];
          const walberla::float32 tmp_moved_constant_157 =
              _data_src[ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ctr_1 - ctr_2 + micro_edges_per_macro_edge -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        1];
          const walberla::float32 tmp_moved_constant_158 =
              -jac_affine_inv_0_0_GREEN_UP - jac_affine_inv_1_0_GREEN_UP -
              jac_affine_inv_2_0_GREEN_UP;
          const walberla::float32 tmp_moved_constant_159 =
              -jac_affine_inv_0_1_GREEN_UP - jac_affine_inv_1_1_GREEN_UP -
              jac_affine_inv_2_1_GREEN_UP;
          const walberla::float32 tmp_moved_constant_160 =
              -jac_affine_inv_0_2_GREEN_UP - jac_affine_inv_1_2_GREEN_UP -
              jac_affine_inv_2_2_GREEN_UP;
          const walberla::float32 tmp_moved_constant_161 =
              abs_det_jac_affine_GREEN_UP * 0.16666666666666663f;
          const walberla::float32 tmp_moved_constant_162 =
              tmp_moved_constant_154 * tmp_moved_constant_161;
          const walberla::float32 tmp_moved_constant_163 =
          ...
          const walberla::float32 tmp_moved_constant_164 =
              tmp_moved_constant_155 * tmp_moved_constant_161;
          const walberla::float32 tmp_moved_constant_165 =
          ...
          const walberla::float32 tmp_moved_constant_166 =
              tmp_moved_constant_156 * tmp_moved_constant_161;
          const walberla::float32 tmp_moved_constant_167 =
          ...
          const walberla::float32 tmp_moved_constant_168 =
              tmp_moved_constant_157 * tmp_moved_constant_161;
          const walberla::float32 tmp_moved_constant_169 =
              jac_affine_inv_0_0_GREEN_UP * jac_affine_inv_1_0_GREEN_UP +
              jac_affine_inv_0_1_GREEN_UP * jac_affine_inv_1_1_GREEN_UP +
              jac_affine_inv_0_2_GREEN_UP * jac_affine_inv_1_2_GREEN_UP;
          const walberla::float32 tmp_moved_constant_170 =
              jac_affine_inv_0_0_GREEN_UP * jac_affine_inv_2_0_GREEN_UP +
              jac_affine_inv_0_1_GREEN_UP * jac_affine_inv_2_1_GREEN_UP +
              jac_affine_inv_0_2_GREEN_UP * jac_affine_inv_2_2_GREEN_UP;
          const walberla::float32 tmp_moved_constant_171 =
              jac_affine_inv_1_0_GREEN_UP * jac_affine_inv_2_0_GREEN_UP +
              jac_affine_inv_1_1_GREEN_UP * jac_affine_inv_2_1_GREEN_UP +
              jac_affine_inv_1_2_GREEN_UP * jac_affine_inv_2_2_GREEN_UP;
          const walberla::float32 tmp_moved_constant_172 =
          ...
          const walberla::float32 tmp_moved_constant_173 =
          ...
          const walberla::float32 tmp_moved_constant_174 =
          ...
          const walberla::float32 tmp_moved_constant_175 =
          ...
          const walberla::float32 tmp_moved_constant_176 =
              _data_src[-ctr_1 - ctr_2 + micro_edges_per_macro_edge +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        2];
          const walberla::float32 tmp_moved_constant_177 =
              _data_src[-ctr_1 - ctr_2 + micro_edges_per_macro_edge +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 2) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) +
                        ...
                        (((-ctr_2 + micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        1];
          const walberla::float32 tmp_moved_constant_178 =
              _data_src[ctr_1 * (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        ctr_1 - ctr_2 + micro_edges_per_macro_edge -
                        ((ctr_1 * (ctr_1 + 1)) / (2)) -
                        (((-ctr_2 + micro_edges_per_macro_edge) *
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        1];
          const walberla::float32 tmp_moved_constant_179 =
              _data_src[-ctr_1 - ctr_2 + micro_edges_per_macro_edge +
                        (ctr_1 + 1) *
                            (-ctr_2 + micro_edges_per_macro_edge + 1) -
                        (((ctr_1 + 1) * (ctr_1 + 2)) / (2)) -
                        ...
                        (((micro_edges_per_macro_edge + 1) *
                         ...
                         (6)) -
                        2];
          const walberla::float32 tmp_moved_constant_180 =
              -jac_affine_inv_0_0_GREEN_DOWN - jac_affine_inv_1_0_GREEN_DOWN -
              jac_affine_inv_2_0_GREEN_DOWN;
          const walberla::float32 tmp_moved_constant_181 =
              -jac_affine_inv_0_1_GREEN_DOWN - jac_affine_inv_1_1_GREEN_DOWN -
              jac_affine_inv_2_1_GREEN_DOWN;
          const walberla::float32 tmp_moved_constant_182 =
              -jac_affine_inv_0_2_GREEN_DOWN - jac_affine_inv_1_2_GREEN_DOWN -
              jac_affine_inv_2_2_GREEN_DOWN;
          const walberla::float32 tmp_moved_constant_183 =
              abs_det_jac_affine_GREEN_DOWN * 0.16666666666666663f;
          const walberla::float32 tmp_moved_constant_184 =
              tmp_moved_constant_176 * tmp_moved_constant_183;
          const walberla::float32 tmp_moved_constant_185 =
          ...
          const walberla::float32 tmp_moved_constant_186 =
              tmp_moved_constant_177 * tmp_moved_constant_183;
          const walberla::float32 tmp_moved_constant_187 =
          ...
          const walberla::float32 tmp_moved_constant_188 =
              tmp_moved_constant_178 * tmp_moved_constant_183;
          const walberla::float32 tmp_moved_constant_189 =
          ...
          const walberla::float32 tmp_moved_constant_190 =
              tmp_moved_constant_179 * tmp_moved_constant_183;
          const walberla::float32 tmp_moved_constant_191 =
              jac_affine_inv_0_0_GREEN_DOWN * jac_affine_inv_1_0_GREEN_DOWN +
              jac_affine_inv_0_1_GREEN_DOWN * jac_affine_inv_1_1_GREEN_DOWN +
              jac_affine_inv_0_2_GREEN_DOWN * jac_affine_inv_1_2_GREEN_DOWN;
          const walberla::float32 tmp_moved_constant_192 =
              jac_affine_inv_0_0_GREEN_DOWN * jac_affine_inv_2_0_GREEN_DOWN +
              jac_affine_inv_0_1_GREEN_DOWN * jac_affine_inv_2_1_GREEN_DOWN +
              jac_affine_inv_0_2_GREEN_DOWN * jac_affine_inv_2_2_GREEN_DOWN;
          const walberla::float32 tmp_moved_constant_193 =
              jac_affine_inv_1_0_GREEN_DOWN * jac_affine_inv_2_0_GREEN_DOWN +
              jac_affine_inv_1_1_GREEN_DOWN * jac_affine_inv_2_1_GREEN_DOWN +
              jac_affine_inv_1_2_GREEN_DOWN * jac_affine_inv_2_2_GREEN_DOWN;
          const walberla::float32 tmp_moved_constant_194 =
          ...
          const walberla::float32 tmp_moved_constant_195 =
          ...
          const walberla::float32 tmp_moved_constant_196 =
          ...
          const walberla::float32 tmp_moved_constant_197 =
        ...
        const walberla::float32 tmp_kernel_op_6 = src_dof_1 * tmp_kernel_op_3;
        const walberla::float32 tmp_kernel_op_8 = src_dof_2 * tmp_kernel_op_3;
        const walberla::float32 tmp_kernel_op_10 = src_dof_3 * tmp_kernel_op_3;
        const walberla::float32 elMatVec_0 =
            tmp_kernel_op_10 * tmp_kernel_op_9 +
            tmp_kernel_op_4 *
                (((walberla::float32)((tmp_kernel_op_0 * tmp_kernel_op_0))) +
...
void P1ElementwiseDiffusion_cubes_const_float32::toMatrix_macro_2D(
    ...
    walberla::float32 micro_edges_per_macro_edge_float) const {
  {
    ...
    const walberla::float32 tmp_kernel_op_5 =
        tmp_kernel_op_2 * (jac_affine_inv_0_0_GRAY * jac_affine_inv_1_0_GRAY +
                           jac_affine_inv_0_1_GRAY * jac_affine_inv_1_1_GRAY);
    const walberla::float32 elMat_0_0 =
        tmp_kernel_op_2 *
        (((walberla::float32)((tmp_kernel_op_0 * tmp_kernel_op_0))) +
         ((walberla::float32)((tmp_kernel_op_1 * tmp_kernel_op_1))));
    const walberla::float32 elMat_0_1 = tmp_kernel_op_3;
    const walberla::float32 elMat_0_2 = tmp_kernel_op_4;
    const walberla::float32 elMat_1_0 = tmp_kernel_op_3;
    const walberla::float32 elMat_1_1 =
        tmp_kernel_op_2 * (((walberla::float32)((jac_affine_inv_0_0_GRAY *
                                                 jac_affine_inv_0_0_GRAY))) +
                           ((walberla::float32)((jac_affine_inv_0_1_GRAY *
                                                 jac_affine_inv_0_1_GRAY))));
    const walberla::float32 elMat_1_2 = tmp_kernel_op_5;
    const walberla::float32 elMat_2_0 = tmp_kernel_op_4;
    const walberla::float32 elMat_2_1 = tmp_kernel_op_5;
    const walberla::float32 elMat_2_2 =
        tmp_kernel_op_2 * (((walberla::float32)((jac_affine_inv_1_0_GRAY *
                                                 jac_affine_inv_1_0_GRAY))) +
                           ((walberla::float32)((jac_affine_inv_1_1_GRAY *
                                                 jac_affine_inv_1_1_GRAY))));
    const walberla::float32 tmp_moved_constant_0 =
    ...
    const walberla::float32 tmp_moved_constant_6 =
        tmp_moved_constant_2 *
        (((walberla::float32)((tmp_moved_constant_0 * tmp_moved_constant_0))) +
         ((walberla::float32)((tmp_moved_constant_1 * tmp_moved_constant_1))));
    const walberla::float32 tmp_moved_constant_7 = tmp_moved_constant_3;
    const walberla::float32 tmp_moved_constant_8 = tmp_moved_constant_4;
    const walberla::float32 tmp_moved_constant_9 = tmp_moved_constant_3;
    const walberla::float32 tmp_moved_constant_10 =
        tmp_moved_constant_2 *
        (((walberla::float32)(
             (jac_affine_inv_0_0_BLUE * jac_affine_inv_0_0_BLUE))) +
         ((walberla::float32)(
             (jac_affine_inv_0_1_BLUE * jac_affine_inv_0_1_BLUE))));
    const walberla::float32 tmp_moved_constant_11 = tmp_moved_constant_5;
    const walberla::float32 tmp_moved_constant_12 = tmp_moved_constant_4;
    const walberla::float32 tmp_moved_constant_13 = tmp_moved_constant_5;
    const walberla::float32 tmp_moved_constant_14 =
        tmp_moved_constant_2 *
        (((walberla::float32)(
             (jac_affine_inv_1_0_BLUE * jac_affine_inv_1_0_BLUE))) +
...
void P1ElementwiseDiffusion_cubes_const_float32::toMatrix_macro_3D(
    idx_t *RESTRICT _data_dst, idx_t *RESTRICT _data_src,
    walberla::float32 macro_vertex_coord_id_0comp0,
    walberla::float32 macro_vertex_coord_id_0comp1,
    walberla::float32 macro_vertex_coord_id_0comp2,
    ...
    walberla::float32 micro_edges_per_macro_edge_float) const {
  {
    ...
    const walberla::float32 elMat_0_0 =
        ...
        (((walberla::float32)((tmp_kernel_op_0 * tmp_kernel_op_0))) +
         ((walberla::float32)((tmp_kernel_op_1 * tmp_kernel_op_1))) +
         ((walberla::float32)((tmp_kernel_op_2 * tmp_kernel_op_2))));
    const walberla::float32 elMat_0_1 = tmp_kernel_op_4;
    const walberla::float32 elMat_0_2 = tmp_kernel_op_5;
    const walberla::float32 elMat_0_3 = tmp_kernel_op_6;
    const walberla::float32 elMat_1_0 = tmp_kernel_op_4;
    const walberla::float32 elMat_1_1 =
        tmp_kernel_op_3 *
        (((walberla::float32)(
    ...
    const walberla::float32 elMat_1_2 = tmp_kernel_op_7;
    const walberla::float32 elMat_1_3 = tmp_kernel_op_8;
    const walberla::float32 elMat_2_0 = tmp_kernel_op_5;
    const walberla::float32 elMat_2_1 = tmp_kernel_op_7;
    const walberla::float32 elMat_2_2 =
        tmp_kernel_op_3 *
        (((walberla::float32)(
    ...
    const walberla::float32 elMat_2_3 = tmp_kernel_op_9;
    const walberla::float32 elMat_3_0 = tmp_kernel_op_6;
    const walberla::float32 elMat_3_1 = tmp_kernel_op_8;
    const walberla::float32 elMat_3_2 = tmp_kernel_op_9;
    const walberla::float32 elMat_3_3 =
        tmp_kernel_op_3 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_10 =
        ...
        (((walberla::float32)((tmp_moved_constant_0 * tmp_moved_constant_0))) +
         ((walberla::float32)((tmp_moved_constant_1 * tmp_moved_constant_1))) +
         ((walberla::float32)((tmp_moved_constant_2 * tmp_moved_constant_2))));
    const walberla::float32 tmp_moved_constant_11 = tmp_moved_constant_4;
    const walberla::float32 tmp_moved_constant_12 = tmp_moved_constant_5;
    const walberla::float32 tmp_moved_constant_13 = tmp_moved_constant_6;
    const walberla::float32 tmp_moved_constant_14 = tmp_moved_constant_4;
    const walberla::float32 tmp_moved_constant_15 =
        tmp_moved_constant_3 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_16 = tmp_moved_constant_7;
    const walberla::float32 tmp_moved_constant_17 = tmp_moved_constant_8;
    const walberla::float32 tmp_moved_constant_18 = tmp_moved_constant_5;
    const walberla::float32 tmp_moved_constant_19 = tmp_moved_constant_7;
    const walberla::float32 tmp_moved_constant_20 =
        tmp_moved_constant_3 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_21 = tmp_moved_constant_9;
    const walberla::float32 tmp_moved_constant_22 = tmp_moved_constant_6;
    const walberla::float32 tmp_moved_constant_23 = tmp_moved_constant_8;
    const walberla::float32 tmp_moved_constant_24 = tmp_moved_constant_9;
    const walberla::float32 tmp_moved_constant_25 =
        tmp_moved_constant_3 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_36 =
        ...
        (((walberla::float32)(
         ...
         ((walberla::float32)(
             (tmp_moved_constant_28 * tmp_moved_constant_28))));
    const walberla::float32 tmp_moved_constant_37 = tmp_moved_constant_30;
    const walberla::float32 tmp_moved_constant_38 = tmp_moved_constant_31;
    const walberla::float32 tmp_moved_constant_39 = tmp_moved_constant_32;
    const walberla::float32 tmp_moved_constant_40 = tmp_moved_constant_30;
    const walberla::float32 tmp_moved_constant_41 =
        tmp_moved_constant_29 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_42 = tmp_moved_constant_33;
    const walberla::float32 tmp_moved_constant_43 = tmp_moved_constant_34;
    const walberla::float32 tmp_moved_constant_44 = tmp_moved_constant_31;
    const walberla::float32 tmp_moved_constant_45 = tmp_moved_constant_33;
    const walberla::float32 tmp_moved_constant_46 =
        tmp_moved_constant_29 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_47 = tmp_moved_constant_35;
    const walberla::float32 tmp_moved_constant_48 = tmp_moved_constant_32;
    const walberla::float32 tmp_moved_constant_49 = tmp_moved_constant_34;
    const walberla::float32 tmp_moved_constant_50 = tmp_moved_constant_35;
    const walberla::float32 tmp_moved_constant_51 =
        tmp_moved_constant_29 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_63 = tmp_moved_constant_56;
    const walberla::float32 tmp_moved_constant_64 = tmp_moved_constant_57;
    const walberla::float32 tmp_moved_constant_65 = tmp_moved_constant_58;
    const walberla::float32 tmp_moved_constant_66 = tmp_moved_constant_56;
    const walberla::float32 tmp_moved_constant_67 =
        tmp_moved_constant_55 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_68 = tmp_moved_constant_59;
    const walberla::float32 tmp_moved_constant_69 = tmp_moved_constant_60;
    const walberla::float32 tmp_moved_constant_70 = tmp_moved_constant_57;
    const walberla::float32 tmp_moved_constant_71 = tmp_moved_constant_59;
    const walberla::float32 tmp_moved_constant_72 =
        tmp_moved_constant_55 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_73 = tmp_moved_constant_61;
    const walberla::float32 tmp_moved_constant_74 = tmp_moved_constant_58;
    const walberla::float32 tmp_moved_constant_75 = tmp_moved_constant_60;
    const walberla::float32 tmp_moved_constant_76 = tmp_moved_constant_61;
    const walberla::float32 tmp_moved_constant_77 =
        tmp_moved_constant_55 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_89 = tmp_moved_constant_82;
    const walberla::float32 tmp_moved_constant_90 = tmp_moved_constant_83;
    const walberla::float32 tmp_moved_constant_91 = tmp_moved_constant_84;
    const walberla::float32 tmp_moved_constant_92 = tmp_moved_constant_82;
    const walberla::float32 tmp_moved_constant_93 =
        tmp_moved_constant_81 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_94 = tmp_moved_constant_85;
    const walberla::float32 tmp_moved_constant_95 = tmp_moved_constant_86;
    const walberla::float32 tmp_moved_constant_96 = tmp_moved_constant_83;
    const walberla::float32 tmp_moved_constant_97 = tmp_moved_constant_85;
    const walberla::float32 tmp_moved_constant_98 =
        tmp_moved_constant_81 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_99 = tmp_moved_constant_87;
    const walberla::float32 tmp_moved_constant_100 = tmp_moved_constant_84;
    const walberla::float32 tmp_moved_constant_101 = tmp_moved_constant_86;
    const walberla::float32 tmp_moved_constant_102 = tmp_moved_constant_87;
    const walberla::float32 tmp_moved_constant_103 =
        tmp_moved_constant_81 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_115 = tmp_moved_constant_108;
    const walberla::float32 tmp_moved_constant_116 = tmp_moved_constant_109;
    const walberla::float32 tmp_moved_constant_117 = tmp_moved_constant_110;
    const walberla::float32 tmp_moved_constant_118 = tmp_moved_constant_108;
    const walberla::float32 tmp_moved_constant_119 =
        tmp_moved_constant_107 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_120 = tmp_moved_constant_111;
    const walberla::float32 tmp_moved_constant_121 = tmp_moved_constant_112;
    const walberla::float32 tmp_moved_constant_122 = tmp_moved_constant_109;
    const walberla::float32 tmp_moved_constant_123 = tmp_moved_constant_111;
    const walberla::float32 tmp_moved_constant_124 =
        tmp_moved_constant_107 *
        (((walberla::float32)(
    ...
    const walberla::float32 tmp_moved_constant_125 = tmp_moved_constant_113;
    const walberla::float32 tmp_moved_constant_126 = tmp_moved_constant_110;
    const walberla::float32 tmp_moved_constant_127 = tmp_moved_constant_112;
    const walberla::float32 tmp_moved_constant_128 = tmp_moved_constant_113;
    const walberla::float32 tmp_moved_constant_129 =
        tmp_moved_constant_107 *
        (((walberla::float32)(
...
if (-ctr_1 - ctr_2 + micro_edges_per_macro_edge - 2 >= 0) {
  ...
  const walberla::float32 elMat_1_0 = tmp_kernel_op_4;
  const walberla::float32 elMat_1_1 =
      tmp_kernel_op_3 * (((walberla::float32)((jac_affine_inv_0_0_WHITE_UP *
                                               jac_affine_inv_0_0_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_0_1_WHITE_UP *
                                               jac_affine_inv_0_1_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_0_2_WHITE_UP *
  ...
  const walberla::float32 elMat_2_1 = tmp_kernel_op_7;
  const walberla::float32 elMat_2_2 =
      tmp_kernel_op_3 * (((walberla::float32)((jac_affine_inv_1_0_WHITE_UP *
                                               jac_affine_inv_1_0_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_1_1_WHITE_UP *
                                               jac_affine_inv_1_1_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_1_2_WHITE_UP *
  ...
  const walberla::float32 elMat_3_2 = tmp_kernel_op_9;
  const walberla::float32 elMat_3_3 =
      tmp_kernel_op_3 * (((walberla::float32)((jac_affine_inv_2_0_WHITE_UP *
                                               jac_affine_inv_2_0_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_2_1_WHITE_UP *
                                               jac_affine_inv_2_1_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_2_2_WHITE_UP *
  ...
  const walberla::float32 tmp_moved_constant_130 = -jac_affine_inv_0_0_BLUE_UP -
                                                   jac_affine_inv_1_0_BLUE_UP -
                                                   jac_affine_inv_2_0_BLUE_UP;
  const walberla::float32 tmp_moved_constant_131 = -jac_affine_inv_0_1_BLUE_UP -
                                                   jac_affine_inv_1_1_BLUE_UP -
                                                   jac_affine_inv_2_1_BLUE_UP;
  const walberla::float32 tmp_moved_constant_132 = -jac_affine_inv_0_2_BLUE_UP -
                                                   jac_affine_inv_1_2_BLUE_UP -
                                                   jac_affine_inv_2_2_BLUE_UP;
  const walberla::float32 tmp_moved_constant_133 =
      abs_det_jac_affine_BLUE_UP * 0.16666666666666663f;
  ...
  const walberla::float32 tmp_moved_constant_141 = tmp_moved_constant_134;
  const walberla::float32 tmp_moved_constant_142 = tmp_moved_constant_135;
  const walberla::float32 tmp_moved_constant_143 = tmp_moved_constant_136;
  const walberla::float32 tmp_moved_constant_144 = tmp_moved_constant_134;
  const walberla::float32 tmp_moved_constant_145 =
      tmp_moved_constant_133 *
      (((walberla::float32)(
           (jac_affine_inv_0_0_BLUE_UP * jac_affine_inv_0_0_BLUE_UP))) +
       ...
       ((walberla::float32)(
           (jac_affine_inv_0_2_BLUE_UP * jac_affine_inv_0_2_BLUE_UP))));
  const walberla::float32 tmp_moved_constant_146 = tmp_moved_constant_137;
  const walberla::float32 tmp_moved_constant_147 = tmp_moved_constant_138;
  const walberla::float32 tmp_moved_constant_148 = tmp_moved_constant_135;
  const walberla::float32 tmp_moved_constant_149 = tmp_moved_constant_137;
  const walberla::float32 tmp_moved_constant_150 =
      tmp_moved_constant_133 *
      (((walberla::float32)(
           (jac_affine_inv_1_0_BLUE_UP * jac_affine_inv_1_0_BLUE_UP))) +
       ...
       ((walberla::float32)(
           (jac_affine_inv_1_2_BLUE_UP * jac_affine_inv_1_2_BLUE_UP))));
  const walberla::float32 tmp_moved_constant_151 = tmp_moved_constant_139;
  const walberla::float32 tmp_moved_constant_152 = tmp_moved_constant_136;
  const walberla::float32 tmp_moved_constant_153 = tmp_moved_constant_138;
  const walberla::float32 tmp_moved_constant_154 = tmp_moved_constant_139;
  const walberla::float32 tmp_moved_constant_155 =
      tmp_moved_constant_133 *
      (((walberla::float32)(
           (jac_affine_inv_2_0_BLUE_UP * jac_affine_inv_2_0_BLUE_UP))) +
  ...
  const walberla::float32 tmp_moved_constant_166 =
      ...
      (((walberla::float32)(
       ...
       ((walberla::float32)(
           (tmp_moved_constant_158 * tmp_moved_constant_158))));
  const walberla::float32 tmp_moved_constant_167 = tmp_moved_constant_160;
  const walberla::float32 tmp_moved_constant_168 = tmp_moved_constant_161;
  const walberla::float32 tmp_moved_constant_169 = tmp_moved_constant_162;
  const walberla::float32 tmp_moved_constant_170 = tmp_moved_constant_160;
  const walberla::float32 tmp_moved_constant_171 =
      tmp_moved_constant_159 *
      (((walberla::float32)(
           (jac_affine_inv_0_0_BLUE_DOWN * jac_affine_inv_0_0_BLUE_DOWN))) +
       ...
       ((walberla::float32)(
           (jac_affine_inv_0_2_BLUE_DOWN * jac_affine_inv_0_2_BLUE_DOWN))));
  const walberla::float32 tmp_moved_constant_172 = tmp_moved_constant_163;
  const walberla::float32 tmp_moved_constant_173 = tmp_moved_constant_164;
  const walberla::float32 tmp_moved_constant_174 = tmp_moved_constant_161;
  const walberla::float32 tmp_moved_constant_175 = tmp_moved_constant_163;
  const walberla::float32 tmp_moved_constant_176 =
      tmp_moved_constant_159 *
      (((walberla::float32)(
           (jac_affine_inv_1_0_BLUE_DOWN * jac_affine_inv_1_0_BLUE_DOWN))) +
       ...
       ((walberla::float32)(
           (jac_affine_inv_1_2_BLUE_DOWN * jac_affine_inv_1_2_BLUE_DOWN))));
  const walberla::float32 tmp_moved_constant_177 = tmp_moved_constant_165;
  const walberla::float32 tmp_moved_constant_178 = tmp_moved_constant_162;
  const walberla::float32 tmp_moved_constant_179 = tmp_moved_constant_164;
  const walberla::float32 tmp_moved_constant_180 = tmp_moved_constant_165;
  const walberla::float32 tmp_moved_constant_181 =
      tmp_moved_constant_159 *
      (((walberla::float32)(
           (jac_affine_inv_2_0_BLUE_DOWN * jac_affine_inv_2_0_BLUE_DOWN))) +
  ...
  const walberla::float32 tmp_moved_constant_193 = tmp_moved_constant_186;
  const walberla::float32 tmp_moved_constant_194 = tmp_moved_constant_187;
  const walberla::float32 tmp_moved_constant_195 = tmp_moved_constant_188;
  const walberla::float32 tmp_moved_constant_196 = tmp_moved_constant_186;
  const walberla::float32 tmp_moved_constant_197 =
      tmp_moved_constant_185 *
      (((walberla::float32)(
           (jac_affine_inv_0_0_GREEN_UP * jac_affine_inv_0_0_GREEN_UP))) +
       ...
       ((walberla::float32)(
           (jac_affine_inv_0_2_GREEN_UP * jac_affine_inv_0_2_GREEN_UP))));
  const walberla::float32 tmp_moved_constant_198 = tmp_moved_constant_189;
  const walberla::float32 tmp_moved_constant_199 = tmp_moved_constant_190;
  const walberla::float32 tmp_moved_constant_200 = tmp_moved_constant_187;
  const walberla::float32 tmp_moved_constant_201 = tmp_moved_constant_189;
  const walberla::float32 tmp_moved_constant_202 =
      tmp_moved_constant_185 *
      (((walberla::float32)(
           (jac_affine_inv_1_0_GREEN_UP * jac_affine_inv_1_0_GREEN_UP))) +
       ((walberla::float32)(
       ...
       ((walberla::float32)(
           (jac_affine_inv_1_2_GREEN_UP * jac_affine_inv_1_2_GREEN_UP))));
  const walberla::float32 tmp_moved_constant_203 = tmp_moved_constant_191;
  const walberla::float32 tmp_moved_constant_204 = tmp_moved_constant_188;
  const walberla::float32 tmp_moved_constant_205 = tmp_moved_constant_190;
  const walberla::float32 tmp_moved_constant_206 = tmp_moved_constant_191;
  const walberla::float32 tmp_moved_constant_207 =
      tmp_moved_constant_185 *
      (((walberla::float32)(
           (jac_affine_inv_2_0_GREEN_UP * jac_affine_inv_2_0_GREEN_UP))) +
       ((walberla::float32)(
  ...
  const walberla::float32 tmp_moved_constant_208 =
      -jac_affine_inv_0_0_GREEN_DOWN - jac_affine_inv_1_0_GREEN_DOWN -
      jac_affine_inv_2_0_GREEN_DOWN;
  const walberla::float32 tmp_moved_constant_209 =
      -jac_affine_inv_0_1_GREEN_DOWN - jac_affine_inv_1_1_GREEN_DOWN -
      jac_affine_inv_2_1_GREEN_DOWN;
  const walberla::float32 tmp_moved_constant_210 =
      -jac_affine_inv_0_2_GREEN_DOWN - jac_affine_inv_1_2_GREEN_DOWN -
      jac_affine_inv_2_2_GREEN_DOWN;
  const walberla::float32 tmp_moved_constant_211 =
      abs_det_jac_affine_GREEN_DOWN * 0.16666666666666663f;
  const walberla::float32 tmp_moved_constant_212 =
  ...
  const walberla::float32 tmp_moved_constant_213 =
      tmp_moved_constant_211 *
  ...
  const walberla::float32 tmp_moved_constant_214 =
      tmp_moved_constant_211 *
  ...
  const walberla::float32 tmp_moved_constant_215 =
      tmp_moved_constant_211 *
      (jac_affine_inv_0_0_GREEN_DOWN * jac_affine_inv_1_0_GREEN_DOWN +
       jac_affine_inv_0_1_GREEN_DOWN * jac_affine_inv_1_1_GREEN_DOWN +
       jac_affine_inv_0_2_GREEN_DOWN * jac_affine_inv_1_2_GREEN_DOWN);
  const walberla::float32 tmp_moved_constant_216 =
      tmp_moved_constant_211 *
      (jac_affine_inv_0_0_GREEN_DOWN * jac_affine_inv_2_0_GREEN_DOWN +
       jac_affine_inv_0_1_GREEN_DOWN * jac_affine_inv_2_1_GREEN_DOWN +
       jac_affine_inv_0_2_GREEN_DOWN * jac_affine_inv_2_2_GREEN_DOWN);
  const walberla::float32 tmp_moved_constant_217 =
      tmp_moved_constant_211 *
      (jac_affine_inv_1_0_GREEN_DOWN * jac_affine_inv_2_0_GREEN_DOWN +
       jac_affine_inv_1_1_GREEN_DOWN * jac_affine_inv_2_1_GREEN_DOWN +
       jac_affine_inv_1_2_GREEN_DOWN * jac_affine_inv_2_2_GREEN_DOWN);
  const walberla::float32 tmp_moved_constant_218 =
      tmp_moved_constant_211 *
      (((walberla::float32)(
  ...
  const walberla::float32 tmp_moved_constant_219 = tmp_moved_constant_212;
  const walberla::float32 tmp_moved_constant_220 = tmp_moved_constant_213;
  const walberla::float32 tmp_moved_constant_221 = tmp_moved_constant_214;
  const walberla::float32 tmp_moved_constant_222 = tmp_moved_constant_212;
  const walberla::float32 tmp_moved_constant_223 =
      tmp_moved_constant_211 *
      (((walberla::float32)(
           (jac_affine_inv_0_0_GREEN_DOWN * jac_affine_inv_0_0_GREEN_DOWN))) +
       ((walberla::float32)(
       ...
       ((walberla::float32)(
           (jac_affine_inv_0_2_GREEN_DOWN * jac_affine_inv_0_2_GREEN_DOWN))));
  const walberla::float32 tmp_moved_constant_224 = tmp_moved_constant_215;
  const walberla::float32 tmp_moved_constant_225 = tmp_moved_constant_216;
  const walberla::float32 tmp_moved_constant_226 = tmp_moved_constant_213;
  const walberla::float32 tmp_moved_constant_227 = tmp_moved_constant_215;
  const walberla::float32 tmp_moved_constant_228 =
      tmp_moved_constant_211 *
      (((walberla::float32)(
           (jac_affine_inv_1_0_GREEN_DOWN * jac_affine_inv_1_0_GREEN_DOWN))) +
       ((walberla::float32)(
       ...
       ((walberla::float32)(
           (jac_affine_inv_1_2_GREEN_DOWN * jac_affine_inv_1_2_GREEN_DOWN))));
  const walberla::float32 tmp_moved_constant_229 = tmp_moved_constant_217;
  const walberla::float32 tmp_moved_constant_230 = tmp_moved_constant_214;
  const walberla::float32 tmp_moved_constant_231 = tmp_moved_constant_216;
  const walberla::float32 tmp_moved_constant_232 = tmp_moved_constant_217;
  const walberla::float32 tmp_moved_constant_233 =
      tmp_moved_constant_211 *
      (((walberla::float32)(
           (jac_affine_inv_2_0_GREEN_DOWN * jac_affine_inv_2_0_GREEN_DOWN))) +
       ((walberla::float32)(
...
void P1ElementwiseDiffusion_cubes_const_float32::
    computeInverseDiagonalOperatorValues_macro_2D(
        walberla::float32 *RESTRICT _data_invDiag_,
        walberla::float32 macro_vertex_coord_id_0comp0,
        walberla::float32 macro_vertex_coord_id_0comp1,
        walberla::float32 macro_vertex_coord_id_1comp0,
        walberla::float32 macro_vertex_coord_id_1comp1,
        ...
        walberla::float32 micro_edges_per_macro_edge_float) const {
  {
    ...
    const walberla::float32 abs_det_jac_affine_GRAY =
        abs(tmp_coords_jac_1_GRAY);
    const walberla::float32 tmp_kernel_op_0 = abs_det_jac_affine_GRAY * 0.5f;
    const walberla::float32 elMatDiag_0 =
        tmp_kernel_op_0 *
        (((walberla::float32)(
             ((-jac_affine_inv_0_0_GRAY - jac_affine_inv_1_0_GRAY) *
              (-jac_affine_inv_0_0_GRAY - jac_affine_inv_1_0_GRAY)))) +
         ((walberla::float32)(
             ((-jac_affine_inv_0_1_GRAY - jac_affine_inv_1_1_GRAY) *
              (-jac_affine_inv_0_1_GRAY - jac_affine_inv_1_1_GRAY)))));
    const walberla::float32 elMatDiag_1 =
        tmp_kernel_op_0 * (((walberla::float32)((jac_affine_inv_0_0_GRAY *
                                                 jac_affine_inv_0_0_GRAY))) +
                           ((walberla::float32)((jac_affine_inv_0_1_GRAY *
                                                 jac_affine_inv_0_1_GRAY))));
    const walberla::float32 elMatDiag_2 =
        tmp_kernel_op_0 * (((walberla::float32)((jac_affine_inv_1_0_GRAY *
                                                 jac_affine_inv_1_0_GRAY))) +
                           ((walberla::float32)((jac_affine_inv_1_1_GRAY *
                                                 jac_affine_inv_1_1_GRAY))));
    const walberla::float32 tmp_moved_constant_0 =
        ...
        walberla::float32 micro_edges_per_macro_edge_float) const {
  {
    ...
    const walberla::float32 elMatDiag_2 =
        ...
        (((walberla::float32)(
         ...
         ((walberla::float32)(
             (jac_affine_inv_1_2_WHITE_UP * jac_affine_inv_1_2_WHITE_UP))));
    const walberla::float32 elMatDiag_3 =
        tmp_kernel_op_0 *
        (((walberla::float32)(
             (jac_affine_inv_2_0_WHITE_UP * jac_affine_inv_2_0_WHITE_UP))) +
         ((walberla::float32)(
       ...
       ((walberla::float32)(
           ((-jac_affine_inv_0_2_WHITE_UP - jac_affine_inv_1_2_WHITE_UP -
            ...
            (-jac_affine_inv_0_2_WHITE_UP - jac_affine_inv_1_2_WHITE_UP -
             jac_affine_inv_2_2_WHITE_UP)))));
  const walberla::float32 elMatDiag_1 =
      tmp_kernel_op_0 * (((walberla::float32)((jac_affine_inv_0_0_WHITE_UP *
                                               jac_affine_inv_0_0_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_0_1_WHITE_UP *
                                               jac_affine_inv_0_1_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_0_2_WHITE_UP *
                                               jac_affine_inv_0_2_WHITE_UP))));
  const walberla::float32 elMatDiag_2 =
      tmp_kernel_op_0 * (((walberla::float32)((jac_affine_inv_1_0_WHITE_UP *
                                               jac_affine_inv_1_0_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_1_1_WHITE_UP *
                                               jac_affine_inv_1_1_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_1_2_WHITE_UP *
                                               jac_affine_inv_1_2_WHITE_UP))));
  const walberla::float32 elMatDiag_3 =
      tmp_kernel_op_0 * (((walberla::float32)((jac_affine_inv_2_0_WHITE_UP *
                                               jac_affine_inv_2_0_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_2_1_WHITE_UP *
                                               jac_affine_inv_2_1_WHITE_UP))) +
                         ((walberla::float32)((jac_affine_inv_2_2_WHITE_UP *
