...
class P1ElementwiseDiffusion_cubes_const_float16
    : public Operator<P1Function<walberla::float16>,
                      P1Function<walberla::float16>>,
      public OperatorWithInverseDiagonal<P1Function<walberla::float16>> {
public:
  P1ElementwiseDiffusion_cubes_const_float16(
      const std::shared_ptr<PrimitiveStorage> &storage, size_t minLevel,
      size_t maxLevel);

  void apply(const P1Function<walberla::float16> &src,
             const P1Function<walberla::float16> &dst, uint_t level,
...
private:
  ...
  /// -------------
  ///     17      25       0       0      0              0                 0 0
  void apply_macro_2D(walberla::float16 *RESTRICT _data_dst,
  ...
  /// -------------
  ///     42      51       0       0      0              0                 0 0
  void apply_macro_3D(walberla::float16 *RESTRICT _data_dst,
                      walberla::float16 *RESTRICT _data_src,
                      walberla::float16 macro_vertex_coord_id_0comp0,
                      walberla::float16 macro_vertex_coord_id_0comp1,
  ...
  std::shared_ptr<P1Function<walberla::float16>> invDiag_;
};
