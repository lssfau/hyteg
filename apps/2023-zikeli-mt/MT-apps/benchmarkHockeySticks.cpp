...
int main( int argc, char* argv[] )
{
   ...
   { // Float32 and Float64
      const SetupType config = {
          ...
          .stoppingCriteria          = hyteg::mixedPrecisionMT::setupMasks::Iterations |
                              hyteg::mixedPrecisionMT::setupMasks::ResidualRate | hyteg::mixedPrecisionMT::setupMasks::ErrorRate,
